...
function mouseovershow1(pid, type) {
    var divid = document.getElementById("divQuickAdd" + pid);
    if (divid != null && divid != undefined) {
        if (type == "g") {
            document.getElementById("DivDesc" + pid).setAttribute("style", "height:26px;");
        }
        showThisDiv1(divid);
    }
}
...
function mouseOutHidediv1(pid, type) {
    var divid = document.getElementById("divQuickAdd" + pid);
    if (divid != null && divid != undefined) {
        if (type == "g") {
            document.getElementById("DivDesc" + pid).setAttribute("style", "height:46px;");
        }
        HideThisDiv1(divid);
    }
...
function QuickAddItemCart(PriceCatelogueID, ProductType, CookieID, ChangedProductId) {
    ...
    if (hdnDrawStockFrom != null && hdnDrawStockFrom != undefined && hdnDrawStockFrom.value.toLowerCase().trim() == "x" &&
        hdnIsStockItem != null && hdnIsStockItem != undefined && hdnIsStockItem.value.toLowerCase() == "true") {
        ...
        for (var i = 0; i < arrQtyFrom.length - 1; i++) {
            if (ProductType == "p") {// for price band type price 
            ...
            else if (ProductType == "g") {// for price band type price 
                if (QtySelectedProduct != '' && Number(QtySelectedProduct)) {
            ...
            else {// for simplematrix type price
        ...
        AutoFill.QuickItemAdd(PriceCatelogueID, QtySelectedProduct, QuantityPrice, CartTax, StoreUserID, TaxRate, TaxID, UnitPrice, mainPriceExcMarkup, ProductName, CookieID, Height, Width, ChangedProductId, MainProductId, ReturnQuickCartAdded);
    }
}
...
function ChnageProduct(PriceCatalogueID) {
    ...
    $.ajax({
        ...
        url: strSitePath + "LoginMethods.aspx/LoadQuantity",
...
function BindQuantity(data) {
    ...
    var NewhdncookieId = "hdncookieId" + ProductID;
    var hdncookieId = document.getElementById("hdncookieId" + PriceCatalogueID).id = NewhdncookieId;
    hdncookieId = document.getElementById(NewhdncookieId); //.id = NewhdncookieId;

    var NewDivDesc = "DivDesc" + ProductID;
    var DivDesc = document.getElementById("DivDesc" + PriceCatalogueID).id = NewDivDesc;
    NewDivDesc = document.getElementById(NewDivDesc);
    ...
    var NewdivmainHover = "divmainHover" + ProductID;
    var divmainHover = document.getElementById("divmainHover" + PriceCatalogueID).id = NewdivmainHover;
    divmainHover = document.getElementById(NewdivmainHover);

    //Added for getting new tax details when new product is selected from dropdown(multiple type product)
    ...
    if (Rewritemodule.toString().toLowerCase() == "on") {
        if (Extension != "gif") {
            if (dataRows[0].ProductImage != "") {
                document.getElementById("imgGetID7" + PID[1]).title = dataRows[0].CatalogueName;
                document.getElementById("imgGetID7" + PID[1]).src = strSitePath + "ImageHandler.ashx?ImageName=" + dataRows[0].ProductImage + " &type=p&aid=" + AccountID + "&cid=" + companyID + "";
            }
            else {
                document.getElementById("imgGetID7" + PID[1]).src = strSitePath + "ImageHandler.ashx?ImageName=t_no_image_available.png&type=r&aid=" + AccountID + "&cid=" + companyID + "";
                document.getElementById("imgGetID7" + PID[1]).title = dataRows[0].CatalogueName;
            }
        }
        ...
        if (Extension == "gif") {
            if (dataRows[0].ProductImage != "") {
                document.getElementById("imgGetID7" + PID[1]).src = strSitePath + "ImageHandler.ashx?ImageName=" + dataRows[0].ProductImage + " &type=p&aid=" + AccountID + "&cid=" + companyID + "";
                document.getElementById("imgGetID7" + PID[1]).title = dataRows[0].CatalogueName;
                document.getElementById("imgGetID7" + PID[1]).setAttribute("style", "height:150px; width:150px;");
            }
            else {
                document.getElementById("imgGetID7" + PID[1]).src = strSitePath + "ImageHandler.ashx?ImageName=t_no_image_available.png&type=r&aid=" + AccountID + "&cid=" + companyID + "";
                document.getElementById("imgGetID7" + PID[1]).title = dataRows[0].CatalogueName;
        ...
        if (Extension != "gif") {
            if (dataRows[0].ProductImage != "") {
                document.getElementById("imgGetID8" + PID[1]).title = dataRows[0].CatalogueName;
                document.getElementById("imgGetID8" + PID[1]).src = strSitePath + "ImageHandler.ashx?ImageName=" + dataRows[0].ProductImage + " &type=p&aid=" + AccountID + "&cid=" + companyID + "";
            }
            else {
                document.getElementById("imgGetID8" + PID[1]).src = strSitePath + "ImageHandler.ashx?ImageName=t_no_image_available.png&type=r&aid=" + AccountID + "&cid=" + companyID + "";
                document.getElementById("imgGetID8" + PID[1]).title = dataRows[0].CatalogueName;
            }
        }
        ...
        if (Extension == "gif") {
            if (dataRows[0].ProductImage != "") {
                document.getElementById("imgGetID8" + PID[1]).src = strSitePath + "ImageHandler.ashx?ImageName=" + dataRows[0].ProductImage + " &type=p&aid=" + AccountID + "&cid=" + companyID + "";
                document.getElementById("imgGetID8" + PID[1]).title = dataRows[0].CatalogueName;
                document.getElementById("imgGetID8" + PID[1]).setAttribute("style", "height:150px; width:150px;");
            }
            else {
                document.getElementById("imgGetID8" + PID[1]).src = strSitePath + "ImageHandler.ashx?ImageName=t_no_image_available.png&type=r&aid=" + AccountID + "&cid=" + companyID + "";
                document.getElementById("imgGetID8" + PID[1]).title = dataRows[0].CatalogueName;
    ...
    document.getElementById(Newhid_PriceCatelogueName).value = dataRows[0].CatalogueName;
    document.getElementById(Newhid_TaxName).value = dataRows[0].ProductTaxName;
    document.getElementById(Newhid_TaxID).value = dataRows[0].ProductTaxId;
    document.getElementById(Newhid_TaxRate).value = dataRows[0].ProductTaxRate;
    ...
    if (MatrixType.toLowerCase() == "p") {
        ...
        btnQucikAddCart.setAttribute("onclick", "javascript:if(quickaddvalidate(" + ProductID + ",'p')) {QuickAddItemCart(" + ProductID + ",'p','" + hdncookieId.value + "'," + ChangedProductID + ")}");

        NewDivDesc.setAttribute("style", "height:46px;");

        divmainHover.setAttribute("onmouseover", "mouseovershow1(" + ProductID + ",'p');");
        //divmainHover.setAttribute("onmouseout", "mouseOutHidediv1(" + ProductID + ",'p');");
        document.getElementById(Newdivcartqty).setAttribute("style", "clear:both;");
    ...
    if (MatrixType.toLowerCase() == "s") {
        ...
        if (hdn_IsCumulative.value.toLowerCase() == "true") {
            ...
            btnQucikAddCart.setAttribute("onmouseout", "javascript:mouseOutHidediv(" + ProductID + ");");
            btnQucikAddCart.setAttribute("onclick", "javascript:if(quickaddvalidate(" + ProductID + ",'s')) {QuickAddItemCart(" + ProductID + ",'s','" + hdncookieId.value + "'," + ChangedProductID + ")}");
            NewDivDesc.setAttribute("style", "height:46px;");
        ...
        divmainHover.setAttribute("onmouseover", "mouseovershow1(" + ProductID + ",'s');");
        //divmainHover.setAttribute("onmouseout", "mouseOutHidediv1(" + ProductID + ",'s');");
        document.getElementById(Newdivcartqty).setAttribute("style", "clear:both;");
    }
    ...
    if (MatrixType.toLowerCase() == "g") {
        ...
        document.getElementById(NewdivcartWidthHeight).appendChild(textbox);
        btnQucikAddCart.setAttribute("onmouseout", "javascript:mouseOutHidediv(" + ProductID + ");");
        btnQucikAddCart.setAttribute("onclick", "javascript:if(quickaddvalidate(" + ProductID + ",'g')) {QuickAddItemCart(" + ProductID + ",'g','" + hdncookieId.value + "'," + ChangedProductID + ")}");

        //document.getElementById("divcartWidthHeight" + Pricecatalogueid).style.marginTop = "0px";
        //divQuickAdd = document.getElementById("divQuickAdd" + PID[0]);
        //divQuickAdd.setAttribute("onmouseover", "mouseovershow1(" + ProductID + ",'g');");
        divmainHover.setAttribute("onmouseover", "mouseovershow1(" + ProductID + ",'g');");
        document.getElementById("DivDesc" + ProductID).setAttribute("style", "height:26px;");
        //divmainHover.setAttribute("onmouseout", "mouseOutHidediv1(" + ProductID + ",'g');");
        document.getElementById(Newdivcartqty).setAttribute("style", "clear:both;");

        //NewDivDesc.setAttribute("style", "height:26px;");
    }
