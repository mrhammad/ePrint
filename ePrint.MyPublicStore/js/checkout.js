...
function BillingValidate() {
    ...
    if (!CheckFinal && !ChkEmailDuplicacy) {
        ...
        var Billingaddress = txtaddressLabelBilling.value + "µ" + //txt_firstName_billing.value + "µ" + txt_lastName_billing.value + "µ" +
                    ...
                    ddl_country_billing.options[ddl_country_billing.selectedIndex].text + "µ" + txt_telephone_billing.value + "µ" + txt_fax_billing.value;
        ...
        if (rbn_sameAddress.checked) {
            ...
            //Commented bcoz remove old loading image 
...
//below function is added for enhancement id 1730
