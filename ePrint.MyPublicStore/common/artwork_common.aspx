<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="artwork_common.aspx.cs" Inherits="ePrint.MyPublicStore.common.artwork_common" %>
            ...
            <MasterTableView CssClass="MasterTableView">
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="File Name" HeaderStyle-HorizontalAlign="Left"
                        ...
                        <ItemTemplate>
                            <div>
                                <asp:LinkButton ID="lbl_FileName" runat="server" Style="display: none;" Text='<%#Eval("OriginalFileName")%>'></asp:LinkButton><a
                                    id="ancFileName" href="#" name='<%#Eval("OriginalFileName")%>' onclick='javascript:OpenAttach(&#039;<%#Eval("UploadFile")%>&#039,&#039;<%#Eval("IsFromStoreAttach")%>&#039;);'
