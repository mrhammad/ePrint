...
namespace PayPalExample
{
	public class NVPAPICaller
	{
		...
		{ 
			...
			try
			{
                //Ticket #10152 paypall b2c eror fixed : You must write ContentLength bytes to the request stream before calling [Begin]GetResponse.
                ServicePointManager.Expect100Continue = true;
                ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;// ASP.NET 4.5
                //ServicePointManager.SecurityProtocol = (SecurityProtocolType)3072; // ASP.NET 4.0
