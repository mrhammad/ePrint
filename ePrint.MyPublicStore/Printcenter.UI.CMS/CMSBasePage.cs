...
namespace Printcenter.UI.CMS
{
	public class CMSBasePage
	{
		...
		public static DataTable Get_CurrencySymbol_Currency(long AccountID)
		{
			return Printcenter.BusinessAccessLayer.CMS.CMS.Get_CurrencySymbol_Currency(AccountID);
		}

		public static DataTable Get_CurrencySymbol_Currency_Company(int companyID)
		{
