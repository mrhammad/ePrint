    ...
    public partial class checkout_paypal : BaseClass, IRequiresSessionState
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.Session["BillingAddress"] != null)
            {
                ...
                foreach (DataRow row in OrderBasePage.Select_BillingShipping_Address(BillingAddress).Rows)
                {
                    ...
                    this.plh_paypal.Controls.Add(new LiteralControl(string.Concat("<input type='hidden' name='first_name' value='", baseClass.SpecialDecode(base.Session["FirstName"].ToString()), "'>")));
                    this.plh_paypal.Controls.Add(new LiteralControl(string.Concat("<input type='hidden' name='last_name' value='", baseClass.SpecialDecode(base.Session["LastName"].ToString()), "'>")));
