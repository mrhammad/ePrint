<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="create_account.aspx.cs" Inherits="ePrint.WebStore.create_account" masterpagefile="~/Templates/MasterPageDefault.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="createAccountMain_div">
        <div class="navigation_div">
            ...
            <a href="<%=strSitepath %>login.aspx">Login</a> > Create account
        </div>
            ...
            <div id="createAccount_area">
                ...
                <div id="createAccount_content">
                    <div id="createAccount_content_left">
                        ...
                        <b>
                            <asp:Label ID="Label5" runat="server" Text="Invoice Information "></asp:Label></b>
                        <div>
                        ...
                        <div>
                            ...
                            <br />
                            <span id="spn_ddlBillCountry" class="mandatoryField DisplayNone">Please select country</span>
                    ...
                    <div id="createAccount_content_right">
                        ...
                        <b>
                            <asp:Label ID="Label9" runat="server" Text="Delivery Information "></asp:Label></b>
                        <div>
                        ...
                        <div>
                            <asp:Label ID="lblShipCountry" runat="server" Text="Country "></asp:Label>
                            ...
                            <br />
                            <span id="spn_ddlShipCountry" class="mandatoryField DisplayNone">Please select country</span>
                            <asp:RequiredFieldValidator ID="req_ShipCountry" runat="server" ControlToValidate="ddlShipCountry"
                                ErrorMessage="Please select country" SetFocusOnError="true" ValidationGroup="CreateAccount"
                                InitialValue="0"></asp:RequiredFieldValidator>
                        </div>
                        <div>
                            <asp:Label ID="lblShipTelephone" runat="server" Text="Telephone "></asp:Label>
                        ...
                        <div>
                            <asp:Label ID="lblShipFax" runat="server" Text="Fax "></asp:Label><br />
                ...
                <div id="createAccount_content_bottom">
                    <div id="createAccount_content_bottom_left">
                        <br />
                        <br />
                        <a href="login.aspx"><small>« </small>Back</a>
                    </div>
                    <div id="createAccount_content_bottom_right">
                        ...
                        <span>
                            <asp:Button ID="btn_createAccount" runat="server" class="WS_Buttons_Style" TabIndex="21"
                                Text="Create an Account" ValidationGroup="CreateAccount" OnClick="Onclick_btnCreateAccount" /></span>
                    </div>
