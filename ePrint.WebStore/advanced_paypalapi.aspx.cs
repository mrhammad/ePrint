    ...
    public partial class advanced_paypalapi : System.Web.UI.Page, IRequiresSessionState
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.Session["BillingAddress"] != null)
            {
                ...
                dataTable1 = OrderBasePage.Select_Individual_Address(this.StoreUserID, Convert.ToInt64(this.Session["BillingAddressID"]), (long)0);
            }
            ...
            else
            {
                ...
                str2 = string.Concat(this.strSitepath, "default.aspx?type=0");
            }
