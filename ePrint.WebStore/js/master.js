...
function defaultText() {
    ...
    document.getElementById('ctl00_txt_search').className = "txtWidthSearch";
    ...
    if (document.getElementById('ctl00_txt_search').value == "") {
        ...
        document.getElementById("ctl00_txt_search").value = "Free Text Search";
    }
}
...
function vaidate_Search() {
    ...
    //txt_search.value = "";
    document.getElementById('ctl00_txt_search').value = "";
    //txt_search.className = "txtWidthSearchColor";
    document.getElementById("ctl00_txt_search").className = "txtWidthSearchColor";
...
function vaidate_SearchImg() {
    ...
    if (document.getElementById("ctl00_txt_search").value == "" || document.getElementById("ctl00_txt_search").value == "Free Text Search") {
...
function Onclick_Search() {
    ...
    if (search) {
        ...
        var str = document.getElementById("ctl00_txt_search").value;
