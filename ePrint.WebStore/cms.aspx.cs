...
namespace ePrint.WebStore
{
    public partial class cms : BaseClass, IRequiresSessionState
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.Session["StoreUserID"] == null && this.AccountType.ToLower() == "p" || this.companyID == 0 && this.accountID == 0)
            {
            ...
            else if (RewriteContext.Current.Params["ID"] != null)
            {
                ...
                this.pageID = Convert.ToInt32(str.Split(keySeparator)[1]);
            }
            ...
            foreach (DataRow dataRow in dataTable1.Rows)
            {
                ...
                if (dataRow["URL"].ToString() == "")
                {
                    ...
                    object[] objArray = new object[] { "<div class='clearTop'><img src='", str1, "' class='imgWidth BorderWhite' alt='", dataRow["bannerTitle"], "'  /></div>" };
                    controls.Add(new LiteralControl(string.Concat(objArray)));
                }
                else
                {
                    ControlCollection controlCollections = this.plhLeftBanner.Controls;
                    object[] item1 = new object[] { "<div class='clearTop'><a href='", dataRow["URL"], "'><img src='", str1, "' class='imgWidth BorderWhite' alt='", dataRow["bannerTitle"], "'  /></a></div>" };
            ...
            foreach (DataRow row1 in dataTable2.Rows)
            {
                ...
                if (row1["URL"].ToString() == "")
                {
                    ...
                    object[] item2 = new object[] { "<div class='clearTop'><img src='", str2, "' class='imgWidth BorderWhite' alt='", row1["bannerTitle"], "'  /></div>" };
                    controls1.Add(new LiteralControl(string.Concat(item2)));
                }
                else
                {
                    ControlCollection controlCollections1 = this.plhRightBanner.Controls;
                    object[] objArray2 = new object[] { "<div class='clearTop'><a href='", row1["URL"], "'><img src='", str2, "' class='imgWidth BorderWhite' alt='", row1["bannerTitle"], "'  /></a></div>" };
