...
namespace ePrint.WebStore
{
    public partial class create_account : System.Web.UI.Page, IRequiresSessionState
    {
        ...
        public static int Check_EmailID_Duplicacy(string val)
        {
            ...
            return LoginBasePage.CheckEmailID_Duplicacy((long)0, val, (long)0);
        }

        protected void custEmailID_Duplicacy_ServerValidate(object source, ServerValidateEventArgs args)
        {
            loginclass _loginclass = new loginclass();
            if (LoginBasePage.CheckEmailID_Duplicacy(this.StoreUserID, this.txt_email.Text, this.AccountID) == -1)
            {
                args.IsValid = false;
                return;
            }
        ...
        protected void Onclick_btnCreateAccount(object sender, EventArgs e)
        {
            ...
            {
                this.StoreUserID = LoginBasePage.Create_StoreUser((long)0, (long)0, this.txt_firstName.Text, this.txt_lastName.Text, this.txt_email.Text, this.txtpassword.Text, this.CompanyID, this.AccountID, "new", this.txtCompanyName.Text);
                if (this.StoreUserID != (long)0)
                {
                    this.SesseionKey = this.comm.UniqueID;
                    this.login.Insert_intoResume_Session(this.txt_email.Text, this.txtpassword.Text, this.AccountID);
                    this.login.LogInFromDefault(this.txt_email.Text, this.txtpassword.Text);
                    ...
                    {
                        this.BillingAddressID = OrderBasePage.Insert_BillingShipping_Address(this.StoreUserID, this.txt_firstName.Text, this.txt_lastName.Text, this.txtBillAddress1.Text, this.txtBillAddress2.Text, this.txtBillCity.Text, this.txtBillState.Text, this.txtBillZipCode.Text, this.txtBillTelephone.Text,"", this.txtBillFax.Text, this.ddlBillCountry.SelectedItem.Text, 1, 0, "Main", this.CreatedDate);
                    ...
                    {
                        this.BillingAddressID = OrderBasePage.Insert_BillingShipping_Address(this.StoreUserID, this.txt_firstName.Text, this.txt_lastName.Text, this.txtBillAddress1.Text, this.txtBillAddress2.Text, this.txtBillCity.Text, this.txtBillState.Text, this.txtBillZipCode.Text, this.txtBillTelephone.Text,"", this.txtBillFax.Text, this.ddlBillCountry.SelectedItem.Text, 1, 1, "Main", this.CreatedDate);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!base.IsPostBack)
            {
                ...
                foreach (DataRow row in OrderBasePage.settings_companyprofile_select(Convert.ToInt32(this.CompanyID)).Rows)
                {
