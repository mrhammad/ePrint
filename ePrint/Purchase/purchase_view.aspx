<%@ page language="C#" masterpagefile="~/Templates/innerMasterPage_withoutLeftTD.master" autoeventwireup="true"  CodeBehind="purchase_view.aspx.cs" Inherits="ePrint.Purchases.purchase_view" title="Untitled Page" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="GridViewpurchase">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="GridViewpurchase" />
                </UpdatedControls>
            </telerik:AjaxSetting>
                    ...
                    <div class="divpadding">
                        <div align="left" nowrap="nowrap">
                            <span class="navigatorpanel" style="padding-left: 10px">
                                <%=objLangClass.GetLanguageConversion("Purchases")%></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="">
                ...
                <div style="height: 18px; margin-top: -10px; margin-bottom: 10px;">
                    ...
                    <div style="float: left; margin-left: 35px; padding-top: 3px;">
                        <asp:LinkButton ID="lnkPurchaseedit" runat="server" Text="Edit View" Style="text-decoration: underline;"
                            OnClientClick="javascript:return editviewID_purchase();" OnClick="btnEditViewPurchase_Click"><%=objLanguage.GetLanguageConversion("Edit_Add")%></asp:LinkButton>
                        <%--&nbsp;/
                    ...
                    <div style="border: 0px solid red; float: right; padding-right: 30px; margin-top: -5px;">
                        ...
                        <div style="float: left; display: none;">
                            <span class="normalText" style="color: #787878">
                                <%=objLangClass.GetLanguageConversion("Or_Try")%></span><a href="../purchase/purchase_search.aspx"
                    ...
                    <div style="width: 100%;">
                        <div align="left" style="padding-top: 5px; width: 100%;">
                            <div id="div_Main" runat="server">
                                    ...
                                    <div id="div_popupAction_View" style="" onmouseover="show();" onmouseout="hide(); ">
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <div style="width: 100%;">
                                                        <asp:Panel ID="pnlActionMenu" runat="server">
                                                            <telerik:RadListBox runat="server" ID="RadListBox1" SelectionMode="Single" Width="100%"
                                                                ...
                                                                <HeaderTemplate>
                                                                    <span style="color: #333; line-height: 23px; font-weight: 100; padding: 5px 0px 5px 5px; font-family: Verdana; font-size: 10px;">
                                                                        <asp:Label ID="lblTest" runat="server"><%=objLangClass.GetLanguageConversion("Change_Status") %></asp:Label></span>
                                                                </HeaderTemplate>
                                                                <Items>
                                                                </Items>
                                                            </telerik:RadListBox>
                                            ...
                                            <tr>
                                                <td>
                                                    <div onclick="javascript:return CheckchkOnlyOne();" class="divDropdownlist" style="border-left: 1px solid #CBCBCB; border-right: 1px solid #CBCBCB;">
                                                        <asp:Label ID="lblCreateNewPO" runat="server"></asp:Label>
                                                    </div>
                                                </td>
                                            </tr>                                            
                                        </table>
                                    </div>
                                    <telerik:RadGrid ID="GridViewpurchase" runat="server" AllowSorting="true" OnItemDataBound="OnRowDataBound_GridViewpurchase"
                                        ...
                                        OnNeedDataSource="GridViewpurchase_NeedDataSource" GroupingEnabled="false" Width="100%"
                                         OnGroupHeaderItemDataBound="GridView1_GroupHeaderItemDataBound"
                                        OnSortCommand="GridViewpurchase_OnSorting" OnItemCommand="GridViewpurchase_ItemCommand"
                                        Skin="Sunset" AllowCustomPaging="false" EnableEmbeddedSkins="true">
                                        <HeaderStyle CssClass="gv_ViewsHeader" />
                                        <FilterMenu CssClass="RadMenu_Eprint_Skin" />
                                        <PagerStyle Mode="NextPrevAndNumeric" CssClass="RadComboBox_Eprint_Skin" AlwaysVisible="false"></PagerStyle>
                                        <MasterTableView OverrideDataSourceControlSorting="true" AllowCustomSorting="true">
                                            <Columns>
                                                <telerik:GridTemplateColumn ItemStyle-HorizontalAlign="Center" AllowFiltering="false"
                                                    ...
                                                    <ItemTemplate>
                                                        <input class="viewcheckboxpos" type="checkbox" runat="server" id="Id" onclick="CheckChanged(event, this, 'ctl00_ContentPlaceHolder1_GridViewpurchase');"
                                                            name="Id" value='<%# DataBinder.Eval(Container, "DataItem.PurchaseID", "{0}") %>' />&nbsp;
                                                    </ItemTemplate>
                                ...
                                <asp:LinkButton ID="lnkPODelete" runat="server" OnClick="lnkPODelete_OnClick" CausesValidation="false"></asp:LinkButton>
                                <asp:LinkButton ID="lnkPOArchive" runat="server" OnClick="lnkPOArchive_OnClick" CausesValidation="false"></asp:LinkButton>
                                <asp:LinkButton ID="lnkPOCopy" runat="server" OnClick="lnkPOCopy_OnClick" CausesValidation="false"></asp:LinkButton>
    ...
    <telerik:RadWindowManager ID="Radwinmanager_POCopy_Confirmation" Title="" runat="server" DestroyOnClose="false" VisibleStatusbar="true" Behaviors="Move,Close" Modal="true">
        <Windows>
            <telerik:RadWindow ID="Radwin_POCopy" runat="server" DestroyOnClose="false" Width="350" Height="200">
                <ContentTemplate>
                    <div class="StatusMain">
                        <div align="center">
                            <asp:Label ID="lbl_POCopyMsg" runat="server"><%=objLangClass.GetLanguageConversion("Is_this_Purchase_Order_copy_to_be_linked_to_the_same_records_as_the_original_Purchase_order_you_are_copying") %></asp:Label>
                        </div>
                        <div class="StatusBtnSpace">
                        </div>
                        <div class="BtnMain" align="center" style="margin-left: -20px; margin-top: 20px;">
                            <div style="float: left">
                                <div id="div_POCopy_btnyes" style="display: block">
                                    <asp:Button ID="POCopy_btnyes" runat="server" Text="Yes" CssClass="button" OnClientClick="javascript:POCopy_btnyes_Close();return false;" />
                                </div>
                            </div>
                            <div>
                            </div>
                            <div style="margin-left: 50px">
                                <div id="div_POCopy_btnno" style="display: block;">
                                    <asp:Button ID="POCopy_btnno" runat="server" Text="No" CssClass="button" OnClientClick="javascript:POCopy_btnno_Close();return false;" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript" language="javascript">
        function addviews() {
            window.location.href = "<%=strSitepath%>" + "Purchase/customviewpurchase.aspx";
        }
    </script>
    <script type="text/javascript">
        var clsTimeID = '';
        ...
        function testjs(val) {
            document.getElementById("<%=hidDeletePO.ClientID %>").value = val;
    ...
    <script type="text/javascript">
        var hidDeletePO = document.getElementById("<%=hidDeletePO.ClientID %>");
        function DeletePurchase(POids) {
            hidDeletePO.value = POids;
            __doPostBack('ctl00$ContentPlaceHolder1$lnkPODelete', '')
        }
        function ArchivePurchase(POids) {
            hidDeletePO.value = POids;
            __doPostBack('ctl00$ContentPlaceHolder1$lnkPOArchive', '')
        }
        function CopyPurchase(POids) {
            hidDeletePO.value = POids;
            __doPostBack('ctl00$ContentPlaceHolder1$lnkPOCopy', '')
        }
        var checktrue = false;
    ...
    <asp:HiddenField ID="editPurchaseViewID" runat="server" Value="0" />
    <asp:HiddenField ID="hdnPOCopyValue" runat="server" Value="" />
    <script type="text/javascript">
        function editviewID_purchase() {
            var ddl = document.getElementById('ctl00_ContentPlaceHolder1_ddl_View');
            var editPurchaseViewID = document.getElementById("<%=editPurchaseViewID.ClientID %>");
            editPurchaseViewID.value = ddl.options[ddl.selectedIndex].value;
        }
    ...
    <script type="text/javascript">
        ...
        if (type == "delete") {
            ...
            check = window.confirm('<%=objLangClass.GetLanguageConversion("UnArchive_Confirmation_Alert") %>');
        }
    if (check) {
        if (type == "delete") {
...
function CheckchkOnlyOne() {
    ...
    if (PageType == "purchase") {
        document.getElementById("div_popupAction_View").style.display = "none";
        var oWndPOCopy = $find("<%=Radwin_POCopy.ClientID%>");
        oWndPOCopy.show();
        return false;
    }
}
...
function POCopy_btnyes_Close() {
    document.getElementById("ctl00_ContentPlaceHolder1_hdnPOCopyValue").value = "yes";
    var oWnd = $find("<%=Radwin_POCopy.ClientID%>");
    oWnd.close();
    CopyPurchase(POCopyID);
    document.getElementById("ds00").style.display = "block";
    var div_Load = document.getElementById("div_Load");
    setLoadingPositionOfDivMove(div_Load);
    return false;
...
function POCopy_btnno_Close() {
    document.getElementById("ctl00_ContentPlaceHolder1_hdnPOCopyValue").value = "no";
    var oWnd = $find("<%=Radwin_POCopy.ClientID%>");
    oWnd.close();
    CopyPurchase(POCopyID);
    document.getElementById("ds00").style.display = "block";
