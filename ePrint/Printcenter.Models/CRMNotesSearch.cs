...
public class CRMNotesSearch
{
	public CRMNotesSearch()
	{
	}

	public static string ReturnNotesSearch(string CompanyID, string SectionID, int NotespageNummber, string WhereCondition, string SearchText)
	{
		int notespageNummber = 5 * NotespageNummber;
		languageClass _languageClass = new languageClass();
		BaseClass baseClass = new BaseClass();
		StringBuilder stringBuilder = new StringBuilder();
		DataSet dataSet = DepartmentBaseClass.CRM_Select_TopFiveNotesSearch(Convert.ToInt32(CompanyID), Convert.ToInt32(SectionID), WhereCondition, baseClass.SpecialEncode(SearchText));
		...
		try
		{
			...
			if (dataTable.Rows.Count > 0)
			{
				foreach (DataRow row in dataTable.Rows)
				{
					...
					{
						string[] strArrays1 = new string[] { "<span title ='", str2.Replace("'", "`"), "'>", _languageClass.GetLanguageConversion("untitled"), "</span>" };
						stringBuilder.Append(string.Concat(strArrays1));
					}
					else
					{
						string[] strArrays2 = new string[] { "<span title ='", str2.Replace("'", "`"), "'>", str1, " </span>" };
					...
					stringBuilder.Append("</td>");
					string str3 = "";
					str3 = baseClass.SpecialDecode(row["UserName"].ToString());
					...
					string[] strArrays5 = new string[] { "<span title ='", str4.Replace("'", "`"), "'>", str3, "</span>" };
					stringBuilder.Append(string.Concat(strArrays5));
					stringBuilder.Append("</div>");
					stringBuilder.Append("</td>");
					string str5 = baseClass.SpecialDecode(row["SpecificName"].ToString());
					...
					stringBuilder.Append("<div style='margin-left:0px;'>");
					string[] strArrays6 = new string[] { "<spantitle ='", str6.Replace("'", "`"), "'>", baseClass.SpecialDecode(row["SpecificName"].ToString()), "</span>" };
					...
					if (row["filename"].ToString() != "")
					{
						...
						object[] objArray = new object[] { "<span id='DeleteNotes_", num1, "' style='margin-left:10px;float:left;margin-top:3px;'><a href='javascript://'><img title='", _languageClass.GetLanguageConversion("Delete"), "' src='../images/delete.gif' style='cursor:pointer;' onclick=\"delete_note('", num2, "');return false;\"/> </a></span>" };
						stringBuilder.Append(string.Concat(objArray));
					}
					else
					{
						object[] languageConversion1 = new object[] { "<span id='ShowAttachIcon' style='display:none; margin-left:10px;float:left;margin-top:3px;'><a href='javascript://'><img src='../images/Attachment.png' title='", _languageClass.GetLanguageConversion("View_Attached_File"), "' style='cursor:pointer;' onclick=\"ViewAttachedFiles('", num2, "','", row["CompanyId"], "');return false;\"/> </a></span>" };
						stringBuilder.Append(string.Concat(languageConversion1));
						object[] objArray1 = new object[] { "<span id='DeleteNotes_", num1, "' style='margin-left:10px;float:left;margin-top:3px;'><a href='javascript://'><img title='", _languageClass.GetLanguageConversion("Delete"), "' src='../images/delete.gif' style='cursor:pointer;' onclick=\"delete_note('", num2, "');return false;\"/> </a></span>" };
			...
			if (dataSet.Tables[0].Rows.Count <= 5 || dataSet.Tables[0].Rows.Count <= dataTable.Rows.Count)
			{
				...
				stringBuilder.Append(string.Concat("<span ID='DivHideMoreNotes' style='margin-left:10px;display:none;'><a onclick='javascript:HideMoreSearchNotesByJson();return false;'style='cursor:pointer;color:#10357f'>", _languageClass.GetLanguageConversion("Hide_More"), "  </a></span>"));
				stringBuilder.Append("</div>");
			}
			else
			{
				...
				stringBuilder.Append("<tr>");
				stringBuilder.Append("<td>");
				stringBuilder.Append(string.Concat("<span ID='DivShowMoreNotes' style='margin-left:10px;display:block; float:left;'><a onclick='javascript:LoadMoreSearchNotesByJson();return false;'style='cursor:pointer;color:#10357f'>", _languageClass.GetLanguageConversion("Show_More"), "  </a></span>"));
				stringBuilder.Append("</td>");
				stringBuilder.Append("<td>");
				stringBuilder.Append(string.Concat("<span ID='DivShowAllNotes' style='margin-left:10px;display:none; float:left;'><a href='javascript://' style='cursor:pointer;color:#10357f;' onclick=\"LoadAllSearchedNotesByJson();return false;\"/>", _languageClass.GetLanguageConversion("Show_All"), "  </a></span>"));
				stringBuilder.Append("</td>");
				stringBuilder.Append("<td>");
				stringBuilder.Append(string.Concat("<span ID='DivHideMoreNotes' style='margin-left:10px;display:none;float:left;'><a onclick='javascript:HideMoreSearchNotesByJson();return false;'style='cursor:pointer;color:#10357f'>", _languageClass.GetLanguageConversion("Hide_More"), "  </a></span>"));
				stringBuilder.Append("</td>");
				stringBuilder.Append("</tr>");
				stringBuilder.Append("</table>");
				stringBuilder.Append("</div>");
