...
function writeDefault(rte, html, width, height, buttons, readOnly) {
	//if (!readOnly) {
		document.writeln('<textarea runat=server id="' + rte + '" name="' + rte + '" id="' + rte + '" style="width: ' + width + 'px; height: ' + height + 'px;">' + html + '</textarea>');
	//} else {
	//	document.writeln('<textarea runat=server id="' + rte + '" name="' + rte + '" id="' + rte + '" style="width: ' + width + 'px; height: ' + height + 'px;" readonly>' + html + '</textarea>');
	//}
}
...
function writeRTE(rte, html, width, height, buttons, readOnly) {
	...
	if (isIE) {
		if (buttons && (width < 600)) width = 550;
	...
	if (buttons == true) {
		document.writeln('<table border=0 class="rteBack" cellpadding=2 cellspacing=1 id="Buttons1_' + rte + '" width="' + tablewidth + '">');
		document.writeln('	<tr>');
		document.writeln('		<td>');
		...
		document.writeln('<table class="rteBack" border=0 cellpadding="0" cellspacing="0" id="Buttons2_' + rte + '" width=200>');
		document.writeln('	<tr>');
		...
		document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');	
		document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'nil.gif" width="27" height="20" border="0" alt=""></td>');			
		document.writeln('		<td width="100%">');
		document.writeln('		</td>');	
		document.writeln('	</tr>');
		document.writeln('</table>');
	}
	document.writeln('<iframe runat=server id="' + rte + '" name="' + rte + '" width="' + width + 'px" height="' + height + 'px" src="' + includesPath + 'blank.htm"></iframe>');

//document.writeln('<textarea id="' + rte + '" name="' + rte + '" width="' + width + 'px" height="' + height + 'px"></textarea>');
