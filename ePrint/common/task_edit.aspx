...
<%@ page language="C#" masterpagefile="~/Templates/innerMasterPage_withLeftTD.master" autoeventwireup="true" CodeBehind="task_edit.aspx.cs" Inherits="ePrint.common.task_edit" title="Untitled Page" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <td>
                <table id="Table3" cellspacing="0" cellpadding="0" width="100%" border="0" height="23">
                    <tr>
                        ...
                        <%--r1.jpg--%>
                        <td nowrap="nowrap" width="98%" class="bgcustomize" style="padding-left: 10px">
                            <span class="navigatorpanel">
                                <%=objLanguage.GetLanguageConversion("Task_Edit_Task")%></span><%--</a>--%>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <table cellspacing="2" cellpadding="2" width="100%" align="center" border="0">
                                            ...
                                            <tr valign="top">
                                                <td class="label" valign="top" style="width: 20%" nowrap="nowrap">
                                                    <%--&nbsp;<asp:Label ID="lblassigned" runat="server" Width="65px" Text="Assigned To" CssClass="normaltext"></asp:Label>--%>
                                                    <div style="float: left">
                                                        <asp:Label ID="lblassigned" runat="server" Text='' CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Assigned_To")%></asp:Label>
                                                    </div>
                                                    <div style="float: right">
                                                        <asp:ImageButton Style="vertical-align: top" ID="ImageButton3" runat="server" CausesValidation="False"
                                                            ImageUrl="~/images/plus.gif" ToolTip="Select User" Visible="false" /></div>
                                                </td>
                                                <td valign="top" style="width: 30%" nowrap="nowrap">
                                                    <asp:DropDownList runat="server" ID="ddlassigneto" CssClass="normaltext" Width="200px">
                                                    </asp:DropDownList>
                                                </td>
                                                <td class="label" valign="top" style="width: 20%">
                                                    <%--class="newLabelText"--%>
                                                    &nbsp;<asp:Label ID="lblstatus" runat="server" Text='' CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Status")%></asp:Label>
                                                    <span style="color: red">*</span>
                                                </td>
                                                <td valign="top" style="width: 30%" colspan="2">
                                            ...
                                            <tr valign="middle">
                                                <td class="label" valign="middle">
                                                    <div style="float: left">
                                                        <asp:Label ID="lblsubject" runat="server" Width="65px" Text="Subject" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Subject")%><span class="redver7">*</span></asp:Label>
                                                    </div>
                                                    <div style="float: right">
                                                        <asp:ImageButton Style="vertical-align: top" ID="ImageButton9" runat="server" CausesValidation="False"
                                                            ImageUrl="~/images/plus.gif" ToolTip='' OnClientClick="javascript:show_hide_subject('show');return false;" /></div>
                                                </td>
                                                ...
                                                <td class="label" valign="top">
                                                    <%--class="newLabelText"--%>
                                                    &nbsp;<asp:Label ID="lblpriority" runat="server" Text='' CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Priority")%></asp:Label>
                                                    <span style="color: red">*</span>
                                                </td>
                                            ...
                                            <tr valign="top">
                                                <td class="label" valign="top">
                                                    <asp:Label ID="lblcontacts" runat="server" Width="65px" Text='' CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Contacts")%></asp:Label>
                                                    </div>
                                                    <div style="float: right">
                                                        <asp:ImageButton Style="vertical-align: top" ID="ImageButton2" runat="server" CausesValidation="False"
                                                            ImageUrl="~/images/plus.gif" ToolTip='' /></div>
                                                </td>
                                                <td valign="top" align="left" nowrap="nowrap">
                                                    <input type="text" name="txtcontacttype" maxlength="200" class="txtbox" style="width: 200px"
                                                        id="txtcontacttype" runat="server" readonly="readonly" />&nbsp;<div style="margin-bottom: 2px;
                                                            margin-top: 3px">
                                                            <asp:Label ID="lblcontacterror" Text="" CssClass="error" runat="server"></asp:Label>
                                                        </div>
                                                </td>
                                                <td class="label" style="width: 20%" nowrap="nowrap">
                                                    <%--class="newLabelText"--%>
                                                    <asp:Label ID="lblduedate" runat="server" CssClass="normaltext">&nbsp;<%=objLanguage.GetLanguageConversion("Due_Date_And_Time_hh_mm")%><span class="redver7">*</span></asp:Label>
                                                </td>
                                                <td valign="top" style="width: 38%" class="normaltext">
                                                    <asp:TextBox ID="txtduedate" runat="server" CssClass="txtbox" Width="82px"></asp:TextBox>&nbsp;
                                                    &nbsp;<asp:DropDownList ID="ddlhour" runat="server" CssClass="normaltext" Width="50px"
                                                        ToolTip="Hour(s)">
                                                    </asp:DropDownList>
                                                    :
                                                    <asp:DropDownList ID="ddlminute" runat="server" CssClass="normaltext" Width="50px"
                                                        ToolTip="Minute(s)">
                                                    </asp:DropDownList>
                                                    <br />
                                                    <asp:Label ID="lblduedate_value" Visible="false" runat="server" CssClass="normaltext"
                                                        Width="75px"></asp:Label>
                                                    <div style="margin-top: 5px;">
                                                        <span id="spn_txtDueDate" class="spanerrorMsg" style="display: none; width: 200px;
                                                            white-space: normal"></span>
                                                    </div>
                                                </td>
                                            </tr>
                                            <asp:PlaceHolder runat="server" ID="pnlLinkedTo" Visible="false">
                                                <tr>
                                                    <td class="label" valign="top">
                                                        &nbsp;<asp:Label ID="Label1" runat="server" Text='' CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Linked_To")%></asp:Label>
                                                    </td>
                                                    <td nowrap="nowrap" align="left" colspan="3">
                                                        <div style="float: left;" id="drpDiv">
                                            ...
                                            <tr style="display: none">
                                                ...
                                                <td valign="top" align="left">
                                                    <asp:TextBox ID="txttype" runat="server" CssClass="txtbox" MaxLength="200" Width="200px"></asp:TextBox>&nbsp;<asp:ImageButton
                                                        Style="vertical-align: middle" ID="ImageButton1" runat="server" CausesValidation="False"
                                            ...
                                            <tr>
                                                ...
                                                <td class="normaltext" colspan="4">
                                                    <asp:TextBox ID="txtcomment" Rows="8" Width="96%" runat="server" TextMode="MultiLine"
                    ...
                    <tr>
                        <td align="left">
                            <div style="width: 90%; border: 0px solid">
                                ...
                                <div style="float: right; width: 50%; border: 0px solid;">
                                    <div style="float: right;">
                                        <div align="left">
                                            <div style="float: left;">
                                                <div id="div_btncancel" style="display: block">
                                                    <asp:Button ID="btncancel" runat="server" CausesValidation="False" CssClass="button"
                                                        Text="Cancel" OnClientClick="javascript:loadingimage(this.id,'div_cancelprocess');" /><%-- OnClick="btncancel_OnClick"--%>
                                                </div>
            ...
            <tr>
                ...
                <td class="popup-top-middlebg">
                    <div align="left" class="Label-PopupHeading" style="float: left; padding-top: 6px;
                        padding-left: 1px">
                        <b>
                            <%=objLanguage.GetLanguageConversion("Stock_Alert")%></b>
                    ...
                    <div style="float: right; padding-top: 6px; padding-right: 10px">
                        <div class="CancelButtonDiv">
                            <asp:ImageButton ID="ImageButton5" ToolTip='Cancel' ImageUrl="~/images/closebtn.png"
                                runat="server" CausesValidation="false" OnClientClick="show_hide_subject('hide');return false;" />
                        </div>
                    </div>
                </td>
                                ...
                                <tr>
                                    <td valign="top">
                                        ...
                                        <div style="float: left" class="box">
                                            ...
                                            <span id="spn_txtSubject" class="spanerrorMsg" style="white-space: nowrap; display: none;
                                                width: 133px;">
    ...
    <script type="text/javascript">
        ...
        function testdate() {
            ...
            if (txtduedate.value == '') {
                document.getElementById("spn_txtDueDate").innerHTML = "Please enter a valid Date";
                document.getElementById("spn_txtDueDate").style.display = "block";
                CheckFinal = false;
            }
            else {
                if (ValidateForm(txtduedate, 'spn_txtDueDate', DateFormat_New) == false) {
                    CheckFinal = false;
                }
            }
    ...
    <script type="text/javascript">
        function show_hide_subject(distype) {
            ...
            if (document.getElementById("drpDiv") != null) {
                drpDiv = document.getElementById("drpDiv");
                drpDiv.style.display = "none";

            }

            if (trim12(distype) == "show") {
    ...
    <asp:Panel ID="pnlMoreThanOneRecord" Visible="false" runat="server">
        <script type="text/javascript">
            ...
            window.radopen(openwin, 'Lead', 'width=600,height=500,status=no,scrollbars=yes,resizable=yes,top=100,title=yes,location=no,titlebar=no,left=270,top=100');
            SetRadWindow('divrad', 'divBackGroundNew', '200');
        </script>
    </asp:Panel>
