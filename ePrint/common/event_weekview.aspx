<%@ page language="C#" masterpagefile="~/Templates/innerMasterPage_withLeftTD.master" autoeventwireup="true" CodeBehind="event_weekview.aspx.cs" Inherits="ePrint.common.event_weekview" title="Calendar Week View" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellspacing="0" cellpadding="5" width="100%" align="center" border="0" id="TABLE2"
                ...
                <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" id="TABLE1">
                    <tr>
                        ...
                        <td align="center" style="width: 10%">
                            <table cellspacing="0" cellpadding="5" width="97%" align="center" border="0" id="TABLE3">
                                <tr>
                                    <td>
                                        ...
                                        <fieldset>
                                            ...
                                            <table cellspacing="0" cellpadding="0" class="Border1px_New" width="95%" align="center"
                                                ...
                                                <tr height="23">
                                                    ...
                                                    <%--r1.jpg--%>
                                                    <td width="98%" class="bgcustomize" nowrap="nowrap" align="center">
                                                        <%--background="<%=strImagepath%>r2.jpg"--%>
                                                        <a style="width: 50; vertical-align: middle" href="event_weekview.aspx?ReqDate=<%=previousdatetime1%>&dispstatus=<%=disptype%>"
                                                            class='WhiteVer9'>
                                                        ...
                                                        <span class="navigatorpanel" style="width: 150; vertical-align: middle">
                                                            ...
                                                            &nbsp;-&nbsp;
                                                            <%=nextweek1%>
                                                        </span><a style="width: 50; vertical-align: middle" href="event_weekview.aspx?ReqDate=<%=nextdatetime1%>&dispstatus=<%=disptype%>"
                                                            class='White'>
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <table cellspacing="0" cellpadding="5" width="100%" align="center" border="0" id="TABLE8"
                                                            class="borderWithoutTop">
                                        ...
                                        <fieldset>
                                            ...
                                            <div align="left" style="float: left; width: 45%; padding-bottom: 2px; display: none;">
                                                <asp:DropDownList ID="DropDownList1" CssClass="normaltext" AutoPostBack="True" runat="server"
                                                    ...
                                                    <asp:ListItem Selected="True" Value="n7">Next 7 Days</asp:ListItem>
                                            ...
                                            <table cellspacing="0" cellpadding="0" class="Border1px_New" width="99%" align="center"
                                                border="0" id="TABLE7">
                                                <tr height="23">
                                                    <td width="1%" valign="top" align="left" class="bgcustomize">
                                                        <img alt="" src="<%=strImagepath%>lt_tabnotch.gif" width="5" height="5" />
                                                    ...
                                                    <td width="18%" class="bgcustomize">
                                                        <div>
                                                            <div style='float: left; width: 20px;'>
                                                                <a style="vertical-align: middle" href="event_weekview.aspx?ReqDate=<%=previousdatetime1%>&dispstatus=<%=disptype%>"
                                                                    class='WhiteVer9'>
                                                                    <img src='../images/prev.gif' border='0' alt='Previous Day'></a></div>
                                                            <div style='float: left; width: 10px;'>
                                                                &nbsp;</div>
                                                            <div style='float: left;'>
                                                                <a href="#" class="subnavigator" style="cursor: default">
                                                                    <%=objLanguage.GetLanguageConversion("Due_Date")%></a></div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td width="28%" class="bgcustomize">
                                                        <%--background="<%=strImagepath%>r2.jpg"--%>
                                                        <a href="#" class="subnavigator" style="cursor: default">
                                                            <%=objLanguage.GetLanguageConversion("Contact_Name")%></a>
                                                    </td>
                                                    <td width="22%" class="bgcustomize">
                                                        ...
                                                        <div align="left">
                                                            ...
                                                            <div style="float: left; width: 10px;">
                                                                &nbsp;</div>
                                                            <div style="float: left;">
                                                                <a style="width: 50; vertical-align: middle" href="event_weekview.aspx?ReqDate=<%=nextdatetime1%>&dispstatus=<%=disptype%>"
                                                                    class='White'>
                                                                    <img src='../Images/Next.gif' border='0' alt='Next Day'></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td width="1%" valign="top" align="right" class="bgcustomize">
        ...
        <tr>
            <td>
                <asp:Image ID="Image2" runat="server" Width="100" Height="3" ImageUrl="~/images/nil.gif" />
            </td>
        </tr>
    </table>
</asp:Content>
