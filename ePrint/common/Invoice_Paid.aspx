<%@ Page Title="Invoice Payment" Language="C#" MasterPageFile="~/Templates/popUpMasterPage.master" AutoEventWireup="true" CodeBehind="Invoice_Paid.aspx.cs" Inherits="ePrint.common.Invoice_Paid" EnableViewStateMac="false" EnableEventValidation="false" Theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="pnlgridAccountingCodes" ChildrenAsTriggers="false" UpdateMode="Conditional"
        ...
        <ContentTemplate>
            <div id="div_ProgressToInvoice" align="left" style="display: block; border: 0px solid red; z-index: 100; width: 97%; height: 50%"
                align="center">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="center" valign="top">
                            <div id="divJobItems" style="word-break: break-word;">
                                <asp:PlaceHolder ID="plhJobItems" runat="server"></asp:PlaceHolder>
                                <asp:HiddenField ID="hdnAllItemIDs" runat="server" />
                                <asp:HiddenField ID="hdnSelectedItemIDs" runat="server" />
                                <asp:HiddenField ID="hdnAmounts" runat="server" Value="0" />
                            </div>
                            <script type="text/javascript" language="javascript">
                                var asyncState = true;
                                // Ticket #8665 Unable to create invoice in DMC   
                                ...
                                function JobItemListNext() {
                                    IsInvoicePossible = true;
                                    var Currency = '<%=Currency%>';
                                    var hdnAllItemIDs = document.getElementById("<%=hdnAllItemIDs.ClientID %>");
                                    var hdnAmounts = document.getElementById("<%=hdnAmounts.ClientID %>");
                                    var hdnSelectedItemIDs = document.getElementById("<%=hdnSelectedItemIDs.ClientID %>");

                                    var SelectItemsAmount = 0;

                                    if (hdnAllItemIDs.value != "") {
                                        var IDs = hdnAllItemIDs.value.split('¶');
                                        var Cnt = 0;
                                        for (var i = 0; i < IDs.length - 1; i++) {
                                            var chk = document.getElementById("chkJobItems_" + IDs[i]);
                                            if (chk.checked) {
                                                asyncState = false;
                                                if (IsInvoicePossible) {
                                                    AutoFill.CheckInvoicePossible(Number(0), Number(chk.value), IsInvoicePossibleSelectedFromJob);
                                                    if (IsInvoicePossible) {
                                                        var Amount = document.getElementById("hdnItemAmount_" + IDs[i] + "").value;
                                                        SelectItemsAmount = Number(SelectItemsAmount) + Number(Amount);
                                                        hdnSelectedItemIDs.value += IDs[i] + "¶";
                                                    }
                                                }
                                                Cnt++;
                                            }
                                        ...
                                        hdnAmounts.value = SelectItemsAmount;
                                    }

                                    if (IsInvoicePossible && '<%=SR_WhenStockReduced%>' == 'j') {
                                        if (hdnSelectedItemIDs.value != "") {
                                            var SelectedIDs = hdnSelectedItemIDs.value.split('¶');
                                            for (var i = 0; i < SelectedIDs.length - 1; i++) {
                                                asyncState = false;
                                                if (!IsAllocationExist) {
                                                    AutoFill.CheckAllocationExist(Number(0), Number(SelectedIDs[i]), IsInvoiceAllocationExist);
                                                    if (IsAllocationExist) { break; }
                                                }
                                            }
                                        }
                                    }

                                    document.getElementById("divJobItems").style.display = "none";
                                    document.getElementById("<%=div_JobStatus.ClientID%>").style.display = "block";
                                    OutStandingAmount = SelectItemsAmount;
                                    document.getElementById("ctl00_ContentPlaceHolder1_RadPanelBar1_i1_lblInvoiceSellingprice_").innerHTML = Currency + Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, SelectItemsAmount, 0, '', false, false, false);
                                    document.getElementById("ctl00_ContentPlaceHolder1_RadPanelBar1_i1_lblOustandingAmt").innerHTML = Currency + Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, SelectItemsAmount, 0, '', false, false, false);
                                }
                                    ...
                                    <tr>
                                        <td>
                                            <telerik:RadPanelBar runat="server" ID="RadPanelBar1" Height="100%" Skin="Default"
                                                ...
                                                <Items>
                                                    <telerik:RadPanelItem Text="Job Status" Font-Bold="true" Expanded="true" Width="455px"
                                                        CssClass="rounded-ReportTopcorners" Selected="true">
                                                        <ContentTemplate>
                                                            <div id="div_ProformaInvoice" runat="server" style="width: 98%">
                                                                <div class="box" style="margin-left: 5px; margin-bottom: 6px; width: 100%">
                                                                    <asp:RadioButton ID="rdnProformaInvYes" runat="server" Checked="false" GroupName="ProformaInvoice"
                                                                        Width="300px" /><br />
                                                                    <asp:RadioButton ID="rdnProformaInvNo" runat="server" Checked="true" GroupName="ProformaInvoice" /><br />
                                                                </div>
                                                    ...
                                                    <telerik:RadPanelItem Width="455px" Text="Invoice Payment" Expanded="false" Font-Bold="true"
                                                        ...
                                                        <ContentTemplate>
                                                            <div id="div_invpayment" style="margin-top: 8px; margin-left: 12px">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; float: left">
                                                                            ...
                                                                            <div id="PaidYesNo_module" runat="server" style="width: 100%; display: none">
                                                                                <div align="left" style="border: 0px solid black">
                                                                                    ...
                                                                                    <div class="box" style="margin-left: 1px">
                                                                                        <span id="spn_PaymentMode_Module" style="width: auto; padding-left: 4px; padding-right: 4px; display: none;"
                                                                                            class="spanerrorMsg">
                                                                                ...
                                                                                <div align="left">
                                                                                    ...
                                                                                    <div class="box" style="margin-left: 1px">
                                                                                        <span id="spn_InvoicePaymentDaterfq_module" style="width: auto; padding-left: 4px; padding-right: 4px; display: none"
                                                                                            class="spanerrorMsg">
                                                                                ...
                                                                                <div align="left">
                                                                                    ...
                                                                                    <div id="DivNotes_Text_module" class="MultileText" style="float: left; margin-top: -3px; margin-left: -1px">
                                                                                        <asp:TextBox ID="txt_PaymentDetailNotes_module" runat="server" TextMode="MultiLine"
                                                                                            SkinID="textPad_est"></asp:TextBox>
                                                                                    </div>
                                                                                    <div id="DivNotes_Value_module" runat="server" class="box" style="float: left; margin-top: -3px; width: 100px; display: none">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div id="div_CreditCardDetails_module" runat="server" style="display: none; width: 100%; border: 0px solid black">
                                                                                <div>
                                                                                    <div style="float: left; width: 100%;">
                                                                                        ...
                                                                                        <div style="float: left; width: 170px; padding-left: 3px" id="div_holderNameText_module">
                                                                                            ...
                                                                                            <span id="spn_HolderName_module" class="spanerrorMsg" style="display: none; float: left; width: auto; padding-left: 4px; padding-right: 4px">&nbsp;&nbsp;&nbsp;This is a
                                                                                                required field</span>
                                                                                        </div>
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <div style="margin-left: 114px; border: 0px solid black;" id="div_CardNumberText_module">
                                                                                        <div style="float: left; padding-left: 3px; width: 170px">
                                                                                            ...
                                                                                            <span id="spn_cardNumber_module" class="spanerrorMsg" style="display: none; float: left; width: auto; padding-left: 4px; padding-right: 4px">Please enter valid card number</span>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div style="border: 0px solid black">
                                                                                        ...
                                                                                        <div style="border: 0px solid black">
                                                                                            ...
                                                                                            <div style="float: left;">
                                                                                                <span id="spn_ddlyear_module" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; text-align: left;">This is a required field</span>
                                                                                            </div>
                                                                                        </div>
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <div style="margin-left: 114px;" id="div_VarificationText_module">
                                                                                        <div style="float: left; padding-left: 3px; width: 170px">
                                                                                            <asp:TextBox ID="txt_verification_module" runat="server" MaxLength="4" Style="width: 60px; float: left;"
                                                                                                onkeypress="javascript:return onlyNumbersforVN(event);"></asp:TextBox>
                                                                                            <span id="spn_verification_module" class="spanerrorMsg" style="width: auto; padding-left: 4px; padding-right: 4px; display: none; float: left;">Please enter valid verification
                                                                                                number</span>
                                                                                        </div>
                                                                                    </div>
                                ...
                                <ContentTemplate>
                                    <div align="left" style="width: 98%; vertical-align: top; margin-top: -13px;">
                                        <asp:UpdatePanel ID="updEdit" runat="server">
                                            <ContentTemplate>
                                                <div align="left" id="divaddforother" runat="server" style="width: 98%; position: absolute; left: 0px;">
                                                    <div align="left">
                                                        <table cellpadding="0" cellspacing="0" style="width: 98%; float: left">
                                                                ...
                                                                <td>
                                                                    <div id="divamountpaid" runat="server">
                                                                        <div id="div_invopmnt" runat="server" align="left" style="width: 100%">
                                                                            ...
                                                                            <div id="divInvDetails" runat="server" align="center" style="padding-left: 12px; padding-right: 5px;">
                                                                     ...
                                                                     <%=objLanguage.GetLanguageConversion("invoice_number")%>   
                                                                         ...
                                                                         <%=objLanguage.GetLanguageConversion("Invoice_Amount")%>
                                                                                            ...
                                                                                            <asp:Label ID="lblInvAmountvalue" Width="150px" runat="server" CssClass="box1" Style="text-align: left; margin-top: 4px;">
                                                                                            </asp:Label>
                                                                                        </td>
                                                                                        <td>
                                                                         ...
                                                                         <%=objLanguage.GetLanguageConversion("Outstanding")%>
                                                                            ...
                                                                            <div style="padding-top: 5px">
                                                                                ...
                                                                                Visible="false">
                                                                                    ...
                                                                                    <asp:LinkButton ID="lblnewpayment" runat="server" Style="text-decoration: underline; margin-right: 0px;"
                                                                                        ForeColor="#10357F" OnClientClick="javascript:hideshowAddEdit();slideIt('divaddforother');return false;">
                                                                                        <span id="spnlnk" runat="server" class="normaltext" style="font-size: 11px; color: #10357F;"></span>
                                                                                    </asp:LinkButton>
                                                                                </div>
                                                                            </div>
                                                                                            ...
                                                                                            <div style="padding: 5px 5px 0px 10px; width: 100%;" align="left">
                                                                                                <div style="width: 100%;">
                                                                                                    <telerik:RadGrid ID="RadGrid2" runat="server" OnItemDataBound="OnItemDataBound_RadGrid2"
                                                                                                        PagerStyle-Visible="true" PagerStyle-AlwaysVisible="true" AllowSorting="false"
                                                                                                        ...
                                                                                                        <MasterTableView ShowFooter="true" CommandItemDisplay="None" Dir="LTR" Frame="Border"
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                <telerik:GridTemplateColumn UniqueName="a" AllowFiltering="false" ItemStyle-HorizontalAlign="Center">
                                                                                                                    ...
                                                                                                                    <ItemTemplate>
                                                                                                                        <div style="float: left; width: 90px; overflow: hidden" align="left">
                                                                                                                            <asp:LinkButton ID="lnkdate" Width="90px" runat="server" Style="text-decoration: none; cursor: default"
                                                                                                                                OnCommand="lnkbtnEdit_Click" ForeColor="Black" CommandArgument='<%#Eval("id")%>'>
                                                                                                                    ...
                                                                                                                    <ItemTemplate>
                                                                                                                        <div>
                                                                                                                            <div style="float: left; width: 90px; overflow: hidden">
                                                                                                                                <asp:LinkButton ID="lnkmode" Width="90px" runat="server" Style="text-decoration: none; cursor: default"
                                                                                                                                    ForeColor="Black" OnCommand="lnkbtnEdit_Click" CommandArgument='<%#Eval("id")%>'>
                                                                                                                ...
                                                                                                                <telerik:GridTemplateColumn AllowFiltering="false" UniqueName="amount" ItemStyle-HorizontalAlign="Right"
                                                                                                                    ...
                                                                                                                    <ItemTemplate>
                                                                                                                        <div>
                                                                                                                            <asp:LinkButton ID="lnkamt" Width="90px" runat="server" Style="text-decoration: none; cursor: default"
                                                                                                                                ForeColor="Black" OnCommand="lnkbtnEdit_Click" CommandArgument='<%#Eval("id")%>'>
                                                                                                                ...
                                                                                                                <telerik:GridTemplateColumn AllowFiltering="false" ItemStyle-HorizontalAlign="Left"
                                                                                                                    ...
                                                                                                                    <ItemTemplate>
                                                                                                                        <div>
                                                                                                                            <asp:LinkButton ID="lnknote" Width="180px" runat="server" Style="text-decoration: none; cursor: default"
                                                                                                                                ForeColor="Black" OnCommand="lnkbtnEdit_Click" CommandArgument='<%#Eval("id")%>'>
                                                                                                                ...
                                                                                                                <telerik:GridTemplateColumn AllowFiltering="false">
                                                                                                                    ...
                                                                                                                    <HeaderTemplate>
                                                                                                                        <div style="float: left">
                                                                                                                            <asp:Label ID="lblAction" Text="Action" runat="server"><%=objLanguage.GetLanguageConversion("Action")%></asp:Label>
                                                                                                                        </div>
                                                                                                                    </HeaderTemplate>
                                                                                                                    <ItemTemplate>
                                                                            ...
                                                                            <div id="divpaymentradio" runat="server" style="display: none; margin-top: 25px; margin-left: 5px;">
                                                                ...
                                                                <td>
                                                                    <div id="PaidYesNo" runat="server" style="width: 100%; display: none; margin-left: 5px;">
                                                                        <div align="left" style="border: 0px solid black">
                                                                            ...
                                                                            <div class="box" style="margin-left: 1px">
                                                                                <span id="spn_PaymentMode" style="width: auto; padding-left: 4px; padding-right: 4px; display: none;"
                                                                                    class="spanerrorMsg">
                                                                                    <%=objLanguage.GetLanguageConversion("Please_select_Payment_Mode")%></span>
                                                                            </div>
                                                                        ...
                                                                        <div align="left">
                                                                            ...
                                                                            <div class="box" style="margin-left: 1px">
                                                                                <span id="spn_InvoicePaymentDaterfq" style="width: auto; padding-left: 4px; padding-right: 4px; display: none"
                                                                                    class="spanerrorMsg">
                                                                                    <%=objLanguage.GetLanguageConversion("Please_Enter_Valid_Date") %></span>
                                                                            </div>
                                                                        ...
                                                                        <div align="left">
                                                                            ...
                                                                            <div id="DivNotes_Text" runat="server" class="MultileText" style="float: left; margin-top: -3px; margin-left: -1px">
                                                                                <asp:TextBox ID="txt_PaymentDetailNotes" runat="server" TextMode="MultiLine" SkinID="textPad_est"></asp:TextBox>
                                                                            </div>
                                                                            <div id="DivNotes_Value" runat="server" class="box" style="float: left; margin-top: -3px; width: 100px; display: none">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div id="div_OdrPaymentDetails" runat="server" style="width: 100%; display: none; margin-left: 5px;">
                                                                        <div align="left">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div id="div_CreditCardDetails" runat="server" style="display: none; width: 100%; margin-left: 5px; border: 0px solid black">
                                                                        <div>
                                                                            <div style="float: left; width: 100%;">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div style="margin-left: 114px; border: 0px solid black" id="div_CardNumberText"
                                                                                ...
                                                                                <div style="float: left; padding-left: 3px; width: 170px">
                                                                                    ...
                                                                                    <span id="spn_cardNumber" class="spanerrorMsg" style="display: none; float: left; width: auto; padding-left: 4px; padding-right: 4px">Please enter valid card number</span>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div>
                                                                            <div style="border: 0px solid black">
                                                                                ...
                                                                                <div style="border: 0px solid black">
                                                                                    ...
                                                                                    <span id="spn_ddlmonth" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px">This is a required field</span>
                                                                                    <div style="float: left;">
                                                                                        <span id="spn_ddlyear" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; text-align: left;">This is a required field</span>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div style="margin-left: 114px;" id="div_VarificationText">
                                                                                <div style="float: left; padding-left: 3px; width: 170px">
                                                                                    <asp:TextBox ID="txt_verification" runat="server" MaxLength="4" Style="width: 60px; padding-left: 3px; float: left;"
                                                                                        onkeypress="javascript:return onlyNumbersforVN(event);"></asp:TextBox>
                                                                                    <span id="spn_verification" class="spanerrorMsg" style="display: none; float: left; width: auto; padding-left: 4px; padding-right: 4px">Please enter valid varification
                                                                                        number</span>
                                                                                </div>
                                                                            </div>
                                        ...
                                        <asp:UpdatePanel ID="upaddedit" runat="server">
                                            <ContentTemplate>
                                                <div id="divaddEdit" runat="server" style="width: 98%; display: none; right: 0px; position: absolute;">
                                                    <asp:Button ID="imgback" runat="server" CssClass="button" Style="padding-left: -10px; margin-bottom: -15px; margin-left: -1px;"
                                                        Text="Back" ToolTip="Back to Payment Record History"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" style="width: 100%; float: left">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div id="divamtpaidAddEdit" runat="server">
                                                                    ...
                                                                    <div id="divamttxtaddEdit" class="box">
                                                                        ...
                                                                        <asp:HiddenField ID="hdntxtvalue" runat="server" Value="0" />
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                <div id="PaidYesNo_Add" runat="server" style="width: 100%;">
                                                                    <div align="left" style="border: 0px solid black">
                                                                        ...
                                                                        <div class="box" style="margin-left: 1px">
                                                                            <span id="spn_PaymentMode_Add" style="width: auto; padding-left: 4px; padding-right: 4px; display: none;"
                                                                                class="spanerrorMsg">
                                                                                <%=objLanguage.GetLanguageConversion("Please_select_Payment_Mode")%></span>
                                                                        </div>
                                                                    ...
                                                                    <div align="left">
                                                                        ...
                                                                        <div id="DivNotes_Text_Add" runat="server" class="MultileText" style="float: left; margin-top: -3px; margin-left: 1px">
                                                                        ...
                                                                        <div id="DivNotes_Value_Add" runat="server" class="box" style="float: left; margin-top: -3px; width: 10px; display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div id="div_CreditCardDetails_Add" runat="server" style="display: none; width: 100%; border: 0px solid black">
                                                                    <div>
                                                                        <div style="float: left; width: 100%;">
                                                                            ...
                                                                            <div style="float: left; width: 170px; padding-left: 4px" id="div_holderNameText_Add"
                                                                                ...
                                                                                <span id="spn_HolderName_Add" class="spanerrorMsg" style="display: none; float: left;">&nbsp;&nbsp;&nbsp;This is a required field</span>
                                                                            </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div style="margin-left: 114px; border: 0px solid black" id="div_CardNumberText_Add"
                                                                            ...
                                                                            <div style="float: left; padding-left: 4px; width: 170px">
                                                                                ...
                                                                                <span id="spn_cardNumber_Add" class="spanerrorMsg" style="display: none; float: left;">Please enter valid card number</span>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div style="border: 0px solid black">
                                                                            ...
                                                                            <div style="border: 0px solid black">
                                                                                ...
                                                                                <span id="spn_ddlmonth_Add" class="spanerrorMsg" style="display: none">This is a required
                                                                                    field</span>
                                                                                <div style="float: left;">
                                                                                    <span id="spn_ddlyear_Add" class="spanerrorMsg" style="display: none; width: 185px; text-align: left;">This is a required field</span>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div style="margin-left: 114px;" id="div_VarificationText_Add">
                                                                            <div style="float: left; padding-left: 4px; width: 170px">
                                                                                <asp:TextBox ID="txt_verification_Add" runat="server" MaxLength="4" Style="width: 60px; padding-left: 3px; float: left;"
                                                                                    onkeypress="javascript:return onlyNumbersforVN(event);"></asp:TextBox>
                                                                                <span id="spn_verification_Add" class="spanerrorMsg" style="display: none; float: left;">Please enter valid varification number</span>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div id="div_StripeCreditCardDetails" runat="server" style="display: none; width: 100%; border: 0px solid black">
                                                                    <div>
                                                                        <div style="float: left; width: 100%;">
                                                                            <asp:Label ID="lbl_HolderName_Add_Stripe" runat="server" CssClass="bglabelforamountpaid"
                                                                                Style="width: 150px"></asp:Label>
                                                                            <div style="float: left; width: 170px; padding-left: 4px" id="div5"
                                                                                runat="server">
                                                                                <asp:TextBox ID="txt_HolderName_Add_Stripe" runat="server" Style="float: left" Width="185px"></asp:TextBox>
                                                                                <span id="spn_HolderName_Add_Stripe" class="spanerrorMsg" style="display: none; float: left;">&nbsp;&nbsp;&nbsp;This is a required field</span>
                                                                            </div>
                                                                            <div id="div_HolderName_Add_Stripe" runat="server">
                                                                                <asp:Label ID="lbl_CardHolderName_Add_Stripe" runat="server" Style="margin-left: 5px;"></asp:Label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="clearBoth">
                                                                    ...
                                                                    <div style="border: 0px solid black">
                                                                        <div style="width: 100%;">
                                                                            <asp:Label ID="lbl_cardType_Add_Stripe" class="bglabelforamountpaid" Style="width: 150px"
                                                                                runat="server"></asp:Label>
                                                                        </div>
                                                                        <div style="padding-left: 70px; width: 350px; border: 0px solid black" id="div7"
                                                                            runat="server">
                                                                            <table style="padding-top: -50px; border: 0px solid black">
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:RadioButton ID="rbnVisaID_Add_Stripe" runat="server" GroupName="credit" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <img id="imgVisaCard_Add_Stripe" runat="server" alt="Visa" title="Visa" src="~/images/StoreImages/cc_visa_icon.jpg"
                                                                                            height="20" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:RadioButton ID="rbnMasterCardID_Add_Stripe" runat="server" GroupName="credit" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <img id="imgMasterCard_Add_Stripe" runat="server" alt="Master Card" title="Master Card"
                                                                                            src="~/images/StoreImages/cc_master_card_icon.jpg" height="20" />
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:RadioButton ID="rbnDiscoverID_Add_Stripe" runat="server" GroupName="credit" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <img id="imgDiscoverCard_Add_Stripe" runat="server" alt="Discover" title="Discover" src="~/images/StoreImages/cc_discover_icon.jpg"
                                                                                            height="20" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:RadioButton ID="rbnAmericanID_Add_Stripe" runat="server" GroupName="credit" Style="padding-bottom: 50px" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <img id="imgAmericanCard_Add_Stripe" runat="server" alt="American Card" title="American Card"
                                                                                            src="~/images/StoreImages/cc_amex_icon.jpg" height="20" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </div>
                                                                        <div id="div_CardType_Add_Stripe" runat="server">
                                                                            <asp:Label ID="lbl_CardTypeValue_Add_Stripe" runat="server" Style="margin-left: 5px;"></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="clearBoth">
                                                                    </div>
                                                                    <div>
                                                                        <div style="width: 100%;">
                                                                            <asp:Label ID="lbl_cardNumber_Add_Stripe" runat="server" Style="width: 150px" CssClass="bglabelforamountpaid"></asp:Label>
                                                                        </div>
                                                                        <div style="margin-left: 114px; border: 0px solid black" id="div_CardNumberText_Add_Stripe"
                                                                            runat="server">
                                                                            <div style="float: left; padding-left: 4px; width: 170px">
                                                                                <asp:TextBox ID="txt_cardNumber_Add_Stripe" runat="server" Style="width: 185px; float: left"></asp:TextBox>
                                                                                <span id="spn_cardNumber_Add_Stripe" class="spanerrorMsg" style="display: none; float: left;">Please enter valid card number</span>
                                                                            </div>
                                                                        </div>
                                                                        <div id="div_CardNumber_Add_Stripe" runat="server">
                                                                            <asp:Label ID="lbl_CardNumberValue_Add_Stripe" runat="server" Style="margin-left: 5px;"></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="clearBoth">
                                                                    </div>
                                                                    <div>
                                                                        <div style="border: 0px solid black">
                                                                            <div style="width: 100%; border: 0px solid red">
                                                                                <asp:Label ID="lbl_expDate_Add_Stripe" runat="server" Style="width: 150px" CssClass="bglabelforamountpaid"></asp:Label>
                                                                            </div>
                                                                            <div style="margin-left: 114px; width: 200px; border: 0px solid green" id="div_MonthYearValue_Add_Stripe"
                                                                                runat="server">
                                                                                <table>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:DropDownList ID="ddl_month_Add_Stripe" runat="server" Style="">
                                                                                                <asp:ListItem Text="Month" Value="0" Selected="True"></asp:ListItem>
                                                                                                <asp:ListItem Text="01" Value="1"></asp:ListItem>
                                                                                                <asp:ListItem Text="02" Value="2"></asp:ListItem>
                                                                                                <asp:ListItem Text="03" Value="3"></asp:ListItem>
                                                                                        ...
                                                                                        <td style="padding-left: 15px">
                                                                                            <asp:DropDownList ID="ddl_year_Add_Stripe" runat="server" Style="">
                                                                                                <asp:ListItem Text="Year" Value="0" Selected="True"></asp:ListItem>
                                                                                                <asp:ListItem Text="2023" Value="2023"></asp:ListItem>
                                                                                                <asp:ListItem Text="2024" Value="2024"></asp:ListItem>
                                                                                                <asp:ListItem Text="2025" Value="2025"></asp:ListItem>
                                                                            ...
                                                                            <div style="border: 0px solid black">
                                                                                ...
                                                                                <span id="spn_ddlmonth_Add_Stripe" class="spanerrorMsg" style="display: none">This is a required
                                                                                    field</span>
                                                                                <div style="float: left;">
                                                                                    <span id="spn_ddlyear_Add_Stripe" class="spanerrorMsg" style="display: none; width: 185px; text-align: left;">This is a required field</span>
                                                                                </div>
                                                                            </div>
                                                                            <div id="div_MonthYear_Add_Stripe" runat="server">
                                                                                <asp:Label ID="lbl_ExpireDate_Add_Stripe" runat="server" Style="margin-left: 5px;"></asp:Label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="clearBoth">
                                                                    ...
                                                                    <div>
                                                                        <div>
                                                                            <asp:Label ID="lbl_verification_Add_Stripe" runat="server" Text="Verification Number" Style="width: 150px"
                                                                                CssClass="bglabelforamountpaid"></asp:Label>
                                                                        </div>
                                                                        <div style="margin-left: 114px;" id="div_VarificationText_Add_Stripe">
                                                                            <div style="float: left; padding-left: 4px; width: 170px">
                                                                                <asp:TextBox ID="txt_verification_Add_Stripe" runat="server" MaxLength="4" Style="width: 60px; padding-left: 3px; float: left;"
                                                                                    onkeypress="javascript:return onlyNumbersforVN(event);"></asp:TextBox>
                                                                                <span id="spn_verification_Add_Stripe" class="spanerrorMsg" style="display: none; float: left;">Please enter valid varification number</span>
                                                                            </div>
                                                                        </div>
                                                                        <div id="div13" runat="server">
                                                                            <asp:Label ID="Label16" runat="server" Style="margin-left: 5px;"></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="clearBoth">
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div id="divbtnrecord" align="left" runat="server" style="display: none; width: 100%; border: 0px solid;">
                                                                    <table>
                                                                        <tr>
                                                                            <div id="Div1" style="margin-right: 25px;" runat="server">
                                                                                ...
                                                                                <td>
                                                                                    <div id="div_recordclosemain" style="margin-right: 150px; margin-top: 0px;">
                                                                                        <div id="div2" style="float: left; margin-left: -5px; vertical-align: top">
                                                                                            <asp:Button ID="btnRecordNclose" runat="server" Text="Record & Close" CssClass="button"
                                                                ...
                                                                <div id="divUpdateMain" align="left" runat="server" style="display: none; width: 100%; border: 0px solid; margin-top: 0px; margin-left: 150px">
                                                ...
                                                <div id="divview" runat="server" style="width: 98%; display: none; right: 0px; position: absolute;">
                                                    <asp:Button ID="imgbackforview" runat="server" CssClass="button" Style="padding-left: -5px; margin-left: 3px;"
                                                        Text="Back" ToolTip="Back to Payment Record History" OnClientClick="javascript:slideView('divview');return false;" />
                                                    <div class="clearBoth" style="margin-top: 12px;">
                                                    </div>
                                                    <fieldset>
                                                        <legend id="lgheader" runat="server"></legend>
                                                        <table id="PaymentDetails" runat="server" cellpadding="0" cellspacing="0" style="width: auto; float: left">
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lblNVHoldervalue" runat="server" Style="margin: 0 0 2px; vertical-align: middle; float: left; font-size: 11px; padding: 5px;">
                                                                    </asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lblNVCardtypeValue" Style="margin: 0 0 2px; vertical-align: middle; float: left; font-size: 11px; padding: 5px;"
                                                                        runat="server">
                                                                    </asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lblNVCardnoValue" Style="margin: 0 0 2px; vertical-align: middle; float: left; font-size: 11px; padding: 5px;"
                                                                        runat="server">
                                                                    </asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div style="margin: 0 0 2px; vertical-align: middle; float: left; font-size: 11px; padding: 5px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lblNVVerNoValue" Style="margin: 0 0 2px; vertical-align: middle; float: left; font-size: 11px; padding: 5px;"
                                                                        runat="server">
                                                                    </asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table id="TableForBraintree" runat="server" cellpadding="0" cellspacing="0" style="width: auto; float: left; display: none;">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblOrderId_BT" Text='Braintree ID' runat="server" CssClass="bglabelforamountpaid"
                                                                        Style="width: 150px"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="lblOrderId_Value" Style="margin: 0 0 2px; vertical-align: middle; float: left; font-size: 11px; padding: 5px;"
                                                                        runat="server">
                                                                    </asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblAuthorizationcode" Text='Authorization Code' runat="server" CssClass="bglabelforamountpaid"
                                                                        Style="width: 150px"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="lblAuthorizationcode_BTvalue" Style="margin: 0 0 2px; vertical-align: middle; float: left; font-size: 11px; padding: 5px;"
                                                                        runat="server">
                                                                    </asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table id="TableForStripe" runat="server" cellpadding="0" cellspacing="0" style="width: auto; float: left; display: none;">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblOrderId_ST" Text='Stripe ID' runat="server" CssClass="bglabelforamountpaid"
                                                                        Style="width: 150px"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="lblOrdetId_STValue" Style="margin: 0 0 2px; vertical-align: middle; float: left; font-size: 11px; padding: 5px;"
                                                                        runat="server">
                                                                    </asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblSTAuthorizationcode" Text='Authorization Code' runat="server" CssClass="bglabelforamountpaid"
                                                                        Style="width: 150px"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="lblAuthorizationcode_STvalue" Style="margin: 0 0 2px; vertical-align: middle; float: left; font-size: 11px; padding: 5px;"
                                                                        runat="server">
                                                                    </asp:Label>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div align="left" style="width: 100%; border: 0px solid">
                                            ...
                                            <div id="div_main" style="float: left; margin-left: 37%; border: 0px solid black">
                                                <div id="DivBtnPay" runat="server" style="float: left; margin-left: -8px; margin-bottom: 5px; display: none;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate_dateForModule() {
            ...
            if (Paymenttype == 'Credit Card' || Paymenttype == 'PayPal' || Paymenttype == 'Braintree Credit Card' || Paymenttype == 'Stripe Credit Card') {
                return true;
            }
            else {
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Close(Invoice_ID) {

            if (Invoice_ID != -1) {
                var oWindow = GetRadWindow();
                var url;
                if (window.location.href.indexOf("ProgressToInvoiceFromJob") != -1) {
                    url = "<%=strSitepath%>invoice/invoice_summary_reeng.aspx?estid=<%=EstimateID%>&InvID=" + Invoice_ID;
                    oWindow.BrowserWindow.location.href = '<%=strSitepath%>invoice/invoice_summary_reeng.aspx?estid=<%=EstimateID%>&InvID=' + Invoice_ID;
                }
                else if (window.location.href.indexOf("ProgressToInvoiceFromOrder") != -1) {
                    url = "<%=strSitepath%>invoice/invoice_order_summary.aspx?frm=view&estid=<%=EstimateID%>&ordid=<%=OrderID%>&InvID=" + Invoice_ID;
                    oWindow.BrowserWindow.location.href = '<%=strSitepath%>invoice/invoice_order_summary.aspx?frm=view&estid=<%=EstimateID%>&ordid=<%=OrderID%>&InvID=' + Invoice_ID;
                }
        ...
        function CreditCardValidation() {
            ...
            if (ddlPayment.options[ddlPayment.selectedIndex].value == "4") {
            ...
            else if (ddlPayment.options[ddlPayment.selectedIndex].value == "15") {
                var txt_cardNumber = document.getElementById("ctl00_ContentPlaceHolder1_txt_cardNumber_Add_Stripe");
                var rbnAmericanID = document.getElementById("ctl00_ContentPlaceHolder1_rbnAmericanID_Add_Stripe");
                var rbnVisaID = document.getElementById("ctl00_ContentPlaceHolder1_rbnVisaID_Add_Stripe");
                var rbnMasterCardID = document.getElementById("ctl00_ContentPlaceHolder1_rbnMasterCardID_Add_Stripe");
                var rbnDiscoverID = document.getElementById("ctl00_ContentPlaceHolder1_rbnDiscoverID_Add_Stripe");
                var txt_verification = document.getElementById("<%=txt_verification_Add_Stripe.ClientID %>");
                var txt_HolderName = document.getElementById("<%=txt_HolderName_Add_Stripe.ClientID %>");
                var ddl_month = document.getElementById("<%=ddl_month_Add_Stripe.ClientID %>");
                var ddl_year = document.getElementById("<%=ddl_year_Add_Stripe.ClientID %>");

                var CreditCheck = false;
                var re = '';

                if (txt_cardNumber.value == "") {
                    document.getElementById("spn_cardNumber_Add_Stripe").style.display = "block";
                    CreditCheck = true;
                }
                else if (!Number(txt_cardNumber.value)) {
                    document.getElementById("spn_cardNumber_Add_Stripe").style.display = "block";
                    document.getElementById("spn_cardNumber_Add_Stripe").innerHTML = '<%=objLanguage.GetLanguageConversion("Please_Enter_Valid_Number") %>';
                    CreditCheck = true;
                }
                ...
                if (!re.test(txt_cardNumber.value)) {
                    ...
                    //                alert('valid');
                    document.getElementById("spn_cardNumber_Add_Stripe").style.display = "none";
                }
                ...
                if (txt_verification.value == "") {
                    document.getElementById("spn_verification_Add_Stripe").style.display = "block";
                    CreditCheck = true;
                }
                else if (!Number(txt_verification.value)) {
                    //                alert('CreditCheck1  _' + CreditCheck);
                    document.getElementById("spn_verification_Add_Stripe").style.display = "block";
                    document.getElementById("spn_verification_Add_Stripe").innerHTML = '<%=objLanguage.GetLanguageConversion("Please_Enter_Valid_Number") %>';
                    CreditCheck = true;
                }
                else {
                    document.getElementById("spn_verification_Add_Stripe").style.display = "none";
                }


                if (txt_HolderName.value == "") {
                    document.getElementById("spn_HolderName_Add_Stripe").style.display = "block";
                    CreditCheck = true;
                }
                else {
                    document.getElementById("spn_HolderName_Add_Stripe").style.display = "none";
                }

                if (ddl_month.selectedIndex == 0 || ddl_year.selectedIndex == 0) {
                    document.getElementById("spn_ddlyear_Add_Stripe").style.display = "block";
                    document.getElementById("spn_ddlyear_Add_Stripe").innerHTML = '<%=objLanguage.GetLanguageConversion("Please_select_valid_month_year") %>';
                    CreditCheck = true;
                }
                else {
                    document.getElementById("spn_ddlyear_Add_Stripe").style.display = "none";
                }
    ...
    <script type="text/javascript">
        ...
        function OnChangeForSummary() {
            ...
            if (document.getElementById("div_ProgressToInvoice").style.display == "block") {
                ...
                var DivBtnPay = document.getElementById("<%=DivBtnPay.ClientID%>");
                ...
                var divbtnrecord = document.getElementById("ctl00_ContentPlaceHolder1_divbtnrecord");
                var DivPayment_Value = document.getElementById("<%=DivDate_Value.ClientID%>");
                var DivDate_Value = document.getElementById("<%=DivDate_Value.ClientID%>");
        ...
        function ProgressJob_reeng_OrderNew() {
            ...
            if (Ispaidenable == '1') {
                if (ret == 1) {
                    ...
                    if (hdnPaymentMode.value == "Credit Card" || hdnPaymentMode.value == "PayPal" || hdnPaymentMode.value == "Braintree Credit Card" || hdnPaymentMode.value == "Stripe Credit Card") {
                        hdnHeader.value = "Progress To Invoice";
                        document.getElementById("<%=DivBtnPay.ClientID%>").style.display = "none";
                        document.getElementById("<%=DivPayment_Value.ClientID%>").style.display = "none";
                        document.getElementById("<%=DivDate_Value.ClientID%>").style.display = "none";
        ...
        function hideshowAddEdit() {
            ...
            if (Paymenttype != 'Credit Card') {
                ...
                //ddl_pmntMode.selectedIndex = 0;
                //if (ddl_pmntMode.options[ddl_pmntMode.selectedIndex].value == "4") {
                //    DisplayCreditCardsForAdd();
                //}
                if (ddl_pmntMode.options[ddl_pmntMode.selectedIndex].value == "15") {
                    DisplayStripeCreditCards();
                }
                options[0].checked = true;
        ...
        function validate_date_Add() {
            ...
            if (flag == true) {
                ...
                //else if (ddlPayment.options[ddlPayment.selectedIndex].value == "4") {
                //    if (rbnVisaID.checked == true || rbnAmericanID.checked == true || rbnMasterCardID.checked == true || rbnDiscoverID.checked == true) {
                //        flag = true;
                //    }
                //    else {
        ...
        function DisplayStripeCreditCards() {
            var ddlPayment = document.getElementById("<%=ddl_Paymentmode_Add.ClientID%>");
            var rbnVisaID = document.getElementById("<%=rbnVisaID_Add_Stripe.ClientID%>");
            var rbnAmericanID = document.getElementById("<%=rbnAmericanID_Add_Stripe.ClientID%>");
            var rbnMasterCardID = document.getElementById("<%=rbnMasterCardID_Add_Stripe.ClientID%>");
            var rbnDiscoverID = document.getElementById("<%=rbnDiscoverID_Add_Stripe.ClientID%>");
            document.getElementById("<%=div_CreditCardDetails_Add.ClientID%>").style.display = "none";
            if (ddlPayment.options[ddlPayment.selectedIndex].value == "15") {
                document.getElementById("<%=div_StripeCreditCardDetails.ClientID%>").style.display = "block";
                document.getElementById("<%=txt_HolderName_Add_Stripe.ClientID%>").value = '';
                document.getElementById("<%=txt_cardNumber_Add_Stripe.ClientID%>").value = '';
                document.getElementById("<%=txt_verification_Add_Stripe.ClientID%>").value = '';
                    document.getElementById("<%=ddl_month_Add_Stripe.ClientID%>").selectedIndex = 0;
                document.getElementById("<%=ddl_year_Add_Stripe.ClientID%>").selectedIndex = 0;
                rbnVisaID.selected = false;
                rbnAmericanID.selected = false;
                rbnMasterCardID.selected = false;
                rbnDiscoverID.selected = false;
                ...
                document.getElementById("<%=div_StripeCreditCardDetails.ClientID%>").style.display = "none";
                rbnVisaID.selected = false;
                rbnAmericanID.selected = false;
                rbnMasterCardID.selected = false;
                rbnDiscoverID.selected = false;
