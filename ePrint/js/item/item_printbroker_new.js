...
function GetPBPhraseBook(para, type) {
    if (para == "header") {
        ...
        window.radopen(strSitepath + "common/phrase_book.aspx?type=" + type, null, '1000', '500');
...
var roundTrip = 0;
var cnt = 1;
function CreatePriceComparison(supObj, value) {
    ...
    if (supValue != "0" && supValue != '') {
        ...
        for (var j = 1; j <= qtyCount; j++) {
            ...
            if (value == 2) {
                ...
                uniData += "<div id='Div_row_" + comnID + "'>"
                //if (j == 1) {
                uniData += "<div id='Div_EmptytxtRefno_" + comnID + "' style='float: left; width: 9%'><input id='txtRefNo_" + comnID + "' type='text' class='textboxnew' style='Width:90%;text-align:right;' /></div>";
                //}
                //else {
                //    uniData += "<div id='Div_EmptytxtRefno_" + comnID + "' style='float: left; width: 9%'>&nbsp;</div>";
                //}
                uniData += "<div id='Div_name_" + comnID + "' style='float: left; width: 6%; word-break: break-all;'>" + name + "</div>";
                uniData += "<div style='float: left; width: 6%;padding-right:5px'><input id='txtQty_" + comnID + "' type='text'  value='" + QtyValue + "' class='textboxnew' style='Width:80%;text-align:right' disabled='true' /></div>";
                uniData += "<div style='float: left; width: 9%'><input id='txtCost_" + comnID + "' type='text' onchange=\"javascript:SelectChkQty('" + comnID + "');\" onclick='this.select();' onfocus='this.select();'  onblur=\"javascript:todecimal_function(this,this.value);AllowNumber(this,this.value);CalculatePrice('" + comnID + "','c');NumberToDecimal(this.id,this.value);\"' class='textboxnew' style='Width:80%;text-align:right' maxlength='20' /></div>";
                ...
                uniData += "<div style='float: left; width: 7%'><select id='ddlDeliveryIncluded_" + comnID + "' onchange=DropdownChange(this,'txtDeliveryCost_" + comnID + "'); style='Width:80%' class='normaltext'><option value='yes'>yes</option><option value='no' " + SelectedValue + ">No</option></select></div>";
                if (j == 1) {
                    uniData += "<div style='float: left; width: 9%'><input id='txtDeliveryDate_" + comnID + "'  onClick=\"javascript:event.cancelBubble=true;this.select();lcs(this,'" + DateFormatNEW + "');\" onblur=\"javascript:CopyDate(" + supValue + "," + qtyCount + ",this.value);\" type='text' class='textboxnew' style='Width:80%' readonly='readonly' /></div>";
                }
                else {
                    uniData += "<div style='float: left; width: 9%'><input id='txtDeliveryDate_" + comnID + "'  onClick=\"javascript:event.cancelBubble=true;this.select();lcs(this,'" + DateFormatNEW + "');\" type='text' class='textboxnew' style='Width:80%' readonly='readonly' /></div>";
                }
                uniData += "<div style='float: left; width: 10%'><input id='txtDeliveryCost_" + comnID + "' " + disabledvalue + "  onblur=\"javascript:AllowNumber(this,this.value);todecimal_function(this,this.value);CalculatePrice('" + comnID + "','c');NumberToDecimal(this.id,this.value);\"' type='text' class='textboxnew' style='Width:80%;text-align:right' maxlength='20' /></div>";
                if (j == 1) {
                    ...
                    uniData += "<div style='float: left; width: 9%'><input id='txtMarkup_" + comnID + "' value='" + pb_markup + "'  onblur=\"javascript:todecimal_function(this,this.value);AllowNumber(this,this.value);CalculatePrice('" + comnID + "','c');NumberToDecimal(this.id,this.value);\"' type='text' class='textboxnew' style='Width:80%;text-align:right' value='' maxlength='20'  /></div>";
                }
                uniData += "<input type='hidden' id='hdnactualmarkup_" + comnID + "' runat='server' />";
                uniData += "<div style='float: left; width: 8%'><input id='txtTotalPrice_" + comnID + "' onblur=\"javascript:AllowNumber(this,this.value);CalculatePrice('" + comnID + "','price');\" type='text' class='textboxnew' style='Width:80%;text-align:right' maxlength='20' /></div>";

                if (isPer1000OutworkType()) {
                    uniData += "<div style='float: left; width: 7%'><input id='txtPer1000TotalPrice_" + comnID + "'readonly onblur=\"javascript:AllowNumber(this,this.value);CalculatePrice('" + comnID + "','price');\" type='text' class='textboxnew' style='Width:80%;text-align:right' maxlength='20' /></div>";
                }
                ...
                if (isPer1000OutworkType()) {
                    ...
                    uniData += "<div id='Div_name_" + comnID + "' style='float: left; width: 7%; word-break: break-all;'>" + name + "</div>";
                }
                ...
                if (isPer1000OutworkType()) {
                    uniData += "<div style='float: left; width: 8%'><input id='txtPer1000TotalPrice_" + comnID + "'readonly onblur=\"javascript:AllowNumber(this,this.value);CalculatePrice('" + comnID + "','price');\" type='text' class='textboxnew' style='Width:80%;text-align:right' maxlength='20' /></div>";
                }
    ...
    for (var k = 1; k <= qtyCount; k++) {
        ...
        if (k != QtyNumber && QtyNumber != 0 && qtyType != "single") {
            ...
            try {
                document.getElementById("txtPer1000TotalPrice_" + CountNew + "").style.display = 'none';
            } catch (e) {

            }

            document.getElementById("chk_" + CountNew + "").style.display = 'none';
            document.getElementById("Div_row_" + CountNew + "").style.display = 'none';

        }
        if (UcPage == "estimate" && k != 1) {
            CountNew = supValue + '_' + k;
            document.getElementById("txtRefNo_" + CountNew + "").style.visibility = 'hidden';
            document.getElementById("Div_name_" + CountNew + "").style.visibility = 'hidden';
        } else {
            CountNew = supValue + '_' + k;
            document.getElementById("Div_row_" + CountNew + "").style.padding = '5px 0px 25px 0px';
        }
    }
...
function OpenUpload() {
    ...
    var Rad_FileUpload = window.radopen(strSitepath + "estimates/artwork_files_upload_0.aspx?pg=" + UcPage + "&PageType=" + QueryType + "&EstimateID=" + EstimateID + "&jobID=" + JobID + "&InvoiceID=" + InvoiceID + "&EstType=" + EstType + "&EstimateItemID=" + EstimateItemID);
                ...
                for (var i = 0; i < strSupArray.length; i++) {
                    ...
                    if (arr1[1] != '' && arr1[1] != 'undefined') {
                        if (arr1[1] == "undefined") {
                            ...
                            OptionData += "<option value='" + arr1[0] + "'>" + SpecialDecode(arr1[1]) + "</option>";
                        }
                    }
...
function add_more() {
    ...
    if (supCount <= 12) {
        ...
        SupData += "<div class='bglabel' style='float:left;'>" + Name + "<img style='cursor:pointer;float:right' id='AddSuppID_" + labelCount + "' src='" + strImagepath + "plus.gif' border='0' title='Add New Supplier' onclick='javascript:openpopup(" + labelCount + ");' /></div>";
        ...
        //////*******//////
        SupData += "<div align='left'>";
        SupData += "<div class='bglabel'>" + Contact + "<img style='cursor:pointer;float:right' id='AddSuppID_" + labelCount + "' src='" + strImagepath + "plus.gif' border='0' title='Add New Contact' onclick='javascript:openpopup_contact(" + labelCount + ");' /></div>";
        ...
        SupData += "<div style='float:right;padding-right:12px;padding-top:2px'>";
...
function openpopup(spnid) {
    ...
    if (QueryType == "add") {
        if (ParentEstimateItemID == 0) {
            ...
            window.radopen(strSitepath + "common/Client_add_new.aspx?type=Supplier&post=" + modulename + "&item=Outwork&id=" + spnid + "&mode=" + QueryType + "&estid=" + EstimateID + "", null, '1000', '500');
            SetRadWindow('divrad', 'divBackGroundNew', '200');
            ...
            window.radopen(strSitepath + "common/Client_add_new.aspx?type=Supplier&post=" + modulename + "&item=Outwork&id=" + spnid + "&mode=" + QueryType + "&estid=" + EstimateID + "&maintype=" + MainType + "&parentestitemid=" + ParentEstimateItemID + "&parentesttype=" + ParentEstimateType + "", null, '1000', '500');
            SetRadWindow('divrad', 'divBackGroundNew', '200');
        }
    }
        ...
        if (ParentEstimateItemID == 0) {
            ...
            window.radopen(strSitepath + "common/Client_add_new.aspx?type=Supplier&post=" + modulename + "&item=Outwork&id=" + spnid + "&mode=" + QueryType + "&estid=" + EstimateID + "&EstItemID=" + EstimateItemID + "&esttype=" + EstType + "&maintype=" + MainType + "", null, '1000', '500');
            SetRadWindow('divrad', 'divBackGroundNew', '200');
        }
        else {
            ...
            window.radopen(strSitepath + "common/Client_add_new.aspx?type=Supplier&post=" + modulename + "&item=Outwork&id=" + spnid + "&mode=" + QueryType + "&estid=" + EstimateID + "&EstItemID=" + EstimateItemID + "&esttype=" + EstType + "&parentestitemid=" + ParentEstimateItemID + "&parentesttype=" + ParentEstimateType + "&subedit=y&sectionid=" + EstimateBookletItemID + "&maintype=" + MainType + "", null, '1000', '500');
            SetRadWindow('divrad', 'divBackGroundNew', '200');
        }
    }
}
    ...
    if (sup.SupplierID == 0 || sup.SupplierID == null) {
        ...
        if (QueryType == "add") {
            if (ParentEstimateItemID == 0) {
                ...
                window.radopen(strSitepath + "contact/contact_add.aspx?type=Supplier&clientid=" + sup.SupplierID + "&pg=" + modulename + "&item=Outwork&id=" + spnid + "&mode=" + QueryType + "&estid=" + EstimateID + "", null, '1000', '500');
                SetRadWindow('divrad', 'divBackGroundNew', '200');
            ...
            if (ParentEstimateItemID == 0) {
                ...
                window.radopen(strSitepath + "contact/contact_add.aspx?type=Supplier&clientid=" + sup.SupplierID + "&pg=" + modulename + "&item=Outwork&id=" + spnid + "&mode=" + QueryType + "&estid=" + EstimateID + "&EstItemID=" + EstimateItemID + "&esttype=" + EstType + "&maintype=" + MainType + "", null, '1000', '500');
                SetRadWindow('divrad', 'divBackGroundNew', '200');
    ...
    PageMethods.GetContacts(CompanyID, val, function Clist(retnValue) {
        ...
        for (var j = 0; j < strContArray.length; j++) {
            ...
            if (arr2[1] != '' && arr2[1] != null) {
                ddl.options.add(new Option(SpecialDecode(arr2[1]), arr2[0], j));
...
function PbNextBtn(next, prev) {
    ...
    if (next == "1") {
        ...
        if ((modulename != "estimates") || (modulename != "orders")) {
            btn_Outwork_PrintEmail.style.display = "block";
        }
    }
    else if (next == "2") {
...
function DivPriceCompClear_part_2() {
    ...
    for (var i = 1; i < labelCount; i++) {
        ...
        if (supObj != null) {
            ...
            document.getElementById("ddlSupplierContact_" + i).disabled = false;
            document.getElementById("ddlSupplier_" + i).disabled = false;
        }
    }
}
...
function CalculatePrice(ext, type) {
    ...
    var hdnactualmarkup = document.getElementById("hdnactualmarkup_" + ext).value;
    ...
    if (type == 'c') {
        if (trim12(txtCost) != '' && txtCost != costvalue) {
            ...
            else if (isPer1000OutworkType()) {

                var perUnitCost = Number(txtCost) / 1000;
                if (ddlMarkup == "percentage") {
                    Markup = (perUnitCost * Number(txtQty)) * (Number(txtMarkup) / Number(100));
                } else if (ddlMarkup == "fixedvalue") {
                    Markup = Number(txtMarkup);
                }
                //total = (Number(txtQty) * Number(txtCost)) + Number(Delivery) + Markup;
                total = (perUnitCost * Number(txtQty)) + Number(Delivery) + Number(Markup);
                totalper1000 = ((Number(total)) / Number(txtQty)) * 1000; //+ Number(Delivery) + Markup;
                txtPer1000TotalPrice.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, totalper1000, 0, '', false, false, true);
            }
            else {
                if (ddlMarkup == "percentage") {
                    Markup = Number((Number(txtCost) + Number(Delivery)) * Number(txtMarkup) / Number(100));
            ...
            if (ddlMarkup == "percentage") {
                var strmarkUp = '';
                strmarkUp = txtMarkup;
                strmarkUp = strmarkUp.substring(0, (strmarkUp.indexOf('.') + 11));
                document.getElementById("hdnactualmarkup_" + ext).value = strmarkUp;
            }
            else if (ddlMarkup == "fixedvalue") {
                document.getElementById("hdnactualmarkup_" + ext).value = Number(txtMarkup);
            }
        ...
        if (trim12(txtCost) != '' && txtCost != costvalue) {
            ...
            if (ddlCostingType.value == 'unit') {
                ...
                //total = (Number(txtQty) * Number(txtCost)) + Number(Delivery) + Markup;
                cost = (perUnitCost * Number(txtQty)) + Number(Delivery) + Number(Markup);
                totalper1000 = ((Number(cost)) / Number(txtQty)) * 1000; //+ Number(Delivery) + Markup;
                txtPer1000TotalPrice.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, totalper1000, 0, '', false, false, true);
            }
            else {
            ...
            if (ddlMarkup == "percentage") {
                var strmarkUp = '';
                strmarkUp = Markup.toString();
                strmarkUp = strmarkUp.substring(0, (strmarkUp.indexOf('.') + 11));
                document.getElementById("hdnactualmarkup_" + ext).value = strmarkUp;
            }
            else if (ddlMarkup == "fixedvalue") {
                document.getElementById("hdnactualmarkup_" + ext).value = Markup;
            }

            if (Number(document.getElementById("txtMarkup_" + ext).value) != 0) {
            ...
            NumberToDecimal(txtTotalPrice.id, txtTotalPrice.value);
            if (Number(txtMarkup) == 0) {
                //document.getElementById("txtMarkup_" + ext).value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, strmarkUp, 0, '', false, false, true);
                if (ddlMarkup == "percentage") {
                    document.getElementById("txtMarkup_" + ext).value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, strmarkUp, 0, '', false, false, true);
                }
                else {
    ...
    if (trim12(txtTitle.value) == '' || trim12(txtTitleDescription.value) == '') {
        ...
        if (qtyType == "single") {
            ...
            if (trim12(txtMultiQty1.value) == '' && trim12(txtMultiQty2.value) == '' && trim12(txtMultiQty3.value) == ''
                ...
                if (txtMultiQty1.value == 0 && txtMultiQty2.value == 0 && txtMultiQty3.value == 0 && txtMultiQty4.value == 0) {

                    document.getElementById("div_qty").style.display = "block";
                    document.getElementById("span_qty").innerHTML = "Please enter quantity";
                    return false;
...
function RFQData() {
    ...
    //this.SupplierPriceCatalogueID = 0;
    //End
...
function SaveOutWork(para) {
    ...
    rfq.Title = SpecialEncode(txtTitle.value);
    rfq.TitleDescription = SpecialEncode(txtTitleDescription.value);
    rfq.TitleIsChecked = chkOutItemTitle.checked;

    rfq.Origination = SpecialEncode(txtOrigination.value);
    rfq.OriginationDescription = SpecialEncode(txtOriginationDescription.value);
    rfq.OriginationIsChecked = chkOutDescription.checked;

    rfq.Artwork = SpecialEncode(txtArtwork.value);
    rfq.ArtworkDescription = SpecialEncode(txtArtworkDescription.value);
    rfq.ArtworkIsChecked = chkOutArtwork.checked;

    rfq.Color = SpecialEncode(txtColor.value);
    rfq.ColorDescription = SpecialEncode(txtColorDescription.value);
    rfq.ColorIsChecked = chkOutColour.checked;

    rfq.Size = SpecialEncode(txtSize.value);
    rfq.SizeDescription = SpecialEncode(txtSizeDescription.value);
    rfq.SizeIsChecked = chkOutSize.checked;

    rfq.Material = SpecialEncode(txtMaterial.value);
    rfq.MaterialDescription = SpecialEncode(txtMaterialDescription.value);
    rfq.MaterialIsChecked = chkOutMaterial.checked;

    rfq.Finishing = SpecialEncode(txtFinishing.value);
    rfq.FinishingDescription = SpecialEncode(txtFinishingDescription.value);
    rfq.FinishingIsChecked = chkOutFinishing.checked;

    rfq.Delivery = SpecialEncode(txtDelivery.value);
    rfq.DeliveryDescription = SpecialEncode(txtDeliveryDescription.value);
    rfq.DeliveryIsChecked = chkOutDelivery.checked;

    rfq.Proofs = SpecialEncode(txtProofs.value);
    rfq.ProofsDescription = SpecialEncode(txtProofsDescription.value);
    rfq.ProofsIsChecked = chkOutProofs.checked;

    rfq.Packing = SpecialEncode(txtPacking.value);
    rfq.PackingDescription = SpecialEncode(txtPackingDescription.value);
    rfq.PackingIsChecked = chkOutPacking.checked;

    rfq.Notes = SpecialEncode(txtNotes.value);
    rfq.NotesDescription = SpecialEncode(txtNotesDescription.value);
    rfq.NotesIsChecked = chkOutNotes.checked;

    rfq.Terms = SpecialEncode(txtTerms.value);
    rfq.TermsDescription = SpecialEncode(txtTermsDescription.value);
    rfq.TermsIsChecked = chkOutInstructions.checked;

    // New Custom Fields
    rfq.CustomDescnLabel1 = SpecialEncode(txt_SuplierLabel1.value);
    rfq.CustomDescnPhraseValue1 = SpecialEncode(txt_SuplierValue1.value);
    rfq.CustomDescnIsChecked1 = Chk_SuplierDescn1.checked;

    rfq.CustomDescnLabel2 = SpecialEncode(txt_SuplierLabel2.value);
    rfq.CustomDescnPhraseValue2 = SpecialEncode(txt_SuplierValue2.value);
    rfq.CustomDescnIsChecked2 = Chk_SuplierDescn2.checked;

    rfq.CustomDescnLabel3 = SpecialEncode(txt_SuplierLabel3.value);
    rfq.CustomDescnPhraseValue3 = SpecialEncode(txt_SuplierValue3.value);
    rfq.CustomDescnIsChecked3 = Chk_SuplierDescn3.checked;

    rfq.CustomDescnLabel4 = SpecialEncode(txt_SuplierLabel4.value);
    rfq.CustomDescnPhraseValue4 = SpecialEncode(txt_SuplierValue4.value);
    rfq.CustomDescnIsChecked4 = Chk_SuplierDescn4.checked;

    rfq.CustomDescnLabel5 = SpecialEncode(txt_SuplierLabel5.value);
    rfq.CustomDescnPhraseValue5 = SpecialEncode(txt_SuplierValue5.value);
    rfq.CustomDescnIsChecked5 = Chk_SuplierDescn5.checked;

    rfq.CustomDescnLabel6 = SpecialEncode(txt_SuplierLabel6.value);
    rfq.CustomDescnPhraseValue6 = SpecialEncode(txt_SuplierValue6.value);
    rfq.CustomDescnIsChecked6 = Chk_SuplierDescn6.checked;

    rfq.CustomDescnLabel7 = SpecialEncode(txt_SuplierLabel7.value);
    rfq.CustomDescnPhraseValue7 = SpecialEncode(txt_SuplierValue7.value);
    rfq.CustomDescnIsChecked7 = Chk_SuplierDescn7.checked;

    rfq.CustomDescnLabel8 = SpecialEncode(txt_SuplierLabel8.value);
    rfq.CustomDescnPhraseValue8 = SpecialEncode(txt_SuplierValue8.value);
    rfq.CustomDescnIsChecked8 = Chk_SuplierDescn8.checked;

    rfq.CustomDescnLabel9 = SpecialEncode(txt_SuplierLabel9.value);
    rfq.CustomDescnPhraseValue9 = SpecialEncode(txt_SuplierValue9.value);
    rfq.CustomDescnIsChecked9 = Chk_SuplierDescn9.checked;

    rfq.CustomDescnLabel10 = SpecialEncode(txt_SuplierLabel10.value);
    rfq.CustomDescnPhraseValue10 = SpecialEncode(txt_SuplierValue10.value);
    rfq.CustomDescnIsChecked10 = Chk_SuplierDescn10.checked;

    rfq.CustomDescnLabel11 = SpecialEncode(txt_SuplierLabel11.value);
    rfq.CustomDescnPhraseValue11 = SpecialEncode(txt_SuplierValue11.value);
    rfq.CustomDescnIsChecked11 = Chk_SuplierDescn11.checked;

    rfq.CustomDescnLabel12 = SpecialEncode(txt_SuplierLabel12.value);
    rfq.CustomDescnPhraseValue12 = SpecialEncode(txt_SuplierValue12.value);
    rfq.CustomDescnIsChecked12 = Chk_SuplierDescn12.checked;

    rfq.CustomDescnLabel13 = SpecialEncode(txt_SuplierLabel13.value);
    rfq.CustomDescnPhraseValue13 = SpecialEncode(txt_SuplierValue13.value);
    rfq.CustomDescnIsChecked13 = Chk_SuplierDescn13.checked;

    rfq.CustomDescnLabel14 = SpecialEncode(txt_SuplierLabel14.value);
    rfq.CustomDescnPhraseValue14 = SpecialEncode(txt_SuplierValue14.value);
    rfq.CustomDescnIsChecked14 = Chk_SuplierDescn14.checked;

    rfq.CustomDescnLabel15 = SpecialEncode(txt_SuplierLabel15.value);
    rfq.CustomDescnPhraseValue15 = SpecialEncode(txt_SuplierValue15.value);
    rfq.CustomDescnIsChecked15 = Chk_SuplierDescn15.checked;

    rfq.CustomDescnLabel16 = SpecialEncode(txt_SuplierLabel16.value);
    rfq.CustomDescnPhraseValue16 = SpecialEncode(txt_SuplierValue16.value);
    rfq.CustomDescnIsChecked16 = Chk_SuplierDescn16.checked;

    rfq.CustomDescnLabel17 = SpecialEncode(txt_SuplierLabel17.value);
    rfq.CustomDescnPhraseValue17 = SpecialEncode(txt_SuplierValue17.value);
    rfq.CustomDescnIsChecked17 = Chk_SuplierDescn17.checked;

    rfq.CustomDescnLabel18 = SpecialEncode(txt_SuplierLabel18.value);
    rfq.CustomDescnPhraseValue18 = SpecialEncode(txt_SuplierValue18.value);
    rfq.CustomDescnIsChecked18 = Chk_SuplierDescn18.checked;

    rfq.CustomDescnLabel19 = SpecialEncode(txt_SuplierLabel19.value);
    rfq.CustomDescnPhraseValue19 = SpecialEncode(txt_SuplierValue19.value);
    rfq.CustomDescnIsChecked19 = Chk_SuplierDescn19.checked;

    rfq.CustomDescnLabel20 = SpecialEncode(txt_SuplierLabel20.value);
    rfq.CustomDescnPhraseValue20 = SpecialEncode(txt_SuplierValue20.value);
    rfq.CustomDescnIsChecked20 = Chk_SuplierDescn20.checked;

    rfq.CustomDescnLabel21 = SpecialEncode(txt_SuplierLabel21.value);
    rfq.CustomDescnPhraseValue21 = SpecialEncode(txt_SuplierValue21.value);
    rfq.CustomDescnIsChecked21 = Chk_SuplierDescn21.checked;

    rfq.CustomDescnLabel22 = SpecialEncode(txt_SuplierLabel22.value);
    rfq.CustomDescnPhraseValue22 = SpecialEncode(txt_SuplierValue22.value);
    rfq.CustomDescnIsChecked22 = Chk_SuplierDescn22.checked;

    rfq.CustomDescnLabel23 = SpecialEncode(txt_SuplierLabel23.value);
    rfq.CustomDescnPhraseValue23 = SpecialEncode(txt_SuplierValue23.value);
    rfq.CustomDescnIsChecked23 = Chk_SuplierDescn23.checked;

    rfq.CustomDescnLabel24 = SpecialEncode(txt_SuplierLabel24.value);
    rfq.CustomDescnPhraseValue24 = SpecialEncode(txt_SuplierValue24.value);
    rfq.CustomDescnIsChecked24 = Chk_SuplierDescn24.checked;

    rfq.CustomDescnLabel25 = SpecialEncode(txt_SuplierLabel25.value);
    rfq.CustomDescnPhraseValue25 = SpecialEncode(txt_SuplierValue25.value);
    rfq.CustomDescnIsChecked25 = Chk_SuplierDescn25.checked;


    //rfq.SupplierPriceCatalogueID = hdn_supplierproductcatalogueid.value;
    //End
            ...
            for (var i = 1; i <= supplierCount; i++) {
                ...
                if (supObj != null) {
                    if (supObj.options[supObj.selectedIndex].value != '0') {
                        ...
                        var priceCount = 0;
                        var checked = '';
                        for (var c = 1; c <= qtyCount; c++) {
                            if (document.getElementById("Div_row_" + sup.SupplierID + '_' + c).style.display != "none") {
                                checked = sup.SupplierID + '_' + c;
                            }
                        }
                        for (var j = 1; j <= qtyCount; j++) {
                            ...
                            //{
                            if (UcPage == "estimate" || UcPage == "webstoreorder" || UcPage == "order") {
                            ...
                            else if (UcPage == "invoice" || UcPage == "job" || UcPage == "jobs") {
                                if (checked != '') {
                                    var SupRefNO = document.getElementById("txtRefNo_" + checked + "").value;
                                } else {
                                    var SupRefNO = document.getElementById("txtRefNo_" + sup.SupplierID + "_1") == null ? "" : document.getElementById("txtRefNo_" + sup.SupplierID + "_1").value;
                                }
                            }
            ...
            if (supObj != null) {
                if (supObj.options[supObj.selectedIndex].value != '0') {
                    ...
                    for (var j = 1; j <= qtyCount; j++) {
                        ...
                        PriceComp.MarkupType = document.getElementById("ddlMarkup_" + comnId).value;
                        PriceComp.MarkupValue = document.getElementById("txtMarkup_" + comnId).value;
                        //PriceComp.MarkupValue = document.getElementById("hdnactualmarkup_" + comnId).value
                        PriceComp.TotalPrice = document.getElementById("txtTotalPrice_" + comnId).value;
                        try {
                            if (isPer1000OutworkType()) {
                                PriceComp.txtPer1000TotalPrice = document.getElementById("txtPer1000TotalPrice_" + comnId).value;
    ...
    if (chkSupQtyCount == 0) {
        alert('No supplier has been selected and so no outwork price/s will display in the summary screen');
    }
...
function LoadToPBbox(s) {
    ...
    if (ArrayPrint[s].CustomDescnIsChecked1 == "False") {
        Chk_SuplierDescn1.checked = false;
    }
    else {
    ...
    if (ArrayPrint[s].CustomDescnIsChecked2 == "False") {
        Chk_SuplierDescn2.checked = false;
    }
    else {
        Chk_SuplierDescn2.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked3 == "False") {
        Chk_SuplierDescn3.checked = false;
    }
    else {
        Chk_SuplierDescn3.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked4 == "False") {
        Chk_SuplierDescn4.checked = false;
    }
    else {
        Chk_SuplierDescn4.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked5 == "False") {
        Chk_SuplierDescn5.checked = false;
    }
    else {
        Chk_SuplierDescn5.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked6 == "False") {
        Chk_SuplierDescn6.checked = false;
    }
    else {
        Chk_SuplierDescn6.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked7 == "False") {
        Chk_SuplierDescn7.checked = false;
    }
    else {
        Chk_SuplierDescn7.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked8 == "False") {
        Chk_SuplierDescn8.checked = false;
    }
    else {
        Chk_SuplierDescn8.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked9 == "False") {
        Chk_SuplierDescn9.checked = false;
    }
    else {
        Chk_SuplierDescn9.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked10 == "False") {
        Chk_SuplierDescn10.checked = false;
    }
    else {
        Chk_SuplierDescn10.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked11 == "False") {
        Chk_SuplierDescn11.checked = false;
    }
    else {
        Chk_SuplierDescn11.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked12 == "False") {
        Chk_SuplierDescn12.checked = false;
    }
    else {
        Chk_SuplierDescn12.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked13 == "False") {
        Chk_SuplierDescn13.checked = false;
    }
    else {
        Chk_SuplierDescn13.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked14 == "False") {
        Chk_SuplierDescn14.checked = false;
    }
    else {
        Chk_SuplierDescn14.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked15 == "False") {
        Chk_SuplierDescn15.checked = false;
    }
    else {
        Chk_SuplierDescn15.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked16 == "False") {
        Chk_SuplierDescn16.checked = false;
    }
    else {
        Chk_SuplierDescn16.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked17 == "False") {
        Chk_SuplierDescn17.checked = false;
    }
    else {
        Chk_SuplierDescn17.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked18 == "False") {
        Chk_SuplierDescn18.checked = false;
    }
    else {
        Chk_SuplierDescn18.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked19 == "False") {
        Chk_SuplierDescn19.checked = false;
    }
    else {
        Chk_SuplierDescn19.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked20 == "False") {
        Chk_SuplierDescn20.checked = false;
    }
    else {
        Chk_SuplierDescn20.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked21 == "False") {
        Chk_SuplierDescn21.checked = false;
    }
    else {
        Chk_SuplierDescn21.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked22 == "False") {
        Chk_SuplierDescn22.checked = false;
    }
    else {
        Chk_SuplierDescn22.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked23 == "False") {
        Chk_SuplierDescn23.checked = false;
    }
    else {
        Chk_SuplierDescn23.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked24 == "False") {
        Chk_SuplierDescn24.checked = false;
    }
    else {
        Chk_SuplierDescn24.checked = true;
    }
    if (ArrayPrint[s].CustomDescnIsChecked25 == "False") {
        Chk_SuplierDescn25.checked = false;
    }
    else {
        Chk_SuplierDescn25.checked = true;
    }

    txtTitle.value = SpecialDecode(ArrayPrint[s].Title);
    txtTitleDescription.value = SpecialDecode(ArrayPrint[s].TitleDescription);
    txtOrigination.value = SpecialDecode(ArrayPrint[s].Origination);
    txtOriginationDescription.value = SpecialDecode(ArrayPrint[s].OriginationDescription);
    txtArtwork.value = SpecialDecode(ArrayPrint[s].Artwork);
    txtArtworkDescription.value = SpecialDecode(ArrayPrint[s].ArtworkDescription);
    txtColor.value = SpecialDecode(ArrayPrint[s].Color);
    txtColorDescription.value = SpecialDecode(ArrayPrint[s].ColorDescription);
    txtSize.value = SpecialDecode(ArrayPrint[s].Size);
    txtSizeDescription.value = SpecialDecode(ArrayPrint[s].SizeDescription);
    txtMaterial.value = SpecialDecode(ArrayPrint[s].Material);
    txtMaterialDescription.value = SpecialDecode(ArrayPrint[s].MaterialDescription);
    txtFinishing.value = SpecialDecode(ArrayPrint[s].Finishing);
    txtFinishingDescription.value = SpecialDecode(ArrayPrint[s].FinishingDescription);
    txtDelivery.value = SpecialDecode(ArrayPrint[s].Delivery);
    txtDeliveryDescription.value = SpecialDecode(ArrayPrint[s].DeliveryDescription);
    txtProofs.value = SpecialDecode(ArrayPrint[s].Proofs);
    txtProofsDescription.value = SpecialDecode(ArrayPrint[s].ProofsDescription);
    txtPacking.value = SpecialDecode(ArrayPrint[s].Packing);
    txtPackingDescription.value = SpecialDecode(ArrayPrint[s].PackingDescription);
    txtNotes.value = SpecialDecode(ArrayPrint[s].Notes);
    txtNotesDescription.value = SpecialDecode(ArrayPrint[s].NotesDescription);
    txtTerms.value = SpecialDecode(ArrayPrint[s].Terms);
    txtTermsDescription.value = SpecialDecode(ArrayPrint[s].TermsDescription);

    // New Fields
    txt_SuplierLabel1.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel1);
    txt_SuplierValue1.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue1);

    txt_SuplierLabel2.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel2);
    txt_SuplierValue2.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue2);

    txt_SuplierLabel3.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel3);
    txt_SuplierValue3.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue3);

    txt_SuplierLabel4.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel4);
    txt_SuplierValue4.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue4);

    txt_SuplierLabel5.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel5);
    txt_SuplierValue5.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue5);

    txt_SuplierLabel6.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel6);
    txt_SuplierValue6.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue6);

    txt_SuplierLabel7.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel7);
    txt_SuplierValue7.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue7);

    txt_SuplierLabel8.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel8);
    txt_SuplierValue8.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue8);

    txt_SuplierLabel9.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel9);
    txt_SuplierValue9.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue9);

    txt_SuplierLabel1.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel1);
    txt_SuplierValue1.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue1);

    txt_SuplierLabel10.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel10);
    txt_SuplierValue10.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue10);

    txt_SuplierLabel11.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel11);
    txt_SuplierValue11.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue11);

    txt_SuplierLabel12.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel12);
    txt_SuplierValue12.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue12);

    txt_SuplierLabel13.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel13);
    txt_SuplierValue13.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue13);

    txt_SuplierLabel14.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel14);
    txt_SuplierValue14.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue14);

    txt_SuplierLabel15.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel15);
    txt_SuplierValue15.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue15);

    txt_SuplierLabel16.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel16);
    txt_SuplierValue16.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue16);

    txt_SuplierLabel17.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel17);
    txt_SuplierValue17.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue17);

    txt_SuplierLabel18.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel18);
    txt_SuplierValue18.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue18);

    txt_SuplierLabel19.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel19);
    txt_SuplierValue19.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue19);

    txt_SuplierLabel20.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel20);
    txt_SuplierValue20.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue20);

    txt_SuplierLabel21.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel21);
    txt_SuplierValue21.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue21);

    txt_SuplierLabel22.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel22);
    txt_SuplierValue22.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue22);

    txt_SuplierLabel23.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel23);
    txt_SuplierValue23.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue23);

    txt_SuplierLabel24.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel24);
    txt_SuplierValue24.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue24);

    txt_SuplierLabel25.value = SpecialDecode(ArrayPrint[s].CustomDescnLabel25);
    txt_SuplierValue25.value = SpecialDecode(ArrayPrint[s].CustomDescnPhraseValue25);
    ...
    for (var p = 0; p < ArrayPrint[s].SupplierList.length; p++) {
        ...
        for (var i = 0; i < supObj.length; i++) {
            if (supObj.options[i].value == ArrayPrint[s].SupplierList[p].SupplierID) {
                ...
                ContObj.disabled = false; //Given by anil to diable ddl suppliercontact
                ...
                for (var j = 1; j <= qtyCount; j++) {
                    ...
                    uniData += "<div id='Div_name_" + comnID + "' style='float: left; width: 6%;'>" + name + "</div>";
                    uniData += "<div style='float: left; width: 6%;padding-right:5px'><input id='txtQty_" + comnID + "' type='text' value='" + QtyValue + "'  class='textboxnew' style='Width:95%;text-align:right;' disabled='true' /></div>";
                    uniData += "<div style='float: left; width: 9%'><input id='txtCost_" + comnID + "' type='text' onchange=\"javascript:SelectChkQty('" + comnID + "');\"  onclick='this.select();' onfocus='this.select();'  onblur=\"javascript:todecimal_function(this,this.value);AllowNumber(this,this.value);CalculatePrice('" + comnID + "','c');NumberToDecimal(this.id,this.value);\"' class='textboxnew' style='Width:95%;text-align:right' maxlength='20' /></div>";
                    ...
                    if (j == 1) {
                        ...
                        if (ProfitTaxKey == 'database') {
                            ...
                            uniData += "<input type='hidden' id='hdnactualmarkup_" + comnID + "' runat='server'  value='" + ArrayPrint[s].PriceList[p].MarkupValue + "' />";
                        }
                        else {
                            ...
                            uniData += "<input type='hidden' id='hdnactualmarkup_" + comnID + "' runat='server' value='" + pb_markup + "' />";
                        }
                    }
                    else {
    ...
    for (var p = 0; p < ArrayPrint[s].PriceList.length; p++) {
        ...
        var SupplierRefNo_Value = '';
        var SupplierRefNo_Value = ArrayPrint[s].PriceList[p].SupplierRefNo;
        var comnID = supValue + '_' + Number(ArrayPrint[s].PriceList[p].QuantityNumber);
        //if (q == 1) {
        ...
        if (supValue != '' && document.getElementById("txtQty_" + comnID + "") != null) {
            if (document.getElementById("txtQty_" + comnID + "").value == ArrayPrint[s].PriceList[p].Quantity) {
                ...
                document.getElementById("txtRefNo_" + comnID + "").value = ArrayPrint[s].PriceList[p].SupplierRefNo;;
                var hdnorgMarkUpvalue = 0;
                ...
                if (ProfitTaxKey == 'database') {
                    ...
                    hdnorgMarkUpvalue = ArrayPrint[s].PriceList[p].MarkupValue;
                }
                else {
                    document.getElementById("txtMarkup_" + comnID + "").value = pb_markup;
                    hdnorgMarkUpvalue = pb_markup;
                }
                // }
                //else {
                //     document.getElementById("txtMarkup_" + comnID + "").value = pb_markup;
                ...
                if (MarType == "percentage") {
                    ...
                    Markup = (Number((Number(ArrayPrint[s].PriceList[p].Cost) + Number(ArrayPrint[s].PriceList[p].DeliveryCost)) * Number(hdnorgMarkUpvalue)) / Number(100));
                ...
                if (ddlCostingType.value == 'unit') {
                    ...
                    Markup = (Number(((Number(ArrayPrint[s].PriceList[p].Cost) * Number(ArrayPrint[s].PriceList[p].Quantity)) + Number(ArrayPrint[s].PriceList[p].DeliveryCost)) * Number(hdnorgMarkUpvalue)) / Number(100));
                ...
                if (ddlCostingType.value == 'simple') {
                ...
                if (isPer1000OutworkType()) {
                    // Markup = (Number(((Number(ArrayPrint[s].PriceList[p].Cost) * Number(ArrayPrint[s].PriceList[p].Quantity)) + Number(ArrayPrint[s].PriceList[p].DeliveryCost)) * pb_markup) / Number(100));
                    var perUnitCost = Number(ArrayPrint[s].PriceList[p].Cost) / 1000;
                    var quantity = Number(ArrayPrint[s].PriceList[p].Quantity);
                    var delCost = Number(ArrayPrint[s].PriceList[p].DeliveryCost);

                    if (MarType == "percentage") {
                        Markup = (Number(perUnitCost * quantity) * (Number(hdnorgMarkUpvalue))) / Number(100);
                        Markup = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, Markup, 0, '', false, false, false);
                    }
                    else if (MarType == "fixedvalue") {
                        if (ProfitTaxKey == 'database') {
                    ...
                    //Markup = (Number(((perUnitCost * quantity) + delCost) * Number(hdnorgMarkUpvalue)) / Number(100));

                    total = Number(perUnitCost * quantity) + Number(delCost) + Number(Markup);
                    total = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, total, 0, '', false, false, false);
                    Markup = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, Markup, 0, '', false, false, false);
                    var totalper1000 = ((Number(total)) / Number(quantity)) * 1000; //+ Number(Delivery) + Markup;
                    document.getElementById("txtPer1000TotalPrice_" + comnID + "").display = true;
                    document.getElementById("txtPer1000TotalPrice_" + comnID + "").value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, totalper1000, 0, '', false, false, false);
                }
...
function ReloadContact_new(ContactID, ContactDDlConName, ContactDDlConID) {
    ...
    if (ContactID != '') {
        ...
        ContactDDlConName = SpecialDecode(ContactDDlConName);
...
function BindSelectedProductOutworkDetails(PricecatalogueID, ItemTitle, Description, Artwork, Color, Size, Material, Delivery, Finishing, Proofs,
    ...
    hdn_supplierproductcatalogueid.value = PricecatalogueID;
    txtprodsearch.value = SpecialDecode(ItemTitle);
    txtTitleDescription.value = SpecialDecode(ItemTitle);
    txtOriginationDescription.value = SpecialDecode(Description);
    txtArtworkDescription.value = SpecialDecode(Artwork);
    txtColorDescription.value = SpecialDecode(Color);
    txtSizeDescription.value = SpecialDecode(Size);
    txtMaterialDescription.value = SpecialDecode(Material);
    txtDeliveryDescription.value = SpecialDecode(Delivery);
    txtFinishingDescription.value = SpecialDecode(Finishing);
    txtProofsDescription.value = SpecialDecode(Proofs);
    txtPackingDescription.value = SpecialDecode(Packing);
    txtNotesDescription.value = SpecialDecode(Notes);
    txtTermsDescription.value = SpecialDecode(Instructions);
    txt_SuplierValue1.value = CustomDescription1;
    txt_SuplierValue2.value = CustomDescription2;
    txt_SuplierValue3.value = CustomDescription3;
    txt_SuplierValue4.value = CustomDescription4;
    txt_SuplierValue5.value = CustomDescription5;
    txt_SuplierValue6.value = CustomDescription6;
    txt_SuplierValue7.value = CustomDescription7;
    txt_SuplierValue8.value = CustomDescription8;
    txt_SuplierValue9.value = CustomDescription9;
    txt_SuplierValue10.value = CustomDescription10;
    txt_SuplierValue11.value = CustomDescription11;
    txt_SuplierValue12.value = CustomDescription12;
    txt_SuplierValue13.value = CustomDescription13;
    txt_SuplierValue14.value = CustomDescription14;
    txt_SuplierValue15.value = CustomDescription15;
    txt_SuplierValue16.value = CustomDescription16;
    txt_SuplierValue17.value = CustomDescription17;
    txt_SuplierValue18.value = CustomDescription18;
    txt_SuplierValue19.value = CustomDescription19;
    txt_SuplierValue20.value = CustomDescription20;
    txt_SuplierValue21.value = CustomDescription21;
    txt_SuplierValue22.value = CustomDescription22;
    txt_SuplierValue23.value = CustomDescription23;
    txt_SuplierValue24.value = CustomDescription24;
    txt_SuplierValue25.value = CustomDescription25;
}
function isPer1000OutworkType() {
    if (ddlCostingType.value == 'per1000') {
        return true;
    }
    return false;
}
