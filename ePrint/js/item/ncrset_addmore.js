// JScript File
  ...
  //************************ START  NcrSet***************************// 
    ...
    { 
      ...
      var txtdata=document.getElementById("ctl00_ContentPlaceHolder1_txtparts");
      var lbldata=document.getElementById("ctl00_ContentPlaceHolder1_lblparts");
      ...
      else if(txtdata.value==2)
      {
        document.getElementById("top").style.display="block";
        document.getElementById("middle").style.display="none";
        document.getElementById("bottom").style.display="block";
      } 
      else if(txtdata.value>=3)
      {
          document.getElementById("top").style.display="block";
          document.getElementById("middle").style.display="block"; 
          document.getElementById("bottom").style.display="block";         
           
          var num= txtdata.value - 2; 
