...
function OpenPaperPopUp(Type) 
{
    if (Type == 'paper') 
    {
        ...
        PopupCenter(strSitepath+"common/common_popup.aspx?type=invselector&pg=estimate&item=paper&papertype=" + papertype + "", '1000', '500')
    }
...
function ShowEstimate(ddlValue, isany) 
{
    ...
    if (ddlValue == 'digital') 
    {
        document.getElementById("lblheader").innerHTML = "Create Item: digital fed ";
        if (isany == null) 
        {
