...
function OpenPaperPopUp(Type) {
    if (Type == 'paper') {
        ...
        window.radopen(strSitepath + "common/common_popup.aspx?type=invselector&pg=estimate&item=paper&papertype=" + papertype + "", '950', '400');
...
function popup_phrasebook(type) {
    ...
    window.radopen(strSitepath + "common/phrase_book.aspx?pg=" + UcPage + "&type=" + type,null, '1000', '500');
    SetRadWindow('divrad', 'divBackGroundNew', '200');
}
...
function OpenPopup(costid, costtypeid, caltype, itemtype, mode, otherinx, guillotineid, paperid, pressid, estothercostid) {
    ...
    window.radopen(strSitepath + "common/common_popup.aspx?type=othercost&costid=" + costid + "&costtypeid=" + costtypeid + "&caltype=" + caltype + "&itemtype=" + itemtype + "&mode=" + mode + "&otherinx=" + OtherIndex + "&pg=estimate&glid=" + guillotineid + "&invid=" + paperid + "&prid=" + pressid + "&estcostid=" + estothercostid + "",null, '1000', '500');
    SetRadWindow('divrad', 'divBackGroundNew', '200');
...
function SaveData() {
    ...
    for (var i = 0; i < ArrayPrint.length; i++) {
        ...
        hid_outwork_title.value = ArrayPrint[i].TitleDescription;
        ...
        StoreData += "Proofs» " + ArrayPrint[i].Proofs + '»' + ArrayPrint[i].ProofsDescription + '»' + ArrayPrint[i].ProofsIsChecked + '±';
        StoreData += "Packing» " + ArrayPrint[i].Packing + '»' + ArrayPrint[i].PackingDescription + '»' + ArrayPrint[i].PackingIsChecked + '±';
        ...
        //StoreData += "SupplierPriceCatalogueID» " + ArrayPrint[i].SupplierPriceCatalogueID + '±';
        // New Fields

        StoreData += "Custom Description 1» " + ArrayPrint[i].CustomDescnLabel1 + '»' + ArrayPrint[i].CustomDescnPhraseValue1 + '»' + ArrayPrint[i].CustomDescnIsChecked1 + '±';
        StoreData += "Custom Description 2» " + ArrayPrint[i].CustomDescnLabel2 + '»' + ArrayPrint[i].CustomDescnPhraseValue2 + '»' + ArrayPrint[i].CustomDescnIsChecked2 + '±';
        StoreData += "Custom Description 3» " + ArrayPrint[i].CustomDescnLabel3 + '»' + ArrayPrint[i].CustomDescnPhraseValue3 + '»' + ArrayPrint[i].CustomDescnIsChecked3 + '±';
        StoreData += "Custom Description 4» " + ArrayPrint[i].CustomDescnLabel4 + '»' + ArrayPrint[i].CustomDescnPhraseValue4 + '»' + ArrayPrint[i].CustomDescnIsChecked4 + '±';
        StoreData += "Custom Description 5» " + ArrayPrint[i].CustomDescnLabel5 + '»' + ArrayPrint[i].CustomDescnPhraseValue5 + '»' + ArrayPrint[i].CustomDescnIsChecked5 + '±';
        StoreData += "Custom Description 6» " + ArrayPrint[i].CustomDescnLabel6 + '»' + ArrayPrint[i].CustomDescnPhraseValue6 + '»' + ArrayPrint[i].CustomDescnIsChecked6 + '±';
        StoreData += "Custom Description 7» " + ArrayPrint[i].CustomDescnLabel7 + '»' + ArrayPrint[i].CustomDescnPhraseValue7 + '»' + ArrayPrint[i].CustomDescnIsChecked7 + '±';
        StoreData += "Custom Description 8» " + ArrayPrint[i].CustomDescnLabel8 + '»' + ArrayPrint[i].CustomDescnPhraseValue8 + '»' + ArrayPrint[i].CustomDescnIsChecked8 + '±';
        StoreData += "Custom Description 9» " + ArrayPrint[i].CustomDescnLabel9 + '»' + ArrayPrint[i].CustomDescnPhraseValue9 + '»' + ArrayPrint[i].CustomDescnIsChecked9 + '±';
        StoreData += "Custom Description 10» " + ArrayPrint[i].CustomDescnLabel10 + '»' + ArrayPrint[i].CustomDescnPhraseValue10 + '»' + ArrayPrint[i].CustomDescnIsChecked10 + '±';
        StoreData += "Custom Description 11» " + ArrayPrint[i].CustomDescnLabel11 + '»' + ArrayPrint[i].CustomDescnPhraseValue11 + '»' + ArrayPrint[i].CustomDescnIsChecked11 + '±';
        StoreData += "Custom Description 12» " + ArrayPrint[i].CustomDescnLabel12 + '»' + ArrayPrint[i].CustomDescnPhraseValue12 + '»' + ArrayPrint[i].CustomDescnIsChecked12 + '±';
        StoreData += "Custom Description 13» " + ArrayPrint[i].CustomDescnLabel13 + '»' + ArrayPrint[i].CustomDescnPhraseValue13 + '»' + ArrayPrint[i].CustomDescnIsChecked13 + '±';
        StoreData += "Custom Description 14» " + ArrayPrint[i].CustomDescnLabel14 + '»' + ArrayPrint[i].CustomDescnPhraseValue14 + '»' + ArrayPrint[i].CustomDescnIsChecked14 + '±';
        StoreData += "Custom Description 15» " + ArrayPrint[i].CustomDescnLabel15 + '»' + ArrayPrint[i].CustomDescnPhraseValue15 + '»' + ArrayPrint[i].CustomDescnIsChecked15 + '±';
        StoreData += "Custom Description 16» " + ArrayPrint[i].CustomDescnLabel16 + '»' + ArrayPrint[i].CustomDescnPhraseValue16 + '»' + ArrayPrint[i].CustomDescnIsChecked16 + '±';
        StoreData += "Custom Description 17» " + ArrayPrint[i].CustomDescnLabel17 + '»' + ArrayPrint[i].CustomDescnPhraseValue17 + '»' + ArrayPrint[i].CustomDescnIsChecked17 + '±';
        StoreData += "Custom Description 18» " + ArrayPrint[i].CustomDescnLabel18 + '»' + ArrayPrint[i].CustomDescnPhraseValue18 + '»' + ArrayPrint[i].CustomDescnIsChecked18 + '±';
        StoreData += "Custom Description 19» " + ArrayPrint[i].CustomDescnLabel19 + '»' + ArrayPrint[i].CustomDescnPhraseValue19 + '»' + ArrayPrint[i].CustomDescnIsChecked19 + '±';
        StoreData += "Custom Description 20» " + ArrayPrint[i].CustomDescnLabel20 + '»' + ArrayPrint[i].CustomDescnPhraseValue20 + '»' + ArrayPrint[i].CustomDescnIsChecked20 + '±';
        StoreData += "Custom Description 21» " + ArrayPrint[i].CustomDescnLabel21 + '»' + ArrayPrint[i].CustomDescnPhraseValue21 + '»' + ArrayPrint[i].CustomDescnIsChecked21 + '±';
        StoreData += "Custom Description 22» " + ArrayPrint[i].CustomDescnLabel22 + '»' + ArrayPrint[i].CustomDescnPhraseValue22 + '»' + ArrayPrint[i].CustomDescnIsChecked22 + '±';
        StoreData += "Custom Description 23» " + ArrayPrint[i].CustomDescnLabel23 + '»' + ArrayPrint[i].CustomDescnPhraseValue23 + '»' + ArrayPrint[i].CustomDescnIsChecked23 + '±';
        StoreData += "Custom Description 24» " + ArrayPrint[i].CustomDescnLabel24 + '»' + ArrayPrint[i].CustomDescnPhraseValue24 + '»' + ArrayPrint[i].CustomDescnIsChecked24 + '±';
        StoreData += "Custom Description 25» " + ArrayPrint[i].CustomDescnLabel25 + '»' + ArrayPrint[i].CustomDescnPhraseValue25 + '»' + ArrayPrint[i].CustomDescnIsChecked25 + '±';
        // end
        StoreData += "§";
        ...
        for (k = 0; k < pirArr.length; k++) {
            if (pirArr[k].Quantity != null && pirArr[k].Quantity != '') {
                ...
                StoreData += "QuantityNumber »" + pirArr[k].QuantityNumber + '±';
                StoreData += "SupplierRefNo »" + pirArr[k].SupplierRefNo + 'Ç';
            }
        }
        StoreData += "µ";
    }
    ...
    for (var i = 0; i < ArrayBroker.length; i++) {
        ...
        if (ArrayBroker[i].ProofsDescription != '') {
            Phrase_BrokerData += "PrintBroker Proofs » " + ArrayBroker[i].ProofsDescription + '±';
        }
        if (ArrayBroker[i].PackingDescription != '') {
            Phrase_BrokerData += "PrintBroker Packing » " + ArrayBroker[i].PackingDescription + '±';
        }
        ...
        if (ArrayBroker[i].TermsDescription != '') {
            Phrase_BrokerData += "PrintBroker Terms » " + ArrayBroker[i].TermsDescription + '±';
        }
        //below code is added for bugid- 1604
        if (ArrayBroker[i].CustomDescnPhraseValue1 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription1 » " + ArrayBroker[i].CustomDescnPhraseValue1 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue2 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription2 » " + ArrayBroker[i].CustomDescnPhraseValue2 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue3 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription3 » " + ArrayBroker[i].CustomDescnPhraseValue3 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue4 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription4 » " + ArrayBroker[i].CustomDescnPhraseValue4 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue5 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription5 » " + ArrayBroker[i].CustomDescnPhraseValue5 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue6 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription6 » " + ArrayBroker[i].CustomDescnPhraseValue6 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue7 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription7 » " + ArrayBroker[i].CustomDescnPhraseValue7 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue8 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription8 » " + ArrayBroker[i].CustomDescnPhraseValue8 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue9 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription9 » " + ArrayBroker[i].CustomDescnPhraseValue9 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue10 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription10 » " + ArrayBroker[i].CustomDescnPhraseValue10 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue11 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription11 » " + ArrayBroker[i].CustomDescnPhraseValue11 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue12 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription12 » " + ArrayBroker[i].CustomDescnPhraseValue12 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue13 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription13 » " + ArrayBroker[i].CustomDescnPhraseValue13 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue14 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription14 » " + ArrayBroker[i].CustomDescnPhraseValue14 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue15 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription15 » " + ArrayBroker[i].CustomDescnPhraseValue15 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue16 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription16 » " + ArrayBroker[i].CustomDescnPhraseValue16 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue17 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription17 » " + ArrayBroker[i].CustomDescnPhraseValue17 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue18 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription18 » " + ArrayBroker[i].CustomDescnPhraseValue18 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue19 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription19 » " + ArrayBroker[i].CustomDescnPhraseValue19 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue20 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription20 » " + ArrayBroker[i].CustomDescnPhraseValue20 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue21 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription21 » " + ArrayBroker[i].CustomDescnPhraseValue21 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue22 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription22 » " + ArrayBroker[i].CustomDescnPhraseValue22 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue23 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription23 » " + ArrayBroker[i].CustomDescnPhraseValue23 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue24 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription24 » " + ArrayBroker[i].CustomDescnPhraseValue24 + '±';
        }
        if (ArrayBroker[i].CustomDescnPhraseValue25 != '') {
            Phrase_BrokerData += "PrintBroker CustomDescription25 » " + ArrayBroker[i].CustomDescnPhraseValue25;
        }
        ...
        for (var i = 0; i < arr1.length; i++) {
            if (i == 0)//tb_EstItemOutwork
            {
                ...
                for (var j = 0; j < arr2.length; j++) {
                    ...
                    else if (arr3[0] == "SupplierPriceCatalogueID") {
                        hdn_supplierproductcatalogueid.value = arr3[1];
                    }
                }
            }
            else if (i == 1)//tb_EstQuantity
            {
                ...
                for (var j = 0; j < arr2.length; j++) {
                    var arr3 = arr2[j].split('»');
                    QtyType = "multiple"; //arr3[0] == " " ? "multiple" : arr3[0];since now using multiple qty textboxes only
                    Qtys += trim12(arr3[3]) + '|';
                }
                rfq.Quantity = Qtys;
                rfq.QtyType = QtyType;
            ...
            else if (i == 2)//tb_EstItemOutworkRFQlabel
            {
                ...
                for (var j = 0; j < arr2.length; j++) {
                    ...
                    {
                        rfq.Proofs = arr3[0];
                        rfq.ProofsDescription = arr3[1];
                        rfq.ProofsIsChecked = arr3[2];
                    }
                    else if (j == 9)//Packing
                    {
                        rfq.Packing = arr3[0];
                        rfq.PackingDescription = arr3[1];
                        rfq.PackingIsChecked = arr3[2];
                    }
                    ...
                    // New Fields
                        ...
                        rfq.CustomDescnLabel1 = arr3[0];
                        rfq.CustomDescnPhraseValue1 = arr3[1];
                        rfq.CustomDescnIsChecked1 = arr3[2];
                    }
                    else if (j == 13) {
                        rfq.CustomDescnLabel2 = arr3[0];
                        rfq.CustomDescnPhraseValue2 = arr3[1];
                        rfq.CustomDescnIsChecked2 = arr3[2];
                    }

                    else if (j == 14) {
                        rfq.CustomDescnLabel3 = arr3[0];
                        rfq.CustomDescnPhraseValue3 = arr3[1];
                        rfq.CustomDescnIsChecked3 = arr3[2];
                    }

                    else if (j == 15) {
                        rfq.CustomDescnLabel4 = arr3[0];
                        rfq.CustomDescnPhraseValue4 = arr3[1];
                        rfq.CustomDescnIsChecked4 = arr3[2];
                    }
                    else if (j == 16) {
                        rfq.CustomDescnLabel5 = arr3[0];
                        rfq.CustomDescnPhraseValue5 = arr3[1];
                        rfq.CustomDescnIsChecked5 = arr3[2];
                    }

                    else if (j == 17) {
                        rfq.CustomDescnLabel6 = arr3[0];
                        rfq.CustomDescnPhraseValue6 = arr3[1];
                        rfq.CustomDescnIsChecked6 = arr3[2];
                    }

                    else if (j == 18) {
                        rfq.CustomDescnLabel7 = arr3[0];
                        rfq.CustomDescnPhraseValue7 = arr3[1];
                        rfq.CustomDescnIsChecked7 = arr3[2];
                    }

                    else if (j == 19) {
                        rfq.CustomDescnLabel8 = arr3[0];
                        rfq.CustomDescnPhraseValue8 = arr3[1];
                        rfq.CustomDescnIsChecked8 = arr3[2];
                    }

                    else if (j == 20) {
                        rfq.CustomDescnLabel9 = arr3[0];
                        rfq.CustomDescnPhraseValue9 = arr3[1];
                        rfq.CustomDescnIsChecked9 = arr3[2];
                    }

                    else if (j == 21) {
                        rfq.CustomDescnLabel10 = arr3[0];
                        rfq.CustomDescnPhraseValue10 = arr3[1];
                        rfq.CustomDescnIsChecked10 = arr3[2];
                    }
                    else if (j == 22) {
                        rfq.CustomDescnLabel11 = arr3[0];
                        rfq.CustomDescnPhraseValue11 = arr3[1];
                        rfq.CustomDescnIsChecked11 = arr3[2];
                    }

                    else if (j == 23) {
                        rfq.CustomDescnLabel12 = arr3[0];
                        rfq.CustomDescnPhraseValue12 = arr3[1];
                        rfq.CustomDescnIsChecked12 = arr3[2];
                    }
                    else if (j == 24) {
                        rfq.CustomDescnLabel13 = arr3[0];
                        rfq.CustomDescnPhraseValue13 = arr3[1];
                        rfq.CustomDescnIsChecked13 = arr3[2];
                    }

                    else if (j == 25) {
                        rfq.CustomDescnLabel14 = arr3[0];
                        rfq.CustomDescnPhraseValue14 = arr3[1];
                        rfq.CustomDescnIsChecked14 = arr3[2];
                    }
                    else if (j == 26) {
                        rfq.CustomDescnLabel15 = arr3[0];
                        rfq.CustomDescnPhraseValue15 = arr3[1];
                        rfq.CustomDescnIsChecked15 = arr3[2];
                    }
                    else if (j == 27) {
                        rfq.CustomDescnLabel16 = arr3[0];
                        rfq.CustomDescnPhraseValue16 = arr3[1];
                        rfq.CustomDescnIsChecked16 = arr3[2];
                    }
                    else if (j == 28) {
                        rfq.CustomDescnLabel17 = arr3[0];
                        rfq.CustomDescnPhraseValue17 = arr3[1];
                        rfq.CustomDescnIsChecked17 = arr3[2];
                    }

                    else if (j == 29) {
                        rfq.CustomDescnLabel18 = arr3[0];
                        rfq.CustomDescnPhraseValue18 = arr3[1];
                        rfq.CustomDescnIsChecked18 = arr3[2];
                    }
                    else if (j == 30) {
                        rfq.CustomDescnLabel19 = arr3[0];
                        rfq.CustomDescnPhraseValue19 = arr3[1];
                        rfq.CustomDescnIsChecked19 = arr3[2];
                    }
                    else if (j == 31) {
                        rfq.CustomDescnLabel20 = arr3[0];
                        rfq.CustomDescnPhraseValue20 = arr3[1];
                        rfq.CustomDescnIsChecked20 = arr3[2];
                    }

                    else if (j == 32) {
                        rfq.CustomDescnLabel21 = arr3[0];
                        rfq.CustomDescnPhraseValue21 = arr3[1];
                        rfq.CustomDescnIsChecked21 = arr3[2];
                    }

                    else if (j == 33) {
                        rfq.CustomDescnLabel22 = arr3[0];
                        rfq.CustomDescnPhraseValue22 = arr3[1];
                        rfq.CustomDescnIsChecked22 = arr3[2];
                    }

                    else if (j == 34) {
                        rfq.CustomDescnLabel23 = arr3[0];
                        rfq.CustomDescnPhraseValue23 = arr3[1];
                        rfq.CustomDescnIsChecked23 = arr3[2];
                    }

                    else if (j == 35) {
                        rfq.CustomDescnLabel24 = arr3[0];
                        rfq.CustomDescnPhraseValue24 = arr3[1];
                        rfq.CustomDescnIsChecked24 = arr3[2];
                    }
                    else if (j == 36) {
                        rfq.CustomDescnLabel25 = arr3[0];
                        rfq.CustomDescnPhraseValue25 = arr3[1];
                        rfq.CustomDescnIsChecked25 = arr3[2];
                    }
                    // End
            ...
            else if (i == 3)//tb_EstItemOutworkSupplier
            {
                ...
                for (var j = 0; j < arr2.length; j++) {
                    ...
                    for (var h = 0; h < arr3.length; h++) {
                        ...
                        else if ("SupplierRefNo" == arr4[0]) {
                            if (arr4[1] == "undefined") {
                                PriceComp.SupplierRefNo = "";
                            }
                            else {
                                PriceComp.SupplierRefNo = arr4[1];
                            }
                        }
                        else if ("QuantityNumber" == arr4[0]) {
                            PriceComp.QuantityNumber = arr4[1];
                        }
                    }
...
function chkPBDescriptionChecked(Obj) {
    ...
    ckOutDescription.checked = Obj.checked;
