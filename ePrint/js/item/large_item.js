...
function PressOnChange(obj) {
    ...
    var Large = hid_LargeFormatPress.value;
    var arr1;
        ...
        if (estimateType == "largeformat") {
            ...
            if (PressID == ddlValue) {
                ...
                for (var k = 0; k < arr2.length; k++) {
                    ...
                    if (arr3[0] == "isFullSheet") {
                        if (arr3[1] == "1") {
                            $("#ctl00_ContentPlaceHolder1_UcLargeItem_chkUSeFullSheets").attr("checked", true);
                        } else {
                            $("#ctl00_ContentPlaceHolder1_UcLargeItem_chkUSeFullSheets").attr("checked", false);
                        }
                    }
                    ...
                    if (arr3[0] == "InventoryName") {
                        lblDefaultPaper.innerHTML = SpecialDecode(arr3[1]);
                        //lblPaperWeight.innerHTML = SpecialDecode(arr2[32]);
                        lblPaperWeight.innerHTML = SpecialDecode(arr2[33]);
                    }
                    //                    if (LargeFormatCalculation == 'square') {
                    if (arr3[0] == "MaterialID2") {
                        hdnpaperID2.value = arr3[1];
                    }
                    if (arr3[0] == "MaterialName2") {
                        lbl_paper2.innerHTML = arr3[1];
                    }
                    if (arr3[0] == "MaterialID3") {
                        hdnpaperID3.value = arr3[1];
                    }
                    if (arr3[0] == "MaterialName3") {
                        lbl_paper3.innerHTML = arr3[1];
                    }

                    if (arr3[0] == "MaterialID4") {
                        hdnpaperID4.value = arr3[1];
                    }
                    if (arr3[0] == "MaterialName4") {
                        lbl_paper4.innerHTML = arr3[1];
                    }
                    if (arr3[0] == "MaterialID5") {
                        hdnpaperID5.value = arr3[1];
                    }
                    if (arr3[0] == "MaterialName5") {
                        lbl_paper5.innerHTML = arr3[1];
                    }
                    //                    }
                    ...
                    if (arr3[0] == "GuillotineName") {
                        lblGuillotine.innerHTML = SpecialDecode(arr3[1]);
                        lblGuillotine.title = SpecialDecode(arr3[1]);
                        if (lblGuillotine.innerHTML.length > 20) {
                            lblGuillotine.innerHTML = lblGuillotine.innerHTML.substring(0, 20) + "...";
                        }
                    }
                    if (LargeFormatCalculation == 'square' || LargeFormatCalculation == 'tilling' ) {
                        if (arr3[0] == "SetupSpoilage_Sqm") {
                            txtSetupSpoilage.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr3[1], 0, '', false, false, false);
                            // alert('1= ' + arr3[2]);
                    ...
                    if (arr3[0] == "RunningSpoilage") {
                        txtRunningSpoilage.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr3[1], 0, '', false, false, false);
                    }
                    ...
                    if (arr3[0] == "PaperType") {
                        ...
                        PaperType = arr3[1];
                        if (PaperType == "web printing" || PaperType == "roll" || PaperType == "mm") {
                            ...
                            PaperTypeNew = 'sheet';
                            ForWebPrinting("no");
                            document.getElementById("div_guillotine_trim").style.display = "none";
                            //                            div_PriceForWholePack1.style.display = "block";
                            //                            div_PriceForWholePack2.style.display = "block";
                            //                            div_PriceForWholePack3.style.display = "block";
                            //                            div_PriceForWholePack4.style.display = "block";
                            //                            div_PriceForWholePack5.style.display = "block";
                            //                            div_WholePack.style.display = "block";
                    ...
                    if (arr3[0] == "SideGutterDepth") {
                        SideGutterDepth = arr3[1];
                    }
                    if (LargeFormatCalculation.toLowerCase() != 'tilling') {
                        if (arr3[0] == "GutterHorizontal") {
                            txtGutterHorizontal.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr3[1], 0, '', false, false, false);
                            if (Number(arr3[1]) != 0) {
                    ...
                    if (arr3[0] == "GutterVertical") {
                        txtGutterVertical.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr3[1], 0, '', false, false, false);
                        if (Number(arr3[1]) != 0) {
                            document.getElementById("div_GuttersCustomSize").style.display = "block";
                            chkGutters.checked = true;
                        }
                    ...
                    if (arr3[0] == "WhiteInkCoverageSide1") {

                        txtWhiteInkCoverageSide1.value = arr3[1];
                    }
                    if (arr3[0] == "WhiteInkCoverageSide2") {

                        txtWhiteInkCoverageSide2.value = arr3[1];
                    }
                }
                IsnewPaper = true;
                ...
                //                if (LargeFormatCalculation == 'square') {
                if (hdnpaperID2.value != '0') {
                    Chk_PriceForWholePack2.style.display = "block";
                    Chk_PaperSupplied2.style.display = "block";
                    Img_delete2.style.display = "block";
                    lbl_paper2.style.display = "block";
                    divpaperstock2.style.display = "block";
                }
                else {
                    Chk_PriceForWholePack2.style.display = "none";
                    Chk_PaperSupplied2.style.display = "none";
                    Img_delete2.style.display = "none";
                    lbl_paper2.style.display = "none";
                    divpaperstock2.style.display = "none";
                }

                if (hdnpaperID3.value != '0') {
                    Chk_PriceForWholePack3.style.display = "block";
                    Chk_PaperSupplied3.style.display = "block";
                    Img_delete3.style.display = "block";
                    lbl_paper3.style.display = "block";
                    divpaperstock3.style.display = "block";
                }
                else {
                    Chk_PriceForWholePack3.style.display = "none";
                    Chk_PaperSupplied3.style.display = "none";
                    Img_delete3.style.display = "none";
                    lbl_paper3.style.display = "none";
                    divpaperstock3.style.display = "none";
                }
                if (hdnpaperID4.value != '0') {
                    Chk_PriceForWholePack4.style.display = "block";
                    Chk_PaperSupplied4.style.display = "block";
                    Img_delete4.style.display = "block";
                    lbl_paper4.style.display = "block";
                    divpaperstock4.style.display = "block";
                }
                else {
                    Chk_PriceForWholePack4.style.display = "none";
                    Chk_PaperSupplied4.style.display = "none";
                    Img_delete4.style.display = "none";
                    lbl_paper4.style.display = "none";
                    divpaperstock4.style.display = "none";
                }
                if (hdnpaperID5.value != '0') {
                    Chk_PriceForWholePack5.style.display = "block";
                    Chk_PaperSupplied5.style.display = "block";
                    Img_delete5.style.display = "block";
                    lbl_paper5.style.display = "block";
                    divpaperstock5.style.display = "block";
                    divaddmorepaper.style.display = "none";
                }
                else {
                    Chk_PriceForWholePack5.style.display = "none";
                    Chk_PaperSupplied5.style.display = "none";
                    Img_delete5.style.display = "none";
                    lbl_paper5.style.display = "none";
                    divpaperstock5.style.display = "none";
                    divaddmorepaper.style.display = "block";
                }
                //                }
...
function OpenPaperPopUp(Type, metarialNo) {
    if (Type == 'paper') {
        ...
        //        if (trim12(PaperTypeNew).toLowerCase() == '') {
        //            papertype = "sheet";
        //        }
        //        else {
        //            papertype = "roll";
        ...
        // PopupCenter(strSitepath + "common/common_popup.aspx?type=invselector&pg=estimate&item=paper&papertype=" + papertype + "", '950', '430')
        var wnd = window.radopen(strSitepath + "common/common_popup.aspx?type=invselector&pg=estimate&item=paper&papertype=" + PaperTypeNew + "&IsLargeMaterial=1&MaterialNo=" + metarialNo);
...
function SendPaperIDandName(id, values, PaperType, MaterialNo, PaperWeight) {
    ...
    if (MaterialNo == 1) {
        ...
        lbl_paper2.style.display = "block";
        hdnpaperID2.value = id;
        lbl_paper2.title = values;
        lbl_paper2.innerHTML = trim12(values);
        lblPaperWt2.innerHTML = PaperWeight;
        hdn_PaperProperties2.value = "";
        Chk_PriceForWholePack2.style.display = "block";
        Chk_PaperSupplied2.style.display = "block";
        Img_delete2.style.display = "block";
        divpaperstock2.style.display = "block";
        ...
        lbl_paper3.style.display = "block";
        hdnpaperID3.value = id;
        lbl_paper3.title = values;
        lbl_paper3.innerHTML = trim12(values);
        lblPaperWt3.innerHTML = PaperWeight;

        hdn_PaperProperties3.value = "";
        Chk_PriceForWholePack3.style.display = "block";
        Chk_PaperSupplied3.style.display = "block";
        Img_delete3.style.display = "block";
        divpaperstock3.style.display = "block";
        ...
        lbl_paper4.style.display = "block";
        hdnpaperID4.value = id;
        lbl_paper4.title = values;
        lbl_paper4.innerHTML = trim12(values);
        lblPaperWt4.innerHTML = PaperWeight;

        hdn_PaperProperties4.value = "";
        Chk_PriceForWholePack4.style.display = "block";
        Chk_PaperSupplied4.style.display = "block";
        Img_delete4.style.display = "block";
        divpaperstock4.style.display = "block";
        ...
        lbl_paper5.style.display = "block";
        hdnpaperID5.value = id;
        lbl_paper5.title = values;
        lbl_paper5.innerHTML = trim12(values);
        lblPaperWt5.innerHTML = PaperWeight;
        hdn_PaperProperties5.value = "";
        Chk_PriceForWholePack5.style.display = "block";
        Chk_PaperSupplied5.style.display = "block";
        Img_delete5.style.display = "block";
        divpaperstock5.style.display = "block";
...
function ForRollandSheets(IsforRoll) {
    if (IsforRoll == "yes") {
        txtportrait.style.display = 'none';
        txtlandscape.style.display = 'none';

        txtPortLength.style.display = 'block';
        txtLandLength.style.display = 'block';
    }
    else {
        txtportrait.style.display = 'block';
        txtlandscape.style.display = 'block';

        txtPortLength.style.display = 'none';
        txtLandLength.style.display = 'none';
    }
}
var InvPaperLength = 0;
var InvPaperWidth = 0;
function GetPaperValue(result) {
    ...
    if (trim12(PaperTypeNew).toLowerCase() == 'sheet') {
        ForRollandSheets('no');
        lblLengthRequired.innerHTML = "";
        if (IsInvChanged == false) {
            LoadToSheetCustom(ddlPrintSheetSize.options[ddlPrintSheetSize.selectedIndex].value);
        }
        ...
        if (funreqtype() == "add" || funreqtype() == "more") {
            if (IsInvChanged == true) {
                txtsectionheight.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, Height, 0, '', false, false, false); //toInteger(Height);
                txtsectionwidth.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, Width, 0, '', false, false, false); //Width;
            }
            Calculations();
            IsInvChanged = false;
        } else {
        ...
        ForRollandSheets('yes');
        var str2 = result.split('µ');
        var PaperSizeID = str2[0];
        var Height = str2[1];
        var Width = str2[2];

        InvPaperLength = Height;
        InvPaperWidth = Width;

        NonHeight = GripDepth;
        NonWeight = SideGutterDepth;


        var IsCallisCalled = false;
        if (IsnewPaper) {
...
function setwidth() {
    ...
    if (is_ie) {
        document.getElementById("div_GuttersCustomSize").style.width = "228px";
    }
    else {
        document.getElementById("div_GuttersCustomSize").style.width = "228px";
    }
...
function GuillotineSelect() {
    ...
    //    if (PaperTypeNew == 'roll') {
    // PopupCenter(strSitepath + "common/common_popup.aspx?type=moreplant&pg=estimate&islarge=yes", '800', '400');   
    window.radopen(strSitepath + "common/common_popup.aspx?type=moreplant&pg=estimate&islarge=yes", null, '1000', '500');
    SetRadWindow('divrad', 'divBackGroundNew', '200');
...
function OpenPopup(costid, costtypeid, caltype, itemtype, mode, otherinx, guillotineid, paperid, pressid, estothercostid) {
    ...
    window.radopen(strSitepath + "common/common_popup.aspx?type=othercost&costid=" + costid + "&costtypeid=" + costtypeid + "&caltype=" + caltype + "&itemtype=" + itemtype + "&mode=" + mode + "&otherinx=" + OtherIndex + "&pg=estimate&glid=" + guillotineid + "&invid=" + paperid + "&prid=" + pressid + "&estcostid=" + estothercostid + "", '800', '500');
    SetRadWindow('divrad', 'divBackGroundNew', '200');
...
function more_plant(section) {
    ...
    window.radopen(strSitepath + "common/common_popup.aspx?type=moreplant&pg=" + section + "", '', 'width=900px,height=400,status=no,scrollbars=yes,resizable=yes,top=100,title=no,location=no,titlebar=no,left=270,top=100');
    SetRadWindow('divrad', 'divBackGroundNew', '200');
...
function more_paper(section) {
    ...
    window.radopen(strSitepath + "common/common_popup.aspx?type=morepaper&pg=" + section + "", '', 'width=900px,height=400,status=no,scrollbars=yes,resizable=yes,top=100,title=no,location=no,titlebar=no,left=270,top=100');
    SetRadWindow('divrad', 'divBackGroundNew', '200');
...
function validatethis(obj, val) {
    if (val != '') {
        document.getElementById("spn_txtQuantity").style.display = "none";
    }
    document.getElementById(obj.id).setAttribute("onblur", "AllowNumber(this,this.value);");
}
...
function LoadToSheetCustom(ddlValue) {
    if (ddlValue == "0") {
        ...
        if (chkPrintSheet.checked == false) {
            chkPrintSheet.checked = false;
            txtsectionheight.value = '';
            txtsectionwidth.value = '';
        }
        ...
        if (chkPrintSheet.checked == false) {
            for (var i = 0; i < arr1.length; i++) {
                var arr2 = arr1[i].split('±');
                if (ddlValue == arr2[0]) {
                    txtsectionheight.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr2[2], 0, '', false, false, false);
                    txtsectionwidth.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr2[3], 0, '', false, false, false);
                }
            }
        }
    }
    CallonChange(ddlValue, 'spn_ddlPrintSheetSize')
}
...
function LoadToItemCustom(ddlValue) {
    ...
    if (ddlValue == "0") {
        ...
        //CallonChange(ddlValue, 'spn_ddlJobItemSize')
    }
    else {
        var arr1 = hid_ddlPrintSheetSize.value.split('µ');
        for (var i = 0; i < arr1.length; i++) {
            var arr2 = arr1[i].split('±');
            if (ddlValue == arr2[0]) {
                txtitemheight.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr2[2], 0, '', false, false, false);
                txtitemwidth.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr2[3], 0, '', false, false, false);
            }
        }
    }
    CallonChange(ddlValue, 'spn_ddlJobItemSize')
...
function PrintSheetCustom(chID) {
    ...
    if (chCheck) {
        ...
        check_printsheetsize = false;
        //txtsectionheight.focus(); // Textboxes to get focus, on 09.09.2011
        //txtsectionwidth.focus();
    }
    else {
...
function ValidateCost() {
    if (ArrayOtherCost.length > 0) {
        ...
        document.getElementById("span_none").innerHTML = "Please select atleast one item to save";
        return false;
    }
}
...
function MadeDefault() {
    ...
    document.getElementById(divPrintQualityDPI).style.display = "none";
...
//                var WareID1,WareName1,WareType1,UnitPrice1,WareItemID1=0;
...
//                        if(AddType=="add")
//                        { 
//                          WarehouseSelectedItem(WareID1,WareName1,WareType1,UnitPrice1,WareItemID1); 
//                          WareID='';WareName='';WareType='';UnitPrice1='',WareItemID1=0;
...
function OtherCostNext() {
    if (ArrayOtherCost.length > 0) {
        ...
        document.getElementById("div_none").style.display = "block";
        document.getElementById("span_none").innerHTML = "Please select atleast one other cost";
    }
}
...
function Side2_block() {
    ...
    //    document.getElementById("div_ink_side_2").style.display = "block";

    document.getElementById("divside2color").style.display = "block";
    document.getElementById("divside2coverage").style.display = "none";
}
function Side2_none() {
    ...
    //    document.getElementById("div_ink_side_2").style.display = "none";
    document.getElementById("divside2color").style.display = "none";
    document.getElementById("divside2coverage").style.display = "none";
}
...
function ShowEstimate(ddlValue, isany) {
    ...
    if (ddlValue == 'largeformat') {
        ddlEstimateType.selectedIndex = 2;
        ...
        if (isany == null) {
            ...
            for (var i = 0; i < arr1.length; i++) {
                if (arr1[i] != '') {
                    ...
                    ddlPress.options.add(new Option(SpecialDecode(PressName), PressID, i));
                }
            }
        ...
        document.getElementById(divPrintQualityDPI).style.display = "block";
...
function LoadSectionValues(nos) {
    ...
    hdnpaperID.value = bookArr[nos].PaperID;
    lblDefaultPaper.innerHTML = bookArr[nos].PaperName;
    Chk_PriceForWholePack1.checked = bookArr[nos].PriceForWhaolePack;
    Chk_PaperSupplied1.checked = bookArr[nos].PaperSupplied;
    ...
    lblGuillotine.innerHTML = SpecialDecode(bookArr[nos].GuilotineName);
    ////new Development
...
function StoreSections() {
    ...
    bklItem.PriceForWhaolePack = Chk_PriceForWholePack1.checked;
    bklItem.PaperSupplied = Chk_PaperSupplied1.checked;
...
function ClaerSectionData() {
    ...
    Chk_PriceForWholePack1.checked = false;
    Chk_PaperSupplied1.checked = false;
...
var check_printsheetsize = false;
function CreateItemValidation() {
    var ddlprintsize_id = document.getElementById('ctl00_ContentPlaceHolder1_UcLargeItem_ddlPrintSheetSize');
    var ddlprintsizeindexnew = ddlprintsize_id.selectedIndex;
    check_printsheetsize = false;

    //design in validation
    if (document.getElementById('div_Qty_2to4').style.display == 'none') {
        document.getElementById('spn_txtQuantity').style.marginLeft = '-263px';
    }
    if (document.getElementById('div_qty12').style.display == 'none') {
        document.getElementById('spn_txtQuantity').style.marginLeft = '-170px';
    }
    if (document.getElementById('div_qty12').style.display == 'none'
        && document.getElementById('div_qty4').style.display == 'none' && document.getElementById('div_qty3').style.display == 'block') {
        document.getElementById('spn_txtQuantity').style.marginLeft = '-156px';
    }
    //
    var IsCorrect = true;
    ...
    if (CheckDecimalPlus(txtsectionheight.value, 'spn_PrintSheetCustomSize', 'spn_PrintSheetCustomSize_numeric', 'yes')
        ...
        document.getElementById("div_PrintSheetCustomSize").style.display == "block") {
        document.getElementById('ctl00_ContentPlaceHolder1_UcLargeItem_chkPrintSheet').checked = true;
        check_printsheetsize = true;
    }
    if (!CheckDecimalPlus(txtsectionheight.value, 'spn_PrintSheetCustomSize', 'spn_PrintSheetCustomSize_numeric', 'yes')
        || !CheckDecimalPlus(txtsectionwidth.value, 'spn_PrintSheetCustomSize', 'spn_PrintSheetCustomSize_numeric', 'yes')) {
        IsCorrect = false;
        ...
        if (document.getElementById('ctl00_ContentPlaceHolder1_UcLargeItem_chkPrintSheet').checked) {
            check_printsheetsize = true;
        }
    }
    if (!CheckDecimalPlus(txtitemheight.value, 'spn_JobItemCustomSize', 'spn_JobItemCustomSize_numeric', 'yes')
        || !CheckDecimalPlus(txtitemwidth.value, 'spn_JobItemCustomSize', 'spn_JobItemCustomSize_numeric', 'yes')) {
        IsCorrect = false;
    }
    ...
    if (estimateType == "largeformat") {
        ...
        else if (CheckReqCompare(txtWhiteInkCoverageSide1.value, 'spn_txtInkCoverageSide1_number', 'spn_txtInkCoverageSide1_number')) {
            IsCorrect = false;
        }

        // alert(chkDoubleSided.checked + '  chkDoubleSided.checked');
        if (chkDoubleSided.checked) {
            if (CallonChange(ddlColors_2.value, 'spnddlcolor2')) {
                IsCorrect = false;
            }
        }

        if (CheckReqCompare(txtInkCoverageSide2.value, 'spn_txtInkCoverageSide2_number', 'spn_txtInkCoverageSide2_number')) {
            IsCorrect = false;
        }
        else if (CheckReqCompare(txtWhiteInkCoverageSide2.value, 'spn_txtInkCoverageSide2_number', 'spn_txtInkCoverageSide2_number')) {
            IsCorrect = false;
        }
    }
    ...
    if (!CheckDecimalPlus(txtInkCoverageSide1.value, 'spn_txtInkCoverageSide1', 'spn_txtInkCoverageSide1_number', 'yes')
        || !CheckDecimalPlus(txtWhiteInkCoverageSide1.value, 'spn_txtInkCoverageSide1', 'spn_txtInkCoverageSide1_number', 'yes')) {
        IsCorrect = false;
    }

    if (!CheckDecimalPlus(txtWhiteInkCoverageSide2.value, 'spn_txtInkCoverageSide2', 'spn_txtInkCoverageSide2_number', 'yes')
        || !CheckDecimalPlus(txtInkCoverageSide2.value, 'spn_txtInkCoverageSide2', 'spn_txtInkCoverageSide2_number', 'yes')) {
        IsCorrect = false;
    }
    //
    if (ddlPrintSheetSize.selectedIndex == 0 && (txtsectionheight.value == '' || txtsectionwidth.value == '') && document.getElementById('ctl00_ContentPlaceHolder1_UcLargeItem_chkPrintSheet').checked) {
        document.getElementById('spn_PrintSheetCustomSize').style.display = 'block';
        IsCorrect = false;
    }
    else {
        document.getElementById('spn_PrintSheetCustomSize').style.display = 'none';
    }
    if (ddlJobItemSize.selectedIndex == 0 && (txtitemwidth.value == '' || txtitemheight.value == '') && document.getElementById('ctl00_ContentPlaceHolder1_UcLargeItem_ChkJobFlatCustom').checked) {
        document.getElementById('spn_JobItemCustomSize').style.display = 'block';
        IsCorrect = false;
    }
    else {
        document.getElementById('spn_JobItemCustomSize').style.display = 'none';
    }
    if (!document.getElementById('ctl00_ContentPlaceHolder1_UcLargeItem_ChkJobFlatCustom').checked) {
        document.getElementById('spn_JobItemCustomSize').style.display = 'none';
    }

    if (ddlprintsizeindexnew == 0 && (document.getElementById('ctl00_ContentPlaceHolder1_UcLargeItem_chkPrintSheet').checked == false && check_printsheetsize == false)) {
        document.getElementById("spn_ddlPrintSheetSize").style.display = "block";
        IsCorrect = false;
    }
    ...
    if (LargeFormatCalculation.toLowerCase() != 'tilling') {
        if (PaperTypeNew == 'roll') {
            if (chkPortrait.checked) {
                if (Number(txtPortLength.value) == 0) {
                    alert('Portrait value cannot be zero');
                    IsCorrect = false;
                }
            }
            else if (chkLandscape.checked) {
                if (Number(txtLandLength.value) == 0) {
                    alert('Landscape value cannot be zero');
                    IsCorrect = false;
                }
            }
        }
        if (PaperTypeNew == 'sheet') {
            if (chkPortrait.checked) {
                if (Number(txtportrait.value) == 0) {
                    alert('Portrait value cannot be zero');
                    IsCorrect = false;
                }
            }
            else if (chkLandscape.checked) {
                if (Number(txtlandscape.value) == 0) {
                    alert('Landscape value cannot be zero');
                    IsCorrect = false;
                }
            }
...
function Check_Width_Height_For_Roll() {
    if ((Number(InvPaperLength) < Number(SH.value))) {
        return false;
    }
    if (Number(InvPaperWidth) < Number(SW.value)) {
        return false;
    }
    return true;
}

function Calculate_step_2() {
    
    //    CalculateLandscape();
    //    CalculatePortrait();
    G_CalculateLandscape("l");
    G_CalculatePortrait("l"); // changed By Pradeep   
    //if (LargeFormatCalculation == 'square' || LargeFormatCalculation == 'tilling') {
    //    G_CalculatePortrait("l"); // changed By Pradeep   
    //}
    //else {
    //    LargeFormat_CalculatePortrait("l");
    //}
}
var Port_Row = 0;
var Port_Col = 0;
...
function Calculations(val) {
    debugger;
    if (QtyNo == 1 || QtyNo == 0) {
        QtyForCalculate = txtQuantity.value;
    }
    else if (QtyNo == 2) {
        QtyForCalculate = txtQuantity_2.value;
    }
    else if (QtyNo == 3) {
        QtyForCalculate = txtQuantity_3.value;
    }
    else if (QtyNo == 4) {
        QtyForCalculate = txtQuantity_4.value;
    }
    Calculate_step_2();
    ...
    if (LargeFormatCalculation == 'square') {
        ...
        lblLandscapeLength.innerHTML = "&nbsp;" + Metre;
        lblPortraitLength.innerHTML = "&nbsp;" + Metre;
    }
    else {
        if (PaperTypeNew == 'sheet') {
            lblLandscapeLength.innerHTML = "&nbsp;" + PrintLayout_MSG_Sheet;
            lblPortraitLength.innerHTML = "&nbsp;" + PrintLayout_MSG_Sheet;
        }
        else {
            lblLandscapeLength.innerHTML = "&nbsp;" + Metre + " required";
            lblPortraitLength.innerHTML = "&nbsp;" + Metre + " required";
        }
    }

    if (PaperTypeNew == 'sheet' && LargeFormatCalculation == 'square') {

        //        result_port.value = Number(Number(result_port.value) * Number(SW.value)) / 1000;
        //        result_land.value = Number(Number(result_land.value) * Number(SW.value)) / 1000;

        result_port.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, result_port.value, 0, '', false, false, false);
        result_land.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, result_land.value, 0, '', false, false, false);
        ...
        var SqItemSizeFull = ((Number(SW.value) / Denominator) * (Number(SH.value) / Denominator));
        var txtport = "";
        var txtland = "";
        var total_calcus = "";
        if ($("#ctl00_ContentPlaceHolder1_UcLargeItem_chkPortrait").attr("checked")) {
            if (PaperTypeNew == "roll") {
                txtport = Number($("#ctl00_ContentPlaceHolder1_UcLargeItem_txtPortLength").val());
            } else {
                txtport = Number($("#ctl00_ContentPlaceHolder1_UcLargeItem_txtportrait").val());
            }
            //SqItemSizeFull = SqItemSizeFull / txtport;
            total_calcus = Math.ceil(Number(QtyForCalculate) / txtport);
            SqItemSizeFull = SqItemSizeFull * total_calcus;
            if (!isFinite(SqItemSizeFull)) {
                SqItemSizeFull = 0;
            }
            ...
            if (PaperTypeNew == "roll") {
                txtland = Number($("#ctl00_ContentPlaceHolder1_UcLargeItem_txtLandLength").val());
            } else {
                txtland = Number($("#ctl00_ContentPlaceHolder1_UcLargeItem_txtlandscape").val());
            }
            //SqItemSizeFull = SqItemSizeFull / txtland;
            total_calcus = Math.ceil(Number(QtyForCalculate) / txtland);
            SqItemSizeFull = SqItemSizeFull * total_calcus;
            if (!isFinite(SqItemSizeFull)) {
                SqItemSizeFull = 0;
            }
        ...
        var SqItemSize = ((Number(IW.value) / Denominator) * (Number(IH.value) / Denominator) * Number(QtyForCalculate));
        var Sqmitemarea = Number(SqItemSize) + (Number(SqItemSize) * (Number(RS.value) / 100)) + Number(SS.value);
        var isChecked = $("#ctl00_ContentPlaceHolder1_UcLargeItem_chkUSeFullSheets").attr("checked");

        if (isChecked) {
            txt_ItemSize.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, SqItemSizeFull, 0, '', false, false, false);
        } else {
            txt_ItemSize.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, Sqmitemarea, 0, '', false, false, false);
        }
        lblLandscapeLength.innerHTML = "&nbsp;" + Metre;
        lblPortraitLength.innerHTML = "&nbsp;" + Metre;
    }
    if (PaperTypeNew == 'roll') {
        ...
        If_Landscape();
        pick_smaller_length();
        //        if ((parseInt(txtPortLength.value) < parseInt(txtLandLength.value)) && (parseInt(txtPortLength.value) != 0)) {
        ...
        if (LargeFormatCalculation == 'square' || LargeFormatCalculation == 'tilling') {
            if (PaperMeasure == "In.") {
                spn_setupSpoilage.innerHTML = SquareFeet; //  "Sq.Ft";
            }
            else {
                spn_setupSpoilage.innerHTML = SquareMeter; //  "Sq.mtr";
            }
        }
        else {
            spn_setupSpoilage.innerHTML = PaperMeasure;
        }
    }
    else {// below if codition for bugid : 1653

        result_port.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, result_port.value, 0, '', false, false, false);
        result_land.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, result_land.value, 0, '', false, false, false);


        //        if (parseInt(result_port.value) <= parseInt(result_land.value)) {
        //            if (parseInt(result_port.value) != 0) {
        //                chkPortrait.checked = true;
        //                chkLandscape.checked = false;
        //                hid_Row.value = row_port.value;
        //                hid_Col.value = col_port.value;
        //            }
        //            else {
        //                chkPortrait.checked = false;
        //                chkLandscape.checked = true;
        //                hid_Row.value = row_land.value;
        //                hid_Col.value = col_land.value;
        //            }

        //        }
        //        else {
        //            if (parseInt(result_land.value) != 0) {
        //                chkPortrait.checked = false;
        //                chkLandscape.checked = true;
        //                hid_Row.value = row_land.value;
        //                hid_Col.value = col_land.value;
        ...
        console.log("Called " + (val ? val.id : "undefined"));
        var large = LargeItemPrintLayout
        if (parseInt(result_port.value) >= parseInt(result_land.value)) {
            if (LargeFormatCalculation == 'square') {
                if (LargeItemPrintLayout == "") {
                    chkPortrait.checked = true;
                    chkLandscape.checked = false;
                    hid_Row.value = row_port.value;
                    hid_Col.value = col_port.value;
                ...
                else if (LargeItemPrintLayout.toLowerCase() == 'p') {// for bugid : 1651
                    chkPortrait.checked = true;
                    chkLandscape.checked = false;
                    hid_Row.value = row_port.value;
                    hid_Col.value = col_port.value;
                    LargeItemPrintLayout = "";
                }
                else if (LargeItemPrintLayout.toLowerCase() == 'l') {// for bugid : 1651
                    chkPortrait.checked = false;
                    chkLandscape.checked = true;
                    hid_Row.value = row_land.value;
                    hid_Col.value = col_land.value;
            ...
            if (LargeFormatCalculation == 'square') {
                ...
                if (LargeItemPrintLayout.toLowerCase() == "l") {
                    chkPortrait.checked = false;
                    chkLandscape.checked = true;
                    hid_Row.value = row_land.value;
                    hid_Col.value = col_land.value;
                ...
                if (LargeItemPrintLayout.toLowerCase() == "p") {
                    chkPortrait.checked = true;
                    chkLandscape.checked = false;
                    hid_Row.value = row_port.value;
                    hid_Col.value = col_port.value;
        ...
        if (LargeFormatCalculation == 'square' || LargeFormatCalculation == 'tilling') {
            ...
            spn_setupSpoilage.innerHTML = Sheets;
        }
    }
}


function pick_smaller_length() {
    
    if (PaperTypeNew == 'roll') {

        //        if (Number(txtPortLength.value) == 0 || Number(txtLandLength.value) == 0) {
        //            if (Number(txtPortLength.value) != 0) {
        ...
        //                Col_Print = Port_Col;
        //            }
        //            else if (Number(txtPortLength.value) != 0) {
        ...
        //        }
        //        else {
        //        if ((Number(txtPortLength.value) < Number(txtLandLength.value)) && (Number(txtPortLength.value) != 0)) {
        //            chkPortrait.checked = true;
        //            chkLandscape.checked = false;
        //            Row_Print = Port_Row;
        //            Col_Print = Port_Col;
        ...
        //        }
        //}
        ////NEWLY ADDED ON 30 / 06 / 2010

        //        if (Number(txtPortLength.value) <= Number(txtLandLength.value)) {
        //            if (Number(txtPortLength.value) != 0 && (Number(Port_Row) > 0 && Number(Port_Col) > 0)) {
        //                chkPortrait.checked = true;
        //                chkLandscape.checked = false;
        //                Row_Print = Port_Row;
        //                Col_Print = Port_Col;
        ...
        //            }
        //        }
        //        else if (Number(txtPortLength.value) >= Number(txtLandLength.value)) {

        //            if (Number(txtLandLength.value) != 0 && (Number(Land_Row) > 0 && Number(Land_Col) > 0)) {
        //                chkPortrait.checked = false;
        //                chkLandscape.checked = true;
        //                Row_Print = Land_Row;
        //                Col_Print = Land_Col;
        ...
        else if (Number(Land_Row) > 0 && Number(Land_Col) > 0) {
            chkPortrait.checked = false;
            chkLandscape.checked = true;
            Row_Print = Land_Row;
            Col_Print = Land_Col;
        }
        else if (Number(Port_Row) > 0 && Number(Port_Col) > 0) {
            chkPortrait.checked = true;
            chkLandscape.checked = false;
            Row_Print = Port_Row;
            Col_Print = Port_Col;
        ...
        hid_Row.value = Row_Print;
        hid_Col.value = Col_Print;

        //Calculations();


        //txtLandLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, TotalArea, 0, '', false, false, false);
        //txtLandLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, result_land.value, 0, '', false, false, false);
        txtLandLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, txtLandLength.value, 0, '', false, false, false);
        var Denominator = 0;
        if (PaperMeasure == "In.") {
            Denominator = 12;
        }
        ...
        if (isNaN(SqItemSizeFull)) {
            SqItemSizeFull = 0;
        }
        if (isNaN(Sqmitemarea)) {
            SqItemSizeFull = 0;
        }
...
function IfLandscape_Roll() {
    Calculate_step_2();
    If_Landscape();
}
function IfPortrait_Roll() {
    Calculate_step_2();
    If_Portrait();
}

function If_Port_Ticked() {
    Row_Print = Port_Row;
    Col_Print = Port_Col;
...
function If_Portrait() {
    if (PaperTypeNew != 'roll') {
        ...
        if (Number(result_port.value) != 0) {
            var LengthRequired = Number(QtyForCalculate) / Number(result_port.value);
            var TotalLength = 0;

            TotalLength = Number(LengthRequired) * Number(IW.value);


            var QtyRow = 0;
            var QtyCol = 0;

            if (Number(QtyForCalculate) < Number(result_port.value)) {
                var shorter;
                var greater;
                if (Number(IW.value) > Number(IH.value)) {
                    greater = Number(IW.value);
                    shorter = Number(IH.value);
                }
                else {
                    greater = Number(IH.value);
                    shorter = Number(IW.value);
                }

                var NewWidth = 0;
                if (chkGutters.checked) {
                    if (Number(QtyForCalculate) > 1) {
                        NewWidth = Number(greater) + Number(HrzGutter.value);
                    }
                    else {
                        NewWidth = Number(greater);
                    }
                }
                else {
                    NewWidth = Number(greater);
                ...
                var Rows = Math.ceil(Number(QtyForCalculate) / Number(col_port.value));

                TotalLength = Number(Number(NewWidth) * Number(Rows));


                Show_Row_Col(Rows, hid_Col.value, 'port');

                Port_Row = Rows;
                Port_Col = hid_Col.value;
            }
            else {

                if (Number(IH.value) > Number(SH.value) / 2) {
                    var TotalLength = Number(Number(IH.value) * QtyForCalculate) / Number(result_port.value);
                } else {
                    TotalLength = Number(Number(SH.value) * Number(QtyForCalculate)) / Number(result_port.value);
                }
                //TotalLength = Number(Number(SH.value) * Number(QtyForCalculate)) / Number(result_port.value);
                //TotalLength = Number(Number(SH.value) * Number(QtyForCalculate)) / Number(result_port.value);

                //additional
                var Total_Rows = Number(Number(QtyForCalculate) * Number(hid_Row.value)) / Number(result_port.value);
                Total_Rows = Math.ceil(Total_Rows);

                Show_Row_Col(Total_Rows, hid_Col.value, 'port');

                Port_Row = hid_Row.value;
                Port_Col = hid_Col.value;
            }

            if (!isNaN(TotalLength) && TotalLength != "Infinity") {
                var RunningSpoialge = Number(TotalLength) * Number(txtRunningSpoilage.value) / 100;
                TotalLength = Number(TotalLength) + Number(txtSetupSpoilage.value);
                TotalLength = Number(TotalLength) + Number(RunningSpoialge);
                ...
                //                TotalArea = Number((Number(TotalLength) * Number(SW.value)) / devidBy) / devidBy;
                TotalArea = Number(TotalLength) / devidBy;
                TotalLength = Number(TotalLength) / devidBy;


                if (LargeFormatCalculation == 'square') {
                    var denominator = 0;
                    // txtPortLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, TotalArea, 0, '', false, false, false);
                    txtPortLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, result_port.value, 0, '', false, false, false);
                    var Denominator = 0;
                    if (PaperMeasure == "In.") {
                        Denominator = 12;
                    }
                    ...
                    txtPortLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, TotalLength, 0, '', false, false, false);
                }
            }

        }
        else {
            txtPortLength.value = "0";
            txtPortLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, txtPortLength.value, 0, '', false, false, false)
...
function Show_Row_Col(Rows, Cols, type) {
    ...
    if (txtQuantity.value == '' || txtQuantity.value == '0') {
        ...
        if (type == 'port') {
            if (LargeFormatCalculation == 'square') {
                lblPortraitLength.innerHTML = "&nbsp;" + Metre; //(" + Rows +" x " + Cols + ")";
            }
            else {
                lblPortraitLength.innerHTML = "&nbsp;" + Metre + " required"; //(" + Rows +" x " + Cols + ")";
            }
        }
        else {
            if (LargeFormatCalculation == 'square') {
                lblLandscapeLength.innerHTML = "&nbsp;" + Metre; //(" + Rows +" x " + Cols + ")";
            }
            else {
                lblLandscapeLength.innerHTML = "&nbsp;" + Metre + " required"; //(" + Rows +" x " + Cols + ")";
            }
        }
    }
}

function If_Landscape() {
    ...
    if (PaperTypeNew != 'roll') {
        ...
        if (Number(result_land.value) != 0) {
            var LengthRequired = Number(QtyForCalculate) / Number(result_land.value);
            var TotalLength = 0;

            TotalLength = Number(LengthRequired) * Number(IH.value);



            if (Number(QtyForCalculate) < Number(result_land.value)) {
                var shorter;
                var greater;
                if (Number(IW.value) > Number(IH.value)) {
                    greater = Number(IW.value);
                ...
                if (chkGutters.checked) {
                    if (Number(QtyForCalculate) > 1) {
                        NewWidth = Number(shorter) + Number(HrzGutter.value);
                    }
                    else {
                        NewWidth = Number(shorter);
                    }
                }
                else {
                    NewWidth = Number(shorter);
                }
                var Rows = Math.ceil(Number(QtyForCalculate) / Number(col_land.value));

                TotalLength = Number(Number(NewWidth) * Number(Rows));



                Show_Row_Col(Rows, hid_Col.value, 'land');

                Land_Row = Rows;
                Land_Col = hid_Col.value;

            }
            else {

                //TotalLength = Number(Number(SH.value) * Number(QtyForCalculate)) / Number(result_land.value);
                TotalLength = Number(Number(SH.value) * Number(QtyForCalculate)) / Number(result_land.value);

                //additional
                var Total_Rows = Number(Number(QtyForCalculate) * Number(hid_Row.value)) / Number(result_land.value);
                Total_Rows = Math.ceil(Total_Rows);

                Show_Row_Col(Total_Rows, hid_Col.value, 'land');

                Land_Row = hid_Row.value;
                Land_Col = hid_Col.value;
            }
            ...
            if (!isNaN(TotalLength) && TotalLength != "Infinity") {
                ...
                TotalLength = Number(TotalLength) + Number(txtSetupSpoilage.value);
                TotalLength = Number(TotalLength) + Number(RunningSpoialge);
                //TotalLength =  roundNumber(TotalLength,2);
                TotalLength = TotalLength;
                var TotalArea = 0;
                var devidBy = 0;
                if (PaperMeasure == "In.") {
                ...
                if (LargeFormatCalculation == 'square') {
                    ...
                    txtLandLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, TotalLength, 0, '', false, false, false);
                }
            }
        }
        else {
            txtLandLength.value = "0";
            txtLandLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, txtLandLength.value, 0, '', false, false, false);
            if (LargeFormatCalculation == 'square') {
                lblLandscapeLength.innerHTML = "&nbsp;" + Metre;
            }
...
//        B = Number(A) / Number(Number(shorter) + Number(HrzGutter.value));
//        C = parseInt(B);
//        row = C;

//        //COL CALCULATION // shorter greater
//        ASW = Number(SW.value) - Number(NonWeight);
//        D = Number(ASW) - Number(VtGutter.value);
//        E = Number(D) / Number(Number(greater) + Number(VtGutter.value));
...
//        //ROW CALCULATION
//        ASH = Number(SH.value) - Number(NonHeight);
//        A = Number(ASH) / Number(shorter);
//        row = parseInt(A);

//        //COL CALCULATION // shorter greater
//        ASW = Number(SW.value) - Number(NonWeight);
//        B = Number(ASW) / Number(greater);
//        col = parseInt(B);
...
//        A = Number(SH.value) / Number(shorter);
//        B = Number(SW.value) / Number(greater); //greater shorter
...
//        var Row_A2 = Number(greater) + Number(HrzGutter.value);
...
//        var Col_B2 = Number(shorter) + Number(VtGutter.value);
...
//        // ROW Calculation
//        var Row_A1 = Number(SH.value) - Number(NonHeight);
//        var Row_A2 = Number(greater);
//        var Row_A = Number(Row_A1) / Number(Row_A2);
//        Row_A = parseInt(Row_A);

//        //COLUMN Calculation
//        var Col_B1 = Number(SW.value) - Number(NonWeight);
//        var Col_B2 = Number(shorter);
//        var Col_B = Number(Col_B1) / Number(Col_B2);
//        Col_B = parseInt(Col_B);
...
//        A = Number(SH.value) / Number(greater);
//        B = Number(SW.value) / Number(shorter);
        ...
        if (arr_0[b] != '') {
            ...
            for (var i = 0; i < arr_1.length; i++) {
                ...
                if (arr_2[0] == "EstimateType") {
                    ...
                    Chk_PriceForWholePack1.checked = arr_2[3] == "True" ? true : false;
                    Chk_PaperSupplied1.checked = arr_2[4] == "True" ? true : false;
                }
                    ...
                    txtPortLength.value = arr_2[2];
                    txtLandLength.value = arr_2[3];
                    hdn_PortraitValue.value = arr_2[2];
                    hdn_LandscapeValue.value = arr_2[3];
                }
                else if (arr_2[0] == "Guillotine") {
                    hid_GuillotineID.value = arr_2[1];
                    lblGuillotine.innerHTML = SpecialDecode(arr_2[2]).length > 25 ? SpecialDecode(arr_2[2]).substring(0, 23) + "..." : SpecialDecode(arr_2[2]);
                }
...
function WarehouseSummaryBack(sumType) {
    if (sumType == 'back') {
        ...
        if (wareCount > 0) {
            ...
            document.getElementById("div_none").style.display = "block";
            document.getElementById("span_none").innerHTML = "Please select atleast one Warehouse Item";
        }
    }
}
...
function TakeValuesFromDB() {
    ...
    for (var b = 0; b < arr_0.length; b++) {
        if (arr_0[b] != '') {
            ...
            for (var i = 0; i < arr_1.length; i++) {
                ...
                if (arr_2[0] == "EstimateType") {
                ...
                else if (arr_2[0] == "PaperWeight2") {
                    lblPaperWt2.innerHTML = arr_2[1];
                }
                else if (arr_2[0] == "PaperWeight3") {
                    lblPaperWt3.innerHTML = arr_2[1];
                }
                else if (arr_2[0] == "PaperWeight4") {
                    lblPaperWt4.innerHTML = arr_2[1];
                }
                else if (arr_2[0] == "PaperWeight5") {
                    lblPaperWt5.innerHTML = arr_2[1];
                }
                else if (arr_2[0] == "Material2") {
                    hdnpaperID2.value = arr_2[1];
                    lbl_paper2.innerHTML = arr_2[2];
                    lbl_paper2.title = arr_2[2];
                    Chk_PriceForWholePack2.checked = arr_2[3] == "True" ? true : false;
                    Chk_PaperSupplied2.checked = arr_2[4] == "True" ? true : false;
                }
                else if (arr_2[0] == "Material3") {
                    hdnpaperID3.value = arr_2[1];
                    lbl_paper3.innerHTML = arr_2[2];
                    lbl_paper3.title = arr_2[2];
                    Chk_PriceForWholePack3.checked = arr_2[3] == "True" ? true : false;
                    Chk_PaperSupplied3.checked = arr_2[4] == "True" ? true : false;
                }
                else if (arr_2[0] == "Material4") {
                    hdnpaperID4.value = arr_2[1];
                    lbl_paper4.innerHTML = arr_2[2];
                    lbl_paper4.title = arr_2[2];
                    Chk_PriceForWholePack4.checked = arr_2[3] == "True" ? true : false;
                    Chk_PaperSupplied4.checked = arr_2[4] == "True" ? true : false;
                }
                else if (arr_2[0] == "Material5") {
                    hdnpaperID5.value = arr_2[1];
                    lbl_paper5.innerHTML = arr_2[2];
                    lbl_paper5.title = arr_2[2];
                    Chk_PriceForWholePack5.checked = arr_2[3] == "True" ? true : false;
                    Chk_PaperSupplied5.checked = arr_2[4] == "True" ? true : false;
                }
                else if (arr_2[0] == "SetupSpoilage") {
                    txtSetupSpoilage.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[1], 0, '', false, false, false);
                }
                else if (arr_2[0] == "RunningSpoilage") {
                    ...
                    for (j = 0; j < ddlColors.length; j++) {
                        if (ddlColors.options[j].value == arr_2[1]) {
                            ...
                            ShowHideInkCoverage1(ddlColors.options[j].value);
                        }
                    }
                    chkDoubleSided.checked = arr_2[2] == "True" ? true : false;
                }
                    ...
                    LoadToSheetCustom(arr_2[1]);
                    chkPrintSheet.checked = arr_2[2] == "True" ? true : false;
                    txtsectionheight.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[3], 0, '', false, false, false);
                    txtsectionwidth.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[4], 0, '', false, false, false);
                    PrintSheetCustom(chkPrintSheet.id);
                }
                else if (arr_2[0] == "ItemSize") {
                    for (j = 0; j < ddlJobItemSize.length; j++) {
                    ...
                    LoadToItemCustom(arr_2[1]);
                    ChkJobFlatCustom.checked = arr_2[2] == "True" ? true : false;
                    txtitemheight.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[3], 0, '', false, false, false);
                    txtitemwidth.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[4], 0, '', false, false, false);
                    JobItemCustom(ChkJobFlatCustom.id);
                }
                else if (arr_2[0] == "Gutters") {
                    chkGutters.checked = arr_2[1] == "True" ? true : false;
                    ...
                    chkPortrait.checked = arr_2[1] == "P" ? true : false;
                    chkLandscape.checked = arr_2[1] == "L" ? true : false;
                    txtportrait.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[2], 0, '', false, false, false);
                    txtlandscape.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[3], 0, '', false, false, false);
                    txtPortLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[2], 0, '', false, false, false);
                    txtLandLength.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[3], 0, '', false, false, false);
                    hdn_PortraitValue.value = arr_2[2];
                    hdn_LandscapeValue.value = arr_2[3];
                }
                else if (arr_2[0] == "Guillotine") {
                    ...
                    for (j = 0; j < ddlColors_2.length; j++) {
                        if (ddlColors_2.options[j].value == arr_2[1]) {
                            ddlColors_2.selectedIndex = j;
                            Side2_block();
                            ShowHideInkCoverage(ddlColors_2.options[j].value);
                        }
                    }
                }
                else if (arr_2[0] == "IsAnyWarehouse") {
                ...
                else if (arr_2[0] == "InventoryPaperType") {

                    if (arr_2[1] == "web printing" || arr_2[1] == "roll") {
                        PaperTypeNew = 'roll';
                        ForWebPrinting("yes");
                    }
                    else {
                    ...
                    //                    if (arr_2[1] == "roll" || arr_2[1] == "web printing") {
                    //                        ForWebPrinting("yes");
                    //                    }
                }
                else if (arr_2[0] == "Row") {
                    hid_Row.value = arr_2[1];
                }
                else if (arr_2[0] == "Col") {
                    hid_Col.value = arr_2[1];
                }
            }
        }
    }
    ...
    div_PriceForWholePack1.style.display = "none";
    div_PriceForWholePack2.style.display = "none";
    div_PriceForWholePack3.style.display = "none";
    div_PriceForWholePack4.style.display = "none";
    div_PriceForWholePack5.style.display = "none";
    div_WholePack.style.display = "none";
            ...
            for (var i = 1; i < 5; i++) {
                ...
                if (Quantity != '') {
                    if (!isNaN(Quantity)) {
                        ...
                        var ddlMultiple = document.getElementById("ddlMultiple");
                        ...
                        ObjPrice.MultipleOf = ddlMultiple.value;
    ...
    if (Number(MultipleOf) != 0) {
        ...
        for (var i = 1; i < 5; i++) {
            ...
            if (Number(SellingPrice) != 0) {
                ...
                SellingPrice = roundNumber(Number(SellingPrice), 2);
...
function checkchanged(MaterialNo) {
    if (MaterialNo == 1) {
        if (Chk_PriceForWholePack1.checked) {
            Chk_PaperSupplied1.checked = false;
        }
        else {
            Chk_PriceForWholePack1.checked = false;
        ...
        if (Chk_PriceForWholePack2.checked) {
            Chk_PaperSupplied2.checked = false;
        }
        else {
            Chk_PriceForWholePack2.checked = false;
        }
    }
    else if (MaterialNo == 3) {
        if (Chk_PriceForWholePack3.checked) {
            Chk_PaperSupplied3.checked = false;
        }
        else {
            Chk_PriceForWholePack3.checked = false;
        }
    }
    else if (MaterialNo == 4) {
        if (Chk_PriceForWholePack4.checked) {
            Chk_PaperSupplied4.checked = false;
        }
        else {
            Chk_PriceForWholePack4.checked = false;
        }
    }
    else if (MaterialNo == 5) {
        if (Chk_PriceForWholePack5.checked) {
            Chk_PaperSupplied5.checked = false;
        }
        else {
            Chk_PriceForWholePack5.checked = false;
        }
    }
}
function checkchanged1(MaterialNo) {
    if (MaterialNo == 1) {
        if (Chk_PaperSupplied1.checked) {
            Chk_PriceForWholePack1.checked = false;
        }
        else {
            Chk_PaperSupplied1.checked = false;
...
function SendGuillotineIDandName(id, values, FirstTrim, SecondTrim) {
    ...
    lblGuillotine.innerHTML = SpecialDecode(values);
    lblGuillotine.style.cursor = "default";
    hid_GuillotineID.value = id;
    if (PaperTypeNew == 'roll') {
        div_guillotine_trim.style.display = "none";
    }
    else {
        chkFirstTrim.checked = FirstTrim;
        chkSecondTrim.checked = SecondTrim;
    }
    //div_guillotine_trim.style.display = hid_GuillotineID.value != "0" ? "block" : "none";
}
...
function DefaultSettings() {
    ...
    for (var i = 0; i < strArr_1.length; i++) {
        ...
        if (strArr_2[0] == "DefaultPriceForWholePack") {
            Chk_PriceForWholePack1.checked = strArr_2[1] == "1" ? true : false;
        }
...
function delete_Papers(MetarialNo) {
    debugger;
    if (delcallback == 0) {
        firstConfirm = window.confirm('Are you sure, you want to delete ? ');
        delcallback = 1;
    }
    if (firstConfirm ) {
        if (MetarialNo == "1") {
            if (hdnpaperID2.value != "0") {
                SendPaperIDandName(hdnpaperID2.value, lbl_paper2.title, '', 1, lblPaperWt2.textContent);
                delete_Papers(2);
                
            }
            else {
                window.alert('Stock 1 cannot be deleted. ');
            }
            //hdnpaperID.value = hdnpaperID2.value;
            //lblDefaultPaper.innerHTML = lbl_paper2.value;
            //hdn_PaperProperties.value = hdn_PaperProperties2.value;
            //hdnpaperID.value = "0";
            //lblDefaultPaper.style.display = "none";
            //hdn_PaperProperties.value = "";
            //Chk_PriceForWholePack1.style.display = "none";
            //Chk_PaperSupplied1.style.display = "none";
            //Img_delete.style.display = "none";


            //peperRow2.style.display = "none";
        }
        else if (MetarialNo == "2") {
            if (hdnpaperID3.value != "0") {
                SendPaperIDandName(hdnpaperID3.value, lbl_paper3.title, '', 2, lblPaperWt3.textContent);
                delete_Papers(3);
        ...
        else if (MetarialNo == "3") {
            if (hdnpaperID4.value != "0") {
                SendPaperIDandName(hdnpaperID4.value, lbl_paper4.title, '', 3, lblPaperWt4.textContent);
                delete_Papers(4);
            ...
            //  peperRow3.style.display = "none";
        }
        else if (MetarialNo == "4") {
            if (hdnpaperID5.value != "0") {
                SendPaperIDandName(hdnpaperID5.value, lbl_paper5.title, '', 4, lblPaperWt5.textContent);
                delete_Papers(5);
            ...
            // peperRow4.style.display = "none";
        }
        else if (MetarialNo == "5") {
            hdnpaperID5.value = "0";
            lbl_paper5.style.display = "none";
            hdn_PaperProperties5.value = "";
            Chk_PriceForWholePack5.style.display = "none";
            Chk_PaperSupplied5.style.display = "none";
            Img_delete5.style.display = "none";
            // peperRow5.style.display = "none";
        }
    }
}

function DefaultLanding() {
    var chkSheetSize = document.getElementById("ctl00_ContentPlaceHolder1_UcLargeItem_chkPrintSheet");
    var chkJobSize = document.getElementById("ctl00_ContentPlaceHolder1_UcLargeItem_ChkJobFlatCustom");
    if (PaperTypeNew == 'roll') {
...
function Addpaperstock() {
    if (divpaperstock2.style.display == "none") {
        divpaperstock2.style.display = "block";
    }
    else if (divpaperstock3.style.display == "none") {
        divpaperstock3.style.display = "block";
    }
    else if (divpaperstock4.style.display == "none") {
        divpaperstock4.style.display = "block";
    }
    else if (divpaperstock5.style.display == "none") {
        divpaperstock5.style.display = "block";
        divaddmorepaper.style.display = "none";
    }
    return false;
...
function ShowHideInkCoverage(ddlvalue) {

    if (ddlvalue == "color") {
        document.getElementById("divside2coverage").style.display = "";
        txtWhiteInkCoverageSide2.style.display = "none";
        txtInkCoverageSide2.style.display = "";
        spninkside2.style.display = "";
        spnwhiteinkside2.style.display = "none";
    }
    else if (ddlvalue == "swhite" || ddlvalue == "dwhite") {
        document.getElementById("divside2coverage").style.display = "";
        txtInkCoverageSide2.style.display = "none";
        txtWhiteInkCoverageSide2.style.display = "";
        spninkside2.style.display = "none";
        spnwhiteinkside2.style.display = "";
        spnwhiteinkside2.style.paddingLeft = "0px";
        txtWhiteInkCoverageSide2.style.marginLeft = "0px";
    }
    else if (ddlvalue == "0") {
        document.getElementById("divside2coverage").style.display = "none";
        //CallonChange(ddlvalue,'spnddlcolor2')
    }
    else {
        document.getElementById("divside2coverage").style.display = "";
        txtWhiteInkCoverageSide2.style.display = "";
        ...
        spninkside2.style.display = "";
        spnwhiteinkside2.style.display = "";
        spnwhiteinkside2.style.paddingLeft = "17px";
        txtWhiteInkCoverageSide2.style.marginLeft = "18px";
    }
    CallonChange(ddlvalue, 'spnddlcolor2')
}

function ShowHideInkCoverage1(ddlvalue) {

    if (ddlvalue == "color") {
        txtWhiteInkCoverageSide1.style.display = "none";
        txtInkCoverageSide1.style.display = "";
        spnink.style.display = "";
        spnwhiteink.style.display = "none";
    }
    else if (ddlvalue == "swhite" || ddlvalue == "dwhite") {
        txtInkCoverageSide1.style.display = "none";
        txtWhiteInkCoverageSide1.style.display = "";
        spnink.style.display = "none";
        spnwhiteink.style.display = "";
        spnwhiteink.style.paddingLeft = "0px";
        txtWhiteInkCoverageSide1.style.marginLeft = "0px";
    }
    else {
        txtWhiteInkCoverageSide1.style.display = "";
        txtInkCoverageSide1.style.display = "";
        spnink.style.display = "";
        spnwhiteink.style.display = "";
        spnwhiteink.style.paddingLeft = "17px";
        txtWhiteInkCoverageSide1.style.marginLeft = "18px";
    }
}


function Remove_Papers() {
    if (divpaperstock5.style.display == "block" && divpaperstock4.style.display == "block" && divpaperstock3.style.display == "block" && divpaperstock2.style.display == "block") {
        hdnpaperID5.value = "0";
        lbl_paper5.style.display = "none";
        hdn_PaperProperties5.value = "";
        Chk_PriceForWholePack5.style.display = "none";
    ...
    else if (divpaperstock4.style.display == "block" && divpaperstock3.style.display == "block" && divpaperstock2.style.display == "block") {
        hdnpaperID4.value = "0";
        lbl_paper4.style.display = "none";
        hdn_PaperProperties4.value = "";
        Chk_PriceForWholePack4.style.display = "none";
    ...
    else if (divpaperstock3.style.display == "block" && divpaperstock2.style.display == "block") {
        hdnpaperID3.value = "0";
        lbl_paper3.style.display = "none";
        hdn_PaperProperties3.value = "";
        Chk_PriceForWholePack3.style.display = "none";
    ...
    else if (divpaperstock2.style.display == "block") {
        hdnpaperID2.value = "0";
        lbl_paper2.style.display = "none";
        hdn_PaperProperties2.value = "";
        Chk_PriceForWholePack2.style.display = "none";
