...
function Calculations() {
    //    CalculateLandscape();
    //    CalculatePortrait();
    G_CalculateLandscape("p");
    G_CalculatePortrait("p"); // Chenged By Pradeep
    if (txtManual.value == "") {
        txtManual.value = 0;
    }
    ...
    if (Number(result_port.value) > Number(result_land.value)) {
        ...
        else if (PadPrintLayout.toLowerCase() == 'p') {// for bugid : 1651
            chkPortrait.checked = true;
            chkLandscape.checked = false;
            chkManual.checked = false;
            PadPrintLayout = '';
        }
        else if (PadPrintLayout.toLowerCase() == 'l') {
            chkPortrait.checked = false;
            chkLandscape.checked = true;
            chkManual.checked = false;
            PadPrintLayout = '';
        } else if (PadPrintLayout.toLowerCase() == 'm') {
            chkPortrait.checked = false;
        ...
        else if (PadPrintLayout.toLowerCase() == 'p') {
            chkPortrait.checked = true;
            chkLandscape.checked = false;
            chkManual.checked = false;
        }
...
function LoadCalculations(ddlid) {
    ...
    if (DDl.selectedIndex != 0) {
        ...
        //        CalculatePortrait();
        G_CalculateLandscape("p");
        G_CalculatePortrait("p"); // Changed By Pradeep
        ...
        if (arr_0[b] != '') {
            ...
            for (var i = 0; i < arr_1.length; i++) {
                ...
                if (arr_2[0] == "EstimateType") {
                    ...
                    txtManual.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[4], 0, '', true, false, false);
                    hdn_PortraitValue.value = arr_2[2];
                    hdn_LandscapeValue.value = arr_2[3];
                    hdnManual.value = arr_2[4]
                }
...
function DefaultLanding() {
    var chkSheetSize = document.getElementById("ctl00_ContentPlaceHolder1_UCPadItem_chkPrintSheet");
    var chkJobSize = document.getElementById("ctl00_ContentPlaceHolder1_UCPadItem_ChkJobFlatCustom");
    document.getElementById("div_ddlPrintSheetSize").style.display = "none";
    document.getElementById("div_ddlJobItemSize").style.display = "none";
