...
function storedata(thisvalue, totalno) {
    ...
    ncritem.chkDoubleSided = chkDoubleSided.checked;
    ...
    if (chkDoubleSided.checked == true) {
        ncritem.Noofsidesprinted = "Double";
    } else {
        ncritem.Noofsidesprinted = "Single";
    }
...
function SaveData(txtpartspersetNew) {
    ...
    for (var i = 0; i < ncrArray.length; i++) {
        ...
        //print layout
        var PrintLayout1 = "L";
        //if (document.getElementById("ctl00_ContentPlaceHolder1_UCDigitalNCRItem_chkPortrait").checked) {
        //    PrintLayout1 = "P";
        //}
...
function LoadonEdit() {
    ...
    GenerateSection();
    LoadData(1, 'load', 1);
    GuttersCustom('ctl00_ContentPlaceHolder1_UCDigitalNCRItem_chkGutters');
}
...
function LoadData(thisvalue, type, val) {
    ...
    if (type == 'loadoninsert') {
        chkDoubleSided.checked = ncrArray[arrindx].chkDoubleSided;
        if (chkDoubleSided.checked == true) {
            ncrArray[arrindx].Noofsidesprinted = "Double";
        } else {
            ncrArray[arrindx].Noofsidesprinted = "Single";
        }
    }
    ...
    //by swetha M.S on 20/4/2011 -- Ref BUGID: 121
    if (ncrArray[arrindx].Noofsidesprinted == '') {
        chkDoubleSided.checked = ncrArray[arrindx].chkDoubleSided;
        if (chkDoubleSided.checked == true) {
            ncrArray[arrindx].Noofsidesprinted = "Double";
        } else {
...
function updateNCRSections() {
    ...
    ncrArray[updindx].chkDoubleSided = chkDoubleSided.checked;
    ...
    if (chkDoubleSided.checked == true) {
        ncrArray[updindx].Noofsidesprinted = "Double";
    } else {
        ncrArray[updindx].Noofsidesprinted = "Single";
    }
...
function partsperset_onblur(thisvalue) {
    ...
    if (QueryType == 'edit') {
        ...
        //PartspersetFromdatabase = Number(ncrArray.length);
    ...
    if (ddlPress.options[ddlPress.selectedIndex].value != 0) {
        __doPostBack('ctl00$ContentPlaceHolder1$UCDigitalNCRItem$lnkNewSection', '');
    }
}
