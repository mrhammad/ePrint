...
function PressOnChange(obj) {
    ...
    if (ChkJobFlatCustom.checked == true) {
    ...
    for (var i = 0; i < arr1.length; i++) {
        ...
        if (estimateType == "digital") {
            if (arr2[0] == ddlValue) {
                ...
                lblDefaultPaper.innerHTML = SpecialDecode(arr2[3]);
                lblDefaultPaper.innerHTML = SpecialDecode(arr2[3]);
                lblDefaultPaper.title = SpecialDecode(arr2[3]);
                lblPaperWeight.innerHTML = SpecialDecode(arr2[16]);
                ...
                lblGuillotine.innerHTML = SpecialDecode(arr2[7]);
                lblGuillotine.title = SpecialDecode(arr2[7]);
                ...
                if ("PrintImageHeight" == NonPrintHt[0]) {
                    NonHeight = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, NonPrintHt[1], 0, '', false, false, false);
                }
                var NonPrintWi = arr2[9].split('»');
                if ("PrintImageWidth" == NonPrintWi[0]) {
                    NonWeight = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, NonPrintWi[1], 0, '', false, false, false);
                }

                if (NonHeight > 0 || NonWeight > 0) {
                    ChkPressRestrictions.checked = true;
                }

                if (arr2[10] != null) {
                    txtGutterHorizontal.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr2[10], 0, '', false, false, false);
                    txtGutterVertical.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr2[11], 0, '', false, false, false);
                ...
                if (arr2[12] != null) {
                    ...
                    if (trim12(setupsploilage[0]) == "SpoilageSheets") {
                        txtSetupSpoilage.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, setupsploilage[1], 0, '', true, false, false);
                    ...
                    if (trim12(runningsploilage[0]) == "RunningSpoilage") {
                        txtRunningSpoilage.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, runningsploilage[1], 0, '', false, false, false);
                    }
                }
...
function SendPaperIDandName(id, values, papertype, Materialno, Paperweight) {
    lblDefaultPaper.title = SpecialDecode(values);
    lblDefaultPaper.innerHTML = SpecialDecode(trim12(values));
...
function GetPaperValue(result) {
    ...
    if (trim12(papertype) == "sheet(s)") {
        ...
        var Height = str2[1];
        var Width = str2[2];
        hid_height.value = Height;
        hid_width.value = Width;
        // while re-run case it was taking inventory height and width to print sheet height and width so it is commented on 21/01/2011
...
function setwidth() {
    ...
    if (is_ie) {
        ...
        document.getElementById("div_GuttersCustomSize").style.width = "235px";
    }
}
setwidth();
...
function GuillotineSelect() {
    ...
    window.radopen(strSitepath + "common/common_popup.aspx?type=moreplant&pg=estimate", 'Guillotine', '1000', '500');
    SetRadWindow('divrad', 'divBackGroundNew', '200');
...
function LoadToItemCustom(ddlValue) {
    ...
    if (ddlValue == "0") {
        ...
        for (var i = 0; i < arr1.length; i++) {
            var arr2 = arr1[i].split('±');
            if (ddlValue == arr2[0]) {
                txtitemheight.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr2[2], decimalPlaces, '', false, false, false);
                txtitemwidth.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr2[3], decimalPlaces, '', false, false, false);
            }
        }
    }
}
    ...
    if (chkLayout == "landscape") {
        ...
        if (ddlBookletType.options[ddlBookletType.selectedIndex].value == 'saddlestiched') {
            ...
            if (chkDoubleSided.checked) {
                ...
                txtPagesPerSignature.value = Number(result_manual.value) * 1;
            }
        }
...
function SaveData() {
    ...
    for (var i = 0; i < bookArr.length; i++) {
        ...
        StoreBooklet += "EstimateBookletItemID »" + bookArr[i].EstimateBookletItemID + '±';
...
function CalculateBookletSection() {
    ...
    if (isNaN(Number(NoOfSignature)) || NoOfSignature == "Infinity" || NoOfSignature == "-Infinity") {
        ...
        txtNoOfSignatures.value = GetNoOfSignatures("0");
        //txtNoOfSignatures.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, txtNoOfSignatures.value, 1, 'ForBooklet', false, false, false);
    }
    else {
        ...
        //        }
        //        else {
        //            txtNoOfSignatures.value = Math.ceil(NoOfSignature, 0); // this is commented on 4/18/2011 as per confirmation from phil and vikash sir -- By smitha
        //            //txtNoOfSignatures.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, NoOfSignature, 1, 'ForBooklet', false, false, false);// this is commented on 15/11/2011 as per confirmation from phil and vikash sir -- By swetha
        //        }
        ...
        if (Number(txtPagesPerSignature.value) % 2 != 0 || Number(txtPagesPerSignature.value) == 2 || Number(txtPagesPerSignature.value) == 0) {
            if (window.confirm('Selected layout is not valid for booklet\n Do you want to continue?')) {
                ...
                if (isNaN(Number(NoOfSignature)) || NoOfSignature == "Infinity" || NoOfSignature == "-Infinity") {
                    ...
                    //                    else {
                    //                        txtNoOfSignatures.value = Math.ceil(NoOfSignature, 0); // this is commented on 4/18/2011 as per confirmation from phil and vikash sir -- By smitha
                    //                        //txtNoOfSignatures.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, NoOfSignature, 1, 'ForBooklet', false, false, false);
                    //                    }
                    txtNoOfSignatures.value = GetNoOfSignatures(NoOfSignature);
                }
            }
...
////Code for language conversion for function Booklet_Click_Next()
//var Page_Per_Print_Alert;

//AutoFill.GetLanguageConversionJS("Booklet_Pages_Per_Print_Sheet_Cannot_Be_Zero", GetLCForAlert, onTimeout, onError);

//function GetLCForAlert(result) {
//    Page_Per_Print_Alert = result;
...
function Booklet_Click_Next() {
    ...
    if (Number(txtPagesPerSignature.value) == 0) {
        IsItOk = false;
        alert(Booklet_Pages_Per_Print_Sheet_Cannot_Be_Zero);
    }
...
function showSides(IsChecked) {
    ...
    if (txtPagesPerSignature.value != "0") {
    ...
    if (ddlValue == 'digital') {
        ...
        if (isany == null) {
            ...
            for (var i = 0; i < arr1.length; i++) {
                if (arr1[i] != '') {
                    var arr2 = arr1[i].split('±');
                    ddlPress.options.add(new Option(SpecialDecode(arr2[1]), arr2[0], i));
                }
            }
...
function ProductTypeShow(para) {
    DdlProductType.selectedIndex = 1; //BOOKLET 
    MadeProductDefault();
    ////Digital////
    ...
    if (para == "singleitem") {
        ...
        document.getElementById(div_Print_Layout).style.display = "block";
...
function MoveNextSection() {
    ...
    if (Number(txtPagesPerSignature.value) == 0) {
        IsItOk = false;
        if (MoveNextsection != "Delete") {
            alert("Booklet pages per print sheet cannot be zero.");
        }
    }
...
function LoadSectionValues(nos) {
    ...
    EditID = bookArr[nos].EstimateBookletItemID;
    ...
    lblDefaultPaper.innerHTML = SpecialDecode(bookArr[nos].PaperName);
    ...
    txtNoOfSignatures.value = GetNoOfSignatures(bookArr[nos].NoOfSignatures);
    ...
    //    hid_width.value = bookArr[nos].InvWidth;
    //    hid_height.value = bookArr[nos].InvHeight;
...
function CopyToNewSection(sectionNo) {
    ...
    if (bookArr[indx] != null) {
        ...
        txtSectionRef.value = "Section " + Number(bookArr.length + 1); //bookArr[indx].SectionRef;
        ...
        lblDefaultPaper.innerHTML = SpecialDecode(bookArr[indx].PaperName);
        ...
        lblGuillotine.innerHTML = SpecialDecode(bookArr[indx].GuilotineName);
        ////new Development
        ...
        //BookletPrintLayout = bookArr[indx].PrintLayout;
        //booklet changes
        ...
        txtPagesPerSignature.value = bookArr[indx].PagesPerSignature;
        //txtNoOfSignatures.value = bookArr[indx].NoOfSignatures;
        txtNoOfSignatures.value = GetNoOfSignatures(bookArr[indx].NoOfSignatures);


        //        hid_width.value = bookArr[indx].InvWidth;
        //        hid_height.value = bookArr[indx].InvHeight;
        for (var i = 0; i < ddlBookletFormat.length; i++) {
...
function OnlyForBooklet() {
        ...
        if (arr_0[b] != '') {
            ...
            for (var i = 0; i < arr_1.length; i++) {
                ...
                if (arr_2[0] == "EstimateType") {
                    ...
                    lblPaperWeight.innerHTML = SpecialDecode(arr_2[1]);
                }
                    ...
                    for (var q = 0; q < StrQtyData.length; q++) {
                        if (q == 0) {
                            txtQuantity.value = StrQtyData[q] == "" ? "" : Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, StrQtyData[q], 0, '', true, false, false);
                            // moreQty('single');
                            moreQty('more');
                        }
                        else if (q == 1) {
                            txtQuantity_2.value = StrQtyData[q] == "" ? "" : Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, StrQtyData[q], 0, '', true, false, false);
                            moreQty('more');
                        }
                        else if (q == 2) {
                            txtQuantity_3.value = StrQtyData[q] == "" ? "" : Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, StrQtyData[q], 0, '', true, false, false);
                            moreQty('more');
                        }
                        else if (q == 3) {
                            txtQuantity_4.value = StrQtyData[q] == "" ? "" : Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, StrQtyData[q], 0, '', true, false, false);
                            moreQty('more');
                        }
                    }
                    ...
                    txtportrait.value = Number(arr_2[2]);
                    txtlandscape.value = Number(arr_2[3]);
                    ...
                    txtPagesPerSignature.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[1], 0, '', true, false, false);
                }
                    ...
                    //txtNoOfSignatures.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[1], 1, '', false, false, false);
                    hdn_PortraitValue.value = GetNoOfSignatures(arr_2[1]);
                }
                ...
                else if (arr_2[0] == "EstimateBookletItemID") {
                    EditID = arr_2[1];
                }
                    //by yogesh checking Inv Paper Width and Height
                else if (arr_2[0] == "InvHeight") {
                    hid_height.value = arr_2[1];
                }
                else if (arr_2[0] == "Invwidth") {
                    hid_width.value = arr_2[1];
                }
            }
            MoveNextSection();
        }
    ...
    LoadSectionValues("0");
    // chkLandscape.checked
    // Calculations();
}

function StoreSections() {
    var bklItem = new ItemClass();
    bklItem.EstimateBookletItemID = EditID;
    EditID = 0;
    ...
    bklItem.InvHeight = hid_height.value;
    bklItem.InvWidth = hid_width.value;
    ...
    //bklItem.PrintLayout = BookletPrintLayout;
    BookletPrintLayout = '';
...
function Calculations(isfromdropdown) {
    debugger;
    if (!chkPrintSheet.checked) {
    ...
    if (!ChkJobFlatCustom.checked) {
        LoadToItemCustom(ddlJobItemSize.options[ddlJobItemSize.selectedIndex].value);
    }
    ...
    if (ddlBookletType.options[ddlBookletType.selectedIndex].value == 'saddlestiched') {
        ...
        //            CalculateLandscape(tempNewJobSheetHight, tempNewJobSheetWidth, true);
        //            CalculatePortrait(tempNewJobSheetHight, tempNewJobSheetWidth, true);    

        G_CalculateLandscape_saddlestiched('b', tempNewJobSheetHight, tempNewJobSheetWidth);
        G_CalculatePortrait_saddlestiched('b', tempNewJobSheetHight, tempNewJobSheetWidth);
        if (txtManual.value == "") {
            txtManual.value = 0;
        }
        ...
        G_CalculateLandscape("b");
        G_CalculatePortrait("b"); // changed By Pradeep
        ...
        if (isfromdropdown == undefined) {
            ...
            if (ddlBookletType.options[ddlBookletType.selectedIndex].value != 'saddlestiched') {
                if (ddlBookletFormat.selectedIndex == 0) {
                    if (chkDoubleSided.checked) {
                        txtPagesPerSignature.value = Number(result_port.value) * 2;
                    } else {
                        txtPagesPerSignature.value = Number(result_port.value) * 1;
...
function LoadCalculations(ddlid) {
    debugger;
    var OldValueOFPotAndLan = ddlBookletFormat.selectedIndex;
    ...
    if (DDl.selectedIndex != 0) {
        ...
        setbooklet_format();
        if (OldValueOFPotAndLan != ddlBookletFormat.selectedIndex) {
            Calculations();
        }
    }
}
...
function setbooklet_format() {
    if (ddlBookletType.options[ddlBookletType.selectedIndex].value != 'saddlestiched') {
        ...
        txtPagesPerSignature.value = parseInt(Number(txtPagesPerSignature.value));
    }
}
...
function RollCalculation(SheetWidth, SheetHeight, ItemWidth, ItemHeight, VGutter, HGutter, NonWidth, NonHeight, IsGutter, IsNonImage, IsFrom) {
    ...
    if (IsFrom == "landscape") {
        while (NewWidth < SheetWidth) {
            ...
            if ((TestWidth < SheetWidth) && infiniteLoopCounter < 5) {
...
function ReCalculateVariableQty() {
    ...
    if (productType != "booklet") {
        ...
        if (chkPortrait.checked) {
            ...
            PrintLayoutQty = Number(txtManual.value);
        }
    }
    else {
        ...
        if (arr_0[b] != '') {
            ...
            for (var i = 0; i < arr_1.length; i++) {
                ...
                if (arr_2[0] == "EstimateType") {
                    ...
                    lblDefaultPaper.innerHTML = SpecialDecode(arr_2[2]);
                    lblDefaultPaper.title = SpecialDecode(arr_2[2]);
                    ChkPriceForWholePack.checked = arr_2[3] == "True" ? true : false;
                    ChkPaperSupplied.checked = arr_2[4] == "True" ? true : false;
                }
                else if (arr_2[0] == "SetupSpoilage") {
                    ...
                    for (var u = 0; u < ddlBookletType.length; u++) {
                        if (ddlBookletType.options[u].value == arr_2[1]) {
                            ddlBookletType.selectedIndex = u;
                    ...
                    //txtNoOfSignatures.value = Eprint_ReturnFinal_Formated_Amount(CompanyID, UserID, arr_2[1], 1, 'ForBooklet', false, false, false);
...
function ShowAddPanel_Estimate(WID, WName, WType, UPrice, packedin, PackedInQty) {
    ...
    setLoadingPositionOfDivMove(div_inventory_select);
...
function CalculateSaddleStichedLandscape() {
    ...
    if (Number(IH.value) > Number(IW.value)) {
        ...
        NewJobSheetWidth = Number(IH.value) * 2;
        NewJobSheetHight = Number(IW.value);
    }
...
function DefaultLanding() {
    var chkSheetSize = document.getElementById("ctl00_ContentPlaceHolder1_UcBooklet_chkPrintSheet");
    var chkJobSize = document.getElementById("ctl00_ContentPlaceHolder1_UcBooklet_ChkJobFlatCustom");
    document.getElementById("div_ddlPrintSheetSize").style.display = "none";
    document.getElementById("div_ddlJobItemSize").style.display = "none";
...
function changetext() {
    ...
    if (selectedval == 'saddlestiched') {
        //document.getElementById("div_plusimg").style.marginTop = "-11px";
        document.getElementById("ctl00_ContentPlaceHolder1_UcBooklet_Label20").innerHTML = 'Print Layout (of the flat booklet item)';
        document.getElementById("ctl00_ContentPlaceHolder1_UcBooklet_lblbookletformat").innerHTML = 'Finished Booklet Format';
        document.getElementById("div_Booklet_itemSize").style.display = "block";
        document.getElementById("div_PrintLayout").style.display = "block";
        document.getElementById("div_Booklet_Format").style.display = "block";
    }
    else if (selectedval == 'perfectbound') {
        document.getElementById("ctl00_ContentPlaceHolder1_UcBooklet_Label20").innerHTML = 'Print Layout';
        //document.getElementById("div_plusimg").style.marginTop = "0px";
        document.getElementById("ctl00_ContentPlaceHolder1_UcBooklet_lblbookletformat").innerHTML = 'Print Layout';
        document.getElementById("div_Booklet_itemSize").style.display = "none";
        document.getElementById("div_PrintLayout").style.display = "block";
        document.getElementById("div_Booklet_Format").style.display = "none";
    }
