...
function buildDimmerDiv()
{
	...
	document.write('<div  id="dimmer" class="dimmer" style="width:' + (docwidthcomplete-100) + 'px; height:' + docheightcomplete + 'px"></div>');	
 ...
 function displayCommon(divid)
	    {
	        ...
	        l = screen.width/4;
	        t =screen.height/2;
	        displayFloatingDiv(divid, 'Common', w, h, l, t);
           return false;
	    }
...
function displayFloatingDiv(divId, title, width, height, left, top) 
{
	...
	{
	document.getElementById(divId).style.top = parseInt(document.body.scrollTop + 10) + 'px';
	 document.getElementById(divId).style.left =parseInt(document.body.scrollLeft + ((screen.width/4)-50))  + 'px';
	
	}
	else
	{
	document.getElementById(divId).style.top = parseInt(window.pageYOffset + 10) + 'px';
	document.getElementById(divId).style.left =parseInt(window.pageXOffset + ((screen.width/4)-50))  + 'px';
