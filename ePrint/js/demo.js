...
var Example1 = new (function () {
    ...
    var $stopwatch, // Stopwatch element on the page
        ...
        updateTimer = function () {
            //  alert("play");
            document.getElementById("ctl00_ContentPlaceHolder1_Client_DivFirstPauseButton").style.display = "block";
            document.getElementById("ctl00_ContentPlaceHolder1_Client_DivFirstStartButton").style.display = "none";
            document.getElementById("ctl00_ContentPlaceHolder1_Client_DivButtonResart").style.display = "block";
    ...
    this.resetStopwatch = function () {
        ...
        document.getElementById("ctl00_ContentPlaceHolder1_Client_DivFirstStartButton").style.display = "block";
        document.getElementById("ctl00_ContentPlaceHolder1_Client_DivFirstPauseButton").style.display = "none";

        this.Timer.stop().once();
    };

    this.resetStopwatch123 = function () {

        var hdncallstaTime = document.getElementById("ctl00_ContentPlaceHolder1_Client_hdncallstaTime");
        hdncallstaTime.value = '';

        var hdncallHours = document.getElementById("ctl00_ContentPlaceHolder1_Client_hdncallHours");
        hdncallHours.value = '';
