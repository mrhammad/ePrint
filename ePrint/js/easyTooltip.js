...
//        },
        ...
        show: function (trigger, event) {
            if (!this.open) {
                ...
                if ($.browser.msie && $.browser.version == "6.0") this.ie(this.skeleton);
            }
