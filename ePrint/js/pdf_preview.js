...
function downloadImage_click(AccountID) {

    window.open(strSitepath + "DocManager.ashx?doctype=previewimage&actid=" + AccountID + "&cid=" + CompanyID + "&filename=" + $("li.selected input")[0].value, '_blank');
}
