<%@ page language="C#" masterpagefile="~/Templates/innerMasterPage_withoutPanel.master" autoeventwireup="true" CodeBehind="estimate_warehouse.aspx.cs" Inherits="ePrint.Estimates.estimate_warehouse" title="Add Estimate" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
                    ...
                    <div class="t">
                        <div class="divpadding">
                            <div align="left" nowrap="nowrap">
                                <span class="navigatorpanel" id="lblheader" runat="server">
                                    <%=objLanguage.GetLanguageConversion("Create_Item_Warehouse_Item")%></span>
                            </div>
                        </div>
                    </div>
                </div>
