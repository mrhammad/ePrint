<%@ page language="C#" masterpagefile="~/Templates/innerMasterPage_withoutPanel.master" CodeBehind="estimate_printbroker.aspx.cs" Inherits="ePrint.Estimates.estimate_printbroker" autoeventwireup="true" title="Add Estimate" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
                ...
                <div class="t">
                    <div class="divpadding">
                        <div align="left" class="bor" nowrap="nowrap">
                            <span class="navigatorpanel" id="Span1">
                                <%=objLanguage.GetLanguageConversion("Supplier_Request_For_Quote_Item_Description")%></span>
                        </div>
                    </div>
                </div>
            </div>
