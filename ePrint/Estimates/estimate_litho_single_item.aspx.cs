...
{
    public partial class estimate_litho_single_item : BaseClass, IRequiresSessionState
    {
        ...
        public estimate_litho_single_item()
        {
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (string.Compare(this.req_type, "add", true) == 0)
            {
                if (base.Request.Params["FromAddAnItem"] != null)
                {
                    if (base.Request.Params["FromAddAnItem"].ToString() == "Y")
                    {
                        ...
                        base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Estimate_Add_Litho_Offset")));
                    }
                }
                else if (base.Request.Params["maintype"] != "edit")
                {
                    ...
                    base.Navigation_Path(string.Concat(strArrays), this.objLanguage.GetLanguageConversion("Estimate_Add_Litho_Offset"));
                }
                else
                {
                    ...
                    base.Navigation_Path(string.Concat(languageConversion1), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Estimate_Add_Litho_Offset")));
                }
            ...
            if (string.Compare(this.req_type, "edit", true) == 0)
            {
                ...
                if (this.IsItemCompleted == 1)
                {
                    ...
                    base.Navigation_Path(string.Concat(strArrays1), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Estimate_Add_Litho_Offset")));
                ...
                if (this.IsItemCompleted == 0)
                {
                    ...
                    base.Navigation_Path(string.Concat(languageConversion2), string.Concat(">&nbsp;", this.objLanguage.GetLanguageConversion("Estimate_Add_Litho_Offset")));
                    base.Title = this.objLanguage.convert(global.pageTitle("Estimate Add", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
                }
            }
        }
