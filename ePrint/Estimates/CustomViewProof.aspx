<%@ Page Title="" Language="C#" MasterPageFile="~/innerMasterPage_withoutLeftTD.Master" AutoEventWireup="true" CodeBehind="CustomViewProof.aspx.cs" Inherits="ePrint.Estimates.CustomViewProof" %>
              ...
              Step 1:Configure Grouping</b>
                                    ...
                                    <div style="float: left; padding-top: 2px">
                                        <asp:DropDownList ID="ddlGroupBy" CssClass="normaltext" Width="150px" runat="server">
                                                ...
                                                <asp:ListItem Text="File Status" Value="FileStatus" />
                    
                                                <asp:ListItem Text="Approval Date" Value="ActualProofApprovalDate" />
                                                <asp:ListItem Text="Production Date" Value="ProductionDate" />
                                                
                                                <asp:ListItem Text="Delivery Date" Value="DeliveryDate" />
                                                <asp:ListItem Text="Creation Date"  Value="CreationDate" />
                                        </asp:DropDownList>
                                    </div>
                                    <div class="only5px">
                                    </div>
                                    ...
                                    <div style="float: left">
                                        <asp:DropDownList ID="ddlDateType" CssClass="normaltext" Width="150px" runat="server">
                                             <asp:ListItem Text="None" Value="None" selected="true" />
                                                ...
                                                <asp:ListItem Text="Approval" Value="ActualProofApprovalDate" />
                                                <asp:ListItem Text="Production" Value="ProductionDate" />
                                                
                                                <asp:ListItem Text="Delivery" Value="DeliveryDate" />
                                                <asp:ListItem Text="CreationDate"  Value="CreationDate" />
