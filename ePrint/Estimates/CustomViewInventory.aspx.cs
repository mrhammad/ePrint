...
{
    public partial class CustomViewInventory : System.Web.UI.Page
    {
        ...
        {
            CustomViewInventory.MoveRecords(this.lstClumns, this.lstSelectedCols);
        }

        protected void btnReMove_OnClick(object sender, EventArgs e)
        {
            CustomViewInventory.ReMoveRecords(this.lstSelectedCols, this.lstClumns);
        }
        ...
        protected void btnsave_OnClick(object sender, EventArgs e)
        {
            ...
            {
                CustomViewInventory usercontrolViewsCustomView = this;
            ...
            string str1 = "InventorySelectView";
            string str2 = "";
            ...
            this.objCreateView.View_Set_Default_All_zero_exist("InventorySelectView", this.companyId);
            if (this.ret <= 0)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            base.Title = this.objLanguage.convert(global.pageTitle("Inventory Select View", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
            ...
            if (!base.IsPostBack)
            {
                ...
                for (int i = 0; i < this.lstClumns.Items.Count; i++)
                {
                    ...
                    if (this.lstClumns.Items[i].Value.ToLower() == "inventoryname")
                    {
                        this.lstClumns.Items[i].Text = "Inventory Name";
                    }
                    if (this.lstClumns.Items[i].Value.ToLower() == "cost")
                    {
                        this.lstClumns.Items[i].Text = "Cost ($)";
                    }
                    if (this.lstClumns.Items[i].Value.ToLower() == "suppliername")
                    {
                        this.lstClumns.Items[i].Text = "Supplier Name";
                    }
                    if (this.lstClumns.Items[i].Value.ToLower() == "unitprice")
                    {
                        this.lstClumns.Items[i].Text = "Unit Price ($)";
                    }
                    if (this.lstClumns.Items[i].Value.ToLower() == "description")
                    {
                        this.lstClumns.Items[i].Text = "Description";
                    }
                    if (this.lstClumns.Items[i].Value.ToLower() == "createddate")
                    {
                        this.lstClumns.Items[i].Text = "Created Date";
                    }
                    if (this.lstClumns.Items[i].Value.ToLower() == "archived")
                    {
                        this.lstClumns.Items[i].Text = "Archived";
                    }
                    if (this.lstClumns.Items[i].Value.ToLower() == "availablequantity")
                    {
                        this.lstClumns.Items[i].Text = "Available Quantity";
                    }
                    if (this.lstClumns.Items[i].Value.ToLower() == "location")
                    {
                        this.lstClumns.Items[i].Text = "Location";
                    }
                    ...
                    if (this.lstClumns.Items[i].Value.ToLower() == "stocktype")
                    {
                        this.lstClumns.Items[i].Text = "Stock Type";
                    }
                    if (this.lstClumns.Items[i].Value.ToLower() == "weight")
                    {
            ...
            if (base.Request.Params["type"] != null)
            {
                if (base.Request.Params["type"].ToString().ToLower() == "edit" && base.Request.Params["id"] != null)
                {
                    ...
                    this.ViewID = Convert.ToInt64(base.Request.Params["id"].ToString());
                    this.iszero = this.objCreateView.Check_Iszeroth_View(this.companyId, this.ViewID, "InventorySelectView");
                    ...
                    if (!base.IsPostBack)
                    {
                        DataTable dataTable = EstimateBasePage.Estimates_ViewName_Select_By_ID(BaseClass.CheckIntegerNull(this.companyId), this.ViewID, "InventorySelectView");
