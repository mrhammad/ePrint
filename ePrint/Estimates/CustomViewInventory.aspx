<%@ Page Title="" Language="C#" MasterPageFile="~/innerMasterPage_withoutLeftTD.Master" AutoEventWireup="true" CodeBehind="CustomViewInventory.aspx.cs" Inherits="ePrint.Estimates.CustomViewInventory" %>
                        ...
                        <table cellspacing="2" cellpadding="2" width="100%" align="center" border="0">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="display: none;float: left; width: 80px">
                                        <b>
                                            <%=objLanguage.GetLanguageConversion("View_Name")%></b>
                                    </div>
                                    <div style="display: none;float: left; border: 0px solid;">
                                    ...
                                    <div style="display: none;float: left; padding-left: 2px">
