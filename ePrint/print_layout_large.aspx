<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print_layout_large.aspx.cs" Inherits="ePrint.print_layout_large"  masterpagefile="~/Templates/popUpMasterPage.master" %>
        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <%--class="borderWithoutTop" removed the class bec of 467 issue--%>
                    <tr>
                        <td>
