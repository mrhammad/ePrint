...
<!-- table wizard -->
<table cellpadding="0" cellspacing="0" class="reDialog NoMarginDialog TableWizard"
    style="width: 706px">
    <tr>
        <td class="reTopcell">
            <telerik:RadTabStrip ShowBaseLine="true" ID="TableWizardTab" runat="server" SelectedIndex="0"
        ...
        <td class="reMiddlecell reTableWizardDialog" style="height: 400px; padding: 0; vertical-align: top;">
            <telerik:RadMultiPage ID="dialogMultiPage" runat="server" SelectedIndex="0">
                <telerik:RadPageView ID="tableDesignRow" runat="server">
                    <dc:TableDesign ID="tableDesignPanel" runat="server"></dc:TableDesign>
                </telerik:RadPageView>
            ...
            <table cellpadding="0" cellspacing="0" class="reConfirmCancelButtonsTbl">
                <tr>
                    <td style="padding-right: 8px;">
                        <button type="button" id="InsertButton" class="button">
                            <script type="text/javascript">
