...
<style type="text/css">
    ...
    .rfdSkinnedButton, .reConfirmCancelButtonsTbl
    {
    ...
    .RadForm_Default.rfdTextbox .rfdDecorated, .RadForm_Default.rfdTextbox .rfdDecorated, .RadForm_Default.rfdTextarea textarea
    {
...
<table cellpadding="0" cellspacing="0" class="reDialog LinkManager NoMarginDialog"
    style="width: 400px; font-family: Verdana,​Verdana,​Arial,​Helvetica; color: #696969;
    font-size: 11px;">
    <tr>
        <td class="reTopcell">
    ...
    <tr>
        <td class="reMiddlecell" style="height: 194px; vertical-align: top; font-family: Verdana ,​Verdana,​Arial,​Helvetica;
            font-size: 11px;">
            <telerik:RadMultiPage ID="dialogMultiPage" runat="server" SelectedIndex="0">
                <telerik:RadPageView ID="hyperlinkFieldset" runat="server">
                    <table border="0" cellpadding="0" cellspacing="0" class="reControlsLayout" style="font-family: Verdana,​Verdana,​Verdana,​Arial,​Helvetica;
        ...
        <tr>
            <td class="reBottomcell">
                <table border="0" cellpadding="0" cellspacing="0" class="reConfirmCancelButtonsTbl">
                    <tr>
                        <td>
                            <button type="button" id="lmInsertButton" class="button" >
                                <script type="text/javascript">
                        ...
                        <td>
                            <button type="button" id="lmCancelButton" class="button">
                                <script type="text/javascript">
