<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomViewJob.ascx.cs" Inherits="ePrint.usercontrol.Views.CustomViewJob" %>
...
<asp:HiddenField ID="hdndescription1" runat="server" Value="" />
<asp:HiddenField ID="hdndescription2" runat="server" Value="" />
<asp:HiddenField ID="hdndescription3" runat="server" Value="" />
<asp:HiddenField ID="hdndescription4" runat="server" Value="" />
<asp:HiddenField ID="hdndescription5" runat="server" Value="" />
<div id="content">
           ...
           <%-- <tr>
                    ...
                    <div id="div_Columns">
                        <asp:Panel ID="pnllst" runat="server">
                            <div id="divMain" style="border: 0px solid black; width: 100%; float: left">
                                <div id="div_lstAllCols" style="width: 225px; float: left; border: 0px solid gray">
                                    <b>
                                        <asp:Label ID="lblAvailableCols" runat="server"></asp:Label></b>
                                    <telerik:RadListBox ID="lstClumns" runat="server" CheckBoxes="true" Width="225px" SelectionMode="Multiple"
                                        Height="200px" CssClass="normaltext" OnItemDataBound="lstClumns_OnItemDataBound">
                                    </telerik:RadListBox>

                                </div>
                                <div style="width: 45px; vertical-align: middle; float: left; padding-left: 10px; border: 0px solid red">
                                    <div style="width: 20%">
                                        &nbsp;
                                    </div>
                                    <div class="only10px">
                                ...
                                <div style="border: 0px solid blue; width: 47%; float: left; padding-left: 10px">
                                    <b>
                                        <asp:Label ID="lblSelectedCols" runat="server"></asp:Label>
                                    </b>
                                    <div>
                                    </div>
                                    <telerik:RadListBox ID="lstSelectedCols" runat="server" Width="230px" Height="200px"
            ...
            <tr>
                <td>
                    ...
                    <%--<div>
                        <asp:RadioButton ID="rdb_Showall" runat="server" GroupName="rdb" onclick="javascript:checkone();"
                            Checked="true"></asp:RadioButton>
                    </div>
                    <div>
                        <asp:RadioButton ID="rdb_Searchby" runat="server" GroupName="rdb" onclick="javascript:checkone();"
                            Checked="false" />
                    </div>--%>
                    <div class="only5px">
                    </div>
                   ...
                   <%-- <div style="float: left; width: 85px">
                        <%=objLanguage.GetLanguageConversion("Show_Records")%>
                    </div>
                    <div style="float: left">
                    ...
                    <asp:PlaceHolder ID="plh1" runat="server">
                        <div id="div_Searchcriteria"  style="display: none; margin-left: 13px; margin-top: -16px;"  runat="server">
                            ...
                            <div class="smallgraytext">
                                <%=objLanguage.GetLanguageConversion("ProformaInvoice_Note_For_CustomView")%>
                            </div>
                        </div>
                        <table cellspacing="2" cellpadding="2" width="100%" align="center" border="0">
                            <tr>
                                    ...
                                    <div style="float: left">
                                        <asp:DropDownList ID="ddlDateType" CssClass="normaltext" Width="150px" runat="server">
                                             <asp:ListItem Text="None" Value="None" selected="true" />
                                                ...
                                                <asp:ListItem Text="CreationDate"  Value="JobDate" />
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="float: left; padding-left: 2px">
                                        <asp:CheckBox ID="chk_setdefault" runat="server" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <div style="float: left; display: none">
                                        <div id="div_btncancel" style="display: block">
                                            <asp:Button ID="btn_Cancel" runat="server" CssClass="button" OnClientClick="javascript:var a=cancelClick(path+'Jobs/jobs_view.aspx');loadingimage(this.id,'div_btncancelprocess');return a;" />
                                        </div>
                                    ...
                                    <div style="float: left;">
                                        <div id="div_btndelete" style="display: block">
                                            <asp:Button ID="btn_delete" runat="server" CssClass="button" Width="65px" OnClick="btndelete_OnClick"
                                    ...
                                    <div style="float: left;">
                                        <div id="div_btnsave" style="display: block">
                                            <asp:Button ID="btn_Save" runat="server" CssClass="button" OnClick="btnsave_OnClick"
                                    ...
                                    <div style="float: left;">
                                        <div id="div_btnsaveasnewview" style="display: block">
                                            <asp:Button ID="btn_saveasnewview" runat="server" CssClass="button" OnClick="btnsaveasnewview_OnClick"
