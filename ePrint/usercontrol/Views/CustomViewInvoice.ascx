<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomViewInvoice.ascx.cs" Inherits="ePrint.usercontrol.Views.CustomViewInvoice" %>
                    ...
                    <b>
                                    ...
                                    <div style="float: left; padding-top: 2px">
                                        <asp:DropDownList ID="ddlGroupBy" CssClass="normaltext" Width="150px" runat="server">
                                                ...
                                                <asp:ListItem Text="Inv. Status" Value="InvoiceStatus" />
                                                <asp:ListItem Text="Item Status" Value="StatusID" />
                                                <asp:ListItem Text="Created Date" Value="CreatedDate" />
                                                <asp:ListItem Text="Payment Date" Value="paymentdate" />
                    ...
                    <asp:PlaceHolder ID="plh1" runat="server">
                        <div id="div_Searchcriteria" style="display: none; margin-left: 13px; margin-top: -16px;" runat="server">
                            ...
                            <div class="smallgraytext">
                                <%=objLanguage.GetLanguageConversion("IsPaid_Note_For_InvoiceCustomView")%>
                            </div>
                        </div>
                        <table cellspacing="2" cellpadding="2" width="100%" align="center" border="0">
                            <tr>
                                    ...
                                    <div style="float: left">
                                        <asp:DropDownList ID="ddlDateType" CssClass="normaltext" Width="150px" runat="server">
                                             <asp:ListItem Text="None" Value="None" selected="true" />
                                                ...
                                                <asp:ListItem Text="Payment" Value="paymentdate" />
                                                <asp:ListItem Text="Delivery" Value="SysDeliveryDate" />
                                    ...
                                    <div style="float: left; border: 0px solid;">
                                        ...
                                        <div style="display: block;" class="error_top">
                                            <span id="spn_txtViewName" class="spanerrorMsg" style="display: none; width: 170px;">
                                                <%=objLanguage.GetLanguageConversion("View_Name_Already_Exists")%></span></div>
                                        <div style="display: block;" class="error_top">
                                ...
                                <td>
                                    ...
                                    <div style="float: left; display: none">
                                        <div id="div_btncancel" style="display: block">
                                            <asp:Button ID="btn_Cancel" runat="server" Text='Cancel' CssClass="button" OnClientClick="javascript:var a= cancelClick(path+'Invoice/invoice_view.aspx');loadingimage(this.id,'div_btncancelprocess');return a;" /><%--OnClick="btncancel_OnClick"--%>
                                        </div>
