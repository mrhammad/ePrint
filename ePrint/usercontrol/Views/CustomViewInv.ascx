<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomViewInv.ascx.cs" Inherits="ePrint.usercontrol.Views.CustomViewInv" %>
                ...
                <div class="divpadding">
                    <div align="left" nowrap="nowrap">
                        <span class="navigatorpanel" style="padding-left: 10px">
                            <%=objLangClass.GetLanguageConversion("Warehouse_Inventory_Custom_View")%>
                        </span>
                    </div>
                </div>
            </div>
                ...
                <td>
                    ...
                    <%--<div>
                        <asp:RadioButton ID="rdb_Showall" runat="server" Text="Show all records" GroupName="rdb"
                            onclick="javascript:checkone();" Checked="true" />
                    </div>
                    <div>
                        <asp:RadioButton ID="rdb_Searchby" runat="server" Text="Search by the following criteria"
                            GroupName="rdb" onclick="javascript:checkone();" Checked="false" />
                    </div>--%>
                    <div class="only5px">
                    </div>
                    <div class="only5px">
                ...
                <td>
                    <asp:PlaceHolder ID="plh1" runat="server">
                        <div id="div_Searchcriteria" style="display: none; margin-left: 13px; margin-top: -16px;" runat="server">
                            ...
                            <div class="smallgraytext">
                                Please Note: While using Archived Column, select one of these two values only -
                                "Yes" or "No"
                            </div>
                        </div>
                        <table cellspacing="2" cellpadding="2" width="100%" align="center" border="0">
                            <tr>
                                <td>
                                    ...
                                    <div style="float: left; width: 80px">
                                        <%=objLangClass.GetLanguageConversion("Sort_By")%>
                                    </div>
                                    <div style="float: left">
                                    ...
                                    <div style="float: left; width: 80px; padding-top: 2px">
                                        <%=objLangClass.GetLanguageConversion("Direction")%>
                                    </div>
                            ...
                            <tr>
                                <td>
                                    <b>
                                        <%=objLangClass.GetLanguageConversion("Step4_Save_This_View_For_Future_Use")%></b>
                                    <hr style="border-top: 1px solid #BDBDBD;" />
                                    <div class="only5px">
                                    </div>
                                    <div style="float: left; width: 80px">
                                        <b>
                                            <%=objLangClass.GetLanguageConversion("View_Name")%></b>
                                    </div>
                                    <div style="float: left; border: 0px solid;">
                                        ...
                                        <div style="display: block;" class="error_top">
                                            <span id="spn_txtViewName" class="spanerrorMsg" style="display: none; width: 170px;">View Name already exists</span>
                                        </div>
                                        <div style="display: block;" class="error_top">
                                ...
                                <td>
                                    ...
                                    <div style="float: left; display: none">
                                        <div id="div_btncancel" style="display: block">
                                            <asp:Button ID="btn_Cancel" runat="server" Text="Cancel" CssClass="button" OnClientClick="javascript:var a= cancelClick(path+'warehouse/warehouse.aspx?type=inventory');loadingimage(this.id,'div_btncancelprocess');return a;" /><%--OnClick="btncancel_OnClick"--%>
                                        </div>
                                    ...
                                    <div id="div_btndelete1" runat="server" style="float: left;">
                    ...
                    <script type="text/javascript">
                        ...
                        function OnClientItemCheckingHandler(sender, eventArgs) {
                            ...
                            if (item.get_text() == "Inventory Code") {
                            ...
                            if (item.get_text() == "Inventory Name") {
                                var message = "You are not allowed to ";
                                message += item.get_checked() ? "uncheck" : "check";
                                message += " the item " + item.get_text();
                                alert(message);
