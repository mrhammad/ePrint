<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomViewPurchase.ascx.cs" Inherits="ePrint.usercontrol.Views.CustomViewPurchase" %>
                ...
                <div class="divpadding">
                    <div align="left" nowrap="nowrap">
                        <span class="navigatorpanel" style="padding-left: 10px">
                            <%=objLangClass.GetLanguageConversion("Purchase_Custom_View")%>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <table width="100%">
         ...
         <%--   <tr>
                    ...
                    <b>
                                    ...
                                    <div style="float: left; padding-top: 2px">
                                        <asp:DropDownList ID="ddlGroupBy" CssClass="normaltext" Width="150px" runat="server">
                                                ...
                                                <asp:ListItem Text="PO Date" Value="PODate" />
                                              
                                                <asp:ListItem Text="Delivery Date" Value="reqdate" />
                                        </asp:DropDownList>
                                    </div>
                                    <div class="only5px">
                                    </div>
                    ...
                    <div id="div_Columns">
                        <asp:Panel ID="pnllst" runat="server">
                            <div id="divMain" style="border: 0px solid black; width: 100%; float: left">
                                ...
                                <div id="div_lstAllCols" style="width: 215px; float: left; border: 0px solid gray">
                                    <b>
                                        <asp:Label ID="lblAvailCols" runat="server"></asp:Label></b>
                                    ...
                                    <%--<asp:CustomValidator ID="CustValidateAllCols" runat="server" ClientValidationFunction="ValidationCriteria"
                                            ErrorMessage=""> OnClientItemChecked="OnClientItemChecked"
                                        </asp:CustomValidator>--%>
                                </div>
                                ...
                                <div style="border: 0px solid blue; width: 47%; float: left; padding-left: 10px">
                                    <b>
                                        <asp:Label ID="lblSelectedCols" runat="server"></asp:Label></b><div>
                                        </div>
            ...
            <tr>
                <td>
                    <b>
                        Step 2: Enable Live or Archived Records
                    <hr style="border-top: 1px solid #BDBDBD;" />
                    <%--color="gray"--%>
                    <div class="only5px">
                    </div>
                ...
                <td>
                                    ...
                                    <div style="float: left">
                                        <asp:DropDownList ID="ddlDateType" CssClass="normaltext" Width="150px" runat="server">
                                             <asp:ListItem Text="None" Value="None" selected="true" />
                                                ...
                                                <asp:ListItem Text="PurchaseOrder" Value="PODate" />
                                                <asp:ListItem Text="Delivery" Value="reqdate" />
                                ...
                                <td>
                                    ...
                                    <div style="float: left; display: none">
                                        <div id="div_btncancel" style="display: block">
                                            <asp:Button ID="btn_Cancel" runat="server" Text="" CssClass="button" OnClientClick="javascript:var a=cancelClick(path+'Purchase/purchase_view.aspx');loadingimage(this.id,'div_cancelprocess');return a;" />
                                        </div>
                                    ...
                                    <div style="float: left; width: 10px">
                                        &nbsp;</div>
                                    <div id="Divdiv_btndelete" runat="server" style="float: left; margin-left: -10px">
                                        <div id="div_btndelete" style="display: block">
                                            <asp:Button ID="btn_delete" runat="server" Text="Delete" CssClass="button" OnClick="btndelete_OnClick"
                                                OnClientClick="javascript:var a=window.confirm('Are you sure you want to Delete this view?'); if(a) loadingimage(this.id,'div_deleteprocess'); return a;"
                                                Visible="false" />
                                        </div>
                                    ...
                                    <div style="float: left; width: 10px">
                                        &nbsp;</div>
                                    <div id="Divdiv_btnsave" runat="server" style="float: left; margin-left: 60px">
                                     ...
                                     <div id="divDiv_btnsaveasnewview" runat="server" style="float: left; margin-left: 10px">
                    ...
                    <script type="text/javascript">
                        ...
                        function OnClientItemCheckingHandler(sender, eventArgs) {
                            ...
                            if (item.get_text() == "Supplier Name") {
                                var message = "You are not allowed to ";
                                message += item.get_checked() ? "uncheck" : "check";
                                message += " the item " + item.get_text();
                                alert(message);
