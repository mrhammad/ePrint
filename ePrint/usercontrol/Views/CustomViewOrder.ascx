<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomViewOrder.ascx.cs" Inherits="ePrint.usercontrol.Views.CustomViewOrder" %>
         ...
         Step 1:Configure Grouping</b>
                                    ...
                                    <div style="float: left; padding-top: 2px">
                                        <asp:DropDownList ID="ddlGroupBy" CssClass="normaltext" Width="150px" runat="server">
                                                ...
                                                <asp:ListItem Text="Ord. Status" Value="OrderStatus" />
                                                <asp:ListItem Text="Item Status" Value="StatusID" />
                                                <asp:ListItem Text="Approval Status" Value="Approved" />
                        ...
                        <asp:Panel ID="pnllst" runat="server">
                            <div id="divMain" style="border: 0px solid black; width: 100%; float: left">
                                <div id="div_lstAllCols" style="width: 215px; float: left">
                                    <b>
                                        <asp:Label ID="lblAvailableCols" runat="server">
                                        </asp:Label></b>
                                ...
                                <div style="border: 0px solid blue; width: 47%; float: left; padding-left: 10px">
                                    <b>
                                        <asp:Label ID="lblSelectedCols" runat="server">
                                        </asp:Label></b>
                        ...
                        <table cellspacing="2" cellpadding="2" width="100%" align="center" border="0">
                                        ...
                                        <asp:DropDownList ID="ddlDateType" CssClass="normaltext" Width="150px" runat="server">
                                             <asp:ListItem Text="None" Value="None" selected="true" />
                                              <%--  <asp:ListItem Text="Artwork" Value="ArtworkDate" />
                                                ...
                                                <asp:ListItem Text="Order" Value="SysOrderedDate" />
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="float: left; padding-left: 2px">
                                        <asp:CheckBox ID="chk_setdefault" runat="server" /></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <div style="float: left; display: none">
                                        <div id="div_btncancel" style="display: block">
                                            <asp:Button ID="btn_Cancel" runat="server" CssClass="button" OnClientClick="javascript:var a= cancelClick(path+'Orders/order_view.aspx');loadingimage(this.id,'div_btncancelprocess');return a;" /><%--OnClick="btncancel_OnClick"--%>
                                        </div>
                                    ...
                                    <div style="float: left;">
                                        <div id="div_btnsaveasnewview" style="display: block;">
                                            <asp:Button ID="btn_saveasnewview" runat="server" CssClass="button" OnClick="btnsaveasnewview_OnClick"
                                                OnClientClick="javascript:var a=validate();if(a)loadingimage(this.id,'div_btnsaveasnewprocess');return a;"
                                                Style="margin-left: 10px" />
                                        </div>
                                        <div id="div_btnsaveasnewprocess" style="display: none">
                                            <img src="<%=strImagepath %>radimg1.gif" class="loadingimg" alt="loading" border="0" />
                                        </div>
                                    </div>
