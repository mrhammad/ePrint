...
{
    public partial class Delivery_Cost_selector : System.Web.UI.UserControl
    {
        ...
        protected void GridBindInk_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            ...
            DataTable dataSet = SettingsBasePage.settings_MIS_Delivery_Costs(this.CompanyID);
            this.GridInk.DataSource = dataSet;
        }

        protected void GridBindInv_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            DataTable item = SettingsBasePage.settings_MIS_Delivery_Cost_Selector(this.CompanyID);
        ...
        {
            this.GridInventory.MasterTableView.Columns[0].HeaderText = this.objlang.GetLanguageConversion("Delivery_Name");
            this.GridInventory.Columns[1].HeaderText = this.objlang.GetLanguageConversion("Type");
  
            this.GridInventory.Columns[2].HeaderText = this.objlang.GetLanguageConversion("Description");
