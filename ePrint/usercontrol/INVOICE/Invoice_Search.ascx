<%@ control language="C#" autoeventwireup="true" CodeBehind="Invoice_Search.ascx.cs" Inherits="ePrint.usercontrol.INVOICE.Invoice_Search" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<%--<telerik:RadScriptManager ID="RadScriptManager1" runat="server" />--%>
<telerik:RadAjaxManagerProxy ID="RADMgrInvoice" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="GridViewInvoice">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="GridViewInvoice" LoadingPanelID="RadAjaxLoadingPanelInvoice" />
            </UpdatedControls>
        </telerik:AjaxSetting>
...
<telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanelInvoice" SkinID="Windows7" runat="server" />
<%--<script type="text/javascript">
    $(document).ready(function () {
        $(".panelHeaderInvoice").click(function () {
            $(".panelContentInvoice").slideToggle("slow");
        });
    });
</script>--%>
<%--<style type="text/css">
                ...
                <div class="t">
                    <div class="divpadding">
                        <div align="left" nowrap="nowrap">
                            <span class="navigatorpanel" style="padding-left: 10px">Invoices</span>
                        </div>
                    </div>
                </div>
            </div>
...
<%--<div class="panelHeaderInvoice">
    <div>
        <span class="HeaderText" style="padding-left: 10px">Invoices</span>
    </div>
</div>--%>
<div>
    <div>
                ...
                <div style="width: 100%;">
                    ...
                    <div align="left" style="padding-top: 5px; width: 100%;">
                        <div id="div_Main" runat="server">
                            <div id="div_Grid">
                                <telerik:RadGrid ID="GridViewInvoice" AllowSorting="true" OnItemDataBound="OnRowDataBound_GridViewInvoice"
                                    ...
                                    OnItemCommand="GridViewInvoice_ItemCommand" Skin="RadGrid_Eprint_Skin" AllowCustomPaging="true"
                                    ...
                                    OnItemCreated="GridViewInvoice_ItemCreated">
                                            ...
                                            <%--<telerik:GridTemplateColumn ItemStyle-HorizontalAlign="left" AllowFiltering="false"
                                                    ...
                                                    <ItemTemplate>
                                                        <input type="checkbox" runat="server" id="Id" onclick="CheckChanged();" name="Id"
                                                            value='<%# DataBinder.Eval(Container, "DataItem.InvoiceID", "{0}") %>' />                                                 
                                                    </ItemTemplate>
