...
{
    public partial class MatchedCustomer : System.Web.UI.UserControl
    {
        public DataSet data;
        ...
        protected void Repeater_OnItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                Label label11 = (Label)e.Item.FindControl("hdnStatusTitle");
                AttributeCollection attributes = htmlAnchor.Attributes;
                string[] text = new string[] { "javascript:BindResultCustomer('", label.Text, "','", this.objBase.SpecialEncode(label1.Text), "','", this.objBase.SpecialEncode(label2.Text), "','", this.objBase.SpecialEncode(label3.Text), "','", this.objBase.SpecialEncode(label4.Text), "','", this.objBase.SpecialEncode(label5.Text), "','", label6.Text, "','", label7.Text, "','", this.objBase.SpecialEncode(label8.Text), "','", this.objBase.SpecialEncode(label9.Text), "','", label10.Text, "','", this.objBase.SpecialEncode(label11.Text), "');" };
