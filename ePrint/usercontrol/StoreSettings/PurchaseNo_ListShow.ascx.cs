...
{
    public partial class PurchaseNo_ListShow : System.Web.UI.UserControl
    {
        ...
        public PurchaseNo_ListShow()
        {
        }

        public void GridBind_Customer(long EstimateID)
        {
            DataTable dataTable = SettingsBasePage.Purchase_Number_View(this.CompanyID, EstimateID);
            foreach (DataRow row in dataTable.Rows)
            {
                row["PONO"] = this.objBase.SpecialDecode(row["PONO"].ToString());
        ...
        //public void lblDeliveryNo_Click(object sender, EventArgs e)
        //{
        //HttpResponse response = base.Response;
        //object[] value = new object[] { this.strSitepath, "Delivery/delivery_add.aspx?type=edit&amp;id=", this.DeliveryID };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.RadGrid_Customer.Columns[0].HeaderText = this.objLanguage.GetLanguageConversion("Purchase_No");
            this.GridBind_Customer(this.EstimateID);
        }
