<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PriceCatalogue_CustomerNames.ascx.cs" Inherits="ePrint.usercontrol.StoreSettings.PriceCatalogue_CustomerNames" %>
                ...
                <ContentTemplate>
                    <telerik:RadGrid ID="RadGrid_Customer" runat="server" ShowHeader="true" Width="100%"
                        ...
                        <MasterTableView AllowFilteringByColumn="true" OverrideDataSourceControlSorting="true">
                            <Columns>
                                <telerik:GridTemplateColumn AllowFiltering="true" HeaderText="Customer Name" HeaderStyle-Width="45%"
