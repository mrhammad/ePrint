...
{
    public partial class PriceCatalogue_CustomerNames : System.Web.UI.UserControl
    {
        ...
        public PriceCatalogue_CustomerNames()
        {
        }

        public void GridBind_Customer(long PriceCatalogueID)
        {
            DataTable dataTable = SettingsBasePage.PriceCatalogue_Customer_View(this.CompanyID, PriceCatalogueID);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.GridBind_Customer(this.PriceCatalogueID);
        }
