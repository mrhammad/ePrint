<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApprovalDate_Update.ascx.cs" Inherits="ePrint.usercontrol.Fields.ApprovalDate_Update" %>

<script>
    $(document).ready(function () {
        $("[id$='txtApprovalDate']").attr("onclick", "javascript:event.cancelBubble=true;this.select();lcs(this,'"
...
<div style="width: 100%; align-content: center;">
    ...
    <div style="margin-bottom: 10px;">
        ...
        <asp:Label Text="Approval Date:" Style="width:auto" runat="server" class="bglabel" />
        <asp:TextBox ID="txtApprovalDate" runat="server" TextMode="DateTime"
            onblur="javascript:CopyDate(1,1,this.value);" Style="height: 23px"></asp:TextBox>
    </div>
    <div style="text-align: right; padding-right: 27%;">
        <asp:Button ID="btnSaveApprovalDate" runat="server" Text="Save" OnClick="btnSaveApprovalDate_Click" OnClientClick=""
