...
{
    public partial class Artwork_Update : System.Web.UI.UserControl
    {
        ...
        protected void btnSaveArtworkDate_Click(object sender, EventArgs e)
        {
            this.divLoadingImage.Style.Add("display", "block");
            //Validation on client side to be applied
            string artworkDate = txtArtworkDate.Text;
