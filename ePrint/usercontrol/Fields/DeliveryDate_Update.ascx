<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeliveryDate_Update.ascx.cs" Inherits="ePrint.usercontrol.Fields.DeliveryDate_Update" %>

<script>
    $(document).ready(function () {
        $("[id$='txtDeliveryDate']").attr("onclick", "javascript:event.cancelBubble=true;this.select();lcs(this,'"
...
<div style="width: 100%; align-content: center;">
    ...
    <div style="margin-bottom: 10px;">
        ...
        <asp:Label Text="Delivery Date:" runat="server" class="bglabel" />
        <asp:TextBox ID="txtDeliveryDate" runat="server" TextMode="DateTime"
