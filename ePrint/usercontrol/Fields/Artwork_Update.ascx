<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Artwork_Update.ascx.cs" Inherits="ePrint.usercontrol.Fields.Artwork_Update" %>

<script>
    $(document).ready(function () {
        $("[id$='txtArtworkDate']").attr("onclick", "javascript:event.cancelBubble=true;this.select();lcs(this,'"
...
<div style="width: 100%; align-content: center;">
    ...
    <div style="margin-bottom: 10px;">
        ...
        <asp:Label Text="Artwork Date:" Style="width:auto" runat="server" class="bglabel" />
        <asp:TextBox ID="txtArtworkDate" runat="server" TextMode="DateTime"
            onblur="javascript:CopyDate(1,1,this.value);" Style="height: 23px"></asp:TextBox>
    </div>
    <div style="text-align: right; padding-right: 27%;">
        <asp:Button ID="btnSaveArtworkDate" runat="server" Text="Save" OnClick="btnSaveArtworkDate_Click" OnClientClick=""
