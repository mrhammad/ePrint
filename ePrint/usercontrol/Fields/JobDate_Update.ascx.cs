...
{
    public partial class JobDate_Update_ascx : System.Web.UI.UserControl
    {
        ...
        protected void btnSaveJobDate_Click(object sender, EventArgs e)
        {
            ...
            DateTime parsedJobDate = new DateTime();
            if (hdnDateFormat.Value == "dd/mm/yyyy")
            {
                ...
                parsedJobDate = DateTime.Parse(jobDate, ukCulture.DateTimeFormat);

                System.Threading.Thread.CurrentThread.CurrentCulture = currentCulture;
            }
            else
            {
                parsedJobDate = DateTime.Parse(jobDate);
            }
            ...
            if (!string.IsNullOrEmpty(jobId) && !string.IsNullOrEmpty(estimateItemID))
            {
                ...
                string type = "JobDate";
                Settings.UpdateJobDates(this.CompanyID, long.Parse(jobId), long.Parse(estimateItemID), parsedJobDate, type);
