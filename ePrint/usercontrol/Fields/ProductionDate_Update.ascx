<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductionDate_Update.ascx.cs" Inherits="ePrint.usercontrol.Fields.ProductionDate_Update" %>

<script>
    $(document).ready(function () {
        $("[id$='txtProductionDate']").attr("onclick", "javascript:event.cancelBubble=true;this.select();lcs(this,'"
...
<div style="width: 100%; align-content: center;">
    ...
    <div style="margin-bottom: 10px;">
        ...
        <asp:Label Text="Production Date:" Style="width:auto" runat="server" class="bglabel" />
        <asp:TextBox ID="txtProductionDate" runat="server" TextMode="DateTime"
            onblur="javascript:CopyDate(1,1,this.value);" Style="height: 23px"></asp:TextBox>
    </div>
    <div style="text-align: right; padding-right: 27%;">
        <asp:Button ID="btnSaveProductionDate" runat="server" Text="Save" OnClick="btnSaveProductionDate_Click" OnClientClick=""
