<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomDate_Update.ascx.cs" Inherits="ePrint.usercontrol.Fields.CustomDate_Update" %>

<script>
    $(document).ready(function () {
        $("[id$='txtCustomDate']").attr("onclick", "javascript:event.cancelBubble=true;this.select();lcs(this,'"
...
<div style="width: 100%; align-content: center;">
    ...
    <asp:HiddenField ID="hdnDateNo" runat="server" />
    ...
    <div style="margin-bottom: 10px;">
        ...
        <asp:Label ID="lbldatetitle" Text="Custom Date:" Style="width:auto" runat="server" class="bglabel" />
        <asp:TextBox ID="txtCustomDate" runat="server" TextMode="DateTime"
            onblur="javascript:CopyDate(1,1,this.value);" Style="height: 23px"></asp:TextBox>
    </div>
    <div style="text-align: right; padding-right: 27%;">
        <asp:Button ID="btnSaveCustomDate" runat="server" Text="Save" OnClick="btnSaveCustomDate_Click" OnClientClick=""
