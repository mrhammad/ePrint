<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActualDeliveryDate_Update.ascx.cs" Inherits="ePrint.usercontrol.Fields.ActualDeliveryDate_Update" %>
<script>
    $(document).ready(function () {
        $("[id$='txtActualDeliveryDate']").attr("onclick", "javascript:event.cancelBubble=true;this.select();lcs(this,'"
...
<div style="width: 100%; align-content: center;">
    ...
    <div style="margin-bottom: 10px;">
        ...
        <asp:Label Text="Actual Delivery Date:" Style="width:auto" runat="server" class="bglabel" />
        <asp:TextBox ID="txtActualDeliveryDate" runat="server" TextMode="DateTime"
