<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Completion_Update.ascx.cs" Inherits="ePrint.usercontrol.Fields.Completion_Update" %>


<script>
    $(document).ready(function () {
        $("[id$='txtCompletionDate']").attr("onclick", "javascript:event.cancelBubble=true;this.select();lcs(this,'"
...
<div style="width: 100%; align-content: center;">
    ...
    <div style="margin-bottom: 10px;">
        ...
        <asp:Label Text="Completion Date:" Style="width:auto" runat="server" class="bglabel" />
        <asp:TextBox ID="txtCompletionDate" runat="server" TextMode="DateTime"
            onblur="javascript:CopyDate(1,1,this.value);" Style="height: 23px"></asp:TextBox>
    </div>
    <div style="text-align: right; padding-right: 27%;">
        <asp:Button ID="btnSaveCompletionDate" runat="server" Text="Save" OnClick="btnSaveCompletionDate_Click" OnClientClick=""
