<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProofDate_Update.ascx.cs" Inherits="ePrint.usercontrol.Fields.ProofDate_Update" %>


<script>
    $(document).ready(function () {
        $("[id$='txtProofDate']").attr("onclick", "javascript:event.cancelBubble=true;this.select();lcs(this,'"
...
<div style="width: 100%; align-content: center;">
    ...
    <div style="margin-bottom: 10px;">
        ...
        <asp:Label Text="Proof Date:" runat="server" class="bglabel" />
        <asp:TextBox ID="txtProofDate" runat="server" TextMode="DateTime"
            onblur="javascript:CopyDate(1,1,this.value);" Style="height: 23px"></asp:TextBox>
    </div>
    <div style="text-align: right; padding-right: 27%;">
        <asp:Button ID="btnSaveProofDate" runat="server" Text="Save" OnClick="btnSaveProofDate_Click" OnClientClick=""
