<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DigitalNCR_item.ascx.cs" Inherits="ePrint.usercontrol.Item.DigitalNCR_item" %>
...
<div id="divMainContent">
    ...
    <div id="div_AlertPopup" style="display: none; position: absolute; width: 1100px; left: 150px; z-index: 10;">
    </div>
    <div id="content">
        ...
        <div style="float: left; width: 50%; border: solid 0px red;">
            <div align="left">
                ...
                <div class="box" style="float: left;">
                    <asp:TextBox ID="txtItemTitle" SkinID="textPad" runat="server" MaxLength="50" onblur="CallonBlur(this.value,'spn_txtItemTitle');"></asp:TextBox>
                    <div>
            ...
            <div id="div_only_digitals_left" align="left">
                <div align="left">
                    <div class="bglabelnewLarge" style="height: 35px; border: 0px solid blue">
                        <div id="div_FinishedQty" style="float: left; border: 0px solid;">
                        </div>
                        <div id="div_BookletQty" style="display: block; float: left;">
                            <%=objLanguage.GetLanguageConversion("NCR_Pad_Quantity")%>
                        </div>
                    ...
                    <div style="float: left; width: 260px;">
                        <div style="float: left; width: 260px; border: 0px solid" id="div_qty12">
                ...
                <div align="left">
                    <div class="bglabelnewLarge">
                        <asp:Label ID="Label2" runat="server" Text="No. of sets per pad" CssClass="normaltext"></asp:Label>
                        <span style="color: Red">*</span>
                    </div>
                    <div class="box" style="float: left;">
                        <asp:TextBox ID="txtsetsperpad" SkinID="textPad" Width="50px" runat="server" MaxLength="20"
                            onblur="AllowNumber(this,this.value);" onkeyup="javascript:ToInteger(this,this.value);"></asp:TextBox>
                        <div>
                            <span id="sp_txtsetsperpad" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                <%=objLanguage.GetLanguageConversion("Please_Enter_No_Of_Sets_Per_Pad")%></span>
                        </div>
                    </div>
                </div>
                <div class="onlyEmpty">
                ...
                <div align="left">
                    <div class="bglabelnewLarge">
                        <asp:Label ID="Label1" runat="server" Text="No. of parts per set" CssClass="normaltext"></asp:Label>
                        <span style="color: Red">*</span>
                    </div>
                    <div class="box" style="float: left;">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:TextBox ID="txtpartsperset" SkinID="textPad" Style="direction: rtl" Width="50px" AutoComplete="Off"
                                    runat="server" MaxLength="1" onblur="javascript:partsperset_onblur(this.value);"
                                    onkeyup="javascript:AllowNumber_WithDefault(this,this.value,'1');ToInteger(this,this.value);getbutton(this.value);setvalue(this.value);">2</asp:TextBox>
                                <asp:LinkButton ID="lnkNewSection" runat="server" OnClick="onclick_lnkNewSection"></asp:LinkButton>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        <asp:UpdateProgress ID="uprogress" runat="server" AssociatedUpdatePanelID="UpdatePanel1" DisplayAfter="0">
                            <ProgressTemplate>
                                <div style="top: 0; left: 0; height: 100%; width: 100%; opacity: 0.5; background-color: #FFF; position: fixed">
                        ...
                        <div>
                            <span id="sp_txtpartsperset" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                <%=objLanguage.GetLanguageConversion("Please_enter_No_of_parts_per_set")%></span>
                        </div>
                    </div>
                </div>
                <div class="onlyEmpty">
                </div>
                <div id="div_SectionRef">
                    <div class="onlyEmpty">
                    </div>
                    <div class="bglabelnewLarge">
                        <asp:Label ID="Label5" runat="server" Text="Part Reference" CssClass="normaltext"></asp:Label>
                        <span style="color: Red">*</span>
                    </div>
                    <div class="box">
                        <asp:TextBox ID="txtSectionRef" SkinID="textPad" runat="server" MaxLength="100" onblur="CallonBlur(this.value,'spn_txtSectionRef');"></asp:TextBox><br />
                        <span id="spn_txtSectionRef" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                            <%=objLanguage.GetLanguageConversion("Please_enter_Part_Reference")%>
                        </span>
                    </div>
                </div>
                <div class="onlyEmpty">
                </div>
                <div id="divimagetype" style="display: none">
                    <div align="left">
                        <div class="bglabelnewLarge">
                            <asp:Label ID="lblimage" runat="server" Text="Image" CssClass="normaltext"></asp:Label>
                            <span style="color: Red">*</span>
                        </div>
                        <div class="box" style="float: left;">
                            <asp:RadioButtonList ID="rdoimagetype" runat="server" RepeatDirection="Vertical"
                                Visible="false">
                                <asp:ListItem Text="UnCommon" Value="uncommon"></asp:ListItem>
                                <asp:ListItem Text="Common" Value="common" Selected="True"></asp:ListItem>
                            </asp:RadioButtonList>
                            <table>
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="rdouncommon" onclick="return gethideonuncommonclick();" GroupName="check"
                                            Text="UnCommon" runat="server" Checked="true" />
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="rdocommon" onclick="return getshowoncommonclick();" GroupName="check"
                                            Text="Common" runat="server" />
                                    </td>
                                    <td>
                                        <div id="divcommonfrom" style="display: none">
                                            <span class="HeaderText">
                                                <%=objLanguage.GetLanguageConversion("From")%></span>
                                            <asp:DropDownList ID="ddlcommonfrom" onchange="javascript:commonfromonchange(this.value);return false;"
                                                SkinID="onlyDDL" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div align="left">
                    ...
                    <div class="ddlsetting" style="float: left;margin-left:-2px;">
                        <asp:UpdatePanel ID="updatepresschangeid" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlPress" CssClass="normaltext" Width="260px" onchange="javascript:onchange_inkval(this.value);onchange_press(this.value);"
                                    runat="server">
                                </asp:DropDownList>
                ...
                <div align="left">
                    <div class="bglabelnewLarge">
                        ...
                        <div style="float: right;">
                            <asp:ImageButton ID="imgbtnDefaultPaper" runat="server" ImageUrl="~/images/plus.gif"
                                OnClientClick="javascript:return MoreStock('paper');" />
                    ...
                    <div class="box" style="float: left;">
                        <div class="graytext" style="overflow: hidden; white-space: nowrap; width: auto; padding-left: 2px;">
                ...
                <div align="left">
                    ...
                    <div class="box">
                        <asp:TextBox ID="txtRunningSpoilage" SkinID="textPad" Width="75px" runat="server"
                            MaxLength="20" onblur="todecimal_function(this,this.value);"></asp:TextBox>&nbsp;%
                        <span id="spn_txtRunningSpoilage" class="spanerrorMsg" style="display: none; float: none; width: 200px; padding-left: 4px; padding-right: 4px;">
                            <%=objLanguage.GetLanguageConversion("Please_Enter_Running_Spoilage")%></span><span
                ...
                <div align="left" style="display: block;">
                    <div class="bglabelnewLarge">
                        <div style="float: left">
                            <asp:Label ID="Label11" runat="server" Text="Colour" CssClass="normaltext"></asp:Label>
                        </div>
                        <div style="display: none">
                    ...
                    <div style="float: left; padding-top: 3px; display: block;">
                        ...
                        <script>
                            ...
                            function show_work(para) {
                                var ddlSide2Color = document.getElementById("<%=ddlColors_2.ClientID %>");
                                var ddlSide1Color = document.getElementById("<%=ddlColors.ClientID %>");
                                if (para == "Double") {
                            ...
                            function side1_on_chnage(val) {
                                ...
                                txtNoOfMakeReady.value = Number(val);
                                //by swetha M.S on 20/4/2011 -- Ref BUGID: 121
                            ...
                            function side2_on_chnage(val) {
                                ...
                                val1 = document.getElementById("<%=ddlColors.ClientID %>").value;
                ...
                <div align="left" id="div_side2_colour" style="display: none">
                    <div class="bglabelnewLarge">
                        <div style="float: left">
                            <asp:Label ID="Label3" runat="server" Text="Side2 Colour" CssClass="normaltext"></asp:Label>
                        </div>
                        <div style="float: right">
        ...
        <div id="div_only_digitals_right" style="float: left; width: 49%; border: solid 0px green;">
            <div id="div_booklet_NoOfPagesInSection" align="left" style="display: none">
                <div align="left">
                    ...
                    <div class="box">
                        ...
                        <div align="left">
                            <span id="spn_txtNoOfPagesInSection" class="spanerrorMsg" style="display: none; width: 175px;">
            ...
            <div align="left">
                ...
                <div style="float: left; width: 206px;" nowrap="nowrap">
                    <div id="div_ddlPrintSheetSize" class="ddlsetting" style="width: 206px;">
                        <asp:DropDownList ID="ddlPrintSheetSize" CssClass="normaltext" Width="175px" onchange="LoadToSheetCustom();LoadCalculations(this.id);"
                            runat="server">
                        </asp:DropDownList>
                        ...
                        <div id="div_PrintSheetCustomSize" class="box" style="display: none; width: 100%;">
                            <span id="spn_sheet_height" style="font-size: 9px;" class="normaltext">
                                <%=objLanguage.GetLanguageConversion("Height")%></span> &nbsp;<asp:TextBox ID="txtsectionheight"
                                    Width="52px" SkinID="textPad" runat="server" MaxLength="20" onblur="Calculations();roundTo3or2DecimalPlaces(this,this.value);"></asp:TextBox>
            ...
            <div align="left">
                ...
                <div style="float: left; width: 206px;" nowrap="nowrap">
                    <div id="div_ddlJobItemSize" class="ddlsetting" style="float: left; width: 206px">
                        <asp:DropDownList ID="ddlJobItemSize" CssClass="normaltext" Width="175px" onchange="LoadToJobCustom();LoadCalculations(this.id);"
                            runat="server">
                        </asp:DropDownList>
            ...
            <div id="div_Booklet_Format" align="left">
                <div class="bglabelnewLarge">
                    <span class="normalText">
                        <%=objLanguage.GetLanguageConversion("NCR_Pad_Format")%></span>
                </div>
                ...
                <div style="float: left;margin-left:2px">
                    <span id="spn_Printlayout" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;margin-left:207px;margin-top:-6px;">
                ...
                <div id="div_GuttersCustomSize" style="display: none; float: left; width: 223px"
                    ...
                    <span class="normaltext" style="font-size: 9px; padding-right: 4px">
                        <%=objLanguage.GetLanguageConversion("Horiz")%></span> &nbsp;<asp:TextBox ID="txtGutterHorizontal"
                            Width="52px" SkinID="textPad" runat="server" MaxLength="20" onclick="javascript:Calculations();todecimal_function(this,this.value);"></asp:TextBox>
                    <font style="font-size: 9px;">
            ...
            <div align="left">
                <div class="bglabelnewLarge" style="height: 30px;">
                    ...
                    <div style="float: right;">
                        <a href="javascript://" style="cursor: pointer;" runat="server" id="divguillotineplusimg"
                            onclick="javascript:GuillotineSelect();return false;">
                            <img src="<%=strImagepath %>plus.gif" border="0" /></a>
                    </div>
                </div>
                <div class="box" style="float: left;">
                    <div align="left" style="overflow: hidden; white-space: nowrap; width: 175px;">
                        <asp:Label ID="lblGuillotine" runat="server" CssClass="graytext" Style="cursor: pointer"></asp:Label>
                        <span id="spn_lblGuillotine" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                            <%=objLanguage.GetLanguageConversion("Please_Enter_Guillotine")%></span>
                    </div>
                    <div id="div_Trim" class="onlyEmpty" align="left" style="display: none">
            ...
            <div id="div_PrintLayout" align="left" style="display: block;">
                <div class="bglabelnewLarge" style="height: 50px;">
                    <div style="float: left;">
            ...
            <div id="div_PrintQualitySector" align="left" style="display: none;">
                <div class="bglabelnewLarge">
                    <asp:Label ID="Label158" runat="server" Text="Print Quality Selector" CssClass="normaltext"></asp:Label>
                </div>
                <div class="box">
                    <asp:DropDownList ID="ddlQualitySector" CssClass="normaltext" Width="175px" runat="server">
                    ...
                    <span id="spn_ddlQualitySector" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                        <%=objLanguage.GetLanguageConversion("Please_Select_Print_quality")%></span>
                </div>
            </div>
            <div id="div_InkCoverage" align="left" style="display: none;">
                <div class="bglabelnewLarge">
                    <asp:Label ID="Label159" runat="server" Text="Ink Coverage" CssClass="normaltext"></asp:Label>
                    <span style="color: Red">*</span>
                </div>
                <div class="box">
                    <div align="left">
                        <div style="float: left;">
                            <%=objLanguage.GetLanguageConversion("Side1")%>:
                        </div>
                        ...
                        <div style="float: left; padding-left: 4px;">
                            <%=objLanguage.GetLanguageConversion("Side2")%>:
                        </div>
                        <div style="float: left; padding-left: 2px;">
                    ...
                    <div align="left">
                        <span id="spn_txtInkCoverageSide1_number" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                            <%=objLanguage.GetLanguageConversion("Please_Enter_Numeric_Value")%></span>
                    </div>
                </div>
                <div class="only5px">
            ...
            <div align="left">
                ...
                <div class="bglabelEmpty" style="width: 26%; float: left">
                </div>
                <div style="float: left">
                    <div align="left" style="float: left;">
                        <div style="float: left;">
                            ...
                            <div id="div_btnprevprocess" class="button" align="center" style="width: 47px; display: none">
                        ...
                        <div style="float: left;">
                            <div id="div_btnsave" style="display: block">
                                <asp:Button ID="btnSave" CssClass="button" Text="Finish" runat="server" OnClick="btnSave_OnClick"
                                    OnClientClick="javascript:var a=NCR_Click_Next(); if(a) loadingimage(this.id,'div_btnsaveprocess');return a;" />
                            </div>
                            <div id="div_btnsaveprocess" class="button" align="center" style="width: 37px; display: none; height: 14px;">
                                <img src="<%=strImagepath %>radimg1.gif" class="loadingimg" alt="loading" border="0" />
                            </div>
                        </div>
                    </div>
                </div>
                <div style="float: left; clear: left; width: 45%; margin-left: 27.5%">
                    <div align="left" style="float: left; margin-top: 5%;">
                        <div id="div_NCRbtn" style="float: left; border: 0px solid;">
                        </div>
                    </div>
                </div>
            </div>
...
<asp:HiddenField ID="hid_ncrdata" Value="" runat="server" />
<asp:HiddenField ID="hid_previous" Value="0" runat="server" />
<asp:HiddenField ID="hid_previous_add" Value="0" runat="server" />
<asp:HiddenField ID="hid_partperset" Value="0" runat="server" />
<asp:HiddenField ID="hid_current" Value="1" runat="server" />
<%--this is used check whether user clicked on buttons or directly clicked on next button--%>
<asp:HiddenField ID="hid_incrementvalue" Value="0" runat="server" />
<asp:HiddenField ID="hid_ncreditdata" Value="" runat="server" />
<asp:HiddenField ID="hid_thisvalue" Value="2" runat="server" />
<asp:HiddenField ID="hid_buttonvalue" Value="1" runat="server" />
<%--this is used to take the dynamic button value ie 1 or 2 or 3 on edit case--%>
...
<asp:HiddenField ID="hidquantityvalue1" runat="server" Value="0" />
<asp:HiddenField ID="hidquantityvalue2" runat="server" Value="0" />
<asp:HiddenField ID="hidquantityvalue3" runat="server" Value="0" />
<asp:HiddenField ID="hidquantityvalue4" runat="server" Value="0" />
<asp:HiddenField ID="hidpartsperset" runat="server" Value="0" />
<asp:HiddenField ID="hid_FinalInkSave1" Value="" runat="server" />
<asp:HiddenField ID="hid_FinalInkSave2" Value="" runat="server" />
<asp:HiddenField ID="hid_calculationid" Value="" runat="server" />
<asp:HiddenField ID="hid_inventoryheight" Value="" runat="server" />
<asp:HiddenField ID="hid_inventorywidth" Value="" runat="server" />
<asp:HiddenField ID="hid_partvalue" Value="1" runat="server" />
<asp:HiddenField ID="hid_checknextorload" Value="0" runat="server" />
<asp:HiddenField ID="hid_lithoncritemid" Value="0" runat="server" />
<asp:HiddenField ID="hid_value" Value="0" runat="server" />
<asp:HiddenField ID="hdn_PressID" Value="0" runat="server" />
...
<script type="text/javascript">
    ...
    ncrArray = []; //clearing the array
    var hid_value = document.getElementById("<%=hid_value.ClientID%>");
    var hid_lithoncritemid = document.getElementById("<%=hid_lithoncritemid.ClientID%>");
    var hid_checknextorload = document.getElementById("<%=hid_checknextorload.ClientID%>");
    ...
    var hdn_PressID = document.getElementById("<%=hdn_PressID.ClientID %>");
    ...
    var PartspersetFromdatabase = "<%=Partsperset %>";
    ...
    function ValidatePaper_HeightWidth() {
        ...
        if (G_CalculateInventorySheet('n', Number(Height), Number(Width)) == 0 && (Height != undefined && Height != null)) {
    ...
    var hid_calculationid = document.getElementById("<%=hid_calculationid.ClientID %>");
    ...
    var divguillotineplusimg = document.getElementById("<%=divguillotineplusimg.ClientID %>");
    ...
    //ncrpartspserset    
    var txtpartsperset = document.getElementById("<%=txtpartsperset.ClientID %>");
    var txtsetsperpad = document.getElementById("<%=txtsetsperpad.ClientID %>");
    var UpdatePanel1 = document.getElementById("<%=UpdatePanel1.ClientID %>");
    ...
    var spn_txtSectionRef = document.getElementById("spn_txtSectionRef");
</script>
<%-- CODING PART END--%>
<script>
    ...
    var hid_ncrdata = document.getElementById("<%=hid_ncrdata.ClientID %>");
    var hid_previous = document.getElementById("<%=hid_previous.ClientID %>");
    var hid_previous_add = document.getElementById("<%=hid_previous_add.ClientID %>");
    var hid_partperset = document.getElementById("<%=hid_partperset.ClientID %>");
    hid_partperset.value = Number("<%=Partsperset %>") - 1;
    var hid_current = document.getElementById("<%=hid_current.ClientID %>");
    var hid_incrementvalue = document.getElementById("<%=hid_incrementvalue.ClientID %>");
    var hid_thisvalue = document.getElementById("<%=hid_thisvalue.ClientID %>");
    var hid_buttonvalue = document.getElementById("<%=hid_buttonvalue.ClientID %>");
    var hid_ncreditdata = document.getElementById("<%=hid_ncreditdata.ClientID %>");
    var hid_partvalue = document.getElementById("<%=hid_partvalue.ClientID %>");

    var commonpath = "<%=nmsCommon.global.sitePath()%>";
    var ArrayNCR = new Array();

    txtSectionRef.value = "Part " + hid_partvalue.value + "";

</script>

<script type="text/javascript" src="<%=strSitepath %>js/Item/settingsjs.js?VN='<%=VersionNumber%>'"></script>
<script type="text/javascript" language="javascript" src="<%=strSitepath %>js/Item/item_DigitalNCR.js?VN='<%=VersionNumber%>'"></script>
<script type="text/javascript">
...
<script>
    ...
    function onchange_press(val) {
        hdn_PressID.value = val;
        if (ddlPress.selectedIndex != 0) {
            var compID = '<%=CompanyID %>';
            val = compID + '±' + val;
            var str = ePrint.press_select.Litho_press_select(val, success);
        }
    ...
    function success(result) {
        ...
        if (arr2[0] == ddlValue) {
            ...
            ////bindplatesmakereadywashupdropdownvalue(arr2[21].split('»')[1]);
        ...
        if ("<%=QueryType%>" == "add") {
            inserttoarray(txtpartsperset.value);
        }
        LoadCalculations("ctl00_ContentPlaceHolder1_UCDigitalNCRItem_ddlPress");



        __doPostBack('ctl00$ContentPlaceHolder1$UCDigitalNCRItem$lnk_ddlPress_OnChange', '');
    }
...
<script>
    //declaring variables
    var hidquantityvalue1 = document.getElementById('<%=hidquantityvalue1.ClientID%>');
    var hidquantityvalue2 = document.getElementById('<%=hidquantityvalue2.ClientID%>');
    var hidquantityvalue3 = document.getElementById('<%=hidquantityvalue3.ClientID%>');
    var hidquantityvalue4 = document.getElementById('<%=hidquantityvalue4.ClientID%>');
    var hidpartsperset = document.getElementById('<%=hidpartsperset.ClientID%>');
    var commonfrom = document.getElementById("divcommonfrom");
    var radiocommon = document.getElementById("<%=rdocommon.ClientID %>");
    var radiouncommon = document.getElementById("<%=rdouncommon.ClientID %>");
    var ddlcommonfrom = document.getElementById("<%=ddlcommonfrom.ClientID %>");
    var ddlPlates = document.getElementById("<%=ddlPlates.ClientID %>");
    var ddlMakeReady = document.getElementById("<%=ddlMakeReady.ClientID %>");
    var ddlWashUp = document.getElementById("<%=ddlWashUp.ClientID%>");
    var divimagetype = document.getElementById("divimagetype");
    var ddlNoOfSide = document.getElementById("<%=ddlNoOfSide.ClientID %>");
    var ddlSide1Color = document.getElementById("<%=ddlColors.ClientID %>");
    var ddlSide2Color = document.getElementById("<%=ddlColors_2.ClientID %>");
    var chkTurn = document.getElementById("<%=chkTurn.ClientID %>");
...
<asp:Panel ID="pnlncredit" runat="server" Visible="false">
    <script type="text/javascript" language="javascript">
        var ddlSide1Color = document.getElementById("<%=ddlColors.ClientID %>");
        var ddlSide2Color = document.getElementById("<%=ddlColors_2.ClientID %>");
        var ddlPlates = document.getElementById("<%=ddlPlates.ClientID %>");
...
<asp:Panel runat="server" ID="pnlgetbuttons" Visible="false">
    <script type="text/javascript">

        var GetButtonNo = '<%=GetButtonNo%>';
        function getbutton(txtval) {
            var cntrls = UpdatePanel1.getElementsByTagName("input");
            for (i = 0; i < cntrls.length; i++) {
                if (cntrls[i].type == "text") {
                    txtpartsperset = cntrls[i];
            ...
            var str = '';
            for (var i = 1; i <= txtval; i++) {
                str += "<div style='float:left;clear:right;'>";
                if (i == '1') {
                    str += "<div style='float:left;'><input type='button' id=btn" + i + " class='booklet_section_active' value=Part" + '&nbsp;' + "" + i + " onclick=Gethideoneditcase(this.value,this.id," + txtval + ");LoadData(this.value,'edit'," + i + ");></div>";
                }
                else if (i != '1') {
                    str += "<div style='float:left;'><input type='button'  id=btn" + i + " class='button' value=Part" + '&nbsp;' + "" + i + " onclick=Gethideoneditcase(this.value,this.id," + txtval + ");LoadData(this.value,'edit'," + i + ");></div>";
                }
                str += "</div>";
                str += "<div style='float:left;width:2px'>&nbsp;</div>";
            }
            document.getElementById("div_NCRbtn").innerHTML = str;
        }
    </script>
</asp:Panel>
<asp:Panel ID="Pnleditmorequantity" runat="server" Visible="false">
    <script type="text/javascript">
...
<script type="text/javascript">
    ...
    if ("<%=QueryType%>" == "add") {
        function getbutton(txtval) {
            ...
            for (var i = 1; i <= txtval; i++) {
                if (i == '1') {
                    str += " <input type='button' id=btn" + i + " class='booklet_section_active' style='padding-bottom: 5px;' value=" + '<%=objLanguage.GetLanguageConversion("Part")%>' + '&nbsp;' + "" + i + " onclick=Gethide(this.value,this.id," + txtval + ");LoadData(this.value,'loadoninsert'," + i + ");> ";
                }
                else if (i != '1') {
                    str += " <input type='button'  id=btn" + i + " class='button' style='padding-bottom: 5px;' value=" + '<%=objLanguage.GetLanguageConversion("Part")%>' + '&nbsp;' + "" + i + " onclick=Gethide(this.value,this.id," + txtval + ");LoadData(this.value,'loadoninsert'," + i + ");> ";
                }
        }
        document.getElementById("div_NCRbtn").innerHTML = str;
    }
    ...
    function Gethide(txtvaaal, txtid, totalno) {
        var cntrls = UpdatePanel1.getElementsByTagName("input");
        for (i = 0; i < cntrls.length; i++) {
            if (cntrls[i].type == "text") {
                txtpartsperset = cntrls[i];
        ...
        for (var i = 1; i <= totalno; i++) {
            if (i == txtvaaal) {
                ...
                document.getElementById("btn" + i + "").style = "padding-bottom: 5px;";
            }
            else {
        ...
        hidquantityvalue1.value = txtQuantity.value;                //to take quantity on button click
...
hidquantityvalue1.value = txtQuantity.value;  //to take on page load
hidquantityvalue2.value = txtQuantity_2.value;
hidquantityvalue3.value = txtQuantity_3.value;
hidquantityvalue4.value = txtQuantity_4.value;
var cntrls1 = UpdatePanel1.getElementsByTagName("input");
for (i = 0; i < cntrls1.length; i++) {
    if (cntrls1[i].type == "text") {
        txtpartsperset = cntrls1[i];
        break;
    }
}
hidpartsperset.value = txtpartsperset.value;
...
//function to clear the commonfrom dropdown elements
function ddlclear(ddlid, length) {
...
function gethideonuncommonclick() {
    divcommonfrom.style.display = "none";
    ddlPlates.disabled = false;
    ddlWashUp.disabled = false;
    ddlMakeReady.disabled = false;
    ...
    txtNoOfPlates.disabled = false;
    txtNoOfMakeReady.disabled = false;
    txtNoOfPlates.value = "1";
    txtNoOfMakeReady.value = "1";
    //by swetha M.S on 20/4/2011 -- Ref BUGID: 121

    ddlPlates.selectedIndex = 1;
    ddlMakeReady.selectedIndex = 1;
    ddlWashUp.selectedIndex = 1;
    ddlNoOfSide.selectedIndex = 0;
    ddlSide1Color.selectedIndex = 0;
    document.getElementById("div_side2_colour").style.display = "none";
}

function getshowoncommonclick() {
    divcommonfrom.style.display = "block";
    ddlPlates.disabled = true;
    ddlWashUp.disabled = true;
    ddlMakeReady.disabled = true;
...
<script>
    ...
    function popup_ink(val) {
        ...
        var hid_FinalInkSave1 = document.getElementById("<%=hid_FinalInkSave1.ClientID%>");
        var hid_FinalInkSave2 = document.getElementById("<%=hid_FinalInkSave2.ClientID%>");
        var ddlPress = document.getElementById("ctl00_ContentPlaceHolder1_UCDigitalNCRItem_ddlPress");
        if (val == 'side1') {
            ddl = document.getElementById("<%=ddlColors.ClientID %>");
        }
        else {
            ddl = document.getElementById("<%=ddlColors_2.ClientID %>");
        }
        if (val == 'side1') {
        ...
        window.radopen("<%=nmsCommon.global.sitePath()%>common/inkselector.aspx?cnt=" + ddl + "&id=" + id + "&type=" + Type + "&EstItemID=" + EstItemID + "&side=" + Side + "&ddlval=" + str + "&EstimateLithoNCRItemID=" + hid_lithoncritemid.value + "&EstimateLithobookletItemID=0&Section=" + hid_value.value + "&Esttype=R&sidenumber=" + val + "&InkType=" + hdn_InkType.value + "&PressChangeVal=" + hid_PressChange.value + "", '', '1000', '500');
        SetRadWindow('divrad', 'divBackGroundNew', '200');
    }
...
<script type="text/javascript" language="javascript">
    ...
    function InnventoryPrompt() {
        ...
        || (reqtype != 'add' && modulename.toLowerCase() == "invoice")) {
            return true;
        }
    }
    ...
    function called_reducestock(val) {
        ...
        document.getElementById('div_AlertPopup').style.display = "none"
        document.getElementById('divBackGroundNew').style.display = "none";
        __doPostBack('ctl00$ContentPlaceHolder1$UCDigitalNCRItem$btnSave', '');
    }
</script>
