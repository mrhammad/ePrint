...
{
    public partial class makeready_costview : UsercontrolBasePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            int count = this.GridMakeReadyCostView.Items.Count;
            for (int i = 0; i < 4; i++)
            {
                if (i >= count)
                {
                ...
                {
                    HiddenField hiddenField = (HiddenField)this.GridMakeReadyCostView.Items[i].FindControl("hdn_MarkupPrice");
                    HiddenField hiddenField1 = (HiddenField)this.GridMakeReadyCostView.Items[i].FindControl("hdn_CostExMarkup");
                    TextBox textBox = (TextBox)this.GridMakeReadyCostView.Items[i].FindControl("txt_Markup");
                    HiddenField hiddenField2 = (HiddenField)this.GridMakeReadyCostView.Items[i].FindControl("hdn_EstimateCalculationID");
            ...
            str = "makeready";
            if (string.Compare(str, "makeready", true) == 0)
            {
        ...
        protected void GridMakeReadyCostView_OnItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == GridItemType.Item || e.Item.ItemType == GridItemType.AlternatingItem)
            {
                ...
                textBox.Attributes.Add("onblur", "javascript:AllowNumber(this,this.value);todecimal_function(this,this.value);MarkupOnBlur_MakeReady(this);");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dataTable = EstimatesBasePage.PCR_MakeReady_Cost_ViewOnPopUp(this.EstimateItemID, this.EstType, this.TypeID, this.Module);
            this.GridMakeReadyCostView.DataSource = dataTable;
            this.GridMakeReadyCostView.DataBind();
