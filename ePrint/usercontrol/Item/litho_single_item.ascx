<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="litho_single_item.ascx.cs" Inherits="ePrint.usercontrol.Item.litho_single_item" %>
...
<div id="divMainContent">
    ...
    <div id="div_AlertPopup" style="display: none; position: absolute; width: 1100px; left: 470px; z-index: 10;">
    </div>
    <div id="content">
        ...
        <div style="float: left; width: 50%; border: solid 0px red;">
            ...
            <div style="display: none;">
                <div id="div_ProductType">
                    <div class="bglabel">
                        <asp:Label ID="Label4" runat="server" Text="Product Type" CssClass="normaltext"></asp:Label>
                        <span style="color: Red">*</span>
                    </div>
                    <div class="ddlsetting">
                        <asp:DropDownList ID="ddlProductType" onchange="javascript:ProductTypeShow(this.value);"
                            CssClass="normaltext" Width="175px" runat="server">
            ...
            <div id="div_only_digitals_left" align="left">
                <div align="left">
                    <div class="bglabelnewLarge" style="height: 38px; border: 0px solid blue">
                        <div id="div_FinishedQty" style="float: left; border: 0px solid;">
                            <asp:Label ID="Label6" runat="server" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Finished_Quantity")%></asp:Label>
                            <span style="color: Red">*</span>
                        </div>
                        <div id="div_BookletQty" style="display: none; float: left;">
                            <asp:Label ID="Label7" runat="server" Text="Booklet Quantity" CssClass="normaltext"></asp:Label>
                            <span style="color: Red">*</span>
                        </div>
                    ...
                    <div style="float: left; width: 50%; padding-top: 2px;">
                        <div id="div_Qty_2to4" style="display: none; border: 0px solid; float: left;">
                            <div class="onlyEmpty">
                            </div>
                            <div align="left" style="border: 0px solid; float: left">
                ...
                <div align="left">
                    ...
                    <div class="ddlsetting" style="float: left; margin-left: -2px">
                        ...
                        <asp:HiddenField ID="hid_SessionPressChangeSingle" runat="server" Value="no" />
                        <asp:HiddenField ID="hid_SessionPressChangeDouble" runat="server" Value="no" />
                ...
                <div align="left">
                    ...
                    <div class="box" style="float: left; margin-left: -4px">
                        <div class="graytext" style="width: auto; padding-left: 2px;">
                        ...
                        <div class="onlyEmpty">
                            <asp:CheckBox ID="ChkPriceForWholePack" onclick="javascript:checkchanged();" runat="server" />
                        </div>
                        <div>
                            <asp:CheckBox ID="ChkPaperSupplied" runat="server" onclick="javascript:checkchanged1();" />
                        </div>
                    </div>
                </div>
                <div class="onlyEmpty">
                    ...
                    <div id="div_Booklet_1" align="left" style="display: none;">
                        <div align="left">
                            ...
                            <div class="box">
                                ...
                                <span id="spn_txtNoOfPagesRequired" class="spanerrorMsg" style="display: none; width: 175px;">
                        ...
                        <div align="left">
                            ...
                            <div class="box">
                                ...
                                <span id="spn_txtPagesPerSection" class="spanerrorMsg" style="display: none; width: 175px;">
                                    <%=objLanguage.GetLanguageConversion("Please_Enter_Pages_Per_Section")%>
                                </span><span id="spn_txtPagesPerSection_number" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                    <%=objLanguage.GetLanguageConversion("Please_Select_Numeric_Value")%></span>
                            </div>
                        </div>
                    </div>
                ...
                <div id="div_Pads_1" align="left" style="display: none;">
                    ...
                    <div class="box">
                        ...
                        <div align="left">
                            <span id="spn_txtNoOfLeavesPerPad" class="spanerrorMsg" style="display: none; width: 175px;">
                ...
                <div align="left">
                    ...
                    <div class="box">
                        <asp:DropDownList ID="ddlNoOfSide" onchange="show_work(this.value);Calculations();"
                            runat="server" Width="75px" SkinID="onlyDDL">
                ...
                <div align="left">
                    <div class="bglabelnewLarge">
                        <div style="float: left">
                            <asp:Label ID="Label11" runat="server" Text="Side1 Color" CssClass="normaltext"></asp:Label>
                        </div>
                        <div style="float: right">
                ...
                <div align="left" id="div_side2_colour" style="display: none">
                    <div class="bglabelnewLarge">
                        <div style="float: left">
                            <asp:Label ID="Label1" runat="server" Text="Side2 Colour" CssClass="normaltext"></asp:Label>
                        </div>
                        <div style="float: right">
                ...
                <div align="left" id="div_work" style="display: none;">
                    <div class="bglabelnewLarge" style="background-color: White; border: solid 0px black;">
                    </div>
                    <div align="left">
                        <div style="float: left">
                            <asp:CheckBox ID="chkSheetWork" onclick="javascript:WorkTick('sheetwork');Calculations();"
                                Text="Sheet Work" runat="server" />
                        </div>
                        <div id="Div_PerfectChk" style="float: left;">
                            <asp:CheckBox ID="chkPerfecting" Text="Perfecting" runat="server" onclick="javascript:WorkTick('perfect');Calculations();" />
                        </div>
                        <div style="float: left">
                            <asp:CheckBox ID="chkTurn" onclick="javascript:WorkTick('turn');Calculations();"
                                Text="Work 'n' Turn" runat="server" />
                        </div>
                        <div style="float: left">
                            <asp:CheckBox ID="chkTumble" onclick="javascript:WorkTick('tumble');Calculations();"
                ...
                <div align="left">
                    ...
                    <div class="box" style="white-space: nowrap; width: 175px;">
        ...
        <div id="div_only_digitals_right" style="float: left; width: 49%; border: solid 0px green;">
                    ...
                    <div class="box">
                        ...
                        <div align="left">
                            <span id="spn_txtNoOfPagesInSection" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                <%=objLanguage.GetLanguageConversion("Please_enter_No_Pages")%></span><span id="spn_txtNoOfPagesInSection_number"
            ...
            <div align="left">
                <%--SHEET SIZE--%>
                <div class="bglabelnewLarge">
                    <asp:Label ID="Label22" runat="server" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Print_Sheet_Size")%></asp:Label>
                    <span style="color: Red">*</span>
                </div>
            ...
            <div align="left">
                <div class="bglabelnewLarge">
                    <asp:Label ID="Label23" runat="server" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Finished_Job_Size_Unfolded")%></asp:Label>
                    <span style="color: Red">*</span>
                </div>
                <div style="float: left; width: 206px;" nowrap="nowrap">
                    <div id="div_ddlJobItemSize" class="ddlsetting" style="float: left; width: 206px">
                        <asp:DropDownList ID="ddlJobItemSize" CssClass="normaltext" Width="175px" onchange="LoadToJobCustom();LoadCalculations(this.id);"
                            runat="server">
                            <%--ItemSize_AssignToSummary('ddlitemsize');--IEB Issue Changes made on 07.09.2011--%>
                        </asp:DropDownList>
            ...
            <div align="left">
                ...
                <div style="float: left; width: 226px;" nowrap="nowrap">
                    <div id="div_GuttersCustomSize" style="display: none; float: left; width: 100%" class="box">
                        <span class="normaltext" style="font-size: 9px;">
                            <%=objLanguage.GetLanguageConversion("Horiz")%></span>&nbsp;&nbsp;&nbsp;<asp:TextBox
                                ID="txtGutterHorizontal" Width="52px" SkinID="textPad" runat="server" MaxLength="20"
                ...
                <div class="box" style="float: left;">
                    <div align="left" style="overflow: hidden; white-space: nowrap; width: 175px;">
                        ...
                        <span id="spn_lblGuillotine" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                            <%=objLanguage.GetLanguageConversion("Please_Selcet_Guillotine")%></span>
                    </div>
                    <div id="div_Trim" class="onlyEmpty" align="left" style="display: none">
                        <asp:CheckBox ID="chkFirstTrim" runat="server" Checked="true" />
                        <asp:CheckBox ID="chkSecondTrim" runat="server" Checked="true" />
                    </div>
            ...
            <div align="left" id="Div_ItemDescn" runat="server" visible="false">
                ...
                <div class="box" style="float: left;">
                    <div id="div2" align="left">
                        <asp:CheckBox ID="Chk_ItemDescn" runat="server" CausesValidation="true" Checked="false" />
                    </div>
                </div>
            </div>
            <div class="only10px">
                            ...
                            <div style="float: left;">
                                <div id="div_btnsave" style="display: block">
                                    <asp:Button ID="btnSave" CssClass="button" runat="server" OnClick="btnSave_OnClick"
                                        OnClientClick="javascript:var a=Validation();if(a)loadingimage(this.id,'div_btnsaveprocess');return a;" />
                                </div>
...
<asp:HiddenField ID="hdnNonHeight" Value="0" runat="server" />
<asp:HiddenField ID="hdnNonWidth" Value="0" runat="server" />
...
<script type="text/javascript" language="javascript">
    ...
    function ValidatePaper_HeightWidth() {
        ...
        if (G_CalculateInventorySheet('f', Number(Height), Number(Width)) == 0 && (Height != undefined && Height != null)) {
...
<script>
    ...
    var ASH;
    var ASW;
    var NonHeight = document.getElementById("<%=hdnNonHeight.ClientID%>").value;
    var NonWeight = document.getElementById("<%=hdnNonWidth.ClientID%>").value;
    var Result;
    ...
    var PrintLayoutSelected = '<%=PrintLayoutSelected%>'; // added for bugid : 1651
</script>
...
<script>
    ...
    var hid_SessionPressChangeSingle = document.getElementById("<%=hid_SessionPressChangeSingle.ClientID %>");
    var hid_SessionPressChangeDouble = document.getElementById("<%=hid_SessionPressChangeDouble.ClientID %>");
    ...
    function success(result) {
        ...
        if (modulename == "invoice" || modulename == "estimates" || modulename == "orders") {
            __doPostBack('ctl00$ContentPlaceHolder1$UCLithoSingle$lnk_ddlPress_OnChange', '');
        }
        else {
            __doPostBack('ctl00$ContentPlaceHolder1$UCSingleItem$lnk_ddlPress_OnChange', '');
        }
    }
    ...
    function SendPaperIDandName(id, values, papertype, invheight, PaperWeight, invwidth) {
        ...
        G_CalculateLandscape("f");
        G_CalculatePortrait("f"); // changed By Pradeep
    ...
    function LoadCalculations(ddlid) {
        ...
        if (txtsectionheight.value != "") {
            ...
            if (DDl.selectedIndex != 0) {
                ...
                if (PrintLayoutSelected == '') { // added for bugid : 1651
                    ...
                    if (PrintLayoutSelected.toLowerCase() == 'p') {
                        chkPortrait.checked = true;
                        chkLandscape.checked = false;
                        chkManual.checked = false;
                        PrintLayoutSelected = ''; // for second run in edit mode need to set by calculation
                    }

                    else if (PrintLayoutSelected.toLowerCase() == 'l') {
                        chkPortrait.checked = false;
                        chkLandscape.checked = true;
                        chkManual.checked = false;
                        PrintLayoutSelected = ''; // for second run in edit mode need to set by calculation
    ...
    function setwidth() {
        ...
        if (is_ie) {
            document.getElementById("div_GuttersCustomSize").style.width = "226px";
        }
        else {
            document.getElementById("div_GuttersCustomSize").style.width = "226px";
        }
    ...
    function Calculations() {
        ...
        if (result_port.value > result_land.value) {
            if (PrintLayoutSelected == '') {
                chkPortrait.checked = true;
                chkLandscape.checked = false;
                chkManual.checked = false;
            }
            if (PrintLayoutSelected.toLowerCase() == 'p') {// for bugid : 1651
                chkPortrait.checked = true;
                chkLandscape.checked = false;
                chkManual.checked = false;
            }
                ...
                chkLandscape.checked = true;
                chkManual.checked = false;
            } else if (PrintLayoutSelected.toLowerCase() == 'm') {
                chkPortrait.checked = false;
                chkLandscape.checked = false;
                chkManual.checked = true;
            }
    ...
    window.radopen("<%=nmsCommon.global.sitePath()%>common/inkselector.aspx?cnt=" + ddl + "&id=" + id + "&type=" + Type + "&EstItemID=" + EstItemID + "&side=" + Side + "&ddlval=" + ddlval + "&Esttype=F&Section=1&sidenumber=" + val + "&InkType=" + hdn_InkType.value + "&PressChangeVal=" + hid_PressChange.value + "", '', '1000', '500');
        SetRadWindow('divrad', 'divBackGroundNew', '200');
    }
...
<script type="text/javascript">
    function bindplatesmakereadywashupdropdownvalue() {
        var ddlSide1Color = document.getElementById("<%=ddlSide1Color.ClientID %>");
...
<script type="text/javascript" language="javascript">
    ...
    function called_reducestock(val) {
        ...
        document.getElementById('div_AlertPopup').style.display = "none"
        document.getElementById('divBackGroundNew').style.display = "none";
        __doPostBack('ctl00$ContentPlaceHolder1$UCLithoSingle$btnSave', '');
    }
</script>
