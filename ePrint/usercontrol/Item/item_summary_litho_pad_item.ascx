<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="item_summary_litho_pad_item.ascx.cs" Inherits="ePrint.usercontrol.Item.item_summary_litho_pad_item" %>
...
<table id="tblLithoSingleItem" width="97%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr id="trQuantity">
        <td>
            <asp:PlaceHolder ID="plhLithoPadItem" runat="server"></asp:PlaceHolder>
        </td>
    </tr>
</table>
