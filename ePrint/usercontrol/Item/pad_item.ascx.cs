...
{
    public partial class pad_item : UsercontrolBasePage
    {
        ...
        public string PadPrintLayout = string.Empty;
                ...
                if (this.modulename != "orders")
                {
                    if (base.Request.Params["FromAddAnItem"] != null)
                    {
                        if (empty.ToString().ToLower() == "yes")
                        {
                            ...
                            object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, this.jID, this.InvID };
                    ...
                    if (this.ParentEstimateItemID == (long)0)
                    {
                        ...
                        object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_add.aspx?type=Edit&prev=y&estid=", this.EstimateID, "&esttype=P&From=F&maintype=", this.MainType, this.jID, this.InvID };
        ...
        private void Click_Add(long ParentItemID, string ParentItemType)
        {
            ...
            if (empty == "P")
            {
                ...
                estimatesItem.LeavesPerPad = Convert.ToDecimal(this.txtNoOfLeavesPerPad.Text);
                ...
                EstimatesBasePage.pad_item_insert(estimatesItem);
                ...
                this.Main_Quantity_Insert(estimatesItem.EstimateItemID, "qty", estimatesItem);
                ...
                {
                    EstimateCommonMethods.UpdateDescription(num, this.EstimateID, "P", false);
                }
            ...
            if (string.Compare(this.modulename, "invoice", true) == 0 || string.Compare(this.modulename, "jobs", true) == 0)
            {
                ...
                EstimateCommonMethods.ShowJobCardDetails(this.CompanyID, this.EstimateID, num, "P");
            ...
            if (this.QueryType == "add" && ParentItemID == (long)0 && EstimatesBasePage.OtherCostSequence_GetCountBy_EstimatType(this.CompanyID, empty) > (long)0)
            {
                HttpResponse response = base.Response;
                object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_Othercost.aspx?isFromOtherCostSeq=1&type=add&estid=", this.EstimateID, "&parentestitemid=", num, "&parentesttype=", empty, "&maintype=edit&subitem=s", empty3, str3 };
                response.Redirect(string.Concat(estimateID));
            }
            ...
            if (this.modulename == "orders")
            {
                ...
                {
                    HttpResponse httpResponse = base.Response;
                    object[] objArray = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", ParentItemID, empty3, str3 };
                    httpResponse.Redirect(string.Concat(objArray));
                    return;
                }
                HttpResponse response1 = base.Response;
                object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", num, empty3, str3 };
                response1.Redirect(string.Concat(estimateID1));
                return;
            }
            if (ParentItemID != (long)0)
            {
                if (empty4.ToString().ToLower() == "yes")
                {
                    HttpResponse httpResponse1 = base.Response;
                    object[] objArray1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&EstItemID=", ParentItemID, empty3, str3 };
                    httpResponse1.Redirect(string.Concat(objArray1));
                    return;
                }
                HttpResponse response2 = base.Response;
                object[] estimateID2 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&EstItemID=", ParentItemID, empty3, str3 };
                response2.Redirect(string.Concat(estimateID2));
                return;
            }
            if (empty4.ToString().ToLower() == "yes")
            {
                HttpResponse httpResponse2 = base.Response;
                object[] objArray2 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&EstItemID=", num, empty3, str3 };
                httpResponse2.Redirect(string.Concat(objArray2));
                return;
            }
            HttpResponse response3 = base.Response;
            object[] estimateID3 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&EstItemID=", num, empty3, str3 };
            response3.Redirect(string.Concat(estimateID3));
        }
        ...
        public void Insert_activity_history(int CompanyID, long ModuleID, long EstimateItemID)
        {
            ...
            {
                string str = "P";
                string str1 = "Sheet Fed Digital Pad Item";
                string empty = string.Empty;
            ...
            {
                string str2 = "P";
                string str3 = "Sheet Fed Digital Pad Item";
                string empty3 = string.Empty;
                if (this.modulename == "estimates")
                {
                    if (str2.ToLower() != "p")
        ...
        public void Main_Quantity_Insert(long EstimateItemID_TempID, string para, EstimatesItem Estitem)
        {
            ...
            for (int i = 1; i <= 4; i++)
            {
                ...
                else
                {
                    ...
                    dataTable = EstimatesBasePage.estimate_pad_item_select(this.CompanyID, EstimateItemID_TempID);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.EstimateID == (long)0 && this.modulename != "invoice")
            {
                HttpResponse response = base.Response;
                string[] invID = new string[] { this.strSitepath, this.modulename, "/", this.submodulename, "_view.aspx", this.jID, this.InvID };
            ...
            this.txtNoOfLeavesPerPad.Attributes.Add("style", "text-align:right");
            ...
            foreach (DataRow row1 in EstimatesBasePage.selectEstimatetype_estimateitemid(this.EstimateItemID, this.EstimateID).Rows)
            {
                this.IsItemCompleted = Convert.ToInt16(row1["IsItemCompleted"].ToString());
                this.IsProductCreated = Convert.ToInt16(row1["IsProductCreated"].ToString());
            }
            ...
            if (string.Compare(this.QueryType, "edit", true) != 0)
            {
                if (string.Compare(this.modulename, "invoice", true) == 0 || string.Compare(this.modulename, "jobs", true) == 0)
                {
                    ...
                    foreach (DataRow dataRow1 in JobBasePage.Job_Quantity_Numbert_Select(this.CompanyID, parentEstimateItemID).Rows)
                    {
        ...
        private void Select_Pads_Item(long ParentItemID, string ParentItemType)
        {
            ...
            DataTable dataTable1 = EstimatesBasePage.pad_item_select(this.CompanyID, this.EstimateItemID);
            StringBuilder stringBuilder = new StringBuilder();
            foreach (DataRow row1 in dataTable1.Rows)
            {
                this.EstimatePadItemID = Convert.ToInt64(row1["EstimatePadItemID"]);
                this.EstimateCalculationID = Convert.ToInt64(row1["EstimateCalculationID"]);
                this.TypeID = this.EstimatePadItemID;
                this.hid_IsSheetCustom.Value = row1["IsSheetCustom"].ToString();
                this.hid_IsJobCustom.Value = row1["IsJobCustom"].ToString();
                if (!base.IsPostBack)
                {
                    this.txtNoOfLeavesPerPad.Text = row1["LeavesPerPad"].ToString();
                ...
                stringBuilder.Append("ProductType»pads±");
                ...
                stringBuilder.AppendFormat("SetupSpoilage»{0}±", Convert.ToDecimal(row1["SetupSpoilage"]));
                stringBuilder.AppendFormat("RunningSpoilage»{0}±", Convert.ToDecimal(row1["RunningSpoilage"]));
                ...
                stringBuilder.AppendFormat("PrintLayout»{0}»{1}»{2}»{3}±", row1["PrintLayout"].ToString(), row1["PortraitValue"].ToString(), row1["LandscapeValue"].ToString(), row1["ManualValue"].ToString());
                ...
                this.PadPrintLayout = row1["PrintLayout"].ToString();
                if (!base.IsPostBack)
                {
        ...
        private void Update_Single_Item()
        {
            ...
            estimatesItem.IsAnyOutwork = 'N';
            estimatesItem.IsAnyOtherCost = 'N';
            if (this.EstimateItemID != (long)0 && this.EstimatePadItemID != (long)0)
            {
                string str = "P";
                estimatesItem.ItemTitle = this.Objclss.SpecialEncode(this.txtItemTitle.Text);
                estimatesItem.EstimatePadItemID = this.EstimatePadItemID;
                ...
                {
                    EstimateCommonMethods.UpdateDescription(this.EstimateItemID, this.EstimateID, "P", true);
                }
                if (this.IsProductCreated == 1)
                {
                    int num = 0;
                    ...
                    DataTable dataTable = EstimatesBasePage.select_Converted_Prodect(this.CompanyID, this.EstimateItemID, "P");
                    if (dataTable.Rows.Count > 0)
                    {
                        dataTable.Rows[0]["PricecatalogueID"].ToString();
                        if (num == 1 || num == 2)
                        {
                            EstimateCommonMethods.insert_UpdatePriceCatalogueQty(Convert.ToInt64(dataTable.Rows[0]["PricecatalogueID"].ToString()), this.EstimateID, this.EstimateItemID, "P", num);
                        }
                    }
                }
                ...
                if (string.Compare(this.modulename, "invoice", true) == 0 || string.Compare(this.modulename, "jobs", true) == 0)
                {
                    EstimateCommonMethods.ShowJobCardDetails(this.CompanyID, this.EstimateID, this.EstimateItemID, "P");
                ...
                if (this.ParentEstimateItemID == (long)0)
                {
                    EstimateCommonMethods.PCR_FormulaTags_Replace(this.EstimateItemID, "P");
                }
                string empty = string.Empty;
                if (this.modulename == "invoice")
                {
