...
{
    public partial class item_summary_litho_pad_item : UsercontrolBasePage
    {
        //protected PlaceHolder plhLithoPadItem;
        ...
        static item_summary_litho_pad_item()
        {
            item_summary_litho_pad_item.IsEditOnlyHisRecords = string.Empty;
        }

        public item_summary_litho_pad_item()
        {
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.Module.ToLower() != "proof")
            {
                ...
                foreach (DataRow row in EstimatesBasePage.estimate_litho_pad_item_select_reeng(this.CompanyID, this.EstimateItemID).Rows)
                {
                    ...
                    long num1 = Convert.ToInt64(row["PaperID"]);
                    long num2 = Convert.ToInt64(row["PressID"]);
                    long num3 = Convert.ToInt64(row["GuillotineID"]);
                    ...
                    else if (this.IsParentItem)
                    {
                        ...
                        {
                            empty = "<a href='#'>Paper</a>";
                            empty1 = "<a href='#'>Press</a>";
                            empty2 = "<a href='#'>Guillotine</a>";
                    ...
                    else
                    {
                        ...
                        empty2 = string.Concat("<a href='#'>", this.objlanguage.GetLanguageConversion("Guillotine"), "</a>");
                        empty3 = string.Concat("<a href='#' name='SPLInk'>", this.objlanguage.GetLanguageConversion("Ink"), "</a>");
                        empty4 = string.Concat("<a href='#' name='SPLInk'>", this.objlanguage.GetLanguageConversion("Plates"), "</a>");
                        empty5 = string.Concat("<a href='#' name='SPLInk'>", this.objlanguage.GetLanguageConversion("Make_Ready"), "</a>");
                        empty6 = string.Concat("<a href='#' name='SPLInk'>", this.objlanguage.GetLanguageConversion("Wash_Up"), "</a>");
                    }
                    ...
                    {
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<table width='100%' cellpadding='0' cellspacing='0' border='0' style='clear: both'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<td style='width: 100%;'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<div class='bglabelItem_summary'  style='width:150px; clear:both;'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<img alt='Img' title='Sheet Fed Offset: Pad'  src='", this.strImagepath, "bullet-blue.png' class='Blue_bullet'  />")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<div style='float:left;'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<div class='additionaloptiontext'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span >", str5, "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</div>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<div class='Edit_DeleteIcon'>"));
                        if (this.IsFromActHist.ToLower() == "yes")
                        {
                            this.plhLithoPadItem.Controls.Add(new LiteralControl("&nbsp;"));
                        }
                        else if (this.Module.ToLower() == "estimate")
                        {
                            if (!this.IsShowJobReRun)
                            {
                                object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_litho_pad_item.aspx?type=edit&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, "&esttype=D&parentestitemid=", this.ParentEstimateItemID, "&parentesttype=", this.ParentEstimateType, "&subedit=y&maintype=", this.MainType };
                                ...
                                {
                                    ControlCollection controls = this.plhLithoPadItem.Controls;
                                ...
                                {
                                    ControlCollection controlCollections = this.plhLithoPadItem.Controls;
                                    object[] estType = new object[] { "&nbsp;<a href='#' onclick=javascript:RemoveSubItems('", this.EstType, "','", this.EstimateItemID, "','", num, "','", this.EstimateID, "','", this.Module.ToString(), "','", this.ParentEstimateItemID, "');><img src=", this.strImagepath, "delete.gif border=0 title=Remove  width=10px height=10px /></a>" };
                        ...
                        else if (this.Module.ToLower() == "job")
                        {
                            ...
                            {
                                object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_litho_pad_item.aspx?type=edit&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, "&esttype=D&parentestitemid=", this.ParentEstimateItemID, "&parentesttype=", this.ParentEstimateType, "&subedit=y&maintype=", this.MainType, this.jID, this.InvID };
                                ...
                                {
                                    ControlCollection controls1 = this.plhLithoPadItem.Controls;
                                ...
                                {
                                    ControlCollection controlCollections1 = this.plhLithoPadItem.Controls;
                                    object[] estType1 = new object[] { "&nbsp;<a href='#' onclick=javascript:RemoveSubItems('", this.EstType, "','", this.EstimateItemID, "','", num, "','", this.EstimateID, "','", this.Module.ToString(), "','", this.ParentEstimateItemID, "');><img src=", this.strImagepath, "delete.gif border=0 title=Remove  width=10px height=10px /></a>" };
                        ...
                        else if (this.Module.ToLower() != "order")
                        {
                            ...
                            {
                                ControlCollection controls2 = this.plhLithoPadItem.Controls;
                            ...
                            {
                                ControlCollection controlCollections2 = this.plhLithoPadItem.Controls;
                                estimateItemID = new object[] { "&nbsp;<a href='#' onclick=javascript:RemoveSubItems('", this.EstType, "','", this.EstimateItemID, "','", num, "','", this.EstimateID, "','", this.Module.ToString(), "','", this.ParentEstimateItemID, "');><img src=", this.strImagepath, "delete.gif border=0 title=Remove  width=10px height=10px /></a>" };
                        ...
                        {
                            object[] estimateID3 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_litho_pad_item.aspx?type=edit&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, "&esttype=D&parentestitemid=", this.ParentEstimateItemID, "&parentesttype=", this.ParentEstimateType, "&subedit=y&maintype=", this.MainType };
                            ...
                            {
                                ControlCollection controls3 = this.plhLithoPadItem.Controls;
                            ...
                            {
                                ControlCollection controlCollections3 = this.plhLithoPadItem.Controls;
                                object[] estType2 = new object[] { "&nbsp;<a href='#' onclick=javascript:RemoveSubItems('", this.EstType, "','", this.EstimateItemID, "','", num, "','", this.EstimateID, "','", this.Module.ToString(), "','", this.ParentEstimateItemID, "');><img src=", this.strImagepath, "delete.gif border=0 title=Remove  width=10px height=10px /></a>" };
                        ...
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</div>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</div>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</table>"));
                    }
                    else
                    {
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<div class='only5px'></div>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<table width='100%' cellpadding='0' cellspacing='0' border='0' style='clear: both; '>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<td style='width: 16%;' colspan='2'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='ItemName_align' style='word-break: break-word;'><b class='ItemTitle_color'>", str4, "</b></div><div style='clear:both;padding-top:10px'></div>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</table>"));
                    }
                    ...
                    this.plhLithoPadItem.Controls.Add(new LiteralControl("<table width='100%' cellpadding='0' cellspacing='0' border='0'>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl("<td style='width: 100%; vertical-align: top;'>"));
                    ...
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span CssClass='normalText'>", stringBuilder1.ToString(), "</span>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl("</table>"));

                    ControlCollection controls4 = this.plhLithoPadItem.Controls;
                    tblWidthMinWidth = new string[] { "<table id='tblLithoPadItem' width='", this.tblWidth, "' cellpadding='0' cellspacing='0' border='0' style='", this.tblWidth_MinWidth, "'>" };
                    controls4.Add(new LiteralControl(string.Concat(tblWidthMinWidth)));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr id='trQuantity'>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", this.objlanguage.GetLanguageConversion("Finished_Quantity"), "</div>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQty1' style='text-align: right; width: 21%; ", str, "'>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity1_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty1, "</span>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQty2' style='text-align: right; width: 21%; ", str1, "'>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity2_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty2, "</span>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQty3' style='text-align: right; width: 21%; ", str2, "'>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity3_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty3, "</span>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdQty4' style='text-align: right; width: 21%; ", str3, "'>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity4_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty4, "</span>")));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                    if (this.IsParentItem)
                    {
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr id='trQtyDescription'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", this.objlanguage.GetLanguageConversion("Qty_Description"), "</div>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQtydesc1' style='text-align: right; width: 21%; ", str, "'>")));
                        ControlCollection controlCollections4 = this.plhLithoPadItem.Controls;
                        var locking = "";
                        var ignorelocking = "";
                        ...
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQtydesc2' style='text-align: right; width: 21%; ", str1, "'>")));
                        ControlCollection controls5 = this.plhLithoPadItem.Controls;
                        if (IsJobLocked && ignorelocking != "true")
                        {
                        ...
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQtydesc3' style='text-align: right; width: 21%; ", str2, "'>")));
                        ControlCollection controlCollections5 = this.plhLithoPadItem.Controls;
                        if (IsJobLocked && ignorelocking != "true")
                        {
                        ...
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdQtydesc4' style='text-align: right; width: 21%; ", str3, "'>")));
                        ControlCollection controls6 = this.plhLithoPadItem.Controls;
                        if (IsJobLocked && ignorelocking != "true")
                        {
                    ...
                    if (this.Module.ToLower() != "proof")
                    {
                        //this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr id='trPaper'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trPaper' style='", showCalculated, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", empty, "</div>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPaper1' style='text-align: right; width: 21%; ", strDimension1, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPaperPrice1' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PaperCostInMarkup1, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPaper2' style='text-align: right; width: 21%; ", strDimension2, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPaperPrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PaperCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPaper3' style='text-align: right; width: 21%; ", strDimension3, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPaperPrice13' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PaperCostInMarkup3, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdPaper4' style='text-align: right; width: 21%; ", strDimension4, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPaperPrice14' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PaperCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                        //this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr id='trInk'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trInk' style='", showCalculated, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", empty3, "</div>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdInk1' style='text-align: right; width: 21%; ", strDimension1, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnInkPrice1' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.InkCostInMarkup1, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdInk2' style='text-align: right; width: 21%; ", strDimension2, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnInkPrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.InkCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdInk3' style='text-align: right; width: 21%; ", strDimension3, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnInkPrice3' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.InkCostInMarkup3, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdInk4' style='text-align: right; width: 21%; ", strDimension4, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnInkPrice4' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.InkCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                        //this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr id='trPress'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trPress' style='", showCalculated, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", empty1, "</div>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPress1' style='text-align: right; width: 21%; ", strDimension1, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPressPrice1' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PressCostInMarkup1, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPress2' style='text-align: right; width: 21%; ", strDimension2, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPressPrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PressCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPress3' style='text-align: right; width: 21%; ", strDimension3, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPressPrice3' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PressCostInMarkup3, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdPress4' style='text-align: right; width: 21%; ", strDimension4, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPressPrice4' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PressCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                        if (num3 > (long)0)
                        {
                            //this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr id='trGuillotine'>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trGuillotine' style='", showCalculated, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", empty2, "</div>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdGuillotine1' style='text-align: right; width: 21%; ", strDimension1, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnGuillotinePrice1' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.GuillotineCostInMarkup1, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdGuillotine2' style='text-align: right; width: 21%; ", strDimension2, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnGuillotinePrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.GuillotineCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdGuillotine3' style='text-align: right; width: 21%; ", strDimension3, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnGuillotinePrice3' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.GuillotineCostInMarkup3, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdGuillotine4' style='text-align: right; width: 21%; ", strDimension4, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnGuillotinePrice4' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.GuillotineCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                        }
                        //this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr id='trPlates'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trPlates' style='", showCalculated, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", empty4, "</div>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPlates1' style='text-align: right; width: 21%; ", strDimension1, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPlatesPrice1' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PlatesCostInMarkup1, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPlates2' style='text-align: right; width: 21%; ", strDimension2, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPlatesPrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PlatesCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPlates3' style='text-align: right; width: 21%; ", strDimension3, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPlatesPrice3' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PlatesCostInMarkup3, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPlates4' style='text-align: right; width: 21%; ", strDimension4, "'>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPlatesPrice4' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PlatesCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                        if (flag)
                        {
                            //this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr id='trMakeReady'>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trMakeReady' style='", showCalculated, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", empty5, "</div>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdMakeReady1' style='text-align: right; width: 21%; ", strDimension1, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnMakeReadyPrice1' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.MakeReadyCostInMarkup1, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdMakeReady2' style='text-align: right; width: 21%; ", strDimension2, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnMakeReadyPrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.MakeReadyCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdMakeReady3' style='text-align: right; width: 21%; ", strDimension3, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnMakeReadyPrice3' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.MakeReadyCostInMarkup3, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdMakeReady4' style='text-align: right; width: 21%; ", strDimension4, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnMakeReadyPrice4' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.MakeReadyCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                        }
                        if (flag1)
                        {
                            //this.plhLithoPadItem.Controls.Add(new LiteralControl("<tr id='trWashUp'>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trWashUp' style='", showCalculated, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", empty6, "</div>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdWashUp1' style='text-align: right; width: 21%; ", strDimension1, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnWashUpPrice1' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.WashUpCostInMarkup1, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdWashUp2' style='text-align: right; width: 21%; ", strDimension2, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnWashUpPrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.WashUpCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdWashUp3' style='text-align: right; width: 21%; ", strDimension3, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnWashUpPrice3' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.WashUpCostInMarkup3, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdWashUp4' style='text-align: right; width: 21%; ", strDimension4, "'>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnWashUpPrice4' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.WashUpCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl(" </td>"));
                            this.plhLithoPadItem.Controls.Add(new LiteralControl("</tr>"));
                        }
                    }
