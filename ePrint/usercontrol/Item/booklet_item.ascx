<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="booklet_item.ascx.cs" Inherits="ePrint.usercontrol.Item.booklet_item" %>
...
<script language="javascript" type="text/javascript">
    var Booklet_Pages_Per_Print_Sheet_Cannot_Be_Zero = "<%=Booklet_Pages_Per_Print_Sheet_Cannot_Be_Zero %>";
</script>
<script>
    ...
    <div id="content">
        ...
        <div id="eprint_si_col_left" style="float: left; width: 50%; border: solid 0px red;">
            ...
            <div align="left" style="display: none;">
                ...
                <div class="ddlsetting">
                    ...
                    <span id="spn_Label3" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;"
                        class="spanErrorMsg">
                        <%=objLanguage.GetLanguageConversion("Select_Estimate_Type")%></span>
                </div>
            </div>
            <div>
            </div>
                ...
                <div id="div_ProductType" style="display: none;">
                    ...
                    <div class="ddlsetting">
                        ...
                        <span id="spn_Label4" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;"
                            class="spanErrorMsg">
                            <%=objLanguage.GetLanguageConversion("Select_Product_Type")%></span>
                    </div>
                </div>
            </div>
            <div class="only5px">
            ...
            <div id="div_only_digitals_left" align="left">
                    ...
                    <div style="float: left; width: 50%; border: 0px solid" id="div_qty12">
                        <div id="div_qty1" class="box" style="float: left; width: 120px; border: 0px solid red;">
                            ...
                            <asp:TextBox ID="txtQuantity" Width="75px" SkinID="textPad" onblur="AllowNumber(this,this.value);"
                                runat="server" onkeyup="javascript:ToInteger(this,this.value);" MaxLength="8"></asp:TextBox>
                            <span id="spn_txtQuantity_number" class="spanerrorMsg" style="display: none; width: 165px; margin-left: -1px">
                ...
                <div style="border: 0px solid">
                    <div style="float: left; border: 0px solid blue; margin-left: 211px; margin-top: -11px; margin-bottom: 3px">
                ...
                <div id="div_SectionRef" style="display: none;">
                    ...
                    <div>
                        <span id="spn_txtSectionRef" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; margin-left: 3px">
                ...
                <div align="left">
                    ...
                    <div class="ddlsetting" style="float: left; margin-left: -2px">
                        <asp:DropDownList ID="ddlPress" CssClass="normaltext" Width="260px" onchange="PressOnChange(this);LoadCalculations(this.id);setbooklet_format();"
                            runat="server">
                        </asp:DropDownList>
                ...
                <div align="left">
                    ...
                    <div class="box" style="float: left;">
                        <div class="graytext" style="overflow: hidden; white-space: nowrap; width: 260px;">
                    ...
                    <div id="div_Booklet_1" align="left" style="display: none;">
                        <div align="left">
                            ...
                            <div class="box">
                                ...
                                <span id="spn_txtNoOfPagesRequired" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-left: 4px;">
                    ...
                    <div class="box">
                        ...
                        <div align="left">
                            <span id="spn_txtNoOfLeavesPerPad" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                <%=objLanguage.GetLanguageConversion("Please_Enter_Leaves_Per_Pads")%></span><span
                ...
                <div align="left">
                    ...
                    <div class="ddlsetting" style="width: 169px; border: 0px solid; margin-left: -2px">
                        <div align="left">
                            <div style="float: left; padding-right: 5px;">
                                <span id="spnSide1" class="normalText" style="display: block;">
                                    <%=objLanguage.GetLanguageConversion("Side1")%></span>
                            </div>
                            <div style="float: left;">
                                <asp:DropDownList ID="ddlColors" runat="server" Width="120px" SkinID="onlyDDL">
                                    <asp:ListItem Text="Colour" Value="color"></asp:ListItem>
                                    <asp:ListItem Text="Black & White" Value="black"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div align="left" id="div_side2" style="display: block;">
                            <div style="float: left;">
                    ...
                    <div style="float: left; padding-top: 3px;">
                        &nbsp;<asp:CheckBox ID="chkDoubleSided" Checked="true" onclick="showSides(this.checked);"
                            Text="Double Sided" runat="server" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="div_only_digitals_right" style="float: left; width: 49%; border: solid 0px green;">
            <div align="left">
                ...
                <div class="box">
                    <div align="left">
                        <asp:DropDownList ID="ddlBookletType" SkinID="onlyDDL" runat="server" onchange="javascript:SetPerfectbound_vs_Saddlestiched();Calculations();CalculateBookletSection();changetext();">
                            <asp:ListItem Value="saddlestiched">Saddle Stiched</asp:ListItem>
                            <asp:ListItem Value="perfectbound">Non Saddle Stitched</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
            <div id="div_booklet_NoOfPagesInSection" align="left" style="display: none">
                <div align="left">
                    ...
                    <div class="box">
                        <div align="left">
                            <asp:TextBox ID="txtNoOfPagesInSection" SkinID="textPad" runat="server" MaxLength="20"
                        ...
                        <div align="left" style="padding-left: 2px">
                            <span id="spn_txtNoOfPagesInSection" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; margin-left: -2px">
                                <%=objLanguage.GetLanguageConversion("Please_Enter_Number_Of_Pages")%></span><span
                                    id="spn_txtNoOfPagesInSection_number" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;"><%=objLanguage.GetLanguageConversion("Please_Enter_Numeric_Value")%></span>
                            <span id="spn_txtNoOfPagesInSection_divide" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                <%=objLanguage.GetLanguageConversion("Please_Enter_Numeric_Value")%></span>
                        </div>
                    </div>
                </div>
            ...
            <div align="left">
                ...
                <div style="float: left; width: 216px;" nowrap="nowrap">
                    <div id="div_ddlPrintSheetSize" class="ddlsetting" style="width: 206px; margin-left: -2px">
                    ...
                    <div align="left">
                        <span id="spn_PrintSheetCustomSize" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                            <%=objLanguage.GetLanguageConversion("Please_Enter_Print_Sheet_Size")%></span><span
                                id="spn_PrintSheetCustomSize_numeric" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-left: 4px;"><%=objLanguage.GetLanguageConversion("Please_Enter_Numeric_Value")%></span>
                    </div>
                </div>
            ...
            <div align="left">
                ...
                <div style="float: left; width: 216px;" nowrap="nowrap">
                    <div id="div_ddlJobItemSize" class="ddlsetting" style="float: left; width: 206px; margin-left: -2px">
                        ...
                        <span id="spn_ddlJobItemSize" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; margin-left: -2px">
                            <%=objLanguage.GetLanguageConversion("Please_Select_Flat_Job_Size")%></span>
                    </div>
                    <div style="float: left; width: 266px;" nowrap="nowrap">
                        <div id="div_JobItemCustomSize" class="box" style="display: none; width: 100%;">
                            <span class="normaltext" style="font-size: 9px;">
                                <%=objLanguage.GetLanguageConversion("Height") %></span> &nbsp;<asp:TextBox ID="txtitemheight"
                                    Width="52px" SkinID="textPad" runat="server" MaxLength="20" onfocus='this.select();'></asp:TextBox>
                            <font style="font-size: 9px;">
                                <%=PaperMeasure %></font><span class="normaltext" style="font-size: 9px; padding-right: 4px;">
                    ...
                    <div align="left" style="padding-left: 5px">
                        <span id="spn_JobItemCustomSize" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; margin-left: -2px">
            ...
            <div id="div_Booklet_Format" align="left" style="display: none">
                <div class="bglabelnewLarge">
                    <span class="normalText">
                        <asp:Label ID="lblbookletformat" runat="server"><%=objLanguage.GetLanguageConversion("Finished_Booklet_Format") %></asp:Label>
                    </span>
                </div>
                <div class="box" style="float: left; width: auto; padding-left: 3px;">
                    <asp:DropDownList ID="ddlBookletFormat" SkinID="onlyDDL" runat="server" onchange="javascript:Calculations('yes');">
            ...
            <div id="div_Booklet_itemSize" align="left">
                <div class="bglabelnewLarge">
                    <asp:Label ID="Label2" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Flat_booklet_item_size")%></asp:Label>
                </div>
                <div id="div_Flatbookletitemsize" style="display: block; float: left; width: 266px"
                    class="box">
                    <span class="normaltext" style="font-size: 9px;">
            ...
            <div align="left">
                ...
                <div style="float: left; padding: 2px 0px 0px 0px; border: 0px solid red; clear: right; margin-left: -1px">
            ...
            <div id="div_PrintLayout" align="left">
                <div class="bglabelnewLarge" style="height: 30px;">
                    <table width="100%" style="vertical-align: top;" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td valign="top">
                                <div id="div_plusimg" style="float: right; padding-left: .5px">
                ...
                <div style="float: left;">
                    <div>
                        <div style="float: left; width: 85px; margin-left: -2px; margin-bottom: 3px">
                    ...
                    <div>
                        <div style="float: left; width: 85px; margin-left: -2px">
            ...
            <div id="div_booklet_NoOfSignatures" align="left" style="display: none">
                <div align="left">
                    ...
                    <div class="box">
                        <asp:TextBox ID="txtPagesPerSignature" onblur="javascript:CalculateBookletSection();Calculations();"
            ...
            <div align="left">
                ...
                <div class="box" style="float: left;">
                    ...
                    <div id="div_Trim" align="left" style="margin-left: -5px">
            ...
            <div align="left" id="Div_ItemDescn" runat="server" visible="false">
                <div class="bglabelnewLarge" style="float: left;">
                    <asp:Label ID="Label1" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Update_Item_Description") %></asp:Label>
                    <a id="img_Description" runat="server" href="javascript:void(0);" cssclass="tooltip"
            ...
            <div align="left">
                ...
                <div class="box" style="float: left; width: 71%">
                    <div align="left" style="white-space: nowrap; border: solid 0px red">
                        <div style="float: left; white-space: nowrap;" nowrap="nowrap">
                            <div style="float: left;">
                                <div style="float: left;">
                                    <div id="div_btnstage" style="display: block">
                                        <asp:Button ID="btnStage2_Previous" CssClass="button" OnClientClick="javascript:loadingimage(this.id,'div_stageprocess')"
                                            OnClick="btnPrevious_OnClick" Text="Previous" runat="server" />
                                    </div>
                                    <div id="div_stageprocess" style="display: none">
                                ...
                                <div id="div_BookletDelete" style="float: left; display: none;">
                                    <div style="float: left;">
                                        <asp:Button ID="Button14" CssClass="button" Text="New Section" OnClientClick="javascript:MoveNextSection();NewSection();return false;"
                                            runat="server" />
                                    </div>
                                    <div style="float: left; width: 10px">
                                        &nbsp;
                                    </div>
                                    <div style="float: left;" id="divDelete">
                                        <asp:UpdatePanel ID="UpBookletDelete" runat="server">
                                            <ContentTemplate>
                                                <asp:Button ID="Button16" CssClass="button" Text="Delete" OnClientClick="javascript:return SectionDelete();"
                                                    OnClick="btn_Delete" runat="server" />
                                ...
                                <div style="float: left;">
                                    <div id="div_btnfinish">
                                        <asp:Button ID="btnSave" CssClass="button" Text="Finish" OnClick="btnSave_OnClick"
                                            OnClientClick="javascript:var a=Booklet_Click_Next();if(a)loadingimage(this.id,'div_finishprocess'); return a;"
                                            runat="server" />
                                    </div>
                                    <div id="div_finishprocess" class='button' style="display: none; height: 12px; width: 32px;">
                                        <img src="<%=strImagepath %>radimg1.gif" class="loadingimg" alt="loading" border="0" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div align="left">
                        <div id="div_btn_nextSection" style="float: left; display: none;">
                            <div style="float: left;">
                                <div align="left" visible="false">
                                    <asp:Button ID="btnStage4_Next" OnClientClick="javascript:NewSection();return false;"
                                        CssClass="button" Text="New Section" runat="server" Visible="false" />
                                </div>
                            </div>
                        </div>
...
<asp:HiddenField ID="hdn_invStockBack" runat="server" Value="no" />
...
<script>
    ...
    function ValidatePaper_HeightWidth() {
        ...
        if (G_CalculateInventorySheet('b', Number(Height), Number(Width)) == 0 && (Height != undefined && Height != null)) {
...
<script>
    ...
    var hdnOldPaperID = document.getElementById("<%=hdnOldPaperID.ClientID %>");
</script>
<script type="text/javascript" language="javascript" src="<%=strSitepath %>js/Item/booklet_item.js?VN='<%=VersionNumber%>'"></script>
<script>
...
<script type="text/javascript" language="javascript">
    ...
    //    }
    //    if (hid_IsSheetCustom.value == "True") {
    ...
    function called_reducestock(val) {
        ...
        document.getElementById('div_finishprocess').style.display = 'block';
        document.getElementById('div_btnfinish').style.display = 'none';
        var hdn_invStockReduce = document.getElementById("<%=hdn_invStockReduce.ClientID %>");
