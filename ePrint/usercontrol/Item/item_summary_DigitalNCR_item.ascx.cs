...
{
    public partial class item_summary_DigitalNCR_item : UsercontrolBasePage
    {
        //protected PlaceHolder plhLithoNCRItem;

        private new BaseClass objBase = new BaseClass();
        ...
        static item_summary_DigitalNCR_item()
        {
            item_summary_DigitalNCR_item.IsEditOnlyHisRecords = string.Empty;
        }

        public item_summary_DigitalNCR_item()
        {
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int num10 = 0;
            int num11 = 0;
            //DataTable dataTable = EstimatesBasePage.estimate_litho_ncr_item_select(this.CompanyID, this.EstimateItemID);
            DataTable dataTable = EstimatesBasePage.estimate_digital_ncr_item_select(this.CompanyID, this.EstimateItemID);
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                long num13 = Convert.ToInt64(row["PaperID"]);
                long num14 = Convert.ToInt64(row["PressID"]);
                long num15 = Convert.ToInt64(row["PlateID"]);
                long num16 = Convert.ToInt64(row["GuillotineID"]);
                bool flag = false;
                bool flag1 = false;
                string id = row["QuantityID"].ToString();
                ...
                //string strDisplayNone = "display:none";
                ...
                if (this.IsParentItem && num11 == 0)
                {
                    ...
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl(string.Concat("<span CssClass='normalText'>", stringBuilder1.ToString(), "</span>")));

                    DataSet dataSet1 = OrderBasePage.Select_OrderItems_WithAdditionalItems(this.EstimateItemID);
                    ...
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<table width='100%' cellpadding='0' cellspacing='0' border='0'>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<tr>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<td style='width: 100%; vertical-align: top;'>"));
                    ...
                    stringBuilder1.Append("<div style='padding-bottom:10px;' class='onlyEmpty'></div>");
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl(string.Concat("<span CssClass='normalText'>", stringBuilder1.ToString(), "</span>")));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("</tr>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("</table>"));

                    stringBuilder1 = new StringBuilder();
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<table width='100%' cellpadding='0' cellspacing='0' border='0' style='clear: both'>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<tr>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<td style='width: 16%;' colspan='2'>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl(string.Concat("<div class='ItemName_align' style='word-break: break-word;'><b class='ItemTitle_color'>", str, "</b></div><div style='clear:both;'></div>")));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("</td>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("</tr>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("</tr>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<td colspan='2' style='padding-top:7px'>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<tr>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<tr>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<td style='width: 16%;'>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabel' style='width: 200px; margin-bottom:-2px;'>", this.objLanguage.GetLanguageConversion("Current_Section"), "</div>")));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("</td>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<td align='left' style='width: 84%;'>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("<div class='box' style='width:auto;'>"));
                    DataView defaultView = dataTable.DefaultView;
                    string[] strArrays = new string[] { "EstimateLithoNCRItemID", "SectionReference" };
                    DataTable table = defaultView.ToTable(true, strArrays);
                    for (int i = 0; i < table.Rows.Count; i++)
                    {
                        if (i == 0)
                        {
                            this.plhLithoNCRItem.Controls.Add(new LiteralControl("<div style='float:left;padding-left:5px;width:38px; border:0px solid red;'>"));
                            ...
                            ControlCollection controls = this.plhLithoNCRItem.Controls;
                            ...
                            this.plhLithoNCRItem.Controls.Add(new LiteralControl("</div>"));
                        }
                        this.plhLithoNCRItem.Controls.Add(new LiteralControl("<div style='float:left;width:auto;padding-left:10px;'>"));
                        ...
                        ControlCollection controlCollections = this.plhLithoNCRItem.Controls;
                        ...
                        if (i == 4)
                        {
                            this.plhLithoNCRItem.Controls.Add(new LiteralControl("<div class='only5px'></div>"));
                        }
                    }
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("</div>"));
                    this.plhLithoNCRItem.Controls.Add(new LiteralControl("</td>"));
                ...
                estimateItemID = new object[] { "<table id='tblBookletItem_", this.EstimateItemID, "_", num11, "' style='display: none;", this.tblWidth_MinWidth, "' width='", this.tblWidth, "' cellpadding='0' cellspacing='0' border='0px'>" };
                ...
                stringBuilder.Append(string.Concat("<span ID='spnQuantity1' CssClass='normalText'>", estimatesItem.Qty1, "</span>"));
                stringBuilder.Append(" </td>");
                stringBuilder.Append(string.Concat("<td id='tdQty2' style='text-align: right; width: 21%; ", str5, "'>"));
                stringBuilder.Append(string.Concat("<span ID='spnQuantity2' CssClass='normalText'>", estimatesItem.Qty2, "</span>"));
                stringBuilder.Append(" </td>");
                stringBuilder.Append(string.Concat("<td id='tdQty3' style='text-align: right; width: 21%; ", str6, "'>"));
                stringBuilder.Append(string.Concat("<span ID='spnQuantity3' CssClass='normalText'>", estimatesItem.Qty3, "</span>"));
                stringBuilder.Append(" </td>");
                stringBuilder.Append(string.Concat(" <td id='tdQty4' style='text-align: right; width: 21%; ", str7, "'>"));
                stringBuilder.Append(string.Concat("<span ID='spnQuantity4' CssClass='normalText'>", estimatesItem.Qty4, "</span>"));
                stringBuilder.Append(" </td>");
                ...
                //stringBuilder.Append(" </td>");
                //stringBuilder.Append(string.Concat("<td id='tdInk1' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                ...
                //stringBuilder.Append(" </td>");
                //stringBuilder.Append(string.Concat("<td id='tdInk2' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                ...
                //stringBuilder.Append(" </td>");
                //stringBuilder.Append(string.Concat("<td id='tdInk3' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                ...
                //stringBuilder.Append(" </td>");
                //stringBuilder.Append(string.Concat(" <td id='tdInk4' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                ...
                if (num16 > (long)0)
                {
                    ...
                    stringBuilder.Append("<td id='tdlbl' style='width: 16%; border:0px solid red;'>");
                ...
                //stringBuilder.Append("</td>");
                //stringBuilder.Append(string.Concat("<td id='tdPlates1' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                ...
                //stringBuilder.Append("</td>");
                //stringBuilder.Append(string.Concat("<td id='tdPlates2' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                ...
                //stringBuilder.Append("</td>");
                //stringBuilder.Append(string.Concat("<td id='tdPlates3' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                ...
                //stringBuilder.Append("</td>");
                //stringBuilder.Append(string.Concat("<td id='tdPlates4' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                ...
                if (flag1)
                {
                    ...
                    stringBuilder.Append("<td id='tdlbl' style='width: 15%'>");
                ...
                {
                    estimateItemID = new object[] { "<table id='tblBookletItem_", this.EstimateItemID, "_All' width='", this.tblWidth, "' cellpadding='0' cellspacing='0' border='0px' style='", this.tblWidth_MinWidth, "'>" };
                    stringBuilder1.Append(string.Concat(estimateItemID));
                    ...
                    stringBuilder1.Append(string.Concat("<span ID='spnQuantity1' CssClass='normalText'>", num[0], "</span>"));
                    stringBuilder1.Append(" </td>");
                    stringBuilder1.Append(string.Concat("<td id='tdQty2' style='text-align: right; width: 21%; ", str5, "'>"));
                    stringBuilder1.Append(string.Concat("<span ID='spnQuantity2' CssClass='normalText'>", num[1], "</span>"));
                    stringBuilder1.Append(" </td>");
                    stringBuilder1.Append(string.Concat("<td id='tdQty3' style='text-align: right; width: 21%; ", str6, "'>"));
                    stringBuilder1.Append(string.Concat("<span ID='spnQuantity3' CssClass='normalText'>", num[2], "</span>"));
                    stringBuilder1.Append(" </td>");
                    stringBuilder1.Append(string.Concat(" <td id='tdQty4' style='text-align: right; width: 21%; ", str7, "'>"));
                    stringBuilder1.Append(string.Concat("<span ID='spnQuantity4' CssClass='normalText'>", num[3], "</span>"));
                    stringBuilder1.Append(" </td>");
                    ...
                    if (this.Module.ToLower() != "proof")
                    {
                        ...
                        //stringBuilder1.Append(" </td>");
                        //stringBuilder1.Append(string.Concat("<td id='tdInk1' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                        ...
                        //stringBuilder1.Append(" </td>");
                        //stringBuilder1.Append(string.Concat("<td id='tdInk2' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                        ...
                        //stringBuilder1.Append(" </td>");
                        //stringBuilder1.Append(string.Concat("<td id='tdInk3' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                        ...
                        //stringBuilder1.Append(" </td>");
                        //stringBuilder1.Append(string.Concat(" <td id='tdInk4' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                        ...
                        //stringBuilder1.Append("<td id='tdlbl' style='width: 16%'>");
                        //stringBuilder1.Append(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", this.objLanguage.GetLanguageConversion("Plates"), "</div>"));
                        //stringBuilder1.Append("</td>");
                        //stringBuilder1.Append(string.Concat("<td id='tdPlates1' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                        ...
                        //stringBuilder1.Append("</td>");
                        //stringBuilder1.Append(string.Concat("<td id='tdPlates2' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                        ...
                        //stringBuilder1.Append("</td>");
                        //stringBuilder1.Append(string.Concat("<td id='tdPlates3' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
                        ...
                        //stringBuilder1.Append("</td>");
                        //stringBuilder1.Append(string.Concat("<td id='tdPlates4' style='text-align: right; width: 21%; ", strDisplayNone, "'>"));
            ...
            this.plhLithoNCRItem.Controls.Add(new LiteralControl(stringBuilder1.ToString()));
            this.plhLithoNCRItem.Controls.Add(new LiteralControl(stringBuilder.ToString()));
        }
    }
}