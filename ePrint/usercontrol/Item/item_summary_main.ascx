<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="item_summary_main.ascx.cs" Inherits="ePrint.usercontrol.Item.item_summary_main" %>
...
<%@ Register TagName="DigitalNCRItem" TagPrefix="UC" Src="~/usercontrol/Item/item_summary_DigitalNCR_item.ascx" %>
...
<script type="text/javascript">
    ...
    //        var obj = $("#ctl00_ContentPlaceHolder1_UCItemSummaryMain_itemdetails_quickLinks_" + PrntEstItmIDs_List[i].toString() + "_liReRun");

    //        //$("#ctl00_ContentPlaceHolder1_UCItemSummaryMain_itemdetails_quickLinks_" + PrntEstItmIDs_List[i].toString() + "_liReRun").css('display', 'none');
    //        $("#ctl00_ContentPlaceHolder1_UCItemSummaryMain_itemdetails_quickLinks_" + PrntEstItmIDs_List[i].toString() + "_RCM_Options").css('display', 'none');
    //        $("#ctl00_ContentPlaceHolder1_UCItemSummaryMain_itemdetails_quickLinks_" + PrntEstItmIDs_List[i].toString() + "_liaddItemhead").css('display', 'none');
    //        $("#ctl00_ContentPlaceHolder1_UCItemSummaryMain_itemdetails_quickLinks_" + PrntEstItmIDs_List[i].toString() + "_liaddItemhead").css('display', 'none');
...
<style>
    #ctl00_ContentPlaceHolder1_UCItemSummaryMain_divstatus a {
...
<script type="text/javascript">
    ...
    function CallSaveBtn(id, id2, CompanyID, EstType, EstID, QtyCnt, SectionCnt) {
        debugger;
        var id = id2.split('_');
        var divID = id[0];
        var ItemID = divID;
        ...
        var btnID = document.getElementById("ctl00_ContentPlaceHolder1_UCItemSummaryMain_UcItemTotal_" + id2);
        ...
        // btnID.click();
        CallSave(EstID, ItemID, EstType, QtyCnt, SectionCnt, 'stay')
        return true;
    }
    function CallStayBtn(id, id2, CompanyID, EstType, EstID, QtyCnt, SectionCnt) {
        debugger;
        var id = id2.split('_');
        var divID = id[0];
        var ItemID = divID;
...
<script>
    ...
    function OpenItemStatus(ID) {
        ...
        var Lock = document.getElementById("ctl00_ContentPlaceHolder1_UCItemSummaryMain_hdnLock_" + ID + "").value;
...
<script language="javascript" type="text/javascript">
    function MessageDisplay() {
        var pnlMessage = document.getElementById("ctl00_ContentPlaceHolder1_UCItemSummaryMain_ctl06_pnlMessage");
    ...
    function Item_PODel_Delete() {
        var hdn_EstItemIDforPODEL_Delete = document.getElementById("ctl00_ContentPlaceHolder1_UCItemSummaryMain_hdn_EstItemIDforPODEL_Delete").value;
        document.getElementById("div_Note").style.display = "none";
    ...
    function PODEL(result) {
        document.getElementById("ctl00_ContentPlaceHolder1_UCItemSummaryMain_Chk_DeletePO").checked = false;
        document.getElementById("ctl00_ContentPlaceHolder1_UCItemSummaryMain_Chk_DeleteDN").checked = false;
        var PO_DEL = result.split('«');
        if (PO_DEL[0] != 'true') {
            document.getElementById("ctl00_ContentPlaceHolder1_UCItemSummaryMain_Chk_DeletePO").disabled = true;
        }
        if (PO_DEL[1] != 'true') {
            document.getElementById("ctl00_ContentPlaceHolder1_UCItemSummaryMain_Chk_DeleteDN").disabled = true;
        }
    }
</script>
