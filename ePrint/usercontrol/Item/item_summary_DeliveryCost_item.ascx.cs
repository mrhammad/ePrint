...
{
    public partial class item_summary_DeliveryCost_item : UsercontrolBasePage
    {
        protected PlaceHolder plhDeliveryCostItem;
        ...
        static item_summary_DeliveryCost_item()
        {
            item_summary_DeliveryCost_item.IsEditOnlyHisRecords = string.Empty;
        }

        public item_summary_DeliveryCost_item()
        {
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.Module.ToLower() != "proof")
            {
                ...
                foreach (DataRow row in EstimatesBasePage.estimate_DeliveryCost_item_select(this.CompanyID, this.EstimateItemID).Rows)
                {
                    long num = Convert.ToInt64(row["EstTypeID"]);
                    EstimatesItem estimatesItem = new EstimatesItem()
                    {
                        Qty1 = Convert.ToInt32(row["Quantity1"]),
                        Qty2 = Convert.ToInt32(0),
                        Qty3 = Convert.ToInt32(0),
                        Qty4 = Convert.ToInt32(0)
                    };
                    ...
                    {
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<table width='100%' cellpadding='0' cellspacing='0' border='0' style='clear: both'>"));
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<tr>"));
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<td style='width: 16%;'>"));
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<div style='float: left;width: 150px'>"));
                        ControlCollection controls = this.plhDeliveryCostItem.Controls;
                        ...
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<div style='width: 3%;float: left' align='right'>"));
                        if (this.Module.ToLower() == "estimate")
                        {
                            if (!this.IsShowJobReRun)
                            {
                                ...
                                ControlCollection controlCollections = this.plhDeliveryCostItem.Controls;
                        ...
                        else if (this.Module.ToLower() != "job")
                        {
                            ...
                            ControlCollection controls1 = this.plhDeliveryCostItem.Controls;
                        ...
                        else if (!this.IsShowInvRerun)
                        {
                            ...
                            ControlCollection controlCollections1 = this.plhDeliveryCostItem.Controls;
                        ...
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("</div>"));
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("</tr>"));
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("</table>"));
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<div style='clear:both;padding-top:10px'></div>"));
                    }
                    else
                    {
                        this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<div style='clear:both;padding-top:10px'></div>"));
                    }
                    ControlCollection controls2 = this.plhDeliveryCostItem.Controls;
                    string[] tblWidthMinWidth = new string[] { "<table id='tblDeliveryCostItem' width='", this.tblWidth, "' cellpadding='0' cellspacing='0' border='0' style='", this.tblWidth_MinWidth, "'>" };
                    controls2.Add(new LiteralControl(string.Concat(tblWidthMinWidth)));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<tr id='trQuantity'>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; margin-bottom:-2px; clear: both'>", this.objLanguage.GetLanguageConversion("Finished_Quantity"), "</div>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQty1' style='text-align: right; width: 21%; ", str1, "'>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity1' CssClass='normalText'>", estimatesItem.Qty1, "</span>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<span hidden ID='hdn_spnQuantity1_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty1, "</span>")));

                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQty2' style='text-align: right; width: 21%; ", str2, "'>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity2' CssClass='normalText'>", estimatesItem.Qty2, "</span>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<span hidden ID='hdn_spnQuantity2_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty2, "</span>")));

                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQty3' style='text-align: right; width: 21%; ", str3, "'>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity3' CssClass='normalText'>", estimatesItem.Qty3, "</span>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<span hidden ID='hdn_spnQuantity3_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty3, "</span>")));

                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdQty4' style='text-align: right; width: 21%; ", str4, "'>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity4' CssClass='normalText'>", estimatesItem.Qty4, "</span>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<span hidden ID='hdn_spnQuantity4_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty4, "</span>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl("</tr>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl("</table>"));
                    ControlCollection controlCollections2 = this.plhDeliveryCostItem.Controls;
                    ...
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<tr id='trQtydesc'>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; margin-bottom:-2px; clear: both'>", this.objLanguage.GetLanguageConversion("Qty_Description"), "</div>")));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQtydesc1' style='text-align: right; width: 21%; ", str1, "'>")));
                    ControlCollection controls3 = this.plhDeliveryCostItem.Controls;
                    var locking = "";
                    var ignorelocking = "";
                    ...
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQtydesc2' style='text-align: right; width: 21%; ", str2, "'>")));
                    ControlCollection controlCollections3 = this.plhDeliveryCostItem.Controls;
                    if (IsJobLocked && ignorelocking != "true")
                    {
                    ...
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQtydesc3' style='text-align: right; width: 21%; ", str3, "'>")));
                    ControlCollection controls4 = this.plhDeliveryCostItem.Controls;
                    if (IsJobLocked && ignorelocking != "true")
                    {
                    ...
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDeliveryCostItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdQtydesc4' style='text-align: right; width: 21%; ", str4, "'>")));
                    ControlCollection controlCollections4 = this.plhDeliveryCostItem.Controls;
                    if (IsJobLocked && ignorelocking != "true")
                    {
