...
{
    public partial class item_summary_ncr_item : UsercontrolBasePage
    {
        ...
        static item_summary_ncr_item()
        {
            item_summary_ncr_item.IsEditOnlyHisRecords = string.Empty;
        }

        public item_summary_ncr_item()
        {
        }
