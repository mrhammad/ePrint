...
{
    public partial class qucikquote_item : UsercontrolBasePage
    {
        ...
        static qucikquote_item()
        {
            qucikquote_item.taxrate = new decimal(0);
            qucikquote_item.QueryType = string.Empty;
            qucikquote_item.modulename = "estimates";
        }

        public qucikquote_item()
        {
        }
        ...
        protected void btnprintemail_OnClick(object sender, EventArgs e)
        {
            ...
            this.Estitem.ModuleType = qucikquote_item.modulename;
            if (qucikquote_item.QueryType == "add")
            {
                this.insertitems();
            }
            else if (qucikquote_item.QueryType == "edit")
            {
                this.updateitems();
            }
            EstimatesBasePage.Estimate_quickquote_insert(this.Estitem, ConnectionClass.IsHandy);
            DataTable dataTable = new DataTable();
            dataTable = (qucikquote_item.modulename != "invoice" ? EstimateBasePage.Estimate_Select_By_EstimateID(this.CompanyID, this.EstimateID) : InvoiceBasePage.InvoiceDetails_ByInvoiceID_Select(this.InvoiceID));
            ...
            {
                EstimateBasePage.QuickQuote_AccountingCode_Insert(this.EstimateItemID, this.CompanyID, Convert.ToInt32(this.ddlAccountCode.SelectedValue));
            }
            EstimatesBasePage.estimate_EstTotalPriceDetails_Update(this.EstimateItemID);
            if (qucikquote_item.QueryType == "add")
            {
                EstimateCommonMethods.UpdateDescription(this.EstimateItemID, this.EstimateID, "Q", false);
                if (string.Compare(qucikquote_item.modulename, "invoice", true) == 0 || string.Compare(qucikquote_item.modulename, "jobs", true) == 0)
                {
            ...
            else if (qucikquote_item.QueryType == "edit")
            {
                ...
                if (this.IsProductCreated == 1)
                {
                    ...
                    DataTable dataTable1 = EstimatesBasePage.select_Converted_Prodect(this.CompanyID, this.EstimateItemID, "Q");
                    if (dataTable1.Rows.Count > 0)
                    {
                        dataTable1.Rows[0]["PricecatalogueID"].ToString();
                        EstimateCommonMethods.insert_UpdatePriceCatalogueQty(Convert.ToInt64(dataTable1.Rows[0]["PricecatalogueID"].ToString()), this.EstimateID, this.EstimateItemID, "Q", num);
                    }
                }
            }
        ...
        protected void btsave_onclick(object sender, EventArgs e)
        {
            ...
            this.Estitem.ItemDescription = this.basec.ReplaceSingleQuote(this.WareItemDesc);
            this.Estitem.ModuleType = qucikquote_item.modulename;
            if (qucikquote_item.QueryType == "add" || this.frmcopyitem == "yes")
            {
                this.insertitems();
            }
            else if (qucikquote_item.QueryType == "edit" && this.frmcopyitem != "yes")
            {
                this.updateitems();
            }
            EstimatesBasePage.Estimate_quickquote_insert(this.Estitem, ConnectionClass.IsHandy);
            ...
            else if (qucikquote_item.QueryType == "edit")
            {
                ...
                if (this.IsProductCreated == 1)
                {
                    ...
                    DataTable dataTable = EstimatesBasePage.select_Converted_Prodect(this.CompanyID, this.EstimateItemID, "Q");
            ...
            this.InsertTo_activity_History();
            if (qucikquote_item.QueryType == "add" && (string.Compare(qucikquote_item.modulename, "invoice", true) == 0 || string.Compare(qucikquote_item.modulename, "jobs", true) == 0))
            {
                JobBasePage.Job_Jobcard_Insert_NewItem(this.CompanyID, this.EstimateItemID, 1, this.EstimateID);
                EstimateCommonMethods.ShowJobCardDetails(this.CompanyID, this.EstimateID, this.EstimateItemID, "Q");
                string empty = string.Empty;
                ...
                if (string.Compare(qucikquote_item.modulename, "jobs", true) == 0)
                {
            ...
            if (qucikquote_item.QueryType == "edit" && (string.Compare(qucikquote_item.modulename, "invoice", true) == 0 || string.Compare(qucikquote_item.modulename, "jobs", true) == 0))
            {
                EstimateCommonMethods.ShowJobCardDetails(this.CompanyID, this.EstimateID, this.EstimateItemID, "Q");
            }
            if (qucikquote_item.modulename == "jobs")
            {
            ...
            if (qucikquote_item.modulename.ToLower() == "jobs")
            {
                str1 = InvoiceBasePage.IS_INVOICEorJOB_from_Webstore(this.jobID, qucikquote_item.modulename);
            }
            else if (qucikquote_item.modulename.ToLower() == "invoice")
            {
                str1 = InvoiceBasePage.IS_INVOICEorJOB_from_Webstore(this.InvoiceID, qucikquote_item.modulename);
            }
            if (qucikquote_item.modulename == "orders")
            {
                HttpResponse response = base.Response;
                object[] estimateID = new object[] { this.strSitepath, qucikquote_item.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, this.jID, this.InvID };
                response.Redirect(string.Concat(estimateID));
                return;
            }
            if (str1.ToLower() == "yes")
            {
                HttpResponse httpResponse = base.Response;
                object[] objArray = new object[] { this.strSitepath, qucikquote_item.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, this.jID, this.InvID };
                httpResponse.Redirect(string.Concat(objArray));
                return;
            }
            HttpResponse response1 = base.Response;
            object[] estimateID1 = new object[] { this.strSitepath, qucikquote_item.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, this.jID, this.InvID };
            response1.Redirect(string.Concat(estimateID1));
        }
        ...
        public string Insert_Warehouse_ItemDescription()
        {
            ...
            foreach (DataRow row in dataSet.Tables[0].Rows)
            {
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem1 = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem2 = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem3 = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem4 = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem5 = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem6 = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem7 = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem8 = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem9 = this;
                ...
                {
                    qucikquote_item usercontrolItemQucikquoteItem10 = this;
                ...
                qucikquote_item usercontrolItemQucikquoteItem11 = this;
        ...
        public void insertitems()
        {
            ...
            if (this.InvoiceID <= (long)0)
            {
                ...
                long num1 = EstimatesBasePage.Estimate_Item_Insert(this.CompanyID, this.EstimateID, "Q", true, num);
                long num2 = num1;
            ...
            else
            {
                ...
                long num3 = EstimatesBasePage.Estimate_Item_Insert(this.CompanyID, (long)0, "Q", true, num);
                long num4 = num3;
            ...
            if (this.hid_QtyType.Value.ToLower() != "s")
            {
                ...
                this.Estitem.Quantity2 = (this.txtQuantity_2.Text == "" ? 0 : Convert.ToInt32(this.txtQuantity_2.Text.Trim()));
                this.Estitem.Quantity3 = (this.txtQuantity_3.Text == "" ? 0 : Convert.ToInt32(this.txtQuantity_3.Text.Trim()));
                this.Estitem.Quantity4 = (this.txtQuantity_4.Text == "" ? 0 : Convert.ToInt32(this.txtQuantity_4.Text.Trim()));
                this.Estitem.Subtotal1 = (this.txtsubtotal.Text.Trim() == "NaN" ? new decimal(0) : Convert.ToDecimal(this.txtsubtotal.Text.Trim()));
                this.Estitem.Subtotal2 = (this.txtsubtotal1.Text.Trim() == "NaN" ? new decimal(0) : Convert.ToDecimal(this.txtsubtotal1.Text.Trim()));
                this.Estitem.Subtotal3 = (this.txtsubtotal2.Text.Trim() == "NaN" ? new decimal(0) : Convert.ToDecimal(this.txtsubtotal2.Text.Trim()));
                this.Estitem.Subtotal4 = (this.txtsubtotal3.Text.Trim() == "NaN" ? new decimal(0) : Convert.ToDecimal(this.txtsubtotal3.Text.Trim()));
                this.Estitem.CostPrice1 = (this.txtcost.Text.Trim() == "NaN" ? new decimal(0) : Convert.ToDecimal(this.txtcost.Text.Trim()));
                this.Estitem.CostPrice2 = (this.txtcost1.Text.Trim() == "NaN" ? new decimal(0) : Convert.ToDecimal(this.txtcost1.Text.Trim()));
                this.Estitem.CostPrice3 = (this.txtcost2.Text.Trim() == "NaN" ? new decimal(0) : Convert.ToDecimal(this.txtcost2.Text.Trim()));
                this.Estitem.CostPrice4 = (this.txtcost3.Text.Trim() == "NaN" ? new decimal(0) : Convert.ToDecimal(this.txtcost3.Text.Trim()));
            }
            else
            {
            ...
            EstimatesBasePage.estimate_item_details_insert(this.CompanyID, this.EstimateID, this.EstimateItemID, "Q");
        }

        public void InsertTo_activity_History()
        {
            long num = (long)0;
            if (!qucikquote_item.modulename.Contains("job"))
            {
                num = (!qucikquote_item.modulename.Contains("invoice") ? this.EstimateID : this.InvoiceID);
            }
            else
            {
                num = this.jobID;
            }
            if (string.Compare(qucikquote_item.QueryType, "add", true) == 0)
            {
                string str = "Q";
                string str1 = "Quick Quote Item";
                string empty = string.Empty;
                ...
                if (base.Request.Params["FromAddAnItem"] == null)
                {
                    ...
                    if (qucikquote_item.modulename == "estimates")
                    {
                        ...
                        this.objnotes.Estimate_type = "Quick Quote";
                    ...
                    else if (qucikquote_item.modulename == "jobs")
                    {
                        ...
                        this.objnotes.Job_type = "Quick Quote";
                    ...
                    else if (qucikquote_item.modulename == "invoice")
                    {
                        ...
                        this.objnotes.Invoice_type = "Quick Quote";
                    ...
                    else if (qucikquote_item.modulename == "orders")
                    {
                ...
                else if (qucikquote_item.modulename == "estimates")
                {
                    this.objnotes.Item_title = empty;
                    this.objnotes.ModuleName = "estimate";
                    this.objnotes.NotesType = Convert.ToString(Notes.NotesType.EstNewItemAdd);
                    this.objnotes.Estimate_type = "Quick Quote";
                    foreach (DataRow dataRow2 in Notes.select_item_number_for_Activity_History(num, this.EstimateItemID, qucikquote_item.modulename).Rows)
                    {
                ...
                else if (qucikquote_item.modulename == "jobs")
                {
                    ...
                    this.objnotes.Job_type = "Quick Quote";
                    foreach (DataRow row3 in Notes.select_item_number_for_Activity_History(num, this.EstimateItemID, qucikquote_item.modulename).Rows)
                    {
                ...
                else if (qucikquote_item.modulename == "invoice")
                {
                    ...
                    this.objnotes.Invoice_type = "Quick Quote";
                    foreach (DataRow dataRow3 in Notes.select_item_number_for_Activity_History(num, this.EstimateItemID, qucikquote_item.modulename).Rows)
                    {
                ...
                else if (qucikquote_item.modulename == "orders")
                {
                    ...
                    this.objnotes.NotesType = Convert.ToString(Notes.NotesType.EstNewItemAdd);
                    this.objnotes.Estimate_type = "Quick Quote";
                    foreach (DataRow row4 in Notes.select_item_number_for_Activity_History(num, this.EstimateItemID, qucikquote_item.modulename).Rows)
                    {
            ...
            else if (string.Compare(qucikquote_item.QueryType, "edit", true) == 0)
            {
                string str2 = string.Empty;
                if (qucikquote_item.modulename == "estimates")
                {
                    foreach (DataRow dataRow4 in Notes.select_item_number_for_Activity_History(num, this.EstimateItemID, qucikquote_item.modulename).Rows)
                    {
                ...
                {
                    foreach (DataRow row5 in Notes.select_item_number_for_Activity_History(num, this.EstimateItemID, qucikquote_item.modulename).Rows)
                    {
                ...
                {
                    foreach (DataRow dataRow5 in Notes.select_item_number_for_Activity_History(num, this.EstimateItemID, qucikquote_item.modulename).Rows)
                    {
                ...
                {
                    foreach (DataRow row6 in Notes.select_item_number_for_Activity_History(num, this.EstimateItemID, qucikquote_item.modulename).Rows)
                    {
        ...
        public void updateitems()
        {
            ...
            if (this.hid_QtyType.Value.ToLower() != "s")
            {
                ...
                this.Estitem.Subtotal2 = (this.txtsubtotal1.Text.Trim() == "" ? new decimal(0) : Convert.ToDecimal(this.txtsubtotal1.Text.Trim()));
                this.Estitem.Subtotal3 = (this.txtsubtotal2.Text.Trim() == "" ? new decimal(0) : Convert.ToDecimal(this.txtsubtotal2.Text.Trim()));
                this.Estitem.Subtotal4 = (this.txtsubtotal3.Text.Trim() == "" ? new decimal(0) : Convert.ToDecimal(this.txtsubtotal3.Text.Trim()));
                this.Estitem.CostPrice1 = (this.txtcost.Text.Trim() == "" ? new decimal(0) : Convert.ToDecimal(this.txtcost.Text.Trim()));
                this.Estitem.CostPrice2 = (this.txtcost1.Text.Trim() == "" ? new decimal(0) : Convert.ToDecimal(this.txtcost1.Text.Trim()));
                this.Estitem.CostPrice3 = (this.txtcost2.Text.Trim() == "" ? new decimal(0) : Convert.ToDecimal(this.txtcost2.Text.Trim()));
                this.Estitem.CostPrice4 = (this.txtcost3.Text.Trim() == "" ? new decimal(0) : Convert.ToDecimal(this.txtcost3.Text.Trim()));
            }
            else
            {
                this.Estitem.Quantity1 = (this.txtQuantity.Text == "" ? 0 : Convert.ToInt32(this.txtQuantity.Text.Trim()));
            ...
            EstimatesBasePage.estimate_item_details_insert(this.CompanyID, this.EstimateID, this.EstimateItemID, "Q");
            string empty2 = string.Empty;
            DataTable dataTable1 = EstimatesBasePage.Select_AccountingCode_For_Summary(this.CompanyID, this.EstimateItemID, "Q", this.EstimateID);
            foreach (DataRow dataRow in dataTable1.Rows)
            {
                Convert.ToInt32(dataRow["AccountCodeID"]);
                dataRow["Description"].ToString();
            }
            EstimateCommonMethods.PCR_FormulaTags_Replace(this.EstimateItemID, "Q");
        }
        ...
        protected void btsave_onclick_stay(object sender, EventArgs e)
        {
            ...
            HttpResponse response1 = base.Response;
            object[] estimateID1 = new object[] { this.strSitepath, qucikquote_item.modulename, "/", this.submodulename, "_quickquote.aspx?type=add&EstID=", this.EstimateID, "&jID=", this.jobID, "&InvID=", this.InvoiceID, "&FromAddAnItem=Y&maintype=add" };
            response1.Redirect(string.Concat(estimateID1));
        }
