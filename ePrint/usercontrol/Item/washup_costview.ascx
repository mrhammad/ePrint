<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="washup_costview.ascx.cs" Inherits="ePrint.usercontrol.Item.washup_costview" %>
                    ...
                    <div class="t">
                        <div class="divpadding">
                            <div align="left" style="float: left;" nowrap="nowrap">
                                <asp:Label ID="lblCostViewTitle" runat="server">Wash Up Cost View</asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="padding">   <%--class="divBorderItem"--%>
           <%-- <div class='only10px'>
            ...
            <table width="100%">
                <tr>
                    <td>
                        <telerik:RadGrid ID="GridWashUpCostView" AutoGenerateColumns="false" runat="server"
                            PageSize="50" Width="99%" HeaderStyle-Font-Bold="true" CssClass="RadGrid_Eprint_Skin"
                            OnItemDataBound="GridWashUpCostView_OnItemDataBound">
                            <MasterTableView>
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="No. of Colours Used" HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_NoofColoursUsed" runat="server" Text='<%#Eval("NoofColoursUsed")%>'></asp:Label><%--0--%>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Selling Price($)" HeaderStyle-HorizontalAlign="Right"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hdn_NoofColoursUsed" runat="server" Value='<%#Eval("NoofColoursUsed")%>' />
