<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Item_Summary_Proof_SelectItemsAndFiles.ascx.cs" Inherits="ePrint.usercontrol.Item.Item_Summary_Proof_SelectItemsAndFiles" %>
                ...
                <input type="radio" name="items" value="uncheckItems" onclick="javascript: uncheckItems();"> Deselect All
                    ...
                    <br />
                            ...
                            <div id="lstItems" style="border: 0px solid green; height: 300px; overflow-y: scroll; overflow-x: hidden;  word-break: break-word;">
                                <asp:PlaceHolder ID="Plh_Items" runat="server"></asp:PlaceHolder>
                            </div>
                            <div class="onlyEmpty">
                            </div>
                            <div align="center">
