...
{
    public partial class item_summary_pad_item : UsercontrolBasePage
    {
        //protected PlaceHolder plhDigiPadItem;
        ...
        static item_summary_pad_item()
        {
            item_summary_pad_item.IsEditOnlyHisRecords = string.Empty;
        }

        public item_summary_pad_item()
        {
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.Module.ToLower() != "proof")
            {
                ...
                foreach (DataRow row in EstimatesBasePage.estimate_pad_item_select(this.CompanyID, this.EstimateItemID).Rows)
                {
                    ...
                    else if (this.IsParentItem)
                    {
                        if (this.IsFromActHist.ToLower() != "yes")
                        {
                            ...
                            empty = string.Concat(estimateItemID11);
                    ...
                    {
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<table width='100%' cellpadding='0' cellspacing='0' border='0' style='clear: both'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<tr>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<td align='left' style='width: 20%;'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<div class='bglabelItem_summary'  style='width:150px; clear:both;'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<img alt='Img' title='Sheet Fed Digital: Pad'  src='", this.strImagepath, "bullet-blue.png' class='Blue_bullet' />")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<div style='float:left;'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<div class='additionaloptiontext'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span >", str6, "</span>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</div>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<div class='Edit_DeleteIcon' >"));
                        if (this.IsFromActHist.ToLower() == "yes")
                        {
                            this.plhDigiPadItem.Controls.Add(new LiteralControl("&nbsp;"));
                        }
                        else if (this.Module.ToLower() == "estimate")
                        {
                            if (!this.IsShowJobReRun)
                            {
                                object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_pad_item.aspx?type=edit&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, "&esttype=P&parentestitemid=", this.ParentEstimateItemID, "&parentesttype=", this.ParentEstimateType, "&subedit=y&maintype=edit" };
                                ...
                                {
                                    ControlCollection controls = this.plhDigiPadItem.Controls;
                                ...
                                {
                                    ControlCollection controlCollections = this.plhDigiPadItem.Controls;
                        ...
                        else if (this.Module.ToLower() == "job")
                        {
                            ...
                            {
                                object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_pad_item.aspx?type=edit&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, "&esttype=P&parentestitemid=", this.ParentEstimateItemID, "&parentesttype=", this.ParentEstimateType, "&subedit=y&maintype=edit", this.jID, this.InvID };
                                ...
                                {
                                    ControlCollection controls1 = this.plhDigiPadItem.Controls;
                                ...
                                {
                                    ControlCollection controlCollections1 = this.plhDigiPadItem.Controls;
                        ...
                        {
                            object[] estimateID2 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_pad_item.aspx?type=edit&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, "&esttype=P&parentestitemid=", this.ParentEstimateItemID, "&parentesttype=", this.ParentEstimateType, "&subedit=y&maintype=edit", this.jID, this.InvID };
                            string str131 = string.Concat(estimateID2);
                            string str141 = this.objBase.ReturnRoles_Privileges_ForGrid("invoices", "isadd", this.Page.Request.Url.ToString());
                            if (str141.ToLower() == "true" || str141 == "")
                            {
                                ControlCollection controls2 = this.plhDigiPadItem.Controls;
                                string[] strArrays2 = new string[] { "<a href=", str131, "><img src=", this.strImagepath, "edit.gif border=0 title='Edit' width=10px height=10px style='cursor: pointer;' /></a>&nbsp;" };
                                controls2.Add(new LiteralControl(string.Concat(strArrays2)));
                            }
                            string str151 = this.objBase.ReturnRoles_Privileges_ForGrid("invoices", "isdelete", this.Page.Request.Url.ToString());
                            string strRemove = this.objBase.ReturnRoles_Privileges_ForGrid("invoices", "isremove", this.Page.Request.Url.ToString());
                            if (str151.ToLower() == "true" || str151 == "")
                            {
                                ControlCollection controlCollections2 = this.plhDigiPadItem.Controls;
                        ...
                        {
                            object[] estimateID3 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_pad_item.aspx?type=edit&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, "&esttype=P&parentestitemid=", this.ParentEstimateItemID, "&parentesttype=", this.ParentEstimateType, "&subedit=y&maintype=edit" };
                            string str161 = string.Concat(estimateID3);
                            string str171 = this.objBase.ReturnRoles_Privileges_ForGrid("webstoreorder", "isadd", this.Page.Request.Url.ToString());
                            if (str171.ToLower() == "true" || str171 == "")
                            {
                                ControlCollection controls3 = this.plhDigiPadItem.Controls;
                                string[] strArrays3 = new string[] { "<a href=", str161, "><img src=", this.strImagepath, "edit.gif border=0 title='Edit' width=10px height=10px style='cursor: pointer;' /></a>&nbsp;" };
                            ...
                            {
                                ControlCollection controlCollections3 = this.plhDigiPadItem.Controls;
                        ...
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</div>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</div>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</tr>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</table>"));
                    }
                    else
                    {
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<div class='only5px'></div>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<table width='100%' cellpadding='0' cellspacing='0' border='0' style='clear: both; '>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<tr>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<td style='width: 16%;' colspan='2'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='ItemName_align' style='word-break: break-word;'><b class='ItemTitle_color'>", str5, "</b></div><div style='clear:both;padding-top:10px'></div>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</tr>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</table>"));
                    }
                    ...
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("<table width='100%' cellpadding='0' cellspacing='0' border='0'>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("<tr>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("<td style='width: 100%; vertical-align: top;'>"));
                    ...
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span CssClass='normalText'>", stringBuilder1.ToString(), "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("</tr>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("</table>"));

                    ControlCollection controls4 = this.plhDigiPadItem.Controls;
                    string[] tblWidthMinWidth1 = new string[] { "<table id='tblPadItem' width='", this.tblWidth, "' cellpadding='0' cellspacing='0' border='0' style='", this.tblWidth_MinWidth, "'>" };
                    controls4.Add(new LiteralControl(string.Concat(tblWidthMinWidth1)));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("<tr id='trQuantity'>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", this.objLanguage.GetLanguageConversion("Finished_Quantity"), "</div>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQty1' style='text-align: right; width: 21%; ", str1, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity1_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty1, "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQty2' style='text-align: right; width: 21%; ", str2, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity2_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty2, "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQty3' style='text-align: right; width: 21%; ", str3, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity3_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty3, "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdQty4' style='text-align: right; width: 21%; ", str4, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnQuantity4_" + this.EstimateItemID + "' CssClass='normalText'>", estimatesItem.Qty4, "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("</tr>"));
                    if (this.IsParentItem)
                    {
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<tr id='trQtyDescription'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", this.objLanguage.GetLanguageConversion("Qty_Description"), "</div>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQtydesc1' style='text-align: right; width: 21%; ", str1, "'>")));
                        ControlCollection controlCollections4 = this.plhDigiPadItem.Controls;
                        var locking = "";
                        var ignorelocking = "";
                        ...
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQtydesc2' style='text-align: right; width: 21%; ", str2, "'>")));
                        ControlCollection controls5 = this.plhDigiPadItem.Controls;
                        if (IsJobLocked && ignorelocking != "true")
                        {
                            ...
                            controls5.Add(new LiteralControl(string.Concat(objArray3)));
                        }
                        else
                        {
                        ...
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdQtydesc3' style='text-align: right; width: 21%; ", str3, "'>")));
                        ControlCollection controlCollections5 = this.plhDigiPadItem.Controls;
                        if (IsJobLocked && ignorelocking != "true")
                        {
                            ...
                            controlCollections5.Add(new LiteralControl(string.Concat(estimateItemID4)));
                        }
                        else
                        {
                        ...
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdQtydesc4' style='text-align: right; width: 21%; ", str4, "'>")));
                        ControlCollection controls6 = this.plhDigiPadItem.Controls;
                        if (IsJobLocked && ignorelocking != "true")
                        {
                            ...
                            controls6.Add(new LiteralControl(string.Concat(objArray4)));
                        }
                        else
                        {
                    ...
                    //this.plhDigiPadItem.Controls.Add(new LiteralControl("<tr id='trPaper'>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trPaper' style='", showCalculated, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", empty, "</div>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPaper1' style='text-align: right; width: 21%; ", str1, "'>")));
                    ...
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPaper2' style='text-align: right; width: 21%; ", str2, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPaperPrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PaperCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPaper3' style='text-align: right; width: 21%; ", str3, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPaperPrice13' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PaperCostInMarkup3, 0, "", false, false, true, false, true), true), "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdPaper4' style='text-align: right; width: 21%; ", str4, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPaperPrice14' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PaperCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("</tr>"));
                    //this.plhDigiPadItem.Controls.Add(new LiteralControl("<tr id='trPress'>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trPress' style='", showCalculated, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", str, "</div>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPress1' style='text-align: right; width: 21%; ", str1, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPressPrice1' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PressCostInMarkup1, 0, "", false, false, true, false, true), true), "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPress2' style='text-align: right; width: 21%; ", str2, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPressPrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PressCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdPress3' style='text-align: right; width: 21%; ", str3, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPressPrice3' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PressCostInMarkup3, 0, "", false, false, true, false, true), true), "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdPress4' style='text-align: right; width: 21%; ", str4, "'>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnPressPrice4' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.PressCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("</tr>"));
                    if (num3 > (long)0)
                    {
                        //this.plhDigiPadItem.Controls.Add(new LiteralControl("<tr id='trGuillotine'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<tr id='trGuillotine' style='", showCalculated, "'>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("<td id='tdlbl' style='width: 16%'>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<div class='bglabelItem_summary' style='width: 150px; clear: both'>", empty1, "</div>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdGuillotine1' style='text-align: right; width: 21%; ", str1, "'>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnGuillotinePrice1' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.GuillotineCostInMarkup1, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdGuillotine2' style='text-align: right; width: 21%; ", str2, "'>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnGuillotinePrice2' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.GuillotineCostInMarkup2, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<td id='tdGuillotine3' style='text-align: right; width: 21%; ", str3, "'>")));
                        ...
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat(" <td id='tdGuillotine4' style='text-align: right; width: 21%; ", str4, "'>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(string.Concat("<span ID='spnGuillotinePrice4' CssClass='normalText'>", this.commclass.GetCurrencyinRequiredFormate(this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, estimatesItem.GuillotineCostInMarkup4, 0, "", false, false, true, false, true), true), "</span>")));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl(" </td>"));
                        this.plhDigiPadItem.Controls.Add(new LiteralControl("</tr>"));
                    }
                    this.plhDigiPadItem.Controls.Add(new LiteralControl("</table>"));
