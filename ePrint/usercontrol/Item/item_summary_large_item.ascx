<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="item_summary_large_item.ascx.cs" Inherits="ePrint.usercontrol.Item.item_summary_large_item" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<table id="tblLargeItem" width="97%" cellpadding="0" cellspacing="0" border="0">
    <%--<tr>
    ...
    <tr id="trQuantity">
        <td>
            <asp:PlaceHolder ID="plhLargeItem" runat="server"></asp:PlaceHolder>
        </td>
    </tr>
</table>
