<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="item_summary_DeliveryCost_item.ascx.cs" Inherits="ePrint.usercontrol.Item.item_summary_DeliveryCost_item" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<table id="tblDeliveryCostItem" width="97%" cellpadding="0" cellspacing="0" border="0">
<%--    <tr>
    ...
    <tr id="trQuantity">
        <td>
            <asp:PlaceHolder ID="plhDeliveryCostItem" runat="server"></asp:PlaceHolder>
        </td>
    </tr>
</table>
<%--<div id="Div_RadSplit" runat="server">
    ...
    <telerik:RadContextMenu ID="RadContextMenu1" runat="server">
        <Items>
            ...
            <telerik:RadMenuItem Text="Sheed Fed Offset" Style="padding-right: 5px">
                <Items>
                    <telerik:RadMenuItem Text="Single Item" Style="cursor: pointer;">
                    </telerik:RadMenuItem>
                    <telerik:RadMenuItem Text="Pads" Style="cursor: pointer;">
            ...
            <telerik:RadMenuItem Text="Large Formate" Style="cursor: pointer;" />
...
<div id="Div_AdvancedOptions" runat="server" align="left">
