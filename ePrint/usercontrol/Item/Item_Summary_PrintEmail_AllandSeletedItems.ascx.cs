...
{
    public partial class Item_Summary_PrintEmail_AllandSeletedItems : UserControl
    {
        ...
        static Item_Summary_PrintEmail_AllandSeletedItems()
        {
        }

        public Item_Summary_PrintEmail_AllandSeletedItems()
        {
        }
        ...
        protected void btnPrintEmail_Click(object sender, EventArgs e)
        {
            ...
            //proof work commented by hammad
            //if (this.hdnSelectedItemsID.Value.Length <= 0)
            //{
            //    base.Session["SelectedItemForPrint"] = null;
            //}
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!base.IsPostBack)
            {
                this.btnPrintEmail.Text = this.objLanguage.GetLanguageConversion("Print_Email");
            }
