<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="item_summary_pricecatalogue_item.ascx.cs" Inherits="ePrint.usercontrol.Item.item_summary_pricecatalogue_item" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<%@ Register TagName="quicklinksItem" TagPrefix="UC" Src="~/usercontrol/Item/item_summary_quicklinks.ascx" %>

<table id="tblPriceCatalogueItem" width="97%" cellpadding="0" cellspacing="0" border="0">
    <tr id="trQuantity">
        <td>
            <asp:PlaceHolder ID="plhPriceCatalogueItem" runat="server"></asp:PlaceHolder>
        </td>
    </tr>
</table>
<script type="text/javascript" src="<%=strSitepath %>js/pdf_preview.js?VN='<%=VersionNumber%>'"></script>
...
<telerik:RadWindow RenderMode="Lightweight" ID="ImagePopWindow" Title="Image Preview"
    ...
    <ContentTemplate>
        ...
        <ul runat="server" class="slider div_imagePreview" id="div_imagePreview" style="overflow: hidden; background: #323639;">
        </ul>
