<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="single_item.ascx.cs" Inherits="ePrint.single_item" %>
...
<div id="divMainContent">
    ...
    <div id="div_AlertPopup" style="display: none; position: absolute; width: 1100px; z-index: 10; left: 125px;">
    </div>
    ...
    <div id="content">
        ...
        <div style="float: left; width: 50%; border: solid 0px red;">
            ...
            <div align="left" style="display: none;">
                ...
                <div class="ddlsetting">
                    ...
                    <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-73 18th july 2012--%>
                </div>
            </div>
            <div align="left" style="display: none;">
                <div id="div_ProductType" style="display: none;">
                    ...
                    <div class="ddlsetting">
                        ...
                        <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-91 18th july 2012--%>
                    </div>
                </div>
            </div>
            <div class="only5px">
            ...
            <div id="div_only_digitals_left" align="left">
                <div align="left">
                    <div class="bglabelnewLarge" style="height: 38px; border: 0px solid blue">
                        <div id="div_FinishedQty" style="float: left; border: 0px solid;">
                            <%=objLanguage.GetLanguageConversion("Finished_Quantity")%><span style="color: red">
                                *</span>
                        </div>
                    ...
                    <div style="float: left; width: 50%" id="div_qty12">
                        <div id="div_qty1" class="box" style="float: left; width: 120px; border: 0px solid red; vertical-align: top;">
                            ...
                            <span id="spn_txtQuantity_number" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px">
                                <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-133 18th july 2012--%>
                        ...
                        <div id="div_Addmore" class="box" style="float: left; display: none; width: 120px; border: 0px solid red; white-space: nowrap;"
                            nowrap="nowrap">
                    ...
                    <div id="div_Qty_2to4" style="display: none; border: 0px solid; float: left; width: 50%; padding-top: 2px;">
                ...
                <div id="div_SectionRef" style="display: none;">
                    ...
                    <div class="box">
                        ...
                        <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-219 18th july 2012--%>
                    </div>
                </div>
                <div align="left">
                    <div class="onlyEmpty">
                    ...
                    <div class="ddlsetting" style="float: left;margin-left:-1.5px">
                        <asp:DropDownList ID="ddlPress" CssClass="normaltext" Width="260px" onchange="PressOnChange(this);LoadCalculations(this.id);"
                            runat="server">
                        </asp:DropDownList>
                        <span id="spn_ddlPress" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; margin-top: 3px;">
                            <%=objLanguage.GetLanguageConversion("Please_Select_Press") %>
                            <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-234 18th july 2012--%>
                        </span>
                ...
                <div align="left">
                    ...
                    <div class="box" style="float: left;">
                        <div class="graytext" style="overflow: hidden; white-space: nowrap; width: 260px; padding-left: -2px;">
                            ...
                            <%--raghavendra chnaged width to 205 px and added margin-left:2px for proper alignment of validator line no-272 18th july 2012--%>
                        </div>
                        <div class="onlyEmpty" style="margin-left:-4px">
                            <asp:CheckBox ID="ChkPriceForWholePack" Text="" onclick="javascript:checkchanged();"
                                runat="server" />
                        </div>
                        <div style="margin-left:-4px">
                            <asp:CheckBox ID="ChkPaperSupplied" Text="" runat="server" onclick="javascript:checkchanged1();" />
                        </div>
                    </div>
                </div>
                <div class="onlyEmpty">
                ...
                <div align="left">
                    <div class="bglabelnewLarge">
                        <asp:Label ID="Label13" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("SetUp_Spoilage")%></asp:Label>
                        <span style="color: Red">*</span>
                    </div>
                    <div class="box">
                        <asp:TextBox ID="txtSetupSpoilage" SkinID="textPad" Width="75px" runat="server" MaxLength="20"></asp:TextBox>&nbsp;
                        <span id="spnPaperType" class="normaltext">
                            <%=objLanguage.GetLanguageConversion("Sheets") %></span>
                        <br />
                        <span id="spn_txtSetupSpoilage" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;  margin-top: 2px;">
                            <%=objLanguage.GetLanguageConversion("Please_Enter_Setup_Spoilage") %></span>
                        <%--raghavendra chnaged width to 205 px and added margin-left:2px for proper alignment of validator line no-294 18th july 2012--%>
                        <span id="spn_txtSetupSpoilage_number" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; margin-left: 2px">
                            <%=objLanguage.GetLanguageConversion("Please_Select_Numeric_Value") %></span>
                        <%--raghavendra chnaged width to 205 px and added margin-left:2px for proper alignment of validator line no-296 18th july 2012--%>
                    </div>
                </div>
                <div align="left">
                    <div class="bglabelnewLarge">
                        <asp:Label ID="Label14" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Running_Spoilage")%></asp:Label>
                        <span style="color: Red">*</span>
                    </div>
                    <div class="box">
                        ...
                        <br />
                        <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-308 18th july 2012--%>
                        <span id="spn_txtRunningSpoilage" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                            <%=objLanguage.GetLanguageConversion("Please_Enter_Running_Spoilage")%></span><span
                                ...
                                <%=objLanguage.GetLanguageConversion("Please_Select_Numeric_Value") %></span>
                        <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-310 18th july 2012--%>
                    </div>
                </div>
                <div class="only10px">
                </div>
                        ...
                        <div align="left">
                            ...
                            <div class="box">
                                ...
                                <span id="spn_txtNoOfPagesRequired" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                    <%=objLanguage.GetLanguageConversion("Please_Enter_no_of_Pages") %></span> <span
                                        id="spn_txtNoOfPagesRequired_number" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                        <%=objLanguage.GetLanguageConversion("Please_Select_Numeric_Value") %></span>
                            </div>
                        </div>
                        <div align="left">
                            ...
                            <div class="box">
                                ...
                                <span id="spn_txtPagesPerSection" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">Please enter Pages per Section</span><span
                                    id="spn_txtPagesPerSection_number" class="spanerrorMsg" style="display: none; width: 175px;"><%=objLanguage.GetLanguageConversion("Please_Select_Numeric_Value") %></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div align="left">
                    <div class="bglabelnewLarge">
                        <asp:Label ID="Label11" runat="server" Text="" CssClass="normaltext"></asp:Label>
                    </div>
                    <div class="ddlsetting" style="width: 169px; border: 0px solid;margin-left:-2px">
                        <div align="left">
        ...
        <div id="div_only_digitals_right" style="float: left; width: 49%; border: solid 0px green;">
                        ...
                        <div align="left">
                            <span id="spn_txtNoOfPagesInSection" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                <%=objLanguage.GetLanguageConversion("Please_Enter_No_of_Pages") %></span><span id="spn_txtNoOfPagesInSection_number"
                                    class="spanerrorMsg" style="display: none; width: 175px;"><%=objLanguage.GetLanguageConversion("Please_Enter_Numeric_Value") %></span><span
            ...
            <div align="left">
                <div align="left" nowrap="nowrap" style="border: 0px solid;">
                    <%--SHEET SIZE--%>
                    <div class="bglabelnewLarge">
                        <asp:Label ID="Label22" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Print_Sheet_Size")%></asp:Label>
                        <span style="color: Red">*</span>
                    </div>
                    <div style="float: left; width: 206px;" nowrap="nowrap">
                        <div id="div_ddlPrintSheetSize" class="ddlsetting" style="width: 206px;">
                            ...
                            <span id="spn_ddlPrintSheetSize" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;"><u>
                                <%=objLanguage.GetLanguageConversion("Please_Select_Print_Sheet_Size")%></u></span>
                            <asp:HiddenField ID="hid_ddlPrintSheetSize" runat="server" Value="" />
                            <asp:HiddenField ID="hid_3DecimalPaperSize" runat="server" Value="" />
                        </div>
                        <div style="float: left; width: 266px; border: 0px solid red" nowrap="nowrap">
                            <div id="div_PrintSheetCustomSize" class="box" style="display: none; width: 100%;">
                                <span id="spn_sheet_height" style="font-size: 9px;" class="normaltext">
                                    <%=objLanguage.GetLanguageConversion("Height") %></span> &nbsp;<asp:TextBox ID="txtsectionheight"
                                        Width="52px" SkinID="textPad" runat="server" MaxLength="20" Style="text-align: right;"></asp:TextBox>
                                <font style="font-size: 9px;">
                                    <%=PaperMeasure %></font><span id="spn_sheet_width" class="normaltext" style="font-size: 9px;">&nbsp;<%=objLanguage.GetLanguageConversion("Width") %></span>&nbsp;<asp:TextBox
                                        ID="txtsectionwidth" Width="52px" SkinID="textPad" runat="server" MaxLength="20"
                        ...
                        <script>
                            var txtsectionheightNew = document.getElementById("<%=txtsectionheight.ClientID %>");
                            var txtsectionwidthNew = document.getElementById("<%=txtsectionwidth.ClientID %>");
                        </script>
                        <div align="left" style="padding-left: 5px">
                            <span id="spn_PrintSheetCustomSize" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                                <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-454 18th july 2012--%>
                                <%=objLanguage.GetLanguageConversion("Please_Select_Print_Sheet_Size") %></span><span
                                    id="spn_PrintSheetCustomSize_value" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;"><%=objLanguage.GetLanguageConversion("Please_Select_Numeric_Value") %></span>
                            <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-456 18th july 2012--%>
                        </div>
                    </div>
            ...
            <div align="left">
                <div class="bglabelnewLarge">
                    <asp:Label ID="Label23" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Finished_Job_Size_Unfolded")%></asp:Label>
                    <span style="color: Red">*</span>
                </div>
                <div style="float: left; width: 206px;" nowrap="nowrap">
                    <div id="div_ddlJobItemSize" class="ddlsetting" style="float: left; width: 206px">
                        <asp:DropDownList ID="ddlJobItemSize" CssClass="normaltext" Width="175px" onchange="LoadToItemCustom(this.value);LoadCalculations(this.id);ItemSize_AssignToSummary('');"
                            runat="server">
                        </asp:DropDownList>
                        <span id="spn_ddlJobItemSize" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                            <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-477 18th july 2012--%>
                        ...
                        <div id="div_JobItemCustomSize" class="box" style="display: none; width: 100%;">
                            <span class="normaltext" style="font-size: 9px;">
                                <%=objLanguage.GetLanguageConversion("Height") %></span> &nbsp;<asp:TextBox ID="txtitemheight"
                                    Width="52px" SkinID="textPad" runat="server" MaxLength="20" Style="text-align: right;"></asp:TextBox>
                            <font style="font-size: 9px;">
                                <%=PaperMeasure %></font><span class="normaltext" style="font-size: 9px;">&nbsp;<%=objLanguage.GetLanguageConversion("Width") %></span>&nbsp;<asp:TextBox
                                    ID="txtitemwidth" Width="52px" SkinID="textPad" runat="server" MaxLength="20"
                                    Style="text-align: right;"></asp:TextBox>
                            <font style="font-size: 9px;">
                                <%=PaperMeasure %></font>
                        </div>
                    ...
                    <div align="left" style="padding-left: 5px">
                        <span id="spn_JobItemCustomSize" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                            <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-492 18th july 2012--%>
                            <%=objLanguage.GetLanguageConversion("Please_Select_Job_Flat_Size") %></span><span
                                id="spn_JobItemCustomSize_Value" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;"><%=objLanguage.GetLanguageConversion("Please_Select_Numeric_Value") %></span>
                        <%--raghavendra chnaged width to 205 px for proper alignment of validator line no-494 18th july 2012--%>
                    </div>
                </div>
            ...
            <div align="left">
                <div class="bglabelnewLarge" style="margin-top: 3px;">
                    <asp:Label ID="Label24" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Include_Gutters")%></asp:Label>
                </div>
                <div id="div_GuttersCustomSize" style="display: none; float: left; width: 222px; margin-top: 3px;"
                    class="box">
                    <span class="normaltext" style="font-size: 9px; padding-right: 4px">
                        <%=objLanguage.GetLanguageConversion("Horiz") %></span> &nbsp;<asp:TextBox ID="txtGutterHorizontal"
                            Width="52px" SkinID="textPad" runat="server" Style="text-align: right;" MaxLength="20"
                            onclick="javascript:Calculations();"></asp:TextBox>
                    <font style="font-size: 9px;">
                        <%=PaperMeasure %></font><span class="normaltext" style="font-size: 9px; padding-right: 3px">&nbsp;<%=objLanguage.GetLanguageConversion("Vert") %></span>&nbsp;<asp:TextBox
                            ID="txtGutterVertical" Width="52px" SkinID="textPad" runat="server" MaxLength="20"
                            Style="text-align: right;" onclick="javascript:Calculations();"></asp:TextBox>
                    <font style="font-size: 9px;">
                        <%=PaperMeasure %></font>
                </div>
                ...
                <div align="left">
                    <span id="spn_txtGutterHorizantal" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;">
                        <%=objLanguage.GetLanguageConversion("Please_enter_Include_Gutters")%></span><span
                            id="spn_txtGutterHorizantal_value" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px;"><%=objLanguage.GetLanguageConversion("Please_Select_Numeric_Value")%></span>
                </div>
            </div>
            <div class="onlyEmpty">
            ...
            <div align="left">
                <div class="bglabelnewLarge">
                    <asp:Label ID="Label25" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Apply_Press_Restrictions")%></asp:Label>
                </div>
                <div class="box" style="padding: 2px 0px 0px 1px;margin-left:-2px">
            ...
            <div id="div_PrintLayout" align="left">
                <div class="bglabelnewLarge" style="height: 28px;">
                    <div style="float: left;">
                        <asp:Label ID="Label20" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Print_Layout")%></asp:Label>
                        <span style="color: red">*</span>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="float: left;">
                            ...
                            <asp:HiddenField ID="hdn_LandscapeValue" runat="server" Value="0" />
                                ...
                                <input type="hidden" value="0" id="hdntype" name="hdntype" />
            ...
            <div align="left">
                <div class="bglabelnewLarge" style="height: 30px;">
                    <div style="float: left;">
                        <asp:Label ID="Label26" runat="server" Text="" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Guillotine")%></asp:Label>
                    </div>
                    <div style="float: right;">
            ...
            <div align="left" id="Div_ItemDescn" runat="server" visible="false">
                <div class="bglabelnewLarge" style="float: left;">
                    <asp:Label ID="Label1" runat="server" Text="Update Item Description" CssClass="normaltext"></asp:Label>
                    <a id="rerunOverwrite" runat="server" href="javascript:void(0);" cssclass="tooltip"
            ...
            <div align="left">
                ...
                <div class="bglabelempty" style="width: 26%; visibility: hidden">
                </div>
                <div class="box" style="float: left">
                    <div style="float: left; white-space: nowrap;" nowrap="nowrap">
                        <div style="float: left;">
                            ...
                            <div style="float: left;">
                                ...
                                <div id="div_btnsaveprocess" class='button' style="display: none; height: 14px; width: 32px;">
                                    <img src="<%=strImagepath %>radimg1.gif" class="loadingimg" alt="loading" border="0" />
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    var SingleItemPrintLayout = "<%=SingleItemPrintLayout%>";
    ...
    function ValidatePaper_HeightWidth() {
        ...
        var hid_height = document.getElementById("<%=hid_height.ClientID %>");
        var hid_width = document.getElementById("<%=hid_width.ClientID %>");
        if (G_CalculateInventorySheet('s', Number(Height), Number(Width)) == 0 && (Height != undefined && Height != null)) {
    ...
    function popup_layout() {
        ...
        if ((SH.value != "") && (SW.value != "") && (IH.value != "") && (IW.value != "")) {
            if (row == 0 || col == 0) {
                ...
                window.radopen("<%=nmsCommon.global.sitePath()%>print_layout.aspx?SH=" + SH.value + "&SW=" + SW.value + "&IH=" + IH.value + "&IW=" + IW.value + "&type=" + hdntype.value + "&selected=" + hdnselected.value + "&row=" + row + "&col=" + col + "&vg=" + hdnvertical.value + "&hg=" + hdnhorizontal.value + "&nonHeight=" + NonHeight + "&nonWidth=" + NonWeight, '', '1050', '525');
...
<script type="text/javascript" language="javascript" src="<%=strSitepath %>js/Item/single_item.js?VN='<%=VersionNumber%>'"></script>
<script type="text/javascript">
...
<script type="text/javascript" language="javascript">
    ...
    function called_reducestock(val) {
        ...
        var btnid = document.getElementById("<%=btnSave.ClientID %>");
        //loadingimage(btnid, 'div_btnsaveprocess')
        document.getElementById('div_btnsave').style.display = 'none';
        document.getElementById('div_btnsaveprocess').style.display = 'block';
        document.getElementById('div_AlertPopup').style.display = "none"
        document.getElementById('divBackGroundNew').style.display = "none";
        __doPostBack('ctl00$ContentPlaceHolder1$UCSingleItem$btnSave', '');
    }
</script>