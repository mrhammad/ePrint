<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="item_summary_single_item.ascx.cs" Inherits="ePrint.usercontrol.Item.item_summary_single_item" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<table id="tblSingleItem" width="97%" cellpadding="0" cellspacing="0">
   
    <tr id="trQuantity">
        <td valign="top" style="border: 0px solid green;">
            <div style="border: 0px solid green;">
                <asp:PlaceHolder ID="plhDigiSingleItem" runat="server"></asp:PlaceHolder>
            </div>
