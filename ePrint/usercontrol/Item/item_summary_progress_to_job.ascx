                    ...
                    <tr>
                        <td valign="top">
                            ...
                            <div id="divdates" style="<%=divdates_Style%>">
                                <div align="left">
                                    <div align="left" id="div_CON" runat="server">
                                        <div class="bglabel">
                                    ...
                                    <div id="divRadPO" runat="server" style=" min-width:60px;   max-height: 180px; overflow-y: scroll; display:block">
                                    ...
                                    <div align="left" id="div_showinprospect">
                                        <div class="bglabel">
                                    ...
                                    <div style="float: left;">
                                        <div id="div_btnnext" style="display: block; padding-top: 8px;">
                                            <input id="btn_Ok_and_Next_Before" type="button" value='<%=objLanguage.GetLanguageConversion("Ok")%>'
                                                class="button" style="width: 50px" onclick="javascript: var j = Ok_and_Next_Before(); if (j != false) loadingimg(this.id, 'div_nextprocess'); return j;" />
                                        </div>
