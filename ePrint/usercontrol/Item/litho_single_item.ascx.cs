...
{
    public partial class litho_single_item : UsercontrolBasePage
    {
        ...
        //protected HiddenField hid_SessionPressChangeSingle;

        //protected HiddenField hid_SessionPressChangeDouble;
        ...
        //protected HiddenField hdnNonHeight;

        //protected HiddenField hdnNonWidth;
        ...
        public string PrintLayoutSelected = string.Empty;
            ...
            if (this.QueryType == "add")
            {
                if (this.modulename != "orders")
                {
                    ...
                    if (this.ParentEstimateItemID == (long)0)
                    {
                        ...
                        object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_add.aspx?type=Edit&prev=y&estid=", this.EstimateID, "&esttype=F&From=F&maintype=", this.MainType, this.jID, this.InvID };
            ...
            else if (this.QueryType == "edit")
            {
                if (this.modulename != "orders")
                {
                    ...
                    if (base.Request.Params["frm"] != null && base.Request.Params["frm"] == "sum")
                    {
                        if (empty.ToString().ToLower() == "yes")
                        {
                            ...
                            object[] objArray4 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&estitemid=", this.EstimateItemID, this.jID, this.InvID };
                            httpResponse4.Redirect(string.Concat(objArray4));
                            return;
                        }
                        HttpResponse response5 = base.Response;
                        object[] estimateID5 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&estitemid=", this.EstimateItemID, this.jID, this.InvID };
                ...
                else
                {
                    ...
                    if (base.Request.Params["frm"] != null && base.Request.Params["frm"] == "sum")
                    {
                        ...
                        object[] objArray6 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&estitemid=", this.EstimateItemID, this.jID, this.InvID };
        ...
        private void Click_Add(long ParentItemID, string ParentItemType)
        {
            ...
            {
                EstimateCommonMethods.UpdateDescription(num, this.EstimateID, "F", false);
            }
            ...
            if (string.Compare(this.modulename, "invoice", true) == 0 || string.Compare(this.modulename, "jobs", true) == 0)
            {
                ...
                EstimateCommonMethods.ShowJobCardDetails(this.CompanyID, this.EstimateID, num, "F");
            ...
            if (this.modulename == "jobs")
            {
                ...
                {
                    str1 = row1["PhraseText"].ToString();
                }
                foreach (DataRow dataRow1 in SettingsBasePage.settings_default_phrasebook_select(this.CompanyID, "Job Footer").Rows)
                {
                    empty2 = dataRow1["PhraseText"].ToString();
                }
                EstimateBasePage.estimate_tojob_headerfooter_update(this.CompanyID, this.EstimateID, str1, empty2);
            }
            base.Session["dtinks"] = null;
            string str2 = string.Empty;
            if (this.jobID != (long)0)
            {
                str2 = string.Concat("&jID=", this.jobID);
            }
            string empty3 = string.Empty;
            if (this.InvoiceID != (long)0)
            {
                empty3 = string.Concat("&InvID=", this.InvoiceID);
            }
            if (ParentItemID == (long)0)
            {
                ...
                {
                    HttpResponse response = base.Response;
                    object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_Othercost.aspx?isFromOtherCostSeq=1&type=add&estid=", this.EstimateID, "&parentestitemid=", num, "&parentesttype=", empty, "&maintype=edit&subitem=s", str2, empty3 };
                    response.Redirect(string.Concat(estimateID));
                }
            ...
            if (this.modulename == "invoice")
            {
                str3 = InvoiceBasePage.IS_INVOICEorJOB_from_Webstore(this.InvoiceID, this.modulename);
            }
            else if (this.modulename == "jobs")
            {
                str3 = InvoiceBasePage.IS_INVOICEorJOB_from_Webstore(this.jobID, this.modulename);
            }
            if (this.modulename == "orders")
            {
                if (this.ParentEstimateItemID == (long)0)
                {
                    HttpResponse httpResponse = base.Response;
                    object[] objArray = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", num, str2, empty3 };
                    httpResponse.Redirect(string.Concat(objArray));
                    return;
                }
                HttpResponse response1 = base.Response;
                object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID, str2, empty3 };
                response1.Redirect(string.Concat(estimateID1));
                return;
            }
            if (this.ParentEstimateItemID == (long)0)
            {
                if (str3.ToString().ToLower() == "yes")
                {
                    HttpResponse httpResponse1 = base.Response;
                    object[] objArray1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&EstItemID=", num, str2, empty3 };
                    httpResponse1.Redirect(string.Concat(objArray1));
                    return;
                }
                HttpResponse response2 = base.Response;
                object[] estimateID2 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&EstItemID=", num, str2, empty3 };
                response2.Redirect(string.Concat(estimateID2));
                return;
            }
            if (str3.ToString().ToLower() == "yes")
            {
                HttpResponse httpResponse2 = base.Response;
                object[] objArray2 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID, str2, empty3 };
                httpResponse2.Redirect(string.Concat(objArray2));
                return;
            }
            HttpResponse response3 = base.Response;
            object[] estimateID3 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID, str2, empty3 };
            response3.Redirect(string.Concat(estimateID3));
        }
        ...
        public void Insert_activity_history(int CompanyID, long ModuleID, long EstimateItemID)
        {
            ...
            {
                string str = "F";
                string str1 = "Sheet Fed Offset Single Item";
                string empty = string.Empty;
            ...
            {
                string str2 = "F";
                string str3 = "Sheet Fed Offset Single Item";
                string empty3 = string.Empty;
                if (this.modulename == "estimates")
                {
                    if (str2.ToLower() != "f")
        ...
        public void Main_Quantity_Insert(long EstimateItemID_TempID, string para, EstimatesItem Estitem)
        {
            ...
            for (int i = 1; i <= 4; i++)
            {
                ...
                if (i != 1)
                {
                    ...
                    num23 = (textBox.Text.Trim() != "" ? Convert.ToInt32(textBox.Text.Trim()) : 0);
                }
                else if (this.txtQuantity.Text.Trim() != "")
                {
                    num23 = Convert.ToInt32(this.txtQuantity.Text.Trim());
                }
                if (num23 <= 0)
                {
                    numArray[i - 1] = 0;
                ...
                else
                {
                    numArray[i - 1] = num23;
                    DataTable dataTable = new DataTable();
                    dataTable = EstimatesBasePage.estimate_litho_single_item_select(this.CompanyID, EstimateItemID_TempID);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string empty = string.Empty;
            if (baseClass.ReturnRoles_Privileges_ForGrid("warehouse", "isview", this.Page.Request.Url.ToString()).ToLower() != "false")
            {
                this.imgbtnDefaultPaper.Visible = true;
            ...
            {
                this.imgbtnDefaultPaper.Visible = false;
            ...
            this.Label11.Text = string.Concat("Side1 ", this.ObjPage.GetRegionalSettings(this.CompanyID, "Colour"));
            this.Label1.Text = string.Concat("Side2 ", this.ObjPage.GetRegionalSettings(this.CompanyID, "Colour"));
            ...
            if (!base.IsPostBack)
            {
                ...
                this.txtQuantity.Attributes.Add("onblur", "AllowNumber(this,this.value);");
                ...
                this.ddlSide1Color.SelectedIndex = this.inkcount;
                this.ddlSide2Color.SelectedIndex = this.inkcount;
                for (int i = 0; i <= 24; i++)
                {
                ...
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    litho_single_item usercontrolItemLithoSingleItem = this;
                    object obj1 = usercontrolItemLithoSingleItem.dpaperhw;
                    ...
                    usercontrolItemLithoSingleItem.dpaperhw = string.Concat(num);
                }
            ...
            {
                this.select_litho_item(this.ParentEstimateItemID, this.ParentEstimateType);
                if (!base.IsPostBack)
                {
            ...
            if (!base.IsPostBack)
            {
                ...
                {
                    foreach (DataRow dataRow1 in EstimatesBasePage.estimate_select_summary(this.CompanyID, this.EstimateID).Rows)
                    {
                        this.txtItemTitle.Text = this.objBase.SpecialDecode(dataRow1["EstimateTitle"].ToString());
                    }
                }
                else if (base.Request.Params["type"] != null && base.Request.Params["type"].ToString().ToLower() == "edit")
                {
                    foreach (DataRow row2 in EstimatesBasePage.litho_estimate_select(this.CompanyID, this.EstimateItemID).Rows)
                    {
                        this.txtItemTitle.Text = this.objBase.SpecialDecode(row2["ItemTitle"].ToString());
                    }
                }
                if (base.Request.Params["FromAddAnItem"] != null)
                {
            ...
            foreach (DataRow dataRow2 in EstimatesBasePage.selectEstimatetype_estimateitemid(this.EstimateItemID, this.EstimateID).Rows)
            {
                this.IsItemCompleted = Convert.ToInt16(dataRow2["IsItemCompleted"].ToString());
                this.IsProductCreated = Convert.ToInt16(dataRow2["IsProductCreated"].ToString());
            }
            ...
            if (string.Compare(this.QueryType, "add", true) == 0 && this.ParentEstimateItemID > (long)0 && !base.IsPostBack)
            {
                ...
                foreach (DataRow row3 in quantityForItems.Rows)
                {
                    this.txtQuantity.Text = row3["Quantity1"].ToString();
                    this.txtQuantity_2.Text = row3["Quantity2"].ToString();
                    this.txtRunOnQty.Text = row3["Quantity2"].ToString();
                    this.txtQuantity_3.Text = row3["Quantity3"].ToString();
                    this.txtQuantity_4.Text = row3["Quantity4"].ToString();
                }
            }
        ...
        private void select_litho_item(long ParentItemID, string ParentItemType)
        {
            bool flag = false;
            bool flag1 = false;
            if (!base.IsPostBack)
            ...
            DataTable dataTable1 = EstimatesBasePage.litho_estimate_select(this.CompanyID, this.EstimateItemID);
            StringBuilder stringBuilder = new StringBuilder();
            foreach (DataRow dataRow in dataTable1.Rows)
            {
                EstimatesItem estitem = this.Estitem;
                long num4 = Convert.ToInt64(dataRow["EstLithoItemID"]);
                long num5 = num4;
                estitem.EstLithoItemID = num4;
                this.EstLithoID = num5;
                ...
                if (!base.IsPostBack)
                {
                    ...
                    this.hdnNonHeight.Value = this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, Convert.ToDecimal(dataRow["PrintImageHeight"].ToString()), 0, "", false, false, false);
                    this.hdnNonWidth.Value = this.commclass.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, Convert.ToDecimal(dataRow["PrintImageWidth"].ToString()), 0, "", false, false, false);
                    ...
                    {
                        this.PrintLayoutSelected = dataRow["PrintLayout"].ToString();
        ...
        private void Update_Single_Item()
        {
            ...
            if (this.EstimateItemID != (long)0 && this.EstLithoID != (long)0)
            {
            ...
            if (this.EstimateItemID != (long)0 && this.EstLithoID != (long)0)
            {
                ...
                {
                    EstimateCommonMethods.UpdateDescription(this.EstimateItemID, this.EstimateID, "F", true);
                }
                if (this.IsProductCreated == 1)
                {
                    int num1 = 0;
                    ...
                    DataTable dataTable1 = EstimatesBasePage.select_Converted_Prodect(this.CompanyID, this.EstimateItemID, "F");
                    if (dataTable1.Rows.Count > 0)
                    {
                        dataTable1.Rows[0]["PricecatalogueID"].ToString();
                        if (num1 == 1 || num1 == 2)
                        {
                            EstimateCommonMethods.insert_UpdatePriceCatalogueQty(Convert.ToInt64(dataTable1.Rows[0]["PricecatalogueID"].ToString()), this.EstimateID, this.EstimateItemID, "F", num1);
                        }
                    }
                }
                ...
                if (string.Compare(this.modulename, "invoice", true) == 0 || string.Compare(this.modulename, "jobs", true) == 0)
                {
                    ...
                    EstimateCommonMethods.ShowJobCardDetails(this.CompanyID, this.EstimateID, this.EstimateItemID, "F");
            ...
            if (this.ParentEstimateItemID == (long)0)
            {
                EstimateCommonMethods.PCR_FormulaTags_Replace(this.EstimateItemID, "F");
            }
            string str = string.Empty;
            if (this.modulename == "invoice")
            {
