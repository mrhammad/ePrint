...
{
    public partial class DigitalNCR_item : UsercontrolBasePage
    {
        ...
        static DigitalNCR_item()
        {
            DigitalNCR_item.GetButtonNo = string.Empty;
            DigitalNCR_item.querystring = string.Empty;
            DigitalNCR_item.checkmore = "no";
            DigitalNCR_item.Partsperset = "2";
        }

        public DigitalNCR_item()
        {
        }

        protected void Bind_Press(DropDownList ddl, int sqlParameter1, string defaultValue)
        {
            DataTable dataTable = EstimatesBasePage.estimate_Digital_press_select(sqlParameter1);
        ...
        protected void btnPrevious_OnClick(object sender, EventArgs e)
        {
            ...
            if (this.QueryType == "add")
            {
                if (this.modulename != "orders")
                {
                    ...
                    if (this.ParentEstimateItemID == (long)0)
                    {
                        ...
                        object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_add.aspx?type=Edit&prev=y&estid=", this.EstimateID, "&esttype=R&From=F&maintype=", this.MainType, this.jID, this.InvID };
            ...
            else if (this.QueryType == "edit")
            {
                if (this.modulename != "orders")
                {
                    ...
                    object[] objArray5 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_add.aspx?type=Edit&prev=y&estid=", this.EstimateID, "&esttype=R&From=S&EstItemID=", this.EstimateItemID, "&maintype=", this.MainType, this.jID, this.InvID };
        ...
        private void Click_Add(long ParentItemID, string ParentItemType)
        {
            ...
            for (int i = 0; i < num6; i++)
            {
                if (!string.IsNullOrEmpty(strArrays[i]))
                {
                    ...
                    {
                        this.side2color = estimatesItem.NCRSide2color;
                    }
                    this.Popup_inkvalue_insert(num, "", this.PressID, estimatesItem.NCRNoofsidesprinted, empty, this.estlithoncritemid, this.partcount, estimatesItem.NCRSide1color, this.side2color, "add");
                    estimatesItem.GuillotineID = Convert.ToInt64(this.hid_GuillotineID.Value);
                    estimatesItem.PressType = 'C';
                ...
                DigitalNCR_item usercontrolItemNCRItem = this;
            ...
            {
                EstimateCommonMethods.UpdateDescription(num, this.EstimateID, "R", false);
                if (EstimatesBasePage.OtherCostSequence_GetCountBy_EstimatType(this.CompanyID, "R") > (long)0)
                {
                    foreach (DataRow dataRow1 in EstimatesBasePage.digitalncr_item_select(this.CompanyID, num).Rows)
                    {
                        this.EstLithoNCRItemID = Convert.ToInt64(dataRow1["EstimateLithoNcrItemID"]);
                    }
                    HttpResponse response = base.Response;
                    object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_Othercost.aspx?isFromOtherCostSeq=1&type=add&estid=", this.EstimateID, "&parentestitemid=", num, "&booksecid=", this.EstLithoNCRItemID, " &parentesttype=R&maintype=edit&subitem=s", this.jID, this.InvID };
                    response.Redirect(string.Concat(estimateID));
                }
        ...
        protected void ddlPress_OnChange(object sender, EventArgs e)
        {
            if (string.Compare(this.QueryType, "edit", true) == 0)
            {
                ...
                Convert.ToInt32(this.ddlColors.SelectedValue);
                Convert.ToInt32(this.ddlColors_2.SelectedValue);
        ...
        private string Estimate_Calcukation(long EstimateItemID, long EstimateLithoNCRItemID, long PaperID, long PressID, char PressType, long GuillotineID, string EstimateType, string SidesPerprinted, bool worknturn, bool workntumble, string side1color, string side2color, int PlateID)
        {
            StringBuilder stringBuilder = new StringBuilder();
            ...
            foreach (DataRow row in EstimatesBasePage.Estimate_Digital_Press_Select_byPressID(this.CompanyID, PressID).Rows)
            {
        ...
        public void getinkvalues(DataRow drv, int Sessioncount1, string side1color, int CompanyID, long EstimateItemID_TempID, long PressID, long LithoTypeID, string EstimateType, int partcount)
        {
            ...
            for (int i = 0; i < (int)strArrays.Length; i++)
            {
                if (strArrays[i] != "")
                {
                    ...
                    if (Convert.ToInt32(side1color) > Sessioncount1)
                    {
                        if (this.QueryType != "add")
                        {
        ...
        public void Getvaluefromsettings(string side, int CompanyID, long EstimateItemID_TempID, long PressID, string side1color, string side2color, long LithoTypeID, string EstimateType, int partcount)
        {
            if (side.ToLower().Trim() == "single")
            {
                ...
                {
                    if (Convert.ToInt32(side1color) > num)
                    {
            ...
            if (side.ToLower().Trim() == "double")
            {
                ...
                {
                    if (Convert.ToInt32(side1color) > num2)
                    {
                ...
                {
                    if (Convert.ToInt32(side2color) > num3)
                    {
        ...
        public void Insert_activity_history(int CompanyID, long ModuleID, long EstimateItemID)
        {
            ...
            string str = "R";
            string str1 = "Sheet Fed Digital Ncr Item";
            string empty1 = string.Empty;
        ...
        public void Main_Quantity_Insert(long EstimateItemID_TempID, string para, int Qty1, int Qty2, int Qty3, int Qty4, long estlithoncritemid, EstimatesItem Estitem, int partcount)
        {
            ...
            for (int i = 1; i <= 4; i++)
            {
                ...
                else
                {
                    numArray[i - 1] = qty1;
                    DataTable dataTable = new DataTable();
                    dataTable = EstimatesBasePage.estimate_digital_ncr_item_select(this.CompanyID, EstimateItemID_TempID);
                    ...
                    numArray8[i - 1] = calculation.GuillotineCalculation(this.CompanyID, str, qty1, num2[i - 1], dataRow, numArray6[i - 1], ref num9[i - 1], ref numArray9[i - 1], ref num10[i - 1], ref numArray10[i - 1], ref num11[i - 1], ref numArray11[i - 1], num24, ref numArray23[i - 1]);
            ...
            EstimatesBasePage.quantity_insert_digital_item(this.CompanyID, EstimateItemID_TempID, str, numArray[0], num6[0], numArray6[0], numArray4[0], num5[0], num7[0], numArray7[0], num10[0], numArray10[0], num11[0], numArray11[0], num9[0], numArray9[0], numArray12[0], num13[0], numArray14[0], numArray15[0], numArray17[0], numArray18[0], numArray20[0], numArray21[0], numArray[1], num6[1], numArray6[1], numArray4[1], num5[1], num7[1], numArray7[1], num10[1], numArray10[1], num11[1], numArray11[1], num9[1], numArray9[1], numArray12[1], num13[1], numArray14[1], numArray15[1], numArray17[1], numArray18[1], numArray20[1], numArray21[1], numArray[2], num6[2], numArray6[2], numArray4[2], num5[2], num7[2], numArray7[2], num10[2], numArray10[2], num11[2], numArray11[2], num9[2], numArray9[2], numArray12[2], num13[2], numArray14[2], numArray15[2], numArray17[2], numArray18[2], numArray20[2], numArray21[2], numArray[3], num6[3], numArray6[3], numArray4[3], num5[3], num7[3], numArray7[3], num10[3], numArray10[3], num11[3], numArray11[3], num9[3], numArray9[3], numArray12[3], num13[3], numArray14[3], numArray15[3], numArray17[3], numArray18[3], numArray20[3], numArray21[3], para, estlithoncritemid, num14[0], num14[1], num14[2], num14[3], num15[0], num15[1], num15[2], num15[3], num16[0], num16[1], num16[2], num16[3], num17[0], num17[1], num17[2], num17[3], num18[0], num18[1], num18[2], num18[3], num19[0], num19[1], num19[2], num19[3], num20[0], num20[1], num20[2], num20[3], num21[0], num21[1], num21[2], num21[3], num23[0], num23[1], num23[2], num23[3], numArray23[0], numArray23[1], numArray23[2], numArray23[3], num22[0], num22[1], num22[2], num22[3], numArray22[0], numArray22[1], numArray22[2], numArray22[3]);
            //EstimatesBasePage.quantity_insert_offset_item(this.CompanyID, EstimateItemID_TempID, numArray[0], num6[0], numArray6[0], numArray4[0], num5[0], num7[0], numArray7[0], num10[0], numArray10[0], num11[0], numArray11[0], num9[0], numArray9[0], numArray[1], num6[1], numArray6[1], numArray4[1], num5[1], num7[1], numArray7[1], num10[1], numArray10[1], num11[1], numArray11[1], num9[1], numArray9[1], numArray[2], num6[2], numArray6[2], numArray4[2], num5[2], num7[2], numArray7[2], num10[2], numArray10[2], num11[2], numArray11[2], num9[2], numArray9[2], numArray[3], num6[3], numArray6[3], numArray4[3], num5[3], num7[3], numArray7[3], num10[3], numArray10[3], num11[3], numArray11[3], num9[3], numArray9[3], para, estlithoncritemid, num14[0], num14[1], num14[2], num14[3], num15[0], num15[1], num15[2], num15[3], num16[0], num16[1], num16[2], num16[3], num17[0], num17[1], num17[2], num17[3], num18[0], num18[1], num18[2], num18[3], num19[0], num19[1], num19[2], num19[3], num20[0], num20[1], num20[2], num20[3], num21[0], num21[1], num21[2], num21[3],          num23[0], num23[1], num23[2], num23[3], numArray23[0], numArray23[1], numArray23[2], numArray23[3]);
            //EstimatesBasePage.quantity_insert_new(this.CompanyID, EstimateItemID_TempID, numArray[0], num6[0], numArray6[0], numArray4[0], num5[0], num7[0], numArray7[0], num10[0], numArray10[0], num11[0], numArray11[0], num9[0], numArray9[0], numArray[1], num6[1], numArray6[1], numArray4[1], num5[1], num7[1], numArray7[1], num10[1], numArray10[1], num11[1], numArray11[1], num9[1], numArray9[1], numArray[2], num6[2], numArray6[2], numArray4[2], num5[2], num7[2], numArray7[2], num10[2], numArray10[2], num11[2], numArray11[2], num9[2], numArray9[2], numArray[3], num6[3], numArray6[3], numArray4[3], num5[3], num7[3], numArray7[3], num10[3], numArray10[3], num11[3], numArray11[3], num9[3], numArray9[3], para, estlithoncritemid, num14[0], num14[1], num14[2], num14[3], num15[0], num15[1], num15[2], num15[3], num16[0], num16[1], num16[2], num16[3], num17[0], num17[1], num17[2], num17[3], num18[0], num18[1], num18[2], num18[3], num19[0], num19[1], num19[2], num19[3], num20[0], num20[1], num20[2], num20[3], num21[0], num21[1], num21[2], num21[3], num22[0], num22[1], num22[2], num22[3], 0,0,0,0, num23[0], num23[1], num23[2], num23[3], numArray23[0], numArray23[1], numArray23[2], numArray23[3],0,0,0,0,0,0,0,0 );
        ...
        protected void onclick_lnkNewSection(object sender, EventArgs e)
        {
            ...
            decimal num = Convert.ToDecimal(DigitalNCR_item.Partsperset);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!base.IsPostBack)
            {
                ...
                DataSet dataSet = EstimatesBasePage.estimate_for_Digital_add_all(this.CompanyID);
                ...
                if (dataSet.Tables[1] != null && dataSet.Tables[1].Rows.Count > 0)
                {
                    ...
                    //this.hid_DigitalPress.Value = dataSet.Tables[1].Rows[0][0].ToString();
                ...
                if (string.Compare(this.QueryType, "add", true) == 0)
                {
                    ...
                    DigitalNCR_item.querystring = "add";
                }
            }
            if (string.Compare(this.QueryType, "edit", true) == 0)
            {
                ...
                DigitalNCR_item.querystring = "edit";
                if (!base.IsPostBack)
                {
        ...
        public void Popup_inkvalue_insert(long EstimateItemID_TempID, string para, long PressID, string side, string EstimateType, long LithoTypeID, int partcount, string side1color, string side2color, string querytype)
        {
            if (base.Session["dtinks"] == null)
            {
        ...
        private void select_litho_item()
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                {
                    DigitalNCR_item.GetButtonNo = row["NcrPartsPerSet"].ToString();
                    DigitalNCR_item.Partsperset = row["NcrPartsPerSet"].ToString();
                }
                else
                {
                    DigitalNCR_item.GetButtonNo = "1";
                    DigitalNCR_item.Partsperset = "1";
                }
                this.Pnleditmorequantity.Visible = true;
                ...
                stringBuilder.AppendFormat("PartsPerSet»{0}±", DigitalNCR_item.Partsperset);
        ...
        private void Update_Single_Item()
        {
            ...
            if (Convert.ToDecimal(this.hidpartsperset.Value) < Convert.ToDecimal(DigitalNCR_item.Partsperset))
            {
                decimal num = Convert.ToDecimal(DigitalNCR_item.Partsperset) - Convert.ToDecimal(this.hidpartsperset.Value);
            ...
            for (int i = 0; i < (int)strArrays.Length - 1; i++)
            {
                if (!string.IsNullOrEmpty(strArrays[i]))
                {
                    ...
                    //{
                    //  this.Popup_inkvalue_insert(this.EstimateItemID, "", this.PressID, estimatesItem.NCRNoofsidesprinted, this.EstType, (long)estimatesItem.EstimateLithoNCRItemID, this.partcount, estimatesItem.NCRSide1color, this.side2color, "update");
                    //}
                    //else
                    //{
                    //  this.Popup_inkvalue_insert(this.EstimateItemID, "", this.PressID, estimatesItem.NCRNoofsidesprinted, this.EstType, this.estlithoncritemid, this.partcount, estimatesItem.NCRSide1color, this.side2color, "update");
                    //}
                    if (estimatesItem.EstimateLithoNCRItemID == 0)
                    {
                        estimatesItem.GuillotineID = Convert.ToInt64(this.hid_GuillotineID.Value);
