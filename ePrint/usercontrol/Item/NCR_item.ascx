<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NCR_item.ascx.cs" Inherits="ePrint.usercontrol.Item.NCR_item" %>
        ...
        <div style="float: left; width: 50%; border: solid 0px red;">
            ...
            <div id="div_only_digitals_left" align="left">
                ...
                <div align="left">
                    <div class="bglabelnewLarge">
                        <div style="float: left">
                            <asp:Label ID="Label11" runat="server" Text="Side1 Colour" CssClass="normaltext"></asp:Label>
                        </div>
                        <div style="float: right">
                    ...
                    <div class="ddlsetting" style="width: 169px; border: 0px solid">
                        <div align="left">
                            ...
                            <div style="float: left; margin-left: -2px;">
                                ...
                                <asp:DropDownList ID="ddlColors" runat="server" Width="75px" SkinID="onlyDDL" Style="display: none;">
                                </asp:DropDownList>
                            </div>
                        </div>
                    ...
                    <div style="float: left; padding-top: 3px; display: none;">
                        &nbsp;<asp:CheckBox ID="chkDoubleSided" onclick="show_work(this.checked);" Text="Double Sided"
                            runat="server" />
                        <script>
...
<script type="text/javascript" language="javascript" src="<%=strSitepath %>js/Item/item_ncr.js?VN='<%=VersionNumber%>'"></script>
<script type="text/javascript">
...
<script>
    ...
    function success(result) {
        ...
        LoadCalculations("ctl00_ContentPlaceHolder1_UCNCRItem_ddlPress");



        __doPostBack('ctl00$ContentPlaceHolder1$UCNCRItem$lnk_ddlPress_OnChange', '');
    }
...
<script type="text/javascript" language="javascript">
    ...
    function called_reducestock(val) {
        ...
        document.getElementById('div_AlertPopup').style.display = "none"
        document.getElementById('divBackGroundNew').style.display = "none";
        __doPostBack('ctl00$ContentPlaceHolder1$UCNCRItem$btnSave', '');
    }
</script>
