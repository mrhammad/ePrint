<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GoogleMapForASPNet.ascx.cs" Inherits="ePrint.GoogleMapForASPNet" %>
...
<div id="GoogleMap_Div_Container" style="margin-left: 15px; margin-bottom: 30px;">
...
<div id="directions_canvas" style="display: none;">
</div>
