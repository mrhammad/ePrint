...
{
    public partial class internal_delivery_alert_email : BaseClass, IRequiresSessionState
    {
        ...
        static internal_delivery_alert_email()
        {
        }

        public internal_delivery_alert_email()
        {
        }

        public void BindSignature()
        {
            system_autojobalert_email.CompanyID = Convert.ToInt32(this.Session["companyid"].ToString());
            commonClass _commonClass = new commonClass();
            SqlCommand sqlCommand = new SqlCommand("PC_settings_emailsignature_title_select", _commonClass.openConnection())
            {
                CommandType = CommandType.StoredProcedure
            };
            sqlCommand.Parameters.AddWithValue("@CompanyID", system_autojobalert_email.CompanyID);
            ...
            foreach (DataRow row in dataSet.Tables[0].Rows)
            {
                ...
                {
                    system_autojobalert_email.ddlSelectedValue = 0;
                }
                else
                {
                    this.objBass.SetDDLValue(this.ddlSignature, row["EmailFooterID"].ToString());
                    system_autojobalert_email.ddlSelectedValue = Convert.ToInt16(row["EmailFooterID"]);
                    break;
                }
            }
        }
        ...
        {
            DataTable dataTable = this.JobStatusBindTable();
        ...
        {
            base.Response.Redirect("~/Settings/internal_delivery_alert_email.aspx");
        }
        ...
        protected void btnDelete_OnClick(object sender, EventArgs e)
        {
            ...
            foreach (GridDataItem item in this.grdAutoJobAlert.MasterTableView.Items)
            {
                ...
                SettingsBasePage.autojobalert_delete(system_autojobalert_email.CompanyID, num);
            }
            this.GetAutoalertdetails();
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            {
                int num = 0;
                SettingsBasePage.system_auto_internal_alert(system_autojobalert_email.CompanyID, system_autojobalert_email.UserID, Convert.ToInt32(this.ddlStatus.SelectedValue), this.txtSubject.Text, this.RadEditor1.Content.ToString(), Convert.ToInt32(this.ddlSignature.SelectedValue), Convert.ToInt32(this.chkEnabled.Checked), base.SpecialEncode(this.txt_cc.Text), base.SpecialEncode(this.txt_bcc.Text), base.SpecialEncode(this.txt_EmailTo.Text), "InternalDeliveryAlert", Convert.ToInt32(num.ToString()));
            }
            else
            {
                SettingsBasePage.system_auto_internal_alert(system_autojobalert_email.CompanyID, system_autojobalert_email.UserID, Convert.ToInt32(this.ddlStatus.SelectedValue), this.txtSubject.Text, this.RadEditor1.Content.ToString(), Convert.ToInt32(this.ddlSignature.SelectedValue), Convert.ToInt32(this.chkEnabled.Checked), base.SpecialEncode(this.txt_cc.Text), base.SpecialEncode(this.txt_bcc.Text), base.SpecialEncode(this.txt_EmailTo.Text), "InternalDeliveryAlert", Convert.ToInt32(this.lblemail.Text.ToString()));
            }
            this.GetAutoalertdetails();
            this.BindSignature();
            this.hiddenEmailID.Value = null;
            base.Message_Display(this.objLanguage.GetLanguageConversion("Internal_estimate_alert__Added_Successfully"), "msg-success", this.plhMessage);
            base.Response.Redirect("~/Settings/internal_delivery_alert_email.aspx");
        }

        public void GetAutoalertdetails()
        {
            DataTable dataTable = SettingsBasePage.AutoAlertEmailByTemplate_select(system_autojobalert_email.CompanyID, "InternalDeliveryAlert");
        ...
        protected DataTable JobStatusBindTable()
        {
            return SettingsBasePage.SelectModuleStatus(system_autojobalert_email.CompanyID, "deliverynotes");
        }
        ...
        protected void lnkDelete_onclick(object sender, CommandEventArgs e)
        {
            foreach (GridDataItem item in this.grdAutoJobAlert.MasterTableView.Items)
            {
                SettingsBasePage.autojobalert_delete(system_autojobalert_email.CompanyID, Convert.ToInt32(e.CommandArgument));
            }
            this.GetAutoalertdetails();
            this.grdAutoJobAlert.Rebind();
            base.Message_Display(this.objLanguage.GetLanguageConversion("Email_Body_Deleted_Successfully"), "msg-success", this.plhMessage);
        ...
        public void lnkStatus_onClick(object sender, EventArgs e)
        {
            ...
            DataTable dataTable = SettingsBasePage.system_autojobalert(system_autojobalert_email.CompanyID, Convert.ToInt32(linkButton.CommandArgument.ToString()));
            ...
            this.txt_EmailTo.Text = dataTable.Rows[0]["EmailTo"].ToString();
            this.hiddenEmailID.Value = linkButton.CommandArgument.ToString();
            this.lblemail.Text = linkButton.CommandArgument.ToString();
            DataTable dataTable1 = SettingsBasePage.Auto_Module_Alert_EditSelectStatus(system_autojobalert_email.CompanyID, Convert.ToInt32(dataTable.Rows[0]["StatusID"].ToString()), "deliverynotes");
            this.ddlStatus.DataTextField = "StatusTitle";
            this.ddlStatus.DataValueField = "StatusID";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            system_autojobalert_email.CompanyID = Convert.ToInt32(this.Session["companyid"].ToString());
            system_autojobalert_email.UserID = Convert.ToInt32(this.Session["userid"].ToString());
            ...
            base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;>&nbsp;", this.objLanguage.GetLanguageConversion("Email"), "&nbsp;>>&nbsp;", this.objLangauge.GetLanguageConversion("Internal_Delivery_Alert_Email")));
            base.Title = this.objLanguage.convert(global.pageTitle("Internal Delivery Alert Email", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
            this.header_mis.SettingName = this.objLangauge.GetLanguageConversion("Internal_Delivery_Alert_Email");
