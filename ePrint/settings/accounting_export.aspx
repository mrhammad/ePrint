<%@ page title="" language="C#" masterpagefile="~/Templates/settingpage.master" autoeventwireup="true" CodeBehind="accounting_export.aspx.cs" Inherits="ePrint.settings.accounting_export" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="t">
                    <div class="divpadding">
                        <div align="left" nowrap="nowrap">
                            <span class="navigatorpanel" style="padding-left: 10px">Accounting Export </span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="">
        <div id="">
            <iframe id="iframeXeroAPI" scrolling="no" width="100%" height="350" frameborder="0">
                <%--src='<%=xeroapiPath %>'--%>
            </iframe>
        </div>
    </div>
