...
{
    public partial class digital_press_view : BaseClass, IRequiresSessionState
    {
        ...
        protected void btnDelete_OnClick(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(this.hid_Delete_IDs.Value))
            {
                ...
                for (int i = 0; i < (int)strArrays.Length; i++)
                {
                    if (strArrays[i] != "")
                    {
                        SettingsBasePage.settings_digitalpress_delete(this.CompanyID, Convert.ToInt64(strArrays[i]));
                    }
                }
            }
            this.GridBind(this.CompanyID, this.PageSize, 1, "DigitalPressName", "asc", "");
            base.Message_Display(this.objlang.GetLanguageConversion("Digital_Press_Deleted_Successfully"), "msg-success", this.plhMessage);
        }
        ...
        {
            DataSet dataSet = SettingsBasePage.settings_digital_press_PageText(CompanyID, PageSize, PageNumber, SortBy, SortDirection, WhereCondition);
        ...
        {
            SettingsBasePage.DigitalPress_New_Copy(Convert.ToInt64(e.CommandArgument.ToString()));
            this.GridBind(this.CompanyID, this.PageSize, 1, "DigitalPressName", "asc", "");
            this.RadGrid1.Rebind();
            base.Message_Display(this.objlang.GetLanguageConversion("Digital_Press_Copied_Successfully"), "msg-success", this.plhMessage);
        }

        protected void imgDelete_OnCommand(object sender, CommandEventArgs e)
        {
            SettingsBasePage.settings_digitalpress_delete(this.CompanyID, Convert.ToInt64(e.CommandArgument.ToString()));
            this.GridBind(this.CompanyID, this.PageSize, 1, "DigitalPressName", "asc", "");
            this.RadGrid1.Rebind();
            base.Message_Display(this.objlang.GetLanguageConversion("Digital_Press_Deleted_Successfully"), "msg-success", this.plhMessage);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;>&nbsp;", this.objLanguage.GetLanguageConversion("Plant_Presses_Digital_Press_View")));
            base.Title = this.objLanguage.convert(global.pageTitle("Digital Press View", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
            this.header_mis.SettingName = this.objLanguage.GetLanguageConversion("Digital_Press_View");
            ...
            if (!base.IsPostBack && base.Request.Params["suc"] != null)
            {
                ...
                {
                    base.Message_Display(this.objLanguage.GetLanguageConversion("Digital_Press_Saved_Successfully"), "msg-success", this.plhMessage);
                }
                else if (base.Request.Params["suc"].ToString().ToLower() == "up")
                {
                    base.Message_Display(this.objLanguage.GetLanguageConversion("Digital_Press_Updated_Successfully"), "msg-success", this.plhMessage);
                }
                else if (base.Request.Params["suc"].ToString().ToLower() == "de")
                {
                    base.Message_Display(this.objLanguage.GetLanguageConversion("Digital_Press_Deleted_Successfully"), "msg-success", this.plhMessage);
                }
            }
        ...
        protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
        {
            try
            {
                ...
                if (e.Item.ItemType == GridItemType.AlternatingItem || e.Item.ItemType == GridItemType.Item)
                {
                    ...
                    Label label = (Label)e.Item.FindControl("lblGuillotineName");
                    Label text = (Label)e.Item.FindControl("Label3");
                    HtmlAnchor htmlAnchor = (HtmlAnchor)e.Item.FindControl("PressName");
                    HtmlAnchor htmlAnchor1 = (HtmlAnchor)e.Item.FindControl("Description");
        ...
        {
            SettingsBasePage.settings_digital_press_SetDefault(this.CompanyID, Convert.ToInt32(e.CommandArgument));
            this.objBase.Message_Display(this.objlang.GetLanguageConversion("Default_press_set_successfully"), "msg-success", this.plhMessage);
            this.GridBind(this.CompanyID, this.PageSize, 1, "DigitalPressName", "asc", "");
        }
    }
}