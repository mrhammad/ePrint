<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="system_autodeliveryalert_email.aspx.cs" Inherits="ePrint.settings.system_autodeliveryalert_email" MasterPageFile="~/Templates/settingpage.master" %>
                                            ...
                                            <ContentTemplate>
                                                <div id="div1" class="mis_header_panel" style="margin-top: -8px;">
                                                    <telerik:RadGrid ID="grdAutoJobAlert" AutoGenerateColumns="false" runat="server"
                                                        ...
                                                        Width="60%" PagerStyle-AlwaysVisible="true" HeaderStyle-Font-Bold="true" OnItemDataBound="gridautojobalert_OnItemDataBound">
                                                        <%--OnItemDataBound="grdaurojobalert_OnItemDataBound">--%>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <center>
                                                                            <asp:ImageButton ID="ImgButtonErase" ImageUrl="~/Images/erase.png" CommandName="Delete"
                                                                                ...
                                                                                OnCommand="lnkDelete_onclick" ToolTip="Delete" runat="server" OnClientClick="javascript:return ImgButtonErase_ClientClick('ctl00_ContentPlaceHolder1_grdAutoJobAlert',this.id)"></asp:ImageButton></center>
                                                                    </ItemTemplate>
                                                                </telerik:GridTemplateColumn>
                                                            </Columns>
                                                    ...
                                                    <div id="tdemailaddnew" class="autotable">
                                                        <div align="left">
                                                            ...
                                                            <div class="box statusddl">
                                                                ...
                                                                <span id="spn_ddlStatus" class="RFV_Message autoccerrormsg" style="width: auto; padding-left: 4px; padding-right: 4px; margin-top: -20px; margin-left: 185px;"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2">
                                                                            ...
                                                                            <span id="Spn_ErrMsgCC1" class="RFV_Message autoccerrormsg" style="width: auto; padding-left: 4px; padding-right: 4px;"></span>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="autojobccbcc autocc margintop2px">
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2">
                                                                                <span id="Spn_ErrMsgBCC1" class="RFV_Message autoccerrormsg" style="width: auto; padding-left: 4px; padding-right: 4px;"></span><span id="SpnChkErr1" class="RFV_Message autoccerrormsg"></span>
                                                    ...
                                                    <table class="tablerowcolor2 autocustomewidth" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr valign="top" height="23" id="trheaderJob" runat="server">
                                                                ...
                                                                <td class="bgcustomize navigatorpanel custometd">&nbsp;Tag Name
                                                                </td>
                                                                <td class="bgcustomize navigatorpanel statusddl">&nbsp;Description
                                                                </td>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Estimate Number
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Job Number
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Job Title
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;First Name of Customer's Contact
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Last Name of Customer's Contact
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Full Name of Customer's Contact
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Email of Customer's Contact
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Customer Name
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Supplier Name
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;First Name of Supplier's Contact
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Middle Name of Supplier's Contact
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Last Name of Supplier's Contact
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Full Name Supplier's Contact
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Job Delivery Date
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Job Completion Date
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Job Order Number
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Sales Person
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Email of Sales Person
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Job Header
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Job Footer
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Job Value
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative show_hide" valign="middle">
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                                <td class="custometd" nowrap="nowrap">
                                                                                    <input type='text' name="PDFPath" size="30" value='[$PDFPath$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td class="custometdflow">&nbsp;The Path of the PDF File
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows show_hide" valign="middle">
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                                <td class="custometd" nowrap="nowrap">
                                                                                    <input type='text' name="EmailFooter" size="30" value='[$EmailFooter$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td class="custometdflow">&nbsp;The name of the person who is logged in
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Delivery Note Consignee URL
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometdflow">&nbsp;Delivery Note Consignment Note Number
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td class="custometd" nowrap="nowrap">
                                                                                    <input type='text' name="EmailFooter" size="30" value='[$ConsigneeURLWithConsignmentNoteNumber$]'
                                                                                        onclick="this.select();" />
                                                                                </td>
                                                                                <td class="custometdflow">&nbsp;ConsigneeURL With Consignment Note Number
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle" id="trItemNumber" runat="server">
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                                <td class="custometd" nowrap="nowrap">
                                                                                    <input type='text' name="EmailFooter" size="30" value='[$ItemNumber$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td class="custometdflow">&nbsp;Item Number
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle" id="trItemTitle" runat="server">
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                                <td class="custometd" nowrap="nowrap">
                                                                                    <input type='text' name="EmailFooter" size="30" value='[$ItemTitle$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td class="custometdflow">&nbsp;Item Title
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle" id="trItemValueIncTax" runat="server">
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                                <td class="custometd" nowrap="nowrap">
                                                                                    <input type='text' name="EmailFooter" size="30" value='[$ItemValueIncTax$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td class="custometdflow">&nbsp;Item Value Inc Tax
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle" id="trOrderNumber" runat="server">
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                                <td class="custometd" nowrap="nowrap">
                                                                                    <input type='text' name="OrderNumber" size="30" value='[$OrderNumber$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td class="custometdflow">&nbsp;Order Number
                                                                                </td>
                                                                                <td class="custometd1">&nbsp;
                                                                                </td>
                                                                            </tr>
    ...
    <script type="text/javascript">
        function Validating() {
            ...
            if (txt_cc.value == '' && txt_bcc.value == '' && ddlStatus.value == 0) {
                //                Spn_ErrMsgCC1.innerHTML = "Please enter email address"; //Commented due to this ticket id : 13330
                //                Spn_ErrMsgCC1.style.display = "block";
                //                Spn_ErrMsgBCC1.innerHTML = "Please enter email address";
                //                Spn_ErrMsgBCC1.style.display = "block";
                spn_ddlStatus.innerHTML = "Please select status";
                spn_ddlStatus.style.display = "block";
                return false;
            }
            //            else if (txt_cc.value == '') {    //Commented due to this ticket id : 13330
            //                Spn_ErrMsgCC1.innerHTML = "Please enter email address";
            //                Spn_ErrMsgCC1.style.display = "block";
            //                return false;
            //            }
            //            else if (txt_bcc.value == '') {
            //                Spn_ErrMsgBCC1.innerHTML = "Please enter email address";
            //                Spn_ErrMsgBCC1.style.display = "block";
            //                return false;
            //            }
