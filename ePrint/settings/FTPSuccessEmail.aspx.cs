...
{
    public partial class FTPSuccessEmail : BaseClass, IRequiresSessionState
    {
        ...
        {
            base.Response.Redirect("~/Settings/FTPSuccessEmail.aspx");
        }
        ...
        public void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            base.Response.Redirect("~/settings/FTPSuccessEmail.aspx?action=edit");
        }
        ...
        public void EmailBodyGridBind()
        {
            ...
            sqlCommand.Parameters.AddWithValue("@CompanyID", this.CompanyID);
            sqlCommand.Parameters.AddWithValue("@Type", "FTP Success Emails");
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(sqlCommand);
            DataSet dataSet = new DataSet();
            sqlDataAdapter.Fill(dataSet);
            _commonClass.closeConnection();
        ...
        protected void imgbtnCopy_OnCommand(object sender, CommandEventArgs e)
        {
            ...
            object[] objArray = new object[] { this.strSitepath, "Settings/FTPSuccessEmail.aspx?type=mb", num, "&cop=yes" };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.spnTempName.InnerText = this.objLanguage.GetLanguageConversion("Success_Template_Name");
