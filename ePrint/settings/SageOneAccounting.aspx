<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/settingpage.master" AutoEventWireup="true" CodeBehind="SageOneAccounting.aspx.cs" Inherits="ePrint.settings.SageOneAccounting" EnableViewStateMac="false" EnableEventValidation="false" Theme="Theme1" %>
                                    ...
                                    <td style="vertical-align: top;">
                                        <div style="float: left; padding-left: 4px;">
                                            <asp:Button ID="Btn_PurchaseExport" runat="server" CssClass="button" Text="Export"
                                                OnClick="Btn_PurchaseExport_Click" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
...
<%=objLanguage.GetLanguageConversion("MYOB_Accounting_Note")%></asp:Label>
                    </div>
                    <div class="only5px">
                    </div>
                    <div style="clear: both;">
