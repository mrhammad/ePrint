<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/settingpage.Master" AutoEventWireup="true" CodeBehind="StripeRedirect.aspx.cs" Inherits="ePrint.settings.StripeRedirect" %>
    ...
    <div align="left">
            ...
            <div id="content" style="padding-bottom: 10px;" class="estore_settingBox">
                ...
                <div class="mis_header_panel">
                    ...
                    <div style="width: 99%;">
                        <div align="left">
                            <div class="bglabel" style="width: 200px;">
                                <span class="normaltext">URL</span>
                            </div>
                            <div class="DefaultSettingsbox">
                                <asp:TextBox ID="stripeURL" runat="server" CssClass="txtbox" Width="97%"></asp:TextBox>
                     ...
                     <div style="width: 99%;">
                        <div align="left">
                            <div class="bglabel" style="width: 200px;">
                                <span class="normaltext">Thanks Message</span>
                            </div>
                            <div class="DefaultSettingsbox">
                                <asp:TextBox ID="stripeMessage" runat="server" CssClass="txtbox" Width="97%"></asp:TextBox>
                    ...
                    <div style="width: 99%;">
                        <div align="left">
                            <div class="bglabel" style="width: 200px;">
                                <span class="normaltext">Success Page Logo</span>
                            </div>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function displyUpimageName(upimagename) {
                ...
                document.getElementById('<%= lnkUpimagepath.ClientID %>').href = '<%=strSitePath %>' + "DocManagerView.ashx?doctype=stripenew&filename=" + upimagename;
              }
        </script>
</asp:Content>
