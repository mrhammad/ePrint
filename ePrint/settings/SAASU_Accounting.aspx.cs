...
{
public partial class SAASU_Accounting : BaseClass, IRequiresSessionState
    {
        ...
        //    }
        //    string[] secureDocPath2 = new string[] { this.SecureDocPath, this.ServerName, "/", this.Session["CompanyID"].ToString(), "/AccountingExport/Myob/Myob_Customer_", this.DateTimeForFileName.ToString().Replace("/", "-"), ".xls" };
        ...
        protected void btn_InvoiceExport_Click(object sender, EventArgs e)
        {
            ...
            //    Directory.CreateDirectory(string.Concat(strArrays));
            //}
            //string[] secureDocPath1 = new string[] { this.SecureDocPath, this.ServerName, "/", this.Session["CompanyID"].ToString(), "/AccountingExport/SAASU" };
            //if (!Directory.Exists(string.Concat(secureDocPath1)))
            //{
            //    string[] strArrays1 = new string[] { this.SecureDocPath, this.ServerName, "/", this.Session["CompanyID"].ToString(), "/AccountingExport/SAASU" };
            //    Directory.CreateDirectory(string.Concat(strArrays1));
            //}
            ////string[] secureDocPath2 = new string[] { this.SecureDocPath, this.ServerName, "/", this.Session["CompanyID"].ToString(), "/AccountingExport/SAASU/SAASU_Invoice_", this.DateTimeForFileName.ToString().Replace("/", "-"), ".xls" };
            //string[] secureDocPath2 = new string[] { this.SecureDocPath, this.ServerName, "/", this.Session["CompanyID"].ToString(), "/AccountingExport/SAASU/SAASU_Invoice_", this.DateTimeForFileName.ToString().Replace("/", "-"), ".csv" };
            //string str2 = string.Concat(secureDocPath2);
            //Export export = new Export();
            ////export.Save_ExportedDetails_InPath(invoiceeData.Tables[0], Export.ExportFormat.Excel, str2, ",");
            //export.Save_ExportedDetails_InPath(invoiceeData.Tables[0], Export.ExportFormat.CSV, str2, ",");
            //HtmlTextWriter htmlTextWriter = new HtmlTextWriter(new StringWriter());
            ////(new WebExport()).Export_with_XSLT_Web(dataTable, "Invoice.xls");
            //(new WebExport()).Export_with_CSV_Web(dataTable, "Invoice.csv");
        }

        protected void invoicecsvexport()
        {
            string str = "01/01/1900";
            string str1 = "12/31/2100";
            if (this.rdoInvoiceByDateRange.Checked)
        ...
        //        Directory.CreateDirectory(string.Concat(strArrays1));
        //    }
        //    string[] secureDocPath2 = new string[] { this.SecureDocPath, this.ServerName, "/", this.Session["CompanyID"].ToString(), "/AccountingExport/Myob/Myob_Purchase_", this.DateTimeForFileName.ToString().Replace("/", "-"), ".xls" };
        //    string str2 = string.Concat(secureDocPath2);
        //    Export export = new Export();
        ...
        //        Directory.CreateDirectory(string.Concat(strArrays1));
        //    }
        //    string[] secureDocPath2 = new string[] { this.SecureDocPath, this.ServerName, "/", this.Session["CompanyID"].ToString(), "/AccountingExport/Myob/Myob_Supplier_", this.DateTimeForFileName.ToString().Replace("/", "-"), ".xls" };
        //    string str2 = string.Concat(secureDocPath2);
        //    Export export = new Export();
        //    export.Save_ExportedDetails_InPath(customerData.Tables[0], Export.ExportFormat.Excel, str2, ",");
        //    HtmlTextWriter htmlTextWriter = new HtmlTextWriter(new StringWriter());
        ...
        public DataSet GetCustomerData(bool IsExported, string CompanyType, string ValidFromDate, string ValidToDate)
        {
            ...
            return SQL.ExecuteDataset((new commonClass()).strConnection, CommandType.StoredProcedure, "PC_settings_Accounting_export_Contact_Type_myob", sqlParameter);
        }
        ...
        public DataSet GetInvoiceeData(bool IsExported, string ValidFromDate, string ValidToDate, long StatusID)
        {
            ...
            return SQL.ExecuteDataset((new commonClass()).strConnection, CommandType.StoredProcedure, "PC_settings_Accounting_export_Invoice_Type_SAASU", sqlParameter);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;>&nbsp;", this.objLanguage.GetLanguageConversion("SAASU_Accounting")));
            global.pageName = "setting";
            global.pgName = "";
            this.gloobj.setpagename("setting");
            base.Title = this.objLanguage.convert(global.pageTitle("SAASU Accounting", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
            this.DateTimeForFileName = DateTime.Now.ToString("yyyy-MM-d--HH-mm-ss");
            this.header_mis.SettingName = this.objLanguage.GetLanguageConversion("SAASU_Accounting");
