<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/settingpage.Master" AutoEventWireup="true" CodeBehind="FTPFailureEmail.aspx.cs" Inherits="ePrint.settings.FTPFailureEmail" %>
                                        ...
                                        <div id="tdaddnew" align="left" style="width: 100%; display: none;">
                                            ...
                                            <div align="left" style="width: 85%">
                                                <div id="divSupplierRFQ">
                                                    <span class="HeaderText">FTP Failure </span>
                                                    <div class="only5px">
                                                    </div>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="NewAlternative">
                                                                             ...
                                                                             <tr class="NewTableRows">
                                                                                <td></td>
                                                                                <td>
                                                                                    <input type='text' size="30" value='[$TimeStamp$]' readonly="readonly" onclick="this.select();" /></td>
                                                                                <td>&nbsp;Time Stamp</td>
                                                                                <td></td>
                                                                            </tr>
                                                                            <tr class="NewAlternative">
                                                                                <td></td>
                                                                                <td>
                                                                                    <input type='text' size="30" value='[$TargetFTPAddress$]' readonly="readonly" onclick="this.select();" /></td>
                                                                                <td>&nbsp;Target FTP Address</td>
                                                                                <td></td>
                                                                            </tr>
                                                                            <%-- END: FTP Tags --%>
                                                                        </tbody>
