...
{
    public partial class internal_job_alert_email : BaseClass, IRequiresSessionState
    {
        ...
        static internal_job_alert_email()
        {
        }

        public internal_job_alert_email()
        {
        }
        ...
        {
            base.Response.Redirect("~/Settings/internal_job_alert_email.aspx");
        }
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            {
                int num = 0;
                SettingsBasePage.system_auto_internal_alert(system_autojobalert_email.CompanyID, system_autojobalert_email.UserID, Convert.ToInt32(this.ddlStatus.SelectedValue), this.txtSubject.Text, this.RadEditor1.Content.ToString(), Convert.ToInt32(this.ddlSignature.SelectedValue), Convert.ToInt32(this.chkEnabled.Checked), base.SpecialEncode(this.txt_cc.Text), base.SpecialEncode(this.txt_bcc.Text), base.SpecialEncode(this.txt_EmailTo.Text), "InternalJobAlert", Convert.ToInt32(num.ToString()));
            }
            else
            {
                SettingsBasePage.system_auto_internal_alert(system_autojobalert_email.CompanyID, system_autojobalert_email.UserID, Convert.ToInt32(this.ddlStatus.SelectedValue), this.txtSubject.Text, this.RadEditor1.Content.ToString(), Convert.ToInt32(this.ddlSignature.SelectedValue), Convert.ToInt32(this.chkEnabled.Checked), base.SpecialEncode(this.txt_cc.Text), base.SpecialEncode(this.txt_bcc.Text), base.SpecialEncode(this.txt_EmailTo.Text), "InternalJobAlert", Convert.ToInt32(this.lblemail.Text.ToString()));
            }
            this.GetAutoalertdetails();
            this.BindSignature();
        ...
        {
            DataTable dataTable = SettingsBasePage.AutoAlertEmailByTemplate_select(system_autojobalert_email.CompanyID, "InternalJobAlert");
        ...
        {
            return SettingsBasePage.SelectModuleStatus(system_autojobalert_email.CompanyID, "job");
        }
        ...
        public void lnkStatus_onClick(object sender, EventArgs e)
        {
            ...
            DataTable dataTable1 = SettingsBasePage.Auto_Module_Alert_EditSelectStatus(system_autojobalert_email.CompanyID, Convert.ToInt32(dataTable.Rows[0]["StatusID"].ToString()), "job");
            this.ddlStatus.DataTextField = "StatusTitle";
            this.ddlStatus.DataValueField = "StatusID";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;>&nbsp;", this.objLanguage.GetLanguageConversion("Email"), "&nbsp;>>&nbsp;", this.objLangauge.GetLanguageConversion("Internal_job_Alert_Email")));
            base.Title = this.objLanguage.convert(global.pageTitle("Internal Job Alert Email", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
            this.header_mis.SettingName = this.objLangauge.GetLanguageConversion("Internal_Job_Alert_Email");
