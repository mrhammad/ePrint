<%@ page language="C#" masterpagefile="~/Templates/settingpage.master" autoeventwireup="true" CodeBehind="roles_add.aspx.cs" Inherits="ePrint.settings.roles_add" title="Settings: UserRole Add" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:HiddenField ID="hdn_SelectText" runat="server" Value="0" />
    <script type="text/javascript">
        ...
        function SelectAll_None(id, module, count) {
            ...
            var hdn_SelectText = document.getElementById("<%=hdn_SelectText.ClientID%>");
            ...
            hdn_SelectText.value = SelectText;

            if (hdn_SelectText.value == "Select None") {
                if (module == "clients") {
                ...
                document.getElementById(id).innerHTML = '<%=objlang.GetLanguageConversion("Select_All") %>';
                hdn_SelectText.value = "Select All";
            }
            else if (hdn_SelectText.value == "Select All") {
                if (module == "clients") {
                ...
                document.getElementById(id).innerHTML = '<%=objlang.GetLanguageConversion("Select_None") %>';
                hdn_SelectText.value = "Select None";
            }
    }

    function IPFieldsEnable(ID) {
        document.getElementById("ctl00_ContentPlaceHolder1_txtSingleIP").value = "";
        document.getElementById("ctl00_ContentPlaceHolder1_txtMultipleIP").value = "";
        document.getElementById("ctl00_ContentPlaceHolder1_txtFromIP").value = "";
        document.getElementById("ctl00_ContentPlaceHolder1_txtToIP").value = "";
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $(ShowType).click(function () {
                ...
                document.getElementById("ctl00_ContentPlaceHolder1_lstBxType").selectedIndex = 0;
                ...
                <div class="t">
                    <div class="divpadding">
                        <div align="left" style="float: left;" nowrap="nowrap">
                            <asp:Label ID="lblheader" runat="server" CssClass="navigatorpanel"><%=objLanguage.GetLanguageConversion("Settings")%>:&nbsp;<%=objLanguage.GetLanguageConversion("Add_Role")%></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="content" class="estore_settingBox">
        ...
        <div class="mis_header_panel">
                    ...
                    <div align="left">
                        <div align="left" style="border: solid 0px red; width: 100%;">
                            <div align="left">
                                <div class="bglabel" style="float: left; width: 13%;">
                                    <%=objLanguage.GetLanguageConversion("Role_Name")%><span style="color: red">*</span>
                                </div>
                                <div style="float: left; width: 10px">
                                    &nbsp;&nbsp;&nbsp;&nbsp;</div>
                                <div style="float: left;">
                                    <asp:TextBox ID="txtrole" runat="server" MaxLength="100" CssClass="txtBox" Width="175.5px"
                                        SkinID="textPad">
                                    </asp:TextBox>
                                </div>
                                <div style="float: left;">
                                    &nbsp;</div>
                                <asp:RequiredFieldValidator ID="RFVCode" runat="server" ErrorMessage="Please enter Role Name"
                                    CssClass="errorMsg box" ForeColor="" ControlToValidate="txtrole" Display="Dynamic"
                                    Style="width: auto; padding-left: 4px; padding-right: 4px; margin-left: 4px"
                                    SetFocusOnError="true">
                                    <%=objLanguage.GetLanguageConversion("Please_Enter_Role_Name")%></asp:RequiredFieldValidator>
                                <asp:Label ID="lblexist" runat="server" Visible="false" CssClass="error" Width="175px">
                                </asp:Label>
                            </div>
                        </div>
                        <div align="left">
                            ...
                            <div style="float: left;">
                                <asp:TextBox ID="txtDescription" CssClass="txtBox" TextMode="MultiLine" SkinID="textPad"
                                    Width="175.5px" Height="35px" runat="server">
                                </asp:TextBox>
                            </div>
                        </div>
                        <asp:Panel ID="pnlDefaultRoles" runat="server">
                            ...
                            <div align="left" style="display: block">
                                <div class="bglabel" style="float: left; width: 13%;">
                                    <b>
                                        <%=objLanguage.GetLanguageConversion("Privilege_Rights")%></b>
                                </div>
                                <div style="float: left; width: 15px">
                                </div>
                                <span style="padding-left: 10px; padding-top: 4px; float: left"><b>
                                    <%=objLanguage.GetLanguageConversion("Tabs_Available_For_This_Role")%>:</b>
                                </span>
                            </div>
                            <div style="clear: both; padding-top: 2px">
                            </div>
                            <div style="float: left; padding-left: 15%; display: block;">
                            ...
                            <div class="bglabel" style="float: left; width: 13%;">
                                <%=objLanguage.GetLanguageConversion("Special_Privileges")%>
                            </div>
                            ...
                            <div align="left" style="width: 100%;">
                                ...
                                <div style="float: left;">
                                    <div style="float: left;">
                                        <asp:Button ID="btnCancel" runat="server" CssClass="button" Visible="false" Text="Cancel"
                                            Style="padding: 3px 2px 5px;" CausesValidation="false" OnClientClick="javascript:return cancelClick(path+'Settings/user_manager.aspx');" />
                                    </div>
                                    <div style="float: left; width: 10px">
                                        &nbsp;</div>
                                    <div style="float: left">
                                        <div id="div_btnsave" style="display: block">
                                            <asp:Button ID="btnSave" runat="server" CssClass="button" Text="Save" Style="padding: 3px 2px 5px;"
                                                OnClick="btnSave_OnClick" CausesValidation="true" OnClientClick="if(Page_ClientValidate()) {javascript:loadingimage(this.id,'div_btnsaveprocess');} else {return false;}" />
                                        </div>
            ...
            <asp:Panel ID="pnlCustomizeRoles" runat="server">
                <div style="padding: 20px 5px 25px 0px;">
                ...
                <div>
                    <table width="100%" style="margin-top: 15px; padding-left: 3px; padding-right: 3px;">
                        <tr>
                            <td>
                    ...
                    <table cellpadding="2" cellspacing="0" width="1050px">
                        <tr class="Header">
                            <td width="175px" class="Font">
                                <asp:Label ID="lblCPM" runat="server" Text=""><%=objlang.GetLanguageConversion("Cost_Profit_Margin")%></asp:Label>
                            </td>
                            <td width="650px">
                            </td>
                        </tr>
                    ...
                    <table>
                        <tr>
                            ...
                            <td width="650px" style="padding-top: 5px">
                                <asp:Label ID="lblShowCostExMarkup" runat="server" Text=""><%=objlang.GetLanguageConversion("Show_Cost_Ex_Markup_And_Markup")%>
                                </asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td width="10px" align="left" style="display: none;">
                                <asp:CheckBox ID="chkShowMarkup" runat="server" />
                            </td>
                            <td width="650px" style="padding-top: 5px; display: none;">
                                <asp:Label ID="lblShowMarkup" runat="server" Text=""><%=objlang.GetLanguageConversion("Show_Markup")%></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td width="10px" align="left">
                            ...
                            <td width="650px" style="padding-top: 5px">
                                <asp:Label ID="lblShowCostIncMarkup" runat="server" Text=""><%=objlang.GetLanguageConversion("Show_Cost_Inc_Markup")%></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td width="10px" align="left">
                        ...
                        <tr>
                            ...
                            <td width="650px" style="padding-top: 5px">
                                <asp:Label ID="lblShowTax" runat="server" Text=""><%=objlang.GetLanguageConversion("Show_Tax")%></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td width="10px" align="left">
                        ...
                        <tr>
                            ...
                            <td width="650px" style="padding-top: 5px">
                                <asp:Label ID="lblShowGrossProfitMargin" runat="server" Text="Show Gross Profit (%)"><%=objlang.GetLanguageConversion("Show_Gross_Profit")%>
                                </asp:Label>
                            </td>
                        </tr>
                        <tr>
                ...
                <div style="padding: 20px 5px 0px 5px;">
                    <div>
                        <table cellpadding="2" cellspacing="0" width="1050px">
                            <tr class="Header">
                                <td width="175px" class="Font">
                                    <asp:Label ID="lblRecordView" runat="server" Text=""><%=objlang.GetLanguageConversion("Records")%></asp:Label>
                                </td>
                                <td width="650px">
                                </td>
                            </tr>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td colspan="2" style="font-weight: bold;">
                                    <span>
                                        <%=objlang.GetLanguageConversion("For_View")%></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="1%" style="padding-top: 5px">
                                    <asp:RadioButton ID="rdoShowAll" runat="server" Checked="true" GroupName="Show" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td width="90%" style="padding-top: 8px">
                                    <asp:Label ID="Label2" runat="server" Text=""><%=objlang.GetLanguageConversion("Show_as_per_allocation_Sales_Persons")%>
                                    </asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td width="1%" style="padding-top: 5px">
                                    <asp:RadioButton ID="rdoShowType" runat="server" GroupName="Show" />
                                </td>
                                <td width="90%" style="padding-top: 8px">
                                    <asp:Label ID="Label3" runat="server" Text=""><%=objlang.GetLanguageConversion("Show_as_per_allocation_Customer_Type")%>
                                    </asp:Label>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table width="100%">
                            <tr>
                                <td width="90%" style="padding-top: 5px">
                                    <asp:Label ID="lblLock" runat="server" class="bglabel" Style="width: 13%;" Text=""><%=objLanguage.GetLanguageConversion("Lock_User_After")%>
                                    </asp:Label>
                            ...
                            <tr>
                                <td width="90%">
                                    <div class="div_rolesedit_margin">
                                        <asp:Label ID="lblForce" runat="server" class="bglabel" Style="width: 13%;" Text=" "><%=objLanguage.GetLanguageConversion("Force_change_password_after")%>
                                        </asp:Label><%--Text="Force User to change password after "--%>
                                        ...
                                        <div>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td style="width: 80%;">
                                                        <asp:Label ID="Label8" runat="server" Text="Single IP" Style="padding-right: 34px;"><%=objLanguage.GetLanguageConversion("Single_IP")%>
                                                        </asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtSingleIP" runat="server" Enabled="false">
                                                        </asp:TextBox>
                                                        <asp:RegularExpressionValidator ControlToValidate="txtSingleIP" ErrorMessage="Please enter a valid IP Address"
                                                            ...
                                                            runat="server" ID="revSingleIPAddress">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 80%;">
                                                        <asp:Label ID="Label9" runat="server" Text="" Style="padding-right: 26px;"><%=objlang.GetLanguageConversion("Multiple_IP") %>
                                                        </asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtMultipleIP" runat="server" Enabled="false" TextMode="MultiLine"
                                                            Rows="5" Style="width: 200px; font-family: Verdana,Arial,Helvetica; font-size: 11px;">
                                                        </asp:TextBox>
                                                        ...
                                                        <asp:Label runat="server" ID="Label7" Style="font-family: Verdana,Arial,Helvetica;
                                                            font-size: 11px; font-weight: bold; color: Gray;" Text=""><%=objlang.GetLanguageConversion("Please_enter_one_IP_address_per_line")%></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 1%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtFromIP" runat="server" Enabled="false" onkeypress="return Commavalidation(event)">
                                                        </asp:TextBox>
                                                        <asp:Label ID="Label11" runat="server"> <%=objlang.GetLanguageConversion("to")%> </asp:Label>
                                                        <asp:TextBox ID="txtToIP" runat="server" Enabled="false">
                                                        </asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <td width="90%">
                                    <div class="div_rolesedit_margin">
                                        <asp:Label ID="lblRestrict" runat="server" class="bglabel" Style="width: 13%; height: 45px"
                                            Text=""><%=objlang.GetLanguageConversion("In_case_of_unauthorized_access_alert_user_admin")%>
                                        </asp:Label>
                                        <span style="margin-left: 1px;">&nbsp;</span>
                                        <asp:TextBox ID="txtRestrict" TextMode="MultiLine" Width="300px" Height="45px" runat="server"
                                            onblur="javascript:return MultipleEmailAddressesValidation(this.id, 'spnMessage')">
                                        </asp:TextBox>
                                        ...
                                        ForeColor="Red" ControlToValidate="txtRestrict" Display="Dynamic" Width="186px">
                                    </asp:RegularExpressionValidator>--%>
                                        <div style="clear: both">
                                        </div>
                                    </div>
                            ...
                            <tr>
                                <td>
                                    <span id="spnMessage" class="spanerrorMsg" style="width: 200px; display: none; margin-left: 165px">
                    ...
                    <div style="padding: 10px 20px 10px 0px; width: 98%;">
                        <table width="100%">
                            <tr>
                                ...
                                <td align="center">
                                    <div style="float: left; margin-left: 0px; margin-right: 23px;">
                                        <div id="div_btn_SaveRole" style="display: block">
                                            <asp:Button ID="btn_SaveRole" runat="server" CssClass="button" Width="85px" Text="Save"
                                                OnClick="btn_SaveRole_OnClick" CausesValidation="true" Style="float: right; padding: 3px 2px 5px;"
                                                OnClientClick="if(Page_ClientValidate()) {if(MultipleEmailAddressesValidation('ctl00_ContentPlaceHolder1_txtRestrict', 'spnMessage')) {javascript:loadingimg('div_btn_SaveRole','div_SaveRole');} else {return false;}} else {return false;}" />
                                        </div>
                                        <div id="div_SaveRole" class="button" align="center" style="width: 67px; display: none">
                                            <img src="<%=strImagepath %>radimg1.gif" class="trans" alt="loading" border="0" />
                                        </div>
                                    </div>
                                    <asp:Button ID="btn_CancelRole" runat="server" CssClass="button" Width="85px" Text="Cancel"
