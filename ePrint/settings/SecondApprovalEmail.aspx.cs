...
{
    public partial class SecondApprovalEmail : BaseClass, IRequiresSessionState
    {
        ...
        {
            this.CompanyID = Convert.ToInt32(this.Session["companyid"].ToString());
            string returnEmailText = "Second Approval Emails";
            commonClass _commonClass = new commonClass();
        ...
        {
            base.Response.Redirect("~/Settings/SecondApprovalEmail.aspx");
        }
        ...
        public void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            string str = "Second Approval Emails";
            ...
            base.Response.Redirect("~/Settings/SecondApprovalEmail.aspx?action=edit");
        }
        ...
        protected void imgbtnCopy_OnCommand(object sender, CommandEventArgs e)
        {
            ...
            object[] objArray = new object[] { this.strSitepath, "Settings/SecondApprovalEmail.aspx?type=mb", num, "&cop=yes" };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.header_mis.SettingName = this.objLanguage.GetLanguageConversion("Emails_Second_Approval");
