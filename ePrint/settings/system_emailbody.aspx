<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/settingpage.master" AutoEventWireup="true" CodeBehind="system_emailbody.aspx.cs" Inherits="ePrint.settings.system_emailbody" EnableViewStateMac="false" EnableEventValidation="false" Theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        ...
        <telerik:AjaxSetting AjaxControlID="ddlEmailTemplateType">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="ddlstatus" />
            </UpdatedControls>
        </telerik:AjaxSetting>
                                    ...
                                    <div align="left" style="width: 100%;" id="EmaiBody">
                                        ...
                                        <div id="tdaddnew" align="left" style="width: 100%; display: none;">
                                                    ...
                                                    <div id="tdemailaddnew" align="left" style="width: 100%;">
                                                        ...
                                                        <div align="left">
                                                            ...
                                                            <div class="box" style="width: 60%">
                                                                ...
                                                                <span id="spn_specificto" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; margin-left: 4px;">Please select specific
                                                                    type</span>
                                                            </div>
                                                        </div>
                                                        <div class="onlyEmpty">
                                                        ...
                                                        <div id="divTempType" align="left">
                                                            ...
                                                            <div class="box" style="width: 60%">
                                                                <asp:DropDownList ID="ddlEmailTemplateType" runat="server" CssClass="normalText" AutoPostBack="true" 
                                                                    Width="208px" OnSelectedIndexChanged="ddlEmailTemplateType_SelectedIndexChanged"  onchange="Javascript:SelectTemplateType(); ">
                                                                ...
                                                                <span id="spn_ddlEmailTemplateType" class="spanerrorMsg" style="display: none; width: auto; padding-left: 4px; padding-right: 4px; margin-left: 4px;">Please select template
                                                                    type</span>
                                                            </div>
                                                        </div>
                                                        <div class="onlyEmpty">
                                                     ...
                                                     <div align="left">
                                                            <div class="bglabel" style="width: 20%;">
                                                                <asp:Label ID="lblstatus" runat="server">Status on Send</asp:Label>
                                                            </div>
                                                            <div class="box" style="width: 60%">
                                                                <asp:DropDownList ID="ddlstatus" runat="server"  Width="208px" CssClass="normalText">
                                                                </asp:DropDownList>
                                                                <div class="onlyEmpty">
                                                                </div>
                                                                <span id="spn_specificstatusto" class="spanerrorMsg" style="display: none; width: auto;
                                                                    padding-left: 4px; padding-right: 4px; margin-left: 4px;">Please select status</span>
                                                            </div>
                                                        </div>
                                                        <div class="onlyEmpty">
                                                        </div>
                                            ...
                                            <div align="left" style="width: 85%">
                                                    ...
                                                    <table class="tablerowcolor2" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                            <tr valign="top" height="23" id="trheader" runat="server">
                                                                ...
                                                                <td class="bgcustomize navigatorpanel" width="30%">&nbsp;Tag Name
                                                                </td>
                                                                <td class="bgcustomize navigatorpanel" width="60%">&nbsp;Description
                                                                </td>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="1" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Title
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;First Name of Customer's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Last Name of Customer's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Full Name of Customer's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Email of Customer's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Customer Name
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Date
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="EstimatedArtwork" size="30" value='[$EstimatedArtwork$]' readonly="readonly"
                                                                                        onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Artwork
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="EstimatedDelivery" size="30" value='[$EstimatedDelivery$]' readonly="readonly"
                                                                                        onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Delivery
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="ValidFor" size="30" value='[$ValidFor$]' onclick="this.select();" readonly="readonly" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Days Estimate is valid for
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="SalesPerson" size="30" value='[$SalesPerson$]' onclick="this.select();" readonly="readonly" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Sales Person
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="SalesPersonEmail" size="30" value='[$SalesPersonEmail$]' readonly="readonly"
                                                                                        onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Email of Sales Person
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="EstimateHeader" size="30" value='[$EstimateHeader$]' onclick="this.select();"
                                                                                        readonly="readonly" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Header
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="EstimateFooter" size="30" value='[$EstimateFooter$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Footer
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Value
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;The Path of the PDF File
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;The name of the person who is logged in
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;The Path of Attachments
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Delivery Note Consignee URL
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp; Delivery Note Consignment Note Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="test" size="30" value='[$ConsigneeURLWithConsignmentNoteNumber$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Consignee URL With Consignment Note Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                ...
                                                <div id="divSupplierRFQ" style="display: none">
                                                    <span class="HeaderText">Custom Tags for Supplier RFQ</span>
                                                    <div class="only5px">
                                                    </div>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="EstimateNumber" size="30" value='[$EstimateNumber$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Number
                                                                                </td>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;First Name of Supplier's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Last Name of Supplier's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Full Name of Supplier's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Email of Supplier's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Supplier Name
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="EstimateHeader" size="30" value='[$EstimateHeader$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Header
                                                                                </td>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="EstimateValue" size="30" value='[$EstimateValue$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Estimate Value
                                                                                </td>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="test" size="30" value='[$QuoteLink$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Path of the Quote details page
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="test" size="30" value='[$RFQReturnDate]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;RFQ Return Date
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="test" size="30" value='[$RFQReturnTime]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;RFQ Return Time
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="test" size="30" value='[$AttachmentsPath$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;The Path of Attachments
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="JobNumber" size="30" value='[$JobNumber$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Job Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Job Title
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Middle Name of Supplier's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Full Name Supplier's Contact
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Job Delivery Date
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Job Completion Date
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="JobOrderNumber" size="30" value='[$JobOrderNumber$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Job Order Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Job Header
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Job Footer
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Job Value
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Title
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Date
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Order Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Header
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Footer
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Value
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Amount Paid
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Amount Outstanding
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Invoice Due Date
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="CarrierName" size="30" value='[$CarrierName$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Carrier Name
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="ShippedTo" size="30" value='[$ShippedTo$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Shipped To
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="Stripe Payment Link" size="30" value='[$StripePaymentLink$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Stripe Payment Link
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="ConsigneeURL" size="30" value='[$ConsigneeURL$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Consignee URL
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="Consignment Note Number" size="30" value='[$Consignment Note Number$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Consignment Note Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Purchase Title
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Purchase Order Number
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="PurchaseHeader" size="30" value='[$PurchaseHeader$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Purchase Header
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="PurchaseFooter" size="30" value='[$PurchaseFooter$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Purchase Footer
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="RequiredDate" size="30" value='[$RequiredDate$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;
                                                                                </td>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Price Including Tax
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Price Excluding Tax
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Quantity
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td class="setting_emailbodytd">&nbsp;Job Title
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Supplier QuoteNumber
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td class="setting_emailbodytd">&nbsp;Job Order Title
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td class="setting_emailbodytd">&nbsp;The Path of Attachments
                                                                                </td>
                                                                                <td class="setting_emailbodywidht1">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="DeliveryHeader" size="30" value='[$DeliveryHeader$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Delivery Header
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewTableRows" valign="top">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="DeliveryFooter" size="30" value='[$DeliveryFooter$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Delivery Footer
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="DeliveryNumber" size="30" value='[$DeliveryNumber$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Delivery Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp; Order Number
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Delivery Date
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Order Date
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="top">
                                                                                ...
                                                                                <td style="overflow: hidden;" width="60%">&nbsp;Order Value
                                                                                </td>
                                                                                <td width="1%">&nbsp;
                                                                                </td>
                                                                            </tr>
                                                ...
                                                <%--<div id="divProof" style="display: none">
                                                    ...
                                                    <table class="tablerowcolor2" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                            <tr valign="top" height="23" id="tr1" runat="server">
                                                                <td class="bgcustomize" align="left" valign="top" width="1%">
                                                                    <img src="../images/lt_tabnotch.gif" width="5" height="5/">
                                                                </td>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="EstimateTitle" size="30" value='[$EstimateOrJobname$]' onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="Itemtitle" size="30" value='[$CustomerName$]' onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">
                                                                                    &nbsp;Customer Name
                                                                                </td>
        ...
        function SelectTemplateType() {
            ...
            if (ddlEmailTemplateType.selectedIndex != 0) {
                if (ddlEmailTemplateType.selectedIndex == 1) {
                    ...
                    //document.getElementById("divProof").style.display = 'none';
                ...
                //else if (ddlEmailTemplateType.selectedIndex == 8) {
                //    document.getElementById("divestimate").style.display = 'none';
                //    document.getElementById("divSupplierRFQ").style.display = 'none';
                //    document.getElementById("divJOb").style.display = 'none';
                //    document.getElementById("divInvoice").style.display = 'none';
                ...
                //    document.getElementById("divDeliveryNote").style.display = 'none';
                //    document.getElementById("divWebOrder").style.display = 'none';
                //    document.getElementById("divProof").style.display = 'block';
