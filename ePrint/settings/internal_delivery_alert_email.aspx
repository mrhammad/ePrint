<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/settingpage.Master" AutoEventWireup="true" CodeBehind="internal_delivery_alert_email.aspx.cs" Inherits="ePrint.settings.internal_delivery_alert_email" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                        ...
                                        <div id="tdaddnew" class="autotablenone">
                                            ...
                                            <div class="autocustometable">
                                                <div id="divestimate" class="autobtncancel">
                                                    <span class="HeaderText">Custom Tags for Delivery</span>
                                                    <div class="only5px">
                                                    </div>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometd" nowrap="nowrap">
                                                                                    <input type='text' name="InternalDeliveryURL" size="30" value='[$InternalDeliveryURL$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td class="custometdflow">
                                                                                    &nbsp;URL to the page of Delivery
                                                                                </td>
                                                                                <td class="custometd1">
                                                                                    &nbsp;
                                                                                </td>
    ...
    <script type="text/javascript">
        function ImgButtonErase_ClientClick1(GridID, ImageButtonID) {
            if (confirm("Delete this Internal Delivery Alert?")) {
