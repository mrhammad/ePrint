<%@ page language="C#" masterpagefile="~/Templates/settingpage.master" autoeventwireup="true" CodeBehind="digital_press_view.aspx.cs" Inherits="ePrint.settings.digital_press_view" title="Settings: Digital Press" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left" id="pnldetails">
                        ...
                        <div class="divpadding">
                            <div align="left" style="float: left;" nowrap="nowrap">
                                <span class="navigatorpanel">
                                    <%=objLanguage.GetLanguageConversion("Settings")%>:&nbsp;<%=objLanguage.GetLanguageConversion("Digital_Press_View")%></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="content" class="estore_settingBox">
            ...
            <div style="width: 100%; margin-top: -10px;" class="mis_header_panel">
                <div id="">
                                            ...
                                            <div style="width: 100%;">
                                                <div class="divDropdownlist" style="padding-bottom: 7px; padding-top: 7px; width: 130px;">
                                                    <asp:LinkButton ID="btnDelete" runat="server" Text="Delete Selected" CommandName="Delete"
                                                        ...
                                                        OnClick="btnDelete_OnClick"><%=objLanguage.GetLanguageConversion("Detele_Selected")%></asp:LinkButton></div>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <telerik:RadGrid Width="60%" ID="RadGrid1" GridLines="None" CssClass="RadGrid" runat="server"
                                ...
                                OnItemDataBound="RadGrid1_ItemDataBound" HeaderStyle-Font-Bold="true">
                                <MasterTableView CommandItemDisplay="Top" Width="100%" HorizontalAlign="NotSet" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                            ...
                                            <ItemTemplate>
                                                <div style="padding-left: 2px">
                                                    <input type="checkbox" runat="server" id="Id" onclick="CheckChanged();" name="Id"
                                                        value='<%# DataBinder.Eval(Container, "DataItem.DigitalPressID", "{0}") %>' />
                                                </div>
                                                <asp:Label ID="lbl" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container, "DataItem.DigitalPressID", "{0}") %>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn SortExpression="DigitalPressName" HeaderText="Digital Press Name"
                                            HeaderStyle-Width="45%" ItemStyle-Width="45%" UniqueName="DigitalPressName" DataField="DigitalPressName"
                                            ...
                                            <ItemTemplate>
                                                <div style="float: left; width: 99%; overflow: hidden; height: 15px">
                                                    <a title='<%#Eval("DigitalPressName")%>' href='<%=nmsCommon.global.sitePath()%>settings/digital_press_add.aspx?type=edit&id=<%#Eval("DigitalPressID")%>'>
                                                        <asp:Label ID="lblGuillotineName" Width="100%" CssClass="label_GV" runat="server"
                                                            Text='<%#Eval("DigitalPressName")%>' ToolTip='<%#Eval("DigitalPressName")%>'></asp:Label>
                                                    </a>
                                                </div>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn SortExpression="Description" HeaderText="Description"
                                            HeaderStyle-Width="52%" ItemStyle-Width="52%" UniqueName="Description" Visible="true"
                                            ...
                                            <ItemTemplate>
                                                <div style="float: left; width: 99%; overflow: hidden; height: 15px">
                                                    <a title='<%#Eval("Description")%>' href='<%=nmsCommon.global.sitePath()%>settings/digital_press_add.aspx?type=edit&id=<%#Eval("DigitalPressID")%>'>
                                        ...
                                        <telerik:GridTemplateColumn DataField="IsDefaultPress" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <a href="javascript:void(0);" onclick="javascript:return setAsDefault(<%# DataBinder.Eval(Container, "DataItem.DigitalPressID", "{0}") %>,'contact');">
                                                    <div style="float: left; width: 100%; overflow: hidden; height: 18px;">
                                                        ...
                                                        <center>
                                                            <asp:ImageButton ID="img_DefaultDigitalPress" runat="server" CommandName="Set as default"
                                                                CssClass="rollover" Text="Set as default" CommandArgument='<%#Eval("DigitalPressID")%>'
                                                                OnCommand="setDefaultPress_OnClick"></asp:ImageButton></center>
                                                    </div>
                                                </a>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="" HeaderStyle-Width="10%" ItemStyle-Width="10%"
                                            ...
                                            <ItemTemplate>
                                                <center>
                                                    <asp:ImageButton ID="imgbtnDelete" ImageUrl="~/images/erase.png" CommandArgument='<%#Eval("DigitalPressID")%>'
                                                        OnCommand="imgDelete_OnCommand" ToolTip="Delete" OnClientClick="javascript:return EraseCheck();"
                                                        runat="server" />
                                                    <asp:ImageButton runat="server" ID="imgbtnCopy" ImageUrl="~/images/copy.png" ToolTip="Copy"
                                                        CommandArgument='<%#Eval("DigitalPressID")%>' OnCommand="imgCopy_OnCommand" />
                                                </center>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                    </Columns>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="left" style="margin-top: 5px;">
                        <tr>
