...
{
    public partial class ProofApproval_emailbody : BaseClass, IRequiresSessionState
    {
        ...
        {
            base.Response.Redirect("~/Settings/ProofApproval_emailbody.aspx");
        }
        ...
        public void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            string str = "Proof Approval emails";// base.SpecialEncode(this.ddlEmailTemplateType.SelectedValue.ToString());
            ...
            SqlCommand sqlCommand = new SqlCommand("PC_settings_emailbody_insert_proof", (new commonClass()).openConnection())
            {
                CommandType = CommandType.StoredProcedure
            };
            sqlCommand.Parameters.Add("@CompanyID", CompanyID);
            ...
            base.Response.Redirect("~/settings/ProofApproval_emailbody.aspx?action=edit");
        }
        ...
        public void EmailBodyGridBind()
        {
            ...
            sqlCommand.Parameters.AddWithValue("@CompanyID", this.CompanyID);
            sqlCommand.Parameters.AddWithValue("@Type", "Proof Approval emails");
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(sqlCommand);
            DataSet dataSet = new DataSet();
            sqlDataAdapter.Fill(dataSet);
            _commonClass.closeConnection();
        ...
        protected void imgbtnCopy_OnCommand(object sender, CommandEventArgs e)
        {
            ...
            object[] objArray = new object[] { this.strSitepath, "Settings/ProofApproval_emailbody.aspx?type=mb", num, "&cop=yes" };
