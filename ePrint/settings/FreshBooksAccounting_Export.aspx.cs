...
{
    public partial class FreshBooksAccounting_Export : BaseClass, IRequiresSessionState
    {
        //protected settings_Loading ucLoading;
        ...
        public string FBapiPath = string.Empty;
        ...
        public FreshBooksAccounting_Export()
        {
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;>&nbsp;", this.objLanguage.GetLanguageConversion("FB_Accounting_Export")));
            base.Title = this.objLanguage.convert(global.pageTitle("FreshBooks Accounting", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
            ...
            object[] objArray = new object[] { ConfigurationManager.AppSettings["FBAPI"].ToString(), "?key=", str, "&uid=", this.UserID };
            this.FBapiPath = string.Concat(objArray);
        }
    }
}