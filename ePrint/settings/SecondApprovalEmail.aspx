<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/settingpage.Master" AutoEventWireup="true" CodeBehind="SecondApprovalEmail.aspx.cs" Inherits="ePrint.settings.SecondApprovalEmail" %>
                                        ...
                                        <div id="tdaddnew" align="left" style="width: 100%; display: none;">
                                            ...
                                            <div align="left" style="width: 85%">
                                                ...
                                                <div id="divSupplierRFQ" >
                                                    <span class="HeaderText">Second Approval Email </span>
                                                    <div class="only5px">
                                                    </div>
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="ApproverName" size="30" value='[$ApproverName$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">
                                                                                    &nbsp;Approver Name
                                                                                </td>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="ApproverEmail" size="30" value='[$ApproverEmail$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">
                                                                                    &nbsp;Approver Email
                                                                                </td>
                                                                            ...
                                                                            <tr class="NewTableRows" valign="middle">
                                                                                ...
                                                                                <td width="30%" nowrap="nowrap">
                                                                                    <input type='text' name="Estimator Person Email" size="30" value='[$EstimatorPersonEmail$]'
                                                                                        readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td style="overflow: hidden;" width="60%">
                                                                                    &nbsp;Estimator Person Email
                                                                                </td>
                                                                                <td width="1%">
                                                                                    &nbsp;
                                                                                </td>
