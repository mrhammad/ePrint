...
{
    public partial class system_emailbody : BaseClass, IRequiresSessionState
    {
        ...
        static system_emailbody()
        {
        }

        public system_emailbody()
        {
        }

        protected void btnCancel_OnClick(object sender, EventArgs e)
        {
            base.Response.Redirect("~/Settings/system_emailbody.aspx");
        }
        ...
        public void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            string str = base.SpecialEncode(this.ddlEmailTemplateType.SelectedValue.ToString());
            string str1 = this.ddlSpecificType.SelectedValue.ToString();
            ...
            sqlCommand.Parameters.Add("@statusid", this.ddlstatus.SelectedItem.Value);
            ...
            base.Response.Redirect("~/settings/system_emailbody.aspx?action=edit");
        }
        ...
        public void drpLoadFooterTitle()
        {
            ...
            this.ddlEmailTemplateType.SelectedIndex = 0;
        ...
        public void drpSpecificUserselect()
        {
            ...
            this.ddlSpecificType.DataSource = dataSet;
            this.ddlSpecificType.DataTextField = "Name";
            this.ddlSpecificType.DataValueField = "userID";
            this.ddlSpecificType.DataBind();
            this.ddlSpecificType.Items.Insert(0, "General");
            this.ddlSpecificType.Items[0].Text = "General";
            this.ddlSpecificType.Items[0].Value = "0";
        }

        [System.Web.Services.WebMethod]
        public void drpStatusselect(string x="")
        {
            string type = "job";
            if (this.ddlEmailTemplateType.SelectedValue.Contains("estimate") || this.ddlEmailTemplateType.SelectedValue.Contains("supplier"))
            {
                type = "estimate";
            }
            else if (this.ddlEmailTemplateType.SelectedValue.Contains("job"))
            {
                type = "job";
            }
            else if (this.ddlEmailTemplateType.SelectedValue.Contains("invoice"))
            {
                type = "invoice";
            }
            else if (this.ddlEmailTemplateType.SelectedValue.Contains("purchase"))
            {
                type = "purchase";
            }
            else if (this.ddlEmailTemplateType.SelectedValue.Contains("delivery"))
            {
                type = "delivery";
            }
            else if (this.ddlEmailTemplateType.SelectedValue.Contains("webstore"))
            {
                type = "orders";
            }
            else if (this.ddlEmailTemplateType.SelectedValue.Contains("proof"))
            {
                type = "proof";
            }
            ...
            this.CompanyID = Convert.ToInt32(this.Session["companyid"].ToString());
            commonClass _commonClass = new commonClass();
            SqlCommand sqlCommand = new SqlCommand("PC_Status_Select_ForEmailSend", _commonClass.openConnection())
            {
                CommandType = CommandType.StoredProcedure
            };
            sqlCommand.Parameters.AddWithValue("@CompanyID", this.CompanyID);
            ...
            sqlDataAdapter.Fill(dataSet);
            _commonClass.closeConnection();
            this.ddlstatus.DataSource = dataSet;
        ...
        protected void imgbtnCopy_OnCommand(object sender, CommandEventArgs e)
        {
            ...
            object[] objArray = new object[] { this.strSitepath, "Settings/system_emailbody.aspx?type=mb", num, "&cop=yes" };
        ...
        public void lnkBody_onClick(object sender, EventArgs e)
        {
            ...
            if (sqlDataReader.Read())
            {
                ...
                this.drpStatusselect();
                base.SetDDLValue(this.ddlstatus, sqlDataReader["StatusID"].ToString().ToLower().Trim());
                // this.ddlEmailTemplateType_SelectedIndexChanged(this.ddlEmailTemplateType, EventArgs.Empty);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.trheaderSup.BgColor = this.objpage.colorCode(this.companyid, this.Session["pagename"].ToString());
            this.trheaderJob.BgColor = this.objpage.colorCode(this.companyid, this.Session["pagename"].ToString());
            this.trheaderInv.BgColor = this.objpage.colorCode(this.companyid, this.Session["pagename"].ToString());
            this.trheaderPur.BgColor = this.objpage.colorCode(this.companyid, this.Session["pagename"].ToString());
            this.trheaderDeli.BgColor = this.objpage.colorCode(this.companyid, this.Session["pagename"].ToString());
            ...
            base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;>&nbsp;", this.objLanguage.GetLanguageConversion("Email"), "&nbsp;>>&nbsp;", this.objLanguage.GetLanguageConversion("Customers_and_Suppliers")));
            ...
            this.header_mis.SettingName = this.objLanguage.GetLanguageConversion("Customers_and_Suppliers");
            ...
            this.lblstatus.Text = "Status on Send";
