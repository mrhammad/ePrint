<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/settingpage.Master" AutoEventWireup="true" CodeBehind="internal_estimate_alert_email.aspx.cs" Inherits="ePrint.settings.internal_estimate_alert_email" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                                                    ...
                                                                    <table class="borderWithoutTop" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="NewAlternative" valign="middle">
                                                                                ...
                                                                                <td class="custometd" nowrap="nowrap">
                                                                                    <input type='text' name="InternalEstimateURL" size="30" value='[$InternalEstimateURL$]' readonly="readonly" onclick="this.select();" />
                                                                                </td>
                                                                                <td class="custometdflow">
                                                                                    &nbsp;URL to the page of Estimate
                                                                                </td>
                                                                                <td class="custometd1">
                                                                                    &nbsp;
                                                                                </td>
    ...
    <script type="text/javascript">
        function ImgButtonErase_ClientClick1(GridID, ImageButtonID) {
            if (confirm("Delete this Internal Estimate Alert?")) {
