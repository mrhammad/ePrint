...
{
    public partial class system_autojobalert_email : BaseClass, IRequiresSessionState
    {
        ...
        static system_autojobalert_email()
        {
        }

        public system_autojobalert_email()
        {
        }
        ...
        {
            base.Response.Redirect("~/Settings/system_autojobalert_email.aspx");
        }
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            {
                int num = 0;
                SettingsBasePage.system_autojobalert_email(system_autojobalert_email.CompanyID, system_autojobalert_email.UserID, Convert.ToInt32(this.ddlStatus.SelectedValue), this.txtSubject.Text, this.RadEditor1.Content.ToString(), Convert.ToInt32(this.ddlSignature.SelectedValue), Convert.ToInt32(this.chkEnabled.Checked), base.SpecialEncode(this.txt_cc.Text), base.SpecialEncode(this.txt_bcc.Text), Convert.ToInt32(num.ToString()));
            }
            else
            {
                SettingsBasePage.system_autojobalert_email(system_autojobalert_email.CompanyID, system_autojobalert_email.UserID, Convert.ToInt32(this.ddlStatus.SelectedValue), this.txtSubject.Text, this.RadEditor1.Content.ToString(), Convert.ToInt32(this.ddlSignature.SelectedValue), Convert.ToInt32(this.chkEnabled.Checked), base.SpecialEncode(this.txt_cc.Text), base.SpecialEncode(this.txt_bcc.Text), Convert.ToInt32(this.lblemail.Text.ToString()));
            }
            this.GetAutojobalertdetails();
            this.BindSignature();
        ...
        public void GetAutojobalertdetails()
        {
            DataTable dataTable = SettingsBasePage.AutojobAlert_select(system_autojobalert_email.CompanyID);
        ...
        {
            return SettingsBasePage.AutojobAlert_SelectStatus(system_autojobalert_email.CompanyID);
        }
        ...
        public void lnkStatus_onClick(object sender, EventArgs e)
        {
            ...
            DataTable dataTable1 = SettingsBasePage.AutojobAlert_EditSelectStatus(system_autojobalert_email.CompanyID, Convert.ToInt32(dataTable.Rows[0]["StatusID"].ToString()));
            this.ddlStatus.DataTextField = "StatusTitle";
            this.ddlStatus.DataValueField = "StatusID";
