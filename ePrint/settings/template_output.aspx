<%@ page language="C#" autoeventwireup="true" CodeBehind="template_output.aspx.cs" Inherits="ePrint.settings.template_output" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" ValidateRequest="false" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register TagPrefix="UC" TagName="Loading" Src="~/usercontrol/settings/Loading.ascx" %>
 <script type="text/javascript" src="<%=sitepath %>js/commonloading.js?VN='<%=VersionNumber%>'"></script>
    ...
    <div>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function ValidateName(saveType) {
                ...
                window.parent.document.getElementById("item_3").style.color = "black";
                ...
                if (isBlank1) {
                    ...
                    var IsHGroupMain = 'false', isAutoExpand = "", Repeat = 'false';
                    ...
                    for (var j = 0; j < counterdiv.length; j++) {
                        ...
                        else if (objType == 3 || objType == 8 || objType == 9 || objType == 10 || objType == 11 || objType == 12) {
                        ...
                        isAutoExpand = counterdiv[j].getAttribute("isAutoExpand");
                        Repeat = counterdiv[j].getAttribute("repeat");

                        if (GroupID == 'undefined') {
                            GroupID = '0';
                        }
                        if (HGroupID == 'undefined') {
                            HGroupID = '0';
                        }
                        if (IsHGroupMain == 'undefined') {
                            IsHGroupMain = 'false';
                        }
                        if (isAutoExpand == 'undefined') {
                            isAutoExpand = 'false';
                        }
                        ...
                        fieldprop += "objTag»" + objTag + "±" + "GroupID»" + GroupID + "±" + "HGroupID»" + HGroupID + "±";
                        fieldprop += "AssociatedLabel»" + AssociatedLabel + "±" + "IsHGroupMain»" + IsHGroupMain + "±" + "isAutoExpand»" + isAutoExpand + "±" + "repeat»" + Repeat + "µ";
                    }
        ...
        <script type="text/javascript" src="<%=sitepath%>js/rgbcolor.js"></script>
        <script type="text/javascript" src="../js/Item/rightcontext.js"></script>
        <div id="div_TempAddMain" align="left" style="width: 100%;">
            ...
            <div align="left">
                <div>
                    ...
                    <div align="left" style="display: none">
                        <a href="#" onclick="showhideGridline();">CLICK HERE</a>
                        <div class="only5px">
                        </div>
                    </div>
                    <div align="left" style="width: 100%">
                        <div align="left" id="ODS_Editor" style="width: 1150px;">
                            <style>
                                .textalign
                                {
                                    align: right;
                            ...
                            <!-- JavaScript -->
                            <script type="text/javascript" src="../ODSprinting/scripts/prototype.js"></script>
                            <script type="text/javascript" src="../ODSprinting/scripts/lightbox.js"></script>
                            <script src="../ODSprinting/Managment Print_files/WebResource.axd" type="text/javascript"></script>
                            <script src="../ODSprinting/Managment Print_files/js_color_picker_v2.js" type="text/javascript">
                            </script>
                            ...
                            <table width="1000px">
                                <tr valign="top">
                                    <td>
                                        <div id="div_MainEditor" style="float: left; width: 930px">
                                            <div>
                                                <div id="div_btnsavepreview" style="display: block">
                                                    <asp:Button ID="Button2" runat="server" Text="Save & Preview" CssClass="button" OnClientClick="javascript:var a=ValidateName('redirect');if(a)loadingimg('div_btnsavepreview','div_savepreviewprocess');return a;"
                                                        OnClick="btnUpdate_Submit" />
                                                </div>
                                                <div id="div_savepreviewprocess" class="button" align="center" style="width: 95px; display: none">
                                            ...
                                            <div align="left">
                                                ...
                                                <div class="box">
                                                    <asp:CheckBox ID="chkSplit" Visible="false" Text="&nbsp;&nbsp;Split the items so that each item fits on single page.<br><span class='smallgraytext'>(This prevents the start of an item description appearing on onepage and the rest of the item description appearing on the next page)</span>"
                                                        runat="server" />
                                                </div>
                                            </div>
                                            <div style="clear: both">
                                                    ...
                                                    <tr>
                                                        <td valign="top" style="width: 100%">
                                                            <table class="Panel-B" width="100%" border="0" cellspacing="0" cellpadding="2" align="left">
                                                                <tr valign="top">
                                                                    <td id="td_MainEditor" width="100%" style="border-color: #D1DC03; border-width: thin;
                                                                        border-style: solid; height: 933px" valign="top">
                                                                        <div id="div">
                                                                            <table width="100%" cellspacing="0" cellpadding="0" align="center">
                                                                                <tr>
                                                                                    <td valign="top">
                                                                                        <table class="Panel-C" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tr valign="top">
                                                                                                ...
                                                                                                <td width="100%" valign="top">
                                                                                                    <table align="left" width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                                                        <tr valign="top">
                                                                                                            <td>
                                                                                                                <div id="ctl00_ContentPlaceHolder1_pnlToolBar" style="float: left; width: 100%; background-color: #FAFAFA;
                                                                                                                    white-space: nowrap">
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td valign="top" class="menu_bg" style="height: 100%; padding-top: 5px; white-space: nowrap">
                                                                                                                                <div style="float: left; width: 35%">
                                                                                                                                    <table cellpadding="0" cellspacing="0" style="height: 20px; border-right: solid 1px #ffffff;
                                                                                                                                        width: 100%">
                                                                                                                                     
                                                                                                                                        <tr>
                                                                                                                                            <td align="left" valign="top" style="color: #000000; font-family: Arial; font-weight: bold;
                                                                                                                                                font-size: 11px; padding-left: 8px">
                                                                                                                                            <%=objlang.GetLanguageConversion("Textual_Textual")%>
                                                                                                                                        </tr>
                                                                                                                                    </table>
                                                                                                                                    <table cellpadding="0" cellspacing="0" style="height: 24px; border-right: solid 1px #ffffff;
                                                                                                                                    ...
                                                                                                                                    <table cellpadding="2" cellspacing="1" style="height: 25px; border-right: solid 1px #ffffff;
                                                                                                                                        width: 100%; vertical-align: middle;">
                                                                                                                                ...
                                                                                                                                <div style="float: left; width: 12%">
                                                                                                                                    <table cellpadding="0" cellspacing="0" style="height: 20px; border-right: solid 1px #ffffff;
                                                                                                                                        border-left: solid 1px #B2B2B2; width: 100%;">
                                                                                                                                        <tr>
                                                                                                                                            <td align="left" valign="top" style="color: #000000; font-family: Arial; font-weight: bold;
                                                                                                                                                font-size: 11px; padding-left: 8px">
                                                                                                                                            
                                                                                                                                                <%=objlang.GetLanguageConversion("Zoom")%>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </table>
                                                                                                                                    <table cellpadding="2" cellspacing="1" style="height: 25px; border-right: solid 1px #ffffff;
                                                                                                                                        border-left: solid 1px #B2B2B2; width: 100%; vertical-align: middle">
                                                                                                                                        <tr>
                                                                                                                                            <td class="Menu" align="center" valign="middle">
                                                                                                                                    ...
                                                                                                                                    <table cellpadding="2" cellspacing="1" style="height: 24px; border-right: solid 1px #ffffff;
                                                                                                                                        border-left: solid 1px #B2B2B2; width: 100%; vertical-align: middle;">
                                                                                                                                        <tr>
                                                                                                                                ...
                                                                                                                                <div style="float: left; width: 15%">
                                                                                                                                    <table cellpadding="0" cellspacing="0" style="height: 20px; border-left: solid 1px #B2B2B2;
                                                                                                                                        border-right: solid 1px #ffffff; width: 100%;">
                                                                                                                                        <tr>
                                                                                                                                            <td align="left" valign="top" style="color: #000000; font-family: Arial; font-weight: bold;
                                                                                                                                                font-size: 11px; padding-left: 8px">
                                                                                                                                                <%=objlang.GetLanguageConversion("Insert")%>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </table>
                                                                                                                                    <table cellpadding="2" cellspacing="1" style="height: 25px; border-left: solid 1px #B2B2B2;
                                                                                                                                        border-right: solid 1px #ffffff; width: 100%; vertical-align: middle">
                                                                                                                                        <tr>
                                                                                                                                            <td class="Menu" align="left" valign="middle">
                                                                                                                                                ...
                                                                                                                                                <div id="crtlDiv" style="border-right: black 1px solid; border-top: black 1px solid;
                                                                                                                                                    z-index: 5; left: 450px; visibility: hidden; border-left: black 1px solid; width: 407px;
                                                                                                                                                    border-bottom: black 1px solid; position: absolute; top: 300px; height: 79px;
                                                                                                                                                    background-color: #c0c0c0">
                                                                                                                                                    <table style="width: 401px" cellspacing="0" cellpadding="0" border="0">
                                                                                                                                                        <tr>
                                                                                                                                                            <td class="header2" style="width: 204px; height: 38px">
                                                                                                                                                                <span>&nbsp;<span style="font-size: 10pt; color: #000033; font-family: Calibri"> <strong>
                                                                                                                                                                    Object Name :</strong></span></span>
                                                                                                                                                            </td>
                                                                                                                                                            <td>
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            <td class="header2" style="width: 195px; height: 40px">
                                                                                                                                                                <input id="chkBx" type="checkbox"><span style="font-family: Calibri"><span style="font-size: 10pt">
                                                                                                                                                                    <span style="color: #000033"><strong>Multi Line</strong></span></span></span>
                                                                                                                                                            </td>
                                                                                                                                                        </tr>
                                                                                                                                                    </table>
                                                                                                                                                </div>
                                                                                                                                    ...
                                                                                                                                    <table cellpadding="2" cellspacing="1" style="height: 24px; border-left: solid 1px #B2B2B2;
                                                                                                                                        border-right: solid 1px #ffffff; width: 100%; vertical-align: middle">
                                                                                                                                        <tr>
                                                                                                                                            <td class="Menu" align="left" valign="middle">
                                                                                                                                                  <telerik:DialogOpener runat="server" ID="DialogOpener1"></telerik:DialogOpener>
                                                                                                                                                <img style="cursor: hand" onclick="$find('<%= DialogOpener1.ClientID %>').open('ImageManager', {CssClasses: []});return false;" alt="Add Image" src="../ODSprinting/Managment Print_files/add_image.gif">
                                                                                                                                ...
                                                                                                                                <div style="float: left; width: 12%">
                                                                                                                                    <table cellpadding="0" cellspacing="0" style="height: 20px; border-left: solid 1px #B2B2B2;
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td align="left" valign="top" style="color: #000000; font-family: Arial; font-weight: bold;
                                                                                                                                                font-size: 11px; padding-left: 8px">
                                                                                                                                                <%=objlang.GetLanguageConversion("Advanced")%>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </table>
                                                                                                                                    <table cellpadding="0" cellspacing="0" style="height: 25px; border-left: solid 1px #B2B2B2;
                                                                                                                                        width: 100%; vertical-align: middle;">
                                                                                                                                        <tr>
                                                                                                                                            <td align="left" valign="middle" style="padding-left: 5px">
                                                                                                                                                <select style="font-size: 10px; width: 100px" name="alignment" onchange="alignthis(this.value)">
                                                                                                                                                    <option style="font-size: 10px;" value="left"><%=objlang.GetLanguageConversion("Align_Left")%></option>
                                                                                                                                                    <option style="font-size: 10px;" value="center"><%=objlang.GetLanguageConversion("Align_Center")%></option>
                                                                                                                                                    <option style="font-size: 10px;" value="right"><%=objlang.GetLanguageConversion("All_Right")%></option>
                                                                                                                                                </select>
                                                                                                                                            </td>
                                                                                                                                            <td class="Menu" align="left" valign="middle" style="padding: 0px 3px 0px 3px; width: 22px">
                                                                                                                                                <a href="javascript:lockobjects()" title="Lock Objects"><span id="lockobjects"><%=objlang.GetLanguageConversion("Lock")%></span></a>
                                                                                                                                            </td>
                                                                                                                                            <td align="center" style="width: 120px; height: 19px; display: none" valign="middle">
                                                                                                                                                <select id="ctl00_ContentPlaceHolder1_imgBk" style="font-size: 8pt; width: 100px;
                                                                                                                                                    font-family: Calibri" onchange="change_image_background_here(this.value)" name="ctl00_ContentPlaceHolder1_imgBk">
                                                                                                                                                    <option value="" selected><%=objlang.GetLanguageConversion("BackGrounds")%></option>
                                                                                                                                                    <option value="transparentpixel.gif" selected><%=objlang.GetLanguageConversion("None")%></option>
                                                                                                                                                    <option value="bg1.jpg" selected><%=objlang.GetLanguageConversion("Default")%></option>
                                                                                                                                                </select>
                                                                                                                                            </td>
                                                                                                                                    ...
                                                                                                                                    <table cellpadding="0" cellspacing="1" style="height: 24px; border-left: solid 1px #B2B2B2;
                                                                                                                                        width: 100%; vertical-align: middle;">
                                                                                                                                        <tr>
                                                                                                                                            <td style="width: 3px">
                                                                                                                                                &nbsp;
                                                                                                                                                ...
                                                                                                                                                <asp:UpdatePanel ID="updpnlGroup" runat="server" RenderMode="Inline" UpdateMode="Always">
                                                                                                                                                    <ContentTemplate>
                                                                                                                                                        <asp:DropDownList ID="ddlGroup" onchange="ShowHideGroup('show');SetGroup(this.value)"
                                                                                                                                                            Style="font-size: 10px; width: 100px" runat="server">
                                                                                                                                            ...
                                                                                                                                            <td class="Menu" align="left" valign="middle" style="padding: 0px 4px 0px 4px; width: 22px;
                                                                                                                                                display: none" id="editgroupTooltd" runat="server">
                                                                                                                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                                                                                                    <ContentTemplate>
                                                                                                                                                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../Images/Edit.gif" /><%--OnClick="img_Groupeditbtnclick"--%>
                                                                                                                                                        <script>
                                                                                                                                                            function EditGroup() {
                                                                                                                                                                ...
                                                                                                                                                                if (ddlGroup.options[ddlGroup.selectedIndex].value != "0" && ddlGroup.options[ddlGroup.selectedIndex].value != "-2" && ddlGroup.options[ddlGroup.selectedIndex].value != "-1") {
                                                                                                                                                                    ...
                                                                                                                                                                    //document.getElementById(txtGroupName).value = ddlGroup.options[ddlGroup.selectedIndex].value;
                                                                                                                                                                    //  txtGroupName.value = ddlGroup.options[ddlGroup.selectedIndex].text;

                                                                                                                                                                }
                                                                                                                                                                else {
                                                                                                                                                                    alert('<%=objlang.GetLanguageConversion("Please_Select_Atleast_One_Group_Name")%>');
                                                                                                                                                                }
                                                                                                                                                            }
                                                                                                                                            ...
                                                                                                                                            <script language="javascript" type="text/javascript">
                                                                                                                                                function Delete_Confirmation() {
                                                                                                                                                    return window.confirm('<%=objlang.GetLanguageConversion("Are_You_Sure_You_Want_To_Remove_The_Group")%>');
                                                                                                                                                }
                                                                                                                                            </script>
                                                                                                                                            <td class="Menu" align="left" valign="middle" style="padding: 4px 4px 0px 4px; width: 22px;
                                                                                                                                                display: none" id="deletegroupTooltd" runat="server">
                                                                                                                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                                                                                                                                    <ContentTemplate>
                                                                                                                                                        <asp:ImageButton ID="imgbtnDeleteGroup" runat="server" ImageUrl="../ODSprinting/delete_icon.gif"
                                                                                                                                                            ...
                                                                                                                                                            OnClientClick="javascript:return Delete_Confirmation();" />
                                                                                                                                                    </ContentTemplate>
                                                                                                                                                </asp:UpdatePanel>
                                                                                                                                            </td>
                                                                                                                                            <td align="left">
                                                                                                                                                ...
                                                                                                                                                <asp:UpdatePanel ID="updpnlHGroup" runat="server" RenderMode="Inline" UpdateMode="Always">
                                                                                                                                                    <ContentTemplate>
                                                                                                                                            ...
                                                                                                                                            <td class="Menu" align="left" valign="middle" style="padding: 0px 4px 0px 4px; width: 22px;
                                                                                                                                                display: none" id="editHgroupTooltd" runat="server">
                                                                                                                                                <asp:UpdatePanel ID="Updatepnl" runat="server">
                                                                                                                                                    <ContentTemplate>
                                                                                                                                                      
                                                                                                                                                        <asp:ImageButton ID="btn_image" runat="server" ImageUrl="../Images/Edit.gif" />
                                                                                                                                                        ...
                                                                                                                                                        <script>
                                                                                                                                                            function EditHGroup() {
                                                                                                                                                                ...
                                                                                                                                                                if (ddlHGroup.options[ddlHGroup.selectedIndex].value != "0" && ddlHGroup.options[ddlHGroup.selectedIndex].value != "-2" && ddlHGroup.options[ddlHGroup.selectedIndex].value != "-1") {
                                                                                                                                                                    ...
                                                                                                                                                                    alert("Please Select at least one  Horizontal Group Name");
                                                                                                                                            ...
                                                                                                                                            <td class="Menu" align="left" valign="middle" style="padding: 4px 4px 0px 4px; width: 22px;
                                                                                                                                                display: none" id="deleteHgroupTooltd" runat="server">
                                                                                                                                            ...
                                                                                                                                            <td class="Menu" align="left" valign="middle" style="padding: 0px 5px 1px 5px; width: 22px;
                                                                                                                                                display: none">
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td class="popup-top-middlebg">
                                                                                                                                        <div align="left" class="Label-PopupHeading" style="float: left; padding-top: 6px;
                                                                                                                                            padding-left: 1px">
                                                                                                                                            <b><%=objlang.GetLanguageConversion("Add_Group")%></b>
                                                                                                                                        </div>
                                                                                                                                            ...
                                                                                                                                            <div align="left" style="width: 100%">
                                                                                                                                                <div align="left" style="width: 100%">
                                                                                                                                                    <div style="float: left; width: 25%">
                                                                                                                                                        <asp:Label ID="lblGroupName" runat="server" Text="Group Name" CssClass="normalText"></asp:Label>
                                                                                                                                                    </div>
                                                                                                                                                    <div class="box">
                                                                                                                                                        ...
                                                                                                                                                        <span id="spnerrGroupName" class="spanerrorMsg" style="display: none; width: 200px;">
                                                                                                                                                            <%=objlang.GetValueOnLang("Please_Enter_Group_Name")%></span>
                                                                                                                                                    </div>
                                                                                                                                                    <div class="onlyEmpty">
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                                <div align="left" style="width: 100%; clear: both">
                                                                                                                                                    <div style="float: left; width: 25%">
                                                                                                                                                        <asp:Label ID="lblAutoExpand" runat="server" Text="Auto Expand" CssClass="normalText"></asp:Label>
                                                                                                                                                    </div>
                                                                                                                                                    <div class="box">
                                                                                                                                                        <asp:CheckBox ID="chkAutoExpand" runat="server" /></div>
                                                                                                                                                </div>
                                                                                                                                                <div align="left" style="width: 100%;">
                                                                                                                                                    ...
                                                                                                                                                    <div style="float: left; padding-left: 80px;">
                                                                                                                                                        <asp:UpdatePanel ID="UPSAVEGroup" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                                                                                                                                            <ContentTemplate>
                                                                                                                                                                ...
                                                                                                                                                                <asp:Button ID="btnSaveGroup" Text="Save" CssClass="button" runat="server" OnClientClick="javascript:return ValidateGroup();" /><%--OnClick="btnSaveGroup_OnClick"--%>
                                                                                                                                                            </ContentTemplate>
                                                                                                                                                        </asp:UpdatePanel>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                            ...
                                                                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td class="popup-top-middlebg">
                                                                                                                                        <div align="left" class="Label-PopupHeading" style="float: left; padding-top: 6px;
                                                                                                                                            padding-left: 1px">
                                                                                                                                            <b><%=objlang.GetLanguageConversion("Add_HGroup")%></b>
                                                                                                                                        </div>
                                                                                                                                        <div style="float: right; padding-top: 6px; padding-right: 10px">
                                                                                                                                            <div class="CancelButtonDiv">
                                                                                                                                    ...
                                                                                                                                    <td class="popup-middlebg" align="center">
                                                                                                                                        <div id="Div1">
                                                                                                                                            <div align="left" style="width: 100%">
                                                                                                                                                <div align="left" style="width: 100%">
                                                                                                                                                    <div style="float: left; width: 26%">
                                                                                                                                                        <asp:Label ID="lblHGroupName" runat="server" Text="HGroup Name" CssClass="normalText"></asp:Label>
                                                                                                                                                    </div>
                                                                                                                                                    <div class="box">
                                                                                                                                                        ...
                                                                                                                                                        <span id="spnerrHGroupName" class="spanerrorMsg" style="display: none; width: 200px;">
                                                                                                                                                            <%=objlang.GetValueOnLang("Please_Enter_HGroup_Name")%></span>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                                <div align="left" style="width: 100%; clear: both">
                                                                                                                                                    <div style="float: left; width: 26%">
                                                                                                                                                        <asp:Label ID="Label6" runat="server" Text="Remove Label" CssClass="normalText"></asp:Label>
                                                                                                                                                    </div>
                                                                                                                                                    <div class="box">
                                                                                                                                                        <asp:CheckBox ID="chkIsDeleteAllIfBlank" runat="server" /></div>
                                                                                                                                                </div>
                                                                                                                                                <div align="left" style="width: 100%;">
                                                                                                                                                    <div style="float: left; width: 26%">
                                                                                                                                                        &nbsp;</div>
                                                                                                                                                    <div style="float: left; padding-left: 80px;">
                                                                                                                                                        <asp:UpdatePanel ID="UPSAVEHGroup" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                                                                                                                                            <ContentTemplate>
                                                                                                                                                                ...
                                                                                                                                                                <asp:Button ID="btnSaveHGroup" Text="Save" CssClass="button" runat="server" OnClientClick="javascript:return ValidateHGroup();" /><%--OnClick="btnSaveHGroup_OnClick"--%>
                                                                                                                                                            </ContentTemplate>
                                                                                                                                                        </asp:UpdatePanel>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                    ...
                                                                                                                    <table id="tbl_Editor" style="height: 1290px; width: <%=EditorWidth%>;">
                                                                                                                        <tr>
                                                                                                                            <td id="tdDesign" style="display: block; position: absolute" valign="top">
                                                                                                                                ...
                                                                                                                                <div align="center" id="ctl00_ContentPlaceHolder1_Div1" style="background: white;
                                                                                                                                    left: 0px; overflow: visible; width: <%=EditorWidth%>; height: <%=EditorHeight%>;
                                                                                                                                    position: relative; top: 0px; z-index: 1; overflow-y: scroll; overflow-x: hidden;
                                                                                                                                    border: 0px dotted #ADADAD;">
                                                                                                                                   
                                                                                                                                    <div id="ctl00_ContentPlaceHolder1_CardDiv" style="left: 0px; overflow: visible;
                                                                                                                            ...
                                                                                                                            <td>
                                                                                                                                <div id="div_EditFields" style="display: none; position: absolute; z-index: 100000;
                                                                                                                                    left: 471px; top: 481px;">
                                                                                                                                    ...
                                                                                                                                    <table style="border-width: 0pt; width: 314px;" cellpadding="0" cellspacing="0">
                                                                                                                                        <tbody>
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td style="background-image: url(../images/thought_top_tl.gif);">
                                                                                                                                                </td>
                                                                                                                                                <td>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td style="background-image: url(../images/thought_tl_lt.gif);">
                                                                                                                                                </td>
                                                                                                                                                <td id="td_Edit" style="background-image: url(../images/thought_bot_center.gif);
                                                                                                                                                    width: 314px; height: 85px;">
                                                                                                                                                    <table style="background-image: url(../images/thought_bot_center.gif); position: absolute;
                                                                                                                                                        left: 4px; top: 4px;">
                                                                                                                                                        <tbody>
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="left">
                                                                                                                                                                ...
                                                                                                                                                                <td style="text-align: right;" onclick="javascript:CloseEditWindow();">
                                                                                                                                                                    <a title="Close" style="text-decoration: none;" href="javascript://" onclick="CloseEditWindow();"
                                                                                                                                                                        id="btnCloseTextEdit"><%=objlang.GetLanguageConversion("Close")%><img style="margin-left: 2px;" src="../images/close_window.gif"
                                                                                                                                                                        ...
                                                                                                                                                                        <div style="width: 100%;" class="studioMiniToolbar">
                                                                                                                                                                            <div style="margin: 2px 0px 3px;" class="studioToolbarItem" onmouseover="javascript:EditOptionOver(this);window.status='Bold'"
                                                                                                                                                                                ...
                                                                                                                                                                                <img style="" src="../images/bold1.gif" title="Bold" id="toolbarButton_bold_button_mini_toolbar_vpls_text_5"
                                                                                                                                                                                    class="studioToolbarImage" width="21" height="20" border="0" onclick="javascript:CallEditOptions('bold');" /></div>
                                                                                                                                                                            <div style="margin: 2px 0px 3px;" class="studioToolbarItem" onmouseover="javascript:EditOptionOver(this);window.status='Bold'"
                                                                                                                                                                                onmouseout="javascript:EditOptionOut(this);window.status=''">
                                                                                                                                                                                <img style="" src="../images/italic1.gif" title="Italic" id="toolbarButton_italic_button_mini_toolbar_vpls_text_5"
                                                                                                                                                                                    class="studioToolbarImage" width="21" height="20" border="0" onclick="javascript:CallEditOptions('italic');" /></div>
                                                                                                                                                                            <div style="margin: 2px 0px 3px; display: none" class="studioToolbarItem">
                                                                                                                                                                                <img style="" src="../images/underline.gif" title="Underline" id="Img1" class="studioToolbarImage"
                                                                                                                                                                                    width="21" height="20" border="0" /></div>
                                                                                                                                                                            <div style="margin: 2px 0px 3px; display: none" class="studioToolbarItem">
                                                                                                                                                                ...
                                                                                                                                                                <td colspan="2">
                                                                                                                                                                    <div style="overflow-x: hidden; width: 300px;" id="vpls_text_5_innerContainer">
                                                                                                                                                                        <div id="vpls_text_5_inlineText" style="border: 1px solid black; width: 298px; height: 20px;">
                                                                                                                                                                            ...
                                                                                                                                                                            <asp:TextBox ID="txtEditField" runat="server" Style="display: none; border: 0px;
                                                                                                                                                                                width: 296px; height: 18px; margin: 0px; clear: both; background-image: url(../images/thought_bot_center.gif);"></asp:TextBox>
                                                                                                                                                                        </div>
                                                                                                                                                                    </div>
                                                                                                                                                                    <div style="margin-top: 5px;">
                                                                                                                                                                        <%=objlang.GetLanguageConversion("Email_Template_Note")%></div>
                                                                                                                                                                </td>
                                                                                                                                                            </tr>
                                                                                                                                                        </tbody>
                                                                                                                                                    </table>
                                                                                                                                                </td>
                                                                                                                                                <td style="background-image: url(../images/thought_tl_rt.gif);">
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td>
                                                                                                                                                ...
                                                                                                                                                <td style="background-image: url(../images/thought_bot_tl.gif);">
                                                                                                                                                </td>
                                                                                                                                                <td>
                                            ...
                                            <div align="left" style="width: 100%;">
                                                <div align="left" style="display: none;">
                                                    <div class="bglabel" style="width: 20%">
                                                        ...
                                                        <asp:Label ID="Label5" runat="server" Text="Select PDF" CssClass="normalText"></asp:Label>
                                                    </div>
                                                ...
                                                <div align="left">
                                                    <div class="bglabel" style="width: 20%; display: none;">
                                                        <asp:Label ID="lblTaxName" runat="server" Text="Layout Name" CssClass="normalText"></asp:Label>
                                                    </div>
                                                    <div class="box" style="display: none;">
                                                        ...
                                                        <span id="spn_txtName" class="spanerrorMsg" style="display: none; width: 175px;">Please
                                                            enter Layout Name </span><span id="spn_txtProductNameCheck" class="spanerrorMsg"
                                                                style="display: none; width: 175px;">Product Name already exists</span>
                                                    </div>
                                                    <script>
                                                ...
                                                <div align="left" style="clear: both">
                                                    <div style="float: left;">
                                                        <div style="float: left">
                                                            <asp:Button ID="btnUpdate" runat="server" Text="Save & Preview" CssClass="button"
                                                                OnClientClick="javascript:return ValidateName('redirect');" OnClick="btnUpdate_Submit" /></div>
                                    ...
                                    <td>
                                        ...
                                        <div style="float: left; border: 0px solid red;">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                <tr>
                                                    <td class="normalText" style="background-color: #DFFEB1; border-color: #93AB07; border-width: thin;
                                                        border-style: solid; padding-left: 2px; display: none" nowrap>
                                                        Edit Fields
                                                    </td>
                                                </tr>
                                                <tr>
            ...
            <ul class="context-menu" id="global-menu111">
                <span class="HeaderText" style="text-align: center; padding: 4px;">Text Field Options</span>
                <li>
        ...
        <div id="divrad" style="display: none; position: absolute; vertical-align: top; border: 0px solid;
            ...
            function EditField() {
                ...
                for (var i = selObjs.length - 1; i >= 0; i--) {
                    if (selObjs[i] != null) {
                        ...
                        else if (objtype == "8" || objtype == "9" || objtype == "10") {
                            document.getElementById("div_EditFields").style.display = "none";
                        }
                        else {
        ...
        <script>
            ///== To create controls ===//
            //==============================================create control================
            function CreateCtrl(CtrlType, CtrlID, CtrlTag, CtrlValue, CtrlName, CtrlMaxLen, CtrlSize, CtrlFont, CtrlFontSize, CtrlFontWeight, CtrlStyle, CtrlLeft,
                CtrlTop, CtrlWidth, CtrlHeight, CtrlColor, CtrlIsUnderline, CtrlLSpace, CtrlAlign, ConReq, CanEditText, CanMoveObject, ReqNumericValue, MaxChar,
                RotatAngle, CanChangeFont, CanChangeFontSize, CanChageFontColor, isitem, GroupID, HGroupID, AssociatedLabel, IsHGroupMain, isAutoExpand, repeat) {
                document.getElementById("div_CtrlList").style.display = "none";
                document.getElementById("div_EditFields").style.display = "none";
                divids = idnm;
                ...
                if (CtrlType == 1 || CtrlType == 2 || CtrlType == 4 || CtrlType == 5 || CtrlType == 7)//by swetha 7
                {
                    ...
                    txtdiv.setAttribute("isAutoExpand", isAutoExpand);
                    txtdiv.setAttribute("repeat", repeat);
                    ...
                    txtdiv.style.pixelLeft = CtrlLeft;
                    txtdiv.style.pixelTop = CtrlTop;
                    txtdiv.style.pixelWidth = CtrlWidth;
                    txtdiv.style.pixelHeight = CtrlHeight;

                    txtdiv.style.left = CtrlLeft + "px";
                    txtdiv.style.top = CtrlTop + "px";
                    ...
                    if (hid_HasGridlines.value == "no") {
                        ...
                        txtdiv.style.border = "1px dotted #ADADAD";
                        txtdiv.setAttribute("runat", "server");
                        txtdiv.style.position = "absolute";
                        txtdiv.style.backgroundColor = "transparent";
                        txtdiv.style.display = "inline";
                ...
                else if (CtrlType == 8 || CtrlType == 9 || CtrlType == 10 || CtrlType == 11 || CtrlType == 12)//by swetha --- HorizontalRule
                {
    ...
    var div_inter = divsarray.splice(divsarray.length, 0, divids);
        ...
        <script>
            ...
            function loadObjects() {
                ...
                var LogoPath = '<%=strSitepath %>' + 'document/' + CompanyID + '/' + CompanyLogo;
                var LogoWidth = "246";
        ...
        <script>
            ...
            function AddField(objText, objVal, isitem) {
                ...
                if (ctrlName == "CustomText") {
                    ...
                    CreateCtrl(1, '', '' + objVal + '', '' + objVal + '', '' + objText + '', '', '', 'Arial', '9pt', '', 'normal', '150', '100', '250', '15', '000000', '', '0pt', '1', '1', '1', '1', '0', '0', '0', '1', '1', '1', isitem);
            ...
            function ctrlSet() {
                if (selObj != "" && typeObj == "divobj") {
                    ...
                    list = ddlfonts; //document.getElementById(contPlNm + "lstFont");
                    idx = 0;
            ...
            function addtextbox(CtrlType) {
                if (CtrlType == 1) {
                    ...
                    CreateCtrl(1, '', '', objName, objName, '', '', 'Arial', '9pt', '', 'normal', '', '', '150', '15', '000000', '', '0pt', '1', '1', '1', '1', '0', '0', '0', '1', '1', '1', '');

                }
                else if (CtrlType == 2) {
                    var objName = "Enter your text";
                    CreateCtrl(2, '', '', objName, objName, '', '', 'Arial', '9pt', '', 'normal', '200', '100', '250', '15', '000000', '', '0pt', '1', '1', '1', '1', '0', '0', '0', '1', '1', '1', '');
            ...
            function zoomit(a) {                                    //IE,Changes made on 28.09.2011
                ...
                var zvalue_f = document.getElementById("zvalue_f");
                if (a == 'o') {
            ...
            function CallAdjustProperties() {
                ...
                window.radopen('<%=sitepath %>' + "common/templates_editproperty_popup.aspx?id=" + TemplateID + "&page=" + page + "&pop=yes", '1200', '500');
                SetRadWindow('divrad', 'divBackGroundNew', '200');
        ...
        function CheckCurrentTagPosition(objcurrenttag) {
            ...
            if (objcurrenttag.getAttribute("isitem") == 'n') {
                ...
                if (parseInt(cuurentitemtop) < parseInt(itemstart) || parseInt(cuurentitemtop) > parseInt(itemend)) {
                    objcurrenttag.setAttribute("isitem", '');
                    alert('This tag is available only between the item area, Please re-position.');
                }
            }
        }
        ...
        <script>
            ...
            function BindImg(imgName, imgWidth, imgHeight, mode, imgorgpath) {
                ...
                //var LogoPath = '<%=sitepath %>' + Securepath + '<%=ServerName %>' + '/' + CompanyID + '/' + imgName + '';
            ...
            <script>
                function LoadOnEdit() {
                    ...
                    if ('<%=CheckTagsExists %>' == "yes") {
                        ...
                        CreateCtrl(3, '', '', '../images/borders.png', '../images/borders.png', '', '', '', '', '', '', '0', '0', '783', '842', '', '', '', '', '0', '0', '1', '0', '0', '0', '0', '0', '0');
        ...
        <script type="text/javascript">
            ...
            window.parent.document.getElementById("Iframe_forAll").scrolling = "yes";
        </script>
    </div>
    </form>
</body>
