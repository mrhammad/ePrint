...
{
    public partial class DeliveryNo_List : System.Web.UI.Page, IRequiresSessionState
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            base.Title = this.objLanguage.convert(global.pageTitle(this.objLanguage.GetLanguageConversion("DeliveryNote_No"), int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
