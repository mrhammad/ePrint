...
{
    public partial class ProofReturnEmailBody : BaseClass, IRequiresSessionState
    {
        ...
        {
            this.CompanyID = Convert.ToInt32(this.Session["companyid"].ToString());
            string returnEmailText = "Proof Return Emails";
            commonClass _commonClass = new commonClass();
            ...
            sqlCommand.Parameters.AddWithValue("@CompanyID", this.CompanyID);
            sqlCommand.Parameters.AddWithValue("@Type",returnEmailText );
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(sqlCommand);
            DataSet dataSet = new DataSet();
            sqlDataAdapter.Fill(dataSet);
            _commonClass.closeConnection();
        ...
        {
            base.Response.Redirect("~/Settings/ProofReturnEmailBody.aspx");
        }
        ...
        public void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            string str = "Proof Return Emails";// base.SpecialEncode(this.ddlEmailTemplateType.SelectedValue.ToString());
            ...
            SqlCommand sqlCommand = new SqlCommand("PC_settings_ProofReturn_emailbody_insert", (new commonClass()).openConnection())
            {
                CommandType = CommandType.StoredProcedure
            };
            sqlCommand.Parameters.Add("@CompanyID", CompanyID);
            ...
            base.Response.Redirect("~/Settings/ProofReturnEmailBody.aspx?action=edit");
        }
        ...
        public void lnkBody_onClick(object sender, EventArgs e)
        {
            ...
            System.Web.UI.ScriptManager.RegisterStartupScript(this, base.GetType(), " ", "SetBCCAndCCValues('"+TextAreaCC.Value+"','"+TextAreaBCC.Value+"');", true);
        ...
        protected void imgbtnCopy_OnCommand(object sender, CommandEventArgs e)
        {
            ...
            object[] objArray = new object[] { this.strSitepath, "Settings/ProofReturnEmailBody.aspx?type=mb", num, "&cop=yes" };
