<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreshBooksAccounting_Export.aspx.cs" Inherits="ePrint.settings.FreshBooksAccounting_Export" masterpagefile="~/Templates/settingpage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="">
        <div id="padding">
            <iframe id="iframeFBAPI" scrolling="no" width="100%" height="350" frameborder="0">
            </iframe>
        </div>
    </div>
    ...
    <script type="text/javascript">
        var FBPath = "<%=FBapiPath%>";
        PopupCenter(FBPath, '1040', '600');
