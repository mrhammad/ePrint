<%@ page title="Delivery Cost" language="C#" masterpagefile="~/Templates/settingpage.master" autoeventwireup="true" CodeBehind="DeliveryCost.aspx.cs" Inherits="ePrint.settings.DeliveryCost" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="t">
                        <div class="divpadding">
                            <div align="left" style="float: left;" nowrap="nowrap">
                                <asp:Label ID="lblheader" runat="server" CssClass="navigatorpanel"><%=objLanguage.GetLanguageConversion("Settings")%>:<%=objLanguage.GetLanguageConversion("Delivery_Cost")%> </asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="">
                        ...
                        <table style="vertical-align: middle">
                            ...
                            <table style="vertical-align: middle">
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="ChkShipEngine" runat="server" onclick="javascript:EnableDisableShip"/>
                                    </td>
                                    <td>
                            ...
                            <%--<div style="float: left; margin-bottom: 1px; margin-left: 15px">
                                    <div id="div_btn2" style="display: block">
                                        <asp:Button CssClass="button" Skin="EprintbtnSkin" OnClick="btnOtherStoreImport_OnClick" EnableEmbeddedSkins="false" ID="Button2"
                                            ...
                                            <FormTemplate>
                                                <table border="0" cellpadding="0" width="100%" style="margin: 5px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="Chk_OrdersDefault" runat="server" Checked='<%# (DataBinder.Eval(Container.DataItem,"IsDefault") is DBNull ?false:Eval("FromShipEngine")) %>' />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
    ...
    <script type="text/javascript">
        ...
        var chkEnable = document.getElementById('ctl00$ContentPlaceHolder1$ChkShipEngine');
        var button1 = document.getElementById('ctl00_ContentPlaceHolder1_Button1');

        function EnableDisableShip() {
            debugger
