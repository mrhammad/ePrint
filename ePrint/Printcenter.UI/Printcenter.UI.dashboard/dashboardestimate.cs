using Printcenter.BusinessAccessLayer.dashboardNew;
using System;
using System.Data;

namespace Printcenter.UI.dashboard
{
	public class dashboardestimate
	{
		public dashboardestimate()
		{
		}

		public static DataSet CRM_Dashboard_select_Dock(long CompanyID, int CreatedBy)
		{
			return dashboardNew.CRM_Dashboard_select_Dock(CompanyID, CreatedBy);
		}
		...
		{
			return dashboardNew.Dashboard_CustomerActivity_Select(CompanyID, UserID, CompanyType, NoOFRecords, Columns);
		}
		...
		{
			return dashboardNew.Dashboard_LatestNotes_Select(clientid, companyid, companytype, showrecords, salespersonid, noofrecords, columns);
		}

		public static void Dashboard_MiniWidget_Delete(int UserID)
		{
			dashboardNew.Dashboard_MiniWidget_Delete(UserID);
		}
		...
		{
			dashboardNew.Dashboard_MiniWidget_Update(UserID, HomePageState, CopyMasterId, dockposition, indexno);
		}
		...
		{
			return dashboardNew.Dashboard_Select_ByDueDate(CompanyId, WhereCondition, noOfRecords, ModuleName, StatusID, ShowArchvedrecords);
		}
		...
		{
			return dashboardNew.Dashboard_Select_ByDueDate_SplitItem(CompanyId, WhereCondition, noOfRecords, ModuleName, StatusID, ShowArchvedrecords);
		}
		public static DataSet Dashboard_GetInvoiceCodesPercentage(int DateType,long CompanyId)
		{
			return dashboardNew.Dashboard_GetInvoiceCodesPercentage(DateType,CompanyId);
		}
		public static DataSet Dashboard_GetEstStatusCount(long CompanyId)
		{
			return dashboardNew.Dashboard_GetEstStatusCount(CompanyId);
		}
		public static DataSet Dashboard_Select_CallVS(long CompanyId, string DateType, string SalesPersonID)
		{
			return dashboardNew.Dashboard_Select_CallVS(CompanyId, DateType, SalesPersonID);
		}

		public static DataSet Dashboard_Select_CallVSCount(long CompanyId, string DateType, string SalesPersonID)
		{
			return dashboardNew.Dashboard_Select_CallVSCount(CompanyId, DateType, SalesPersonID);
		}

		public static DataTable dashboard_Select_Estimate()
		{
			return dashboardNew.Select_Estimate();
		}
		...
		{
			return dashboardNew.Dashboard_Select_JobsInvoiceEstimatesCountbySalesPersonandStatus(CompanyId, SalesPersonID, ModuleName, StatusID, ShowArchivedrecords);
		}
		...
		{
			return dashboardNew.Dashboard_Select_JobsInvoiceEstimatesCountbySalesPersonandStatus_SplitItem(CompanyId, SalesPersonID, ModuleName, StatusID, ShowArchivedrecords);
		}
		...
		{
			return dashboardNew.Dashboard_Select_JobsInvoiceEstimatesCountbySalesPersonandStatus_SplitItemNew(CompanyId, SalesPersonID, ModuleName, StatusID, ShowArchivedrecords, dateType,IsCalendarYear,StartDate,EndDate);
		}

		public static DataSet Dashboard_Select_Probalility(long CompanyId, string UserID, string Status, bool ShowArcihivedrecords)
		{
			return dashboardNew.Dashboard_Select_Probalility(CompanyId, UserID, Status, ShowArcihivedrecords);
		}
		...
		{
			return dashboardNew.Dashboard_Select_Probalility_SplitItems(CompanyId, UserID, Status, ShowArcihivedrecords);
		}
		...
		{
			return dashboardNew.Dashboard_Select_ProbalilityPercent(CompanyId, Status, ModuleName, ShowArchivedRecords);
		}
		...
		{
			return dashboardNew.Dashboard_Select_ProbalilityPercent_SplitItem(CompanyId, Status, ModuleName, ShowArchivedRecords);
		}
		...
		{
			return dashboardNew.Dashboard_Select_ProbalilityPercent_SplitItemNew(CompanyId, Status, ModuleName, ShowArchivedRecords,DateType,IsCalendarYear,FromDate,ToDate);
		}
		...
		{
			return dashboardNew.Dashboard_Select_SalesPersonByModule(CompanyId, SalesPerson, ModuleName, Status, ShowArchivedStatus);
		}
		...
		{
			return dashboardNew.Dashboard_Select_SalesPersonByModule_SplitItem(CompanyId, SalesPerson, ModuleName, Status, ShowArchivedStatus);
		}
		...
		{
			return dashboardNew.Dashboard_Select_SalesPersonByModule_SplitItemNew(CompanyId, SalesPerson, ModuleName, Status, ShowArchivedStatus,DateType,IsCalendarYear,FromDate,ToDate);
		}
		public static DataSet Dashboard_Select_DailyOrMonthlyJobTotal(long CompanyId, int CopyMasterID,string DateType, int userid)
		{
			return dashboardNew.Dashboard_Select_DailyOrMonthlyJobTotal(CompanyId,CopyMasterID,DateType, userid);
		}
		public static DataTable Dashboard_Select_LastYearDailyOrMonthlyJobTotal(long CompanyId, int CopyMasterID, string DateType)
		{
			return dashboardNew.Dashboard_Select_LastYearDailyOrMonthlyJobTotal(CompanyId, CopyMasterID, DateType);
		}
		...
		{
			return dashboardNew.Dashboard_Select_TaskCall(CompanyId, whereConditions, NoOfRecords, RecordType, SalesPersonID);
		}
		...
		{
			return dashboardNew.Dashboard_Select_TaskCall_ForAdmin(CompanyId, UserID, whereConditions, NoOfRecords, RecordType, CustomerID, Salespersonid);
		}

		public static DataSet Dashboard_Select_TaskEventCall_Today(long ClientID, long CompanyId, int UserID, string Type)
		{
			return dashboardNew.Dashboard_Select_TaskEventCall_Today(ClientID, CompanyId, UserID, Type);
		}

		public static DataTable dashboard_state_select(int UserID)
		{
			return dashboardNew.dashboard_state_select(UserID);
		}

		public static void dashboard_state_update(int UserID, string DBState)
		{
			dashboardNew.dashboard_state_update(UserID, DBState);
		}
		...
		{
			return dashboardNew.Dashboard_Target_Actual_Date_Select(CompanyID, Salesperson, QuarterType, EstimateType, TargetRecordType, Status, ShowArcihivedrecords);
		}
		...
		{
			return dashboardNew.Dashboard_Target_Actual_Date_Select_SplitItem(CompanyID, Salesperson, QuarterType, EstimateType, TargetRecordType, Status, ShowArcihivedrecords);
		}
		...
		{
			return dashboardNew.Dashboard_Target_Actual_Date_SelectPie(CompanyID, Salesperson, QuarterType, EstimateType, TargetRecordType, Status, ShowArcihivedrecords);
		}
		...
		{
			return dashboardNew.Dashboard_Target_Actual_Date_SelectPie_SplitItem(CompanyID, Salesperson, QuarterType, EstimateType, TargetRecordType, Status, ShowArcihivedrecords);
		}

		public static void Dashboard_Widget_Delete(int UserID)
		{
			dashboardNew.Dashboard_Widget_Delete(UserID);
		}
		...
		{
			dashboardNew.Dashboard_Widget_Update(UserID, HomePageState, CopyMasterId, dockposition, indexno);
		}
		...
		{
			return dashboardNew.Dashboard_WidgetTasks_Select(CompanyID, UserID, DispType, TaskStatus, NoOfRecords);
		}

		public static DataSet GetFromUsertype_ShowAll(int companyid, int userid)
		{
			return dashboardNew.GetFromUsertype_ShowAll(companyid, userid);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_AppointmentsTaskscompletedineprint(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_Callscompletedineprint(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_DataForQuoteNumberCount(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
		}

		public static DataTable PC_Dashboard_Select_MiniWidgets(long companyid, long userid)
		{
			return dashboardNew.PC_Dashboard_Select_MiniWidgets(companyid, userid);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_Newcustomerscreatedineprint(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_Quoteconversionrate(UserID, DateType, ArchivedRecords, CompanyID,  IsCalendarYear,  StartDate,  EndDate);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_Saleslivejobsteam(UserID, DateType, ArchivedRecords, CompanyID);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_SaleslivejobsteamWithValue(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate,hostName);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_Salesnumberofjobs(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_Salessubtotalvalueofjobs(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_SalesvalueofjobsGP(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
		}
		...
		{
			return dashboardNew.PC_Dashboard_Select_SalesvalueofinvoicesGP(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
		}
        ...
        {
            return dashboardNew.PC_Dashboard_Select_SalesvalueofjobsGP_Percentage(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
        }
		...
		{
			return dashboardNew.PC_Dashboard_Select_Valueofinvoicessubtotalfigure(UserID, DateType, ArchivedRecords, CompanyID, IsCalendarYear, StartDate, EndDate);
		}

		public static DataTable PC_Dashboard_Select_Widgets(long companyid, long userid)
		{
			return dashboardNew.PC_Dashboard_Select_Widgets(companyid, userid);
		}

        public static DataTable PC_Get_AccessRights(long companyid, long userid)
        {
            return dashboardNew.PC_Get_AccessRights(companyid, userid);
        }

        public static DataSet PC_Dashboard_Select_WidgetsnewPC_Dashboard_Select_Widgetsnew(long companyid, long userid)
		{
			return dashboardNew.PC_Dashboard_Select_WidgetsnewPC_Dashboard_Select_Widgetsnew(companyid, userid);
		}

		public static DataTable Select_Estimate_Converted()
		{
			return dashboardNew.Select_Estimate_Converted();
		}

		public static DataTable Select_Estimate_Highest()
		{
			return dashboardNew.Select_Estimate_Highest();
		}

		public static DataTable select_invoice_highest()
		{
			return dashboardNew.select_invoice_highest();
		}

		public static DataTable select_invoice_latest()
		{
			return dashboardNew.select_invoice_latest();
		}

		public static DataTable select_job_converted()
		{
			return dashboardNew.select_job_converted();
		}

		public static DataTable select_job_highest()
		{
			return dashboardNew.select_job_highest();
		}

		public static DataTable select_job_latest()
		{
			return dashboardNew.select_job_latest();
		}

		public static DataTable Select_SalesperSalespersonperMonth(long CompanyID, long SalesPersonID, long Range, string Type)
		{
			return dashboardNew.PC_Select_SalesperSalespersonperMonth(CompanyID, SalesPersonID, Range, Type);
		}

		public static DataTable Select_TaskCall_forwidgets(long CompanyID, long SalesPersonID, long Range, string Type)
		{
			return dashboardNew.PC_Select_TaskCall_forwidgets(CompanyID, SalesPersonID, Range, Type);
		}
	}
}