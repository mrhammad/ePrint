...
using Printcenter.DataAccessLayer.Department;
using System;
using System.Collections.Generic;
using System.Data;

namespace Printcenter.BusinessAccessLayer.Department
{
	public class Department : BaseBusiness
	{
		public Department()
		{
		}
		...
		{
			return (new DbDepartment()).address_select(ClientID, CompanyID, SelectAll);
		}
		...
		{
			return (new DbDepartment()).address_select_for_filter(ClientID, CompanyID, SelectAll, WhereConditionAddress);
		}
		...
		{
			return (new DbDepartment()).AddressAndCompanyname_select(ClientID, CompanyID, SelectAll, PageSize,CurrentPageIndex, SearchText);
		}

		public static bool CheckApproveEnable(long ClientID)
		{
			return (new DbDepartment()).CheckApproveEnable(ClientID);
		}

		public static DataTable client_contacts_select(int ClientID, int CompanyID, string SelectAll)
		{
			return (new DbDepartment()).client_contacts_select(ClientID, CompanyID, SelectAll);
		}

		public static DataSet client_contacts_selectAll(int ClientID, int CompanyID)
		{
			return (new DbDepartment()).client_contacts_selectAll(ClientID, CompanyID);
		}

		public static void costcenter_details_delete(int CostCenterID)
		{
			(new DbDepartment()).costcenter_details_delete(CostCenterID);
		}
		...
		public static void costcenter_details_insert(int CompanyID, int ClientID, string CostcenterCode, string CostcenterName, int isapplydept, int iscostdefault, int UserID)
		{
			...
			dbDepartment.costcenter_details_insert(CompanyID, ClientID, CostcenterCode, CostcenterName, isapplydept, iscostdefault, UserID);
		}

		public static DataTable costcenter_details_select(string CostCenterID)
		{
			return (new DbDepartment()).costcenter_details_select(CostCenterID);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			dbDepartment.costcenter_details_update(CostCenterID, ClientID, CostcenterCode, CostcenterName, isapplydept, iscostdefault, UserID);
		}

		public static DataTable costcenter_getdefaultcenter(int ClientID)
		{
			return (new DbDepartment()).costcenter_getdefaultcenter(ClientID);
		}

		public static DataTable costcenter_getdetails(int CompanyID, int ClientID)
		{
			return (new DbDepartment()).costcenter_getdetails(CompanyID, ClientID);
		}

		public static DataTable costcenter_getdetails_for_filter(int CompanyID, int ClientID, string WhereConditionCostcenter)
		{
			return (new DbDepartment()).costcenter_getdetails_for_filter(CompanyID, ClientID, WhereConditionCostcenter);
		}

		public static DataSet CRM_Alluser_select(int CompanyID)
		{
			return (new DbDepartment()).CRM_Alluser_select(CompanyID);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_Call_Update(CallID, CompanyID, ClientID, Subject, CallType, CallPurpose, CallDetails, ContactID, CallStartdate, CallStartTime, CallDurationMinutes, CallDurationSeconds, CallResult, AssignedTo, Description, isBillabel, LastUpdatedBy, NotespageNummber, CallEnddate, ContactPhone, ContactMobile, DepartmentPhone);
		}
		...
		{
			return (new DbDepartment()).Crm_Callsubject_Insert(CompanyID, StatusTitle, IsDefault, UserID);
		}
		...
		{
			return (new DbDepartment()).Crm_Completed_Call(ID, CompanyID, ClientId, Sectionname, NotespageNummber);
		}

		public static DataSet CRM_Contact_select(int CompanyID, int clientID)
		{
			return (new DbDepartment()).CRM_Contact_select(CompanyID, clientID);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_ContactNotes_Insert(companyId, sectionname, sectionid, filename, filesize, createUserId, subject, title, NotespageNummber, ContactID);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_ContactNotes_Update(attachmentId, companyId, sectionname, sectionid, filename, filesize, modifyUserID, subject, title, NotespageNummber, ContactID);
		}
		...
		{
			return (new DbDepartment()).Crm_Delete_CloseActivities(ID, CompanyID, ClientId, Sectionname, NotespageNummber);
		}
		...
		{
			return (new DbDepartment()).Crm_Delete_ContactNotes(companyId, sectionid, attachmentId, NotespageNummber, ContactID);
		}

		public static List<CRMNotesView> Crm_Delete_Notes(int companyId, int sectionid, int attachmentId, int NotespageNummber)
		{
			return (new DbDepartment()).Crm_Delete_Notes(companyId, sectionid, attachmentId, NotespageNummber);
		}
		...
		{
			return (new DbDepartment()).Crm_Delete_OpenActivities(ID, CompanyID, ClientId, Sectionname, NotespageNummber);
		}
		...
		{
			return (new DbDepartment()).Crm_Delete_Task(ID, CompanyID, ClientId, Sectionname, NotespageNummber);
		}

		public static void Crm_DismissAlert_Notifications(long ID, long CompanyID, string SectionName)
		{
			(new DbDepartment()).Crm_DismissAlert_Notifications(ID, CompanyID, SectionName);
		}

		public static List<CallItemsEdit> Crm_Edit_Call(int id)
		{
			return (new DbDepartment()).Crm_Edit_Call(id);
		}

		public static List<EventItemsEdit> Crm_Edit_Event(int id)
		{
			return (new DbDepartment()).Crm_Edit_Event(id);
		}

		public static List<NotesItemsDelete> Crm_Edit_Notes(int attachmentId)
		{
			return (new DbDepartment()).Crm_Edit_Notes(attachmentId);
		}

		public static List<TaskItemsEdit> Crm_Edit_Task(int id)
		{
			return (new DbDepartment()).Crm_Edit_Task(id);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_Event_Insert(companyId, subject, Location, ContactId, ContactType, EventDate, EventType, EventTypeID, EventTime, Duration, IsAllDay, Comment, IsSample, assignToUserID, createUserId, createDate, NotespageNummber);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_Event_Update(EventID, CompanyID, Subject, Location, ContactId, ContactType, EventDate, EventType, EventTypeID, EventTime, Duration, Comment, assignToUserID, modifyUserID, ModifiedDate, NotespageNummber);
		}

		public static DataSet CRM_GetEndDateOFCall(int id)
		{
			return (new DbDepartment()).CRM_GetEndDateOFCall(id);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_Notes_Insert(companyId, sectionname, sectionid, filename, filesize, createUserId, subject, title, NotespageNummber, ContactID, SpecificTo);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_Notes_Update(attachmentId, companyId, sectionname, sectionid, filename, filesize, modifyUserID, subject, title, NotespageNummber, SpecificTo);
		}

		public static DataSet CRM_Print_Customer_Info_with_Dept_Info(int CompanyID, int ClientID)
		{
			return (new DbDepartment()).CRM_Print_Customer_Info_with_Dept_Info(CompanyID, ClientID);
		}
		...
		{
			return (new DbDepartment()).CRM_Print_Customer_Info_with_Main_Contact_and_Address(CompanyID, ClientID, CompanyType);
		}
		...
		{
			return (new DbDepartment()).Crm_Search_OpenActivities(CompanyID, ClientID, WhereCondition, NotespageNummber);
		}

		public static DataSet Crm_Select_Addreess(long ClientID, long CompanyID)
		{
			return (new DbDepartment()).Crm_Select_Addreess(ClientID, CompanyID);
		}

		public static DataSet Crm_Select_Alert_Notifications(int CompanyID, int UserID, string CurrentDate, bool IsAdvancedCrm)
		{
			return (new DbDepartment()).Crm_Select_Alert_Notifications(CompanyID, UserID, CurrentDate, IsAdvancedCrm);
		}

		public static DataSet CRM_Select_AttachedFileName(int attachmentId)
		{
			return (new DbDepartment()).CRM_Select_AttachedFileName(attachmentId);
		}

		public static DataSet CRM_Select_CallPurpose(int CompanyID)
		{
			return (new DbDepartment()).CRM_Select_CallPurpose(CompanyID);
		}

		public static DataSet CRM_Select_CloseActivities(int ClientID, int CompanyId)
		{
			return (new DbDepartment()).CRM_Select_CloseActivities(ClientID, CompanyId);
		}

		public static DataSet CRM_Select_CloseActivities_Search(int ClientID, int CompanyId, string WhereCondition)
		{
			return (new DbDepartment()).CRM_Select_CloseActivities_Search(ClientID, CompanyId, WhereCondition);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_select_CloseActivity_SalesTargetSearch(ClientID, CompanyId, UserID, WhereCondition, Type, SearchText);
		}

		public static DataSet CRM_Select_Contact_Notes(int ContactID)
		{
			return (new DbDepartment()).CRM_Select_Contact_Notes(ContactID);
		}

		public static DataSet CRM_Select_Conversion_Persentage_Est_Job(int ClientId, int CompanyId)
		{
			return (new DbDepartment()).CRM_Select_Conversion_Persentage_Est_Job(ClientId, CompanyId);
		}

		public static DataSet CRM_Select_Conversion_Persentage_Est_toInvoice(int ClientId, int CompanyId)
		{
			return (new DbDepartment()).CRM_Select_Conversion_Persentage_Est_toInvoice(ClientId, CompanyId);
		}

		public static DataSet CRM_Select_OpenActivities(int ClientID, int CompanyId)
		{
			return (new DbDepartment()).CRM_Select_OpenActivities(ClientID, CompanyId);
		}

		public static DataSet CRM_Select_OpenActivitiesSearch(int ClientID, int CompanyId, string WhereCondition)
		{
			return (new DbDepartment()).CRM_Select_OpenActivitiesSearch(ClientID, CompanyId, WhereCondition);
		}

		public static DataSet CRM_Select_SalesTarget(int UserID, int CompanyId)
		{
			return (new DbDepartment()).CRM_Select_SalesTarget(UserID, CompanyId);
		}

		public static DataSet Crm_Select_TaskEventCall_Scheduler_Details(long ID, string SectionName)
		{
			return (new DbDepartment()).Crm_Select_TaskEventCall_Scheduler_Details(ID, SectionName);
		}
		...
		{
			return (new DbDepartment()).CRM_Select_Top3Estimate(ClientId, CompanyId, CompanyType, ShowRecords, SelespersonId);
		}
		...
		{
			return (new DbDepartment()).CRM_Select_Top3Invoice(ClientId, CompanyId, CompanyType, ShowRecords, SelespersonId);
		}
		...
		{
			return (new DbDepartment()).CRM_Select_Top3Job(ClientId, CompanyId, CompanyType, ShowRecords, SelespersonId);
		}
		...
		{
			return (new DbDepartment()).CRM_Select_Top3Order(ClientId, CompanyId, CompanyType, ShowRecords, SelespersonId);
		}

		public static DataSet CRM_Select_TopFiveContact(long Clientid)
		{
			return (new DbDepartment()).CRM_Select_TopFiveContact(Clientid);
		}

		public static DataSet CRM_Select_TopFiveNotes(int companyId, int sectionid)
		{
			return (new DbDepartment()).CRM_Select_TopFiveNotes(companyId, sectionid);
		}

		public static DataSet CRM_Select_TopFiveNotesSearch(int companyId, int sectionid, string WhereCondition, string SearchText)
		{
			return (new DbDepartment()).CRM_Select_TopFiveNotesSearch(companyId, sectionid, WhereCondition, SearchText);
		}

		public static DataSet CRM_Select_TopTenNotes(int companyId, int sectionid)
		{
			return (new DbDepartment()).CRM_Select_TopTenNotes(companyId, sectionid);
		}

		public static DataSet CRM_Select_Type_fromUsertype(int CompanyID, int UserTypeID)
		{
			return (new DbDepartment()).CRM_Select_Type_fromUsertype(CompanyID, UserTypeID);
		}

		public static DataSet CRM_Select_Type_fromUsertype(int UserID)
		{
			return (new DbDepartment()).CRM_Select_Type_fromUsertype(UserID);
		}

		public static List<NotesInsertSubject> Crm_subject_Insert(string sampleSubject, int companyId, string languagename)
		{
			return (new DbDepartment()).Crm_subject_Insert(sampleSubject, companyId, languagename);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_Task_Update(taskID, CompanyID, subject, taskStatus, dueDate, taskTime, contactId, contactType, priority, type, typeId, description, assignToUserId, modifyUserId, modifiedDate, NotespageNummber, ContactPhone, ContactMobile, DepartmentPhone);
		}

		public static DataSet Crm_TaskEvent_Select_SalesTerget(int ClientID, int CompanyId, int UserID)
		{
			return (new DbDepartment()).Crm_TaskEvent_Select_SalesTerget(ClientID, CompanyId, UserID);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.Crm_TaskEvent_Select_SalesTerget_Search(ClientID, CompanyId, UserID, WhereCondition, Type, SearchText);
		}

		public static void CRM_Update_AttacmentFileName(int attachmentID, int CompanyID, string fileName, string fileSize)
		{
			(new DbDepartment()).CRM_Update_AttacmentFileName(attachmentID, CompanyID, fileName, fileSize);
		}

		public static List<CRMContactView> Crm_Update_Contact(int companyID, int clientid, int contactid, int NotespageNummber)
		{
			return (new DbDepartment()).Crm_Update_Contact(companyID, clientid, contactid, NotespageNummber);
		}

		public static DataSet CRM_user_select(int CompanyID, int UserID, int ClientID)
		{
			return (new DbDepartment()).CRM_user_select(CompanyID, UserID, ClientID);
		}

		public static DataSet Dashboard_Select_TaskCall_Today_ForallUsers(long CompanyId, long UserId)
		{
			return (new DbDepartment()).Dashboard_Select_TaskCall_Today_ForallUsers(CompanyId, UserId);
		}

		public static DataSet Dashboard_Select_TaskEventCall_Scheduler(int ClientID, int CompanyId, int UserID)
		{
			return (new DbDepartment()).Dashboard_Select_TaskEventCall_Scheduler(ClientID, CompanyId, UserID);
		}
		...
		{
			return (new DbDepartment()).Dashboard_Select_TaskEventCall_ThiSweek(ClientID, CompanyId, UserID, SelectedDate);
		}

		public static DataSet Dashboard_Select_TaskEventCall_Today(long ClientID, long CompanyId, int UserID, string Type)
		{
			return (new DbDepartment()).Dashboard_Select_TaskEventCall_Today(ClientID, CompanyId, UserID, Type);
		}

		public static DataSet Dashboard_Select_TaskEventCall_Today_ForallUsers(long ClientID, long CompanyId, long UserId)
		{
			return (new DbDepartment()).Dashboard_Select_TaskEventCall_Today_ForallUsers(ClientID, CompanyId, UserId);
		}

		public static DataTable department_getAllDetails(int CompanyID, int UserID, int CustomerID, long DeptID)
		{
			return (new DbDepartment()).department_getAllDetails(CompanyID, UserID, CustomerID, DeptID);
		}
		...
		{
			return (new DbDepartment()).department_getAllDetails_for_filter(CompanyID, UserID, CustomerID, DeptID, pageno, pagesize, WhereConditionDepartment);
		}

		public static DataTable department_getDeptNameID(int CompanyID, int UserID, int CustomerID, long DeptID)
		{
			return (new DbDepartment()).department_getDeptNameID(CompanyID, UserID, CustomerID, DeptID);
		}

		public static void departmentcostcentre_delete(long DeptID)
		{
			(new DbDepartment()).departmentcostcentre_delete(DeptID);
		}

		public static void departmentcostcentre_insert(int DeptID, int selectedcostcenter)
		{
			(new DbDepartment()).departmentcostcentre_insert(DeptID, selectedcostcenter);
		}

		public static DataTable departmentcostcentre_select(int DeptID)
		{
			return (new DbDepartment()).departmentcostcentre_select(DeptID);
		}

		public static DataTable DepartmentCustomFields_ScreenName_Select(long CompanyID)
		{
			return (new DbDepartment()).DepartmentCustomFields_ScreenName_Select(CompanyID);
		}

		public static void departmentDelete(int CompanyID, int UserID, int DeleteDeptID, int AssignedDeptID)
		{
			(new DbDepartment()).departmentDelete(CompanyID, UserID, DeleteDeptID, AssignedDeptID);
		}
		...
		{
			DbDepartment dbDepartment = new DbDepartment();
			return dbDepartment.departmentInsert(DeptID, DeptName, CustomerID, ContactID, UserID, AddressID, AddressType, CreatedDate, ModifiedDate, CompanyID, DeliveryAddressID, DeptApproverID, CostCenterID, Othercostcenter, IsApprovalNotRequired, CustomField1, CustomField2, CustomField3, CustomField4, CustomField5, CustomField6, CustomField7, CustomField8, CustomField9, CustomField10, CustomField11, CustomField12, CustomField13, CustomField14, CustomField15, InvoiceContactID, OriginalFileName, ActualFilename, IsPdf, Territory_Manager_Email);
		}

		public static void departmentSetDefault(int CompanyID, int DeptID, int ClientID)
		{
			(new DbDepartment()).departmentSetDefault(CompanyID, DeptID, ClientID);
		}

		public static DataSet Forecast_Select_month(long CompanyId, int QuarterNo)
		{
			return (new DbDepartment()).Forecast_Select_month(CompanyId, QuarterNo);
		}

		public static DataTable GetContactNames(int ClientID, int CompanyID, string ContactName)
		{
			return (new DbDepartment()).GetContactNames(ClientID, CompanyID, ContactName);
		}

		public static DataTable IsApprovalSystem_Enable(int AccountID)
		{
			return (new DbDepartment()).IsApprovalSystem_Enable((long)AccountID);
		}

		public static List<LoadCustomer> LoadCustomerList(int CompanyID)
		{
			return (new DbDepartment()).LoadCustomerList(CompanyID);
		}

		public static List<LoadCustomerNameOnSummary> LoadCustomerNameOnSummary(int CompanyID, int ClientID)
		{
			return (new DbDepartment()).LoadCustomerNameOnSummary(CompanyID, ClientID);
		}

		public static List<LoadTaskStatus> LoadTaskStatusList(int CompanyID)
		{
			return (new DbDepartment()).LoadTaskStatusList(CompanyID);
		}

		public static List<DDLBindList> PopupDDLBind(int CompanyID, int ClientID)
		{
			return (new DbDepartment()).PopupDDLBind(CompanyID, ClientID);
		}

		public static DataSet rm_select_CloseActivity_SalesTarget(int ClientID, int CompanyId, int UserID)
		{
			return (new DbDepartment()).rm_select_CloseActivity_SalesTarget(ClientID, CompanyId, UserID);
		}
	}
}