...
namespace ePrint
{
    public partial class client_add : System.Web.UI.Page
    {
        ...
        protected void btncancel_onclick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (this.postback == "inv")
                {
                    if (this.mode != "edit")
                    {
                        base.Response.Redirect(string.Concat(this.strSitepath, "warehouse/inventory_add.aspx", this.jID, this.InvID));
                    }
                    else
                    {
                ...
                {
                    base.Response.Redirect(string.Concat(this.strSitepath, "common/common_popup.aspx?type=Paper&pg=setting&item=Paper", this.jID, this.InvID));
                    return;
                }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dataTable1 = SettingsBasePage.PaymentTerm_Details_Select((long)this.CompanyID);
            if (dataTable1.Rows.Count > 0)
            {
                foreach (DataRow row1 in dataTable1.Rows)
                {
                    ...
                    object[] objArray = new object[] { value, row1["Days"], "‡", row1["PaymenttermID"], "»" };
            ...
            {
                this.DeliveryAddressID = Convert.ToInt64(dataRow1["DeliveryAddressID"].ToString());
                this.InvoiceAddressID = Convert.ToInt64(dataRow1["InvoiceAddressID"].ToString());
            }
            if (!base.IsPostBack)
            {
                ...
                string empty1 = string.Empty;
                foreach (DataRow row2 in SettingsBasePage.settings_AccountStatus_SetDefault(this.CompanyID).Rows)
                {
                    empty1 = row2["StatusTitle"].ToString();
                }
                if (empty1 != "")
                {
                ...
                DataTable dataTable3 = SettingsBasePage.settings_PaymentTerms_SetDefault(this.CompanyID);
                string str1 = string.Empty;
                foreach (DataRow dataRow2 in dataTable3.Rows)
                {
                    str1 = dataRow2["Name"].ToString();
                }
                ...
                foreach (DataRow row3 in SettingsBasePage.settings_companyprofile_select(this.CompanyID).Rows)
                {
                    for (int k = 0; k < this.ddl_Deliverycountry.Items.Count; k++)
                    {
                        if (this.ddl_Deliverycountry.Items[k].ToString() == row3["Country"].ToString())
                        {
                            this.ddl_Deliverycountry.SelectedIndex = k;
                            this.hdn_selectedcounter.Value = k.ToString();
                        }
                    }
                }
                ...
                if (this.action != "" && this.action == "edit")
                {
                    ...
                    DataTable dataTable4 = CompanyBasePage.company_client_select(this.CompanyID, this.ClientID, this.companytype);
                    foreach (DataRow dataRow3 in dataTable4.Rows)
                    {
                        ...
                        this.txt_companyname.Text = this.basecls.SpecialDecode(dataRow3["ClientName"].ToString());
                        this.txt_companyalias.Text = this.basecls.SpecialDecode(dataRow3["ClientAlias"].ToString());
                        this.hdncmpnyaddressid.Value = this.basecls.SpecialDecode(dataRow3["companyaddressid"].ToString());
                        string str2 = this.basecls.SpecialDecode(dataRow3["companytypeID"].ToString());
                        ...
                        for (int l = 0; l < (int)strArrays.Length; l++)
                        {
                            foreach (RadComboBoxItem radComboBoxItem in this.ddl_type.Items)
                            {
                                ...
                                if (strArrays[l] != radComboBoxItem.Value)
                                {
                                    continue;
                                }
                        ...
                        this.ddl_status.SelectedValue = this.basecls.SpecialDecode(dataRow3["AccountStatus"].ToString());
                        this.txt_accountno.Text = this.basecls.SpecialDecode(dataRow3["AccountNumber"].ToString());
                        this.txt_email.Text = this.basecls.SpecialDecode(dataRow3["BusinessEmail"].ToString());
                        this.txt_creditlimit.Text = this.basecls.SpecialDecode(dataRow3["CreditLimit"].ToString());
                        this.txt_creditref.Text = this.basecls.SpecialDecode(dataRow3["CreditRef"].ToString());
                        this.ddl_tax1.SelectedValue = this.basecls.SpecialDecode(dataRow3["Tax1"].ToString());
                        this.ddl_tax2.SelectedValue = this.basecls.SpecialDecode(dataRow3["Tax2"].ToString());
                        this.txt_taxregno.Text = this.basecls.SpecialDecode(dataRow3["TaxRegNo"].ToString());
                        this.ddl_PaymentTerms.SelectedValue = this.basecls.SpecialDecode(dataRow3["PaymentTerms"].ToString());
                        this.txt_companyno.Text = this.basecls.SpecialDecode(dataRow3["CompanyNumber"].ToString());
                        this.txt_profitmargin.Text = (this.basecls.SpecialDecode(dataRow3["ProfitMargin"].ToString()) == "0" ? "" : this.comncls.Eprint_ReturnFinal_Formated_Amount(this.CompanyID, this.UserID, Convert.ToDecimal(dataRow3["ProfitMargin"].ToString()), 0, "", false, false, true));
                        this.txt_acopened.Text = (dataRow3["AcOpeneddate"].ToString() == "01/01/1900" ? "" : this.comncls.Eprint_return_Date_Before_View(dataRow3["AcOpeneddate"].ToString(), this.CompanyID, this.UserID, false));
                        this.txt_bankcode.Text = this.basecls.SpecialDecode(dataRow3["BankCode"].ToString());
                        this.txt_bankacno.Text = this.basecls.SpecialDecode(dataRow3["BankAccountNumber"].ToString());
                        this.txt_accountname.Text = this.basecls.SpecialDecode(dataRow3["AccountName"].ToString());
                        this.ddl_salesperson.SelectedValue = dataRow3["SalesPerson"].ToString();
                        this.txt_taxnumber.Text = this.basecls.SpecialDecode(dataRow3["TaxNumber"].ToString());
                        this.txt_balance.Text = this.basecls.SpecialDecode(dataRow3["Balance"].ToString());
                        this.txt_description.Text = this.basecls.SpecialDecode(dataRow3["Description"].ToString());
                        this.txt_email.Text = this.basecls.SpecialDecode(dataRow3["BusinessEmail"].ToString());
                        this.txt_url.Text = this.basecls.SpecialDecode(dataRow3["WebSite"].ToString());
                        this.txt_Referencedby.Text = this.basecls.SpecialDecode(dataRow3["ReferencedName"].ToString());
                        this.ddl_Referencedby.SelectedValue = this.basecls.SpecialDecode(dataRow3["ReferencedBy"].ToString());
                        this.ddl_Referencedby.SelectedItem.Text = this.basecls.SpecialDecode(this.ddl_Referencedby.SelectedItem.Text);
                        if (dataRow3["Country"].ToString() != "")
                        {
                            this.ddl_Deliverycountry.SelectedItem.Text = dataRow3["Country"].ToString();
                        }
                        else
                        {
                            this.ddl_Deliverycountry.SelectedIndex = Convert.ToInt32(this.hdn_selectedcounter.Value);
                        }
                        this.txt_Deliveryaddr1.Text = this.basecls.SpecialDecode(dataRow3["Address"].ToString());
                        this.txt_Deliveryaddr2.Text = this.basecls.SpecialDecode(dataRow3["AddressLine2"].ToString());
                        this.txt_Deliveryaddr3.Text = this.basecls.SpecialDecode(dataRow3["City"].ToString());
                        this.txt_Deliveryaddr4.Text = this.basecls.SpecialDecode(dataRow3["State"].ToString());
                        this.txt_Deliveryaddr5.Text = this.basecls.SpecialDecode(dataRow3["ZipCode"].ToString());
                        this.txt_Deliveryphone.Text = this.basecls.SpecialDecode(dataRow3["Telephone"].ToString());
                        this.txt_Deliveryfax.Text = this.basecls.SpecialDecode(dataRow3["EditFax"].ToString());
                        if (dataRow3["RoyalityFree"].ToString().ToLower() != "true")
                        {
                        ...
                        if (Convert.ToInt32(dataRow3["IsCarrier"]) != 1)
                        {
                    ...
                    DataTable dataTable5 = CompanyBasePage.address_select_For_Edit(this.CompanyID, Convert.ToInt32(this.DeliveryAddressID), this.UserID);
                    foreach (DataRow row4 in dataTable5.Rows)
                    {
                        num1++;
                        if (row4["Address"].ToString() == "")
                        {
                            this.lbl_Deliveryaddr1Value.Text = "";
                        }
                        else
                        {
                            this.lbl_Deliveryaddr1Value.Text = this.basecls.SpecialDecode(row4["Address"].ToString());
                        }
                        if (row4["AddressLine2"].ToString() == "")
                        {
                            this.lbl_Deliveryaddr2Value.Text = "";
                        }
                        else
                        {
                            this.lbl_Deliveryaddr2Value.Text = this.basecls.SpecialDecode(row4["AddressLine2"].ToString());
                        }
                        if (row4["City"].ToString() == "")
                        {
                            this.lbl_Deliveryaddr3Value.Text = "";
                        }
                        else
                        {
                            this.lbl_Deliveryaddr3Value.Text = this.basecls.SpecialDecode(row4["City"].ToString());
                        }
                        if (row4["State"].ToString() == "")
                        {
                            this.lbl_Deliveryaddr4Value.Text = "";
                        }
                        else
                        {
                            this.lbl_Deliveryaddr4Value.Text = this.basecls.SpecialDecode(row4["State"].ToString());
                        }
                        if (row4["ZipCode"].ToString() == "")
                        {
                            this.lbl_Deliveryaddr5Value.Text = "";
                        }
                        else
                        {
                            this.lbl_Deliveryaddr5Value.Text = this.basecls.SpecialDecode(row4["ZipCode"].ToString());
                        }
                        ...
                        {
                            this.lbl_DeliverycountryValue.Text = this.basecls.SpecialDecode(row4["Country"].ToString());
                        }
                        if (row4["Telephone"].ToString() == "")
                        {
                            this.lbl_DeliveryphoneValue.Text = "";
                        }
                        else
                        {
                            this.lbl_DeliveryphoneValue.Text = string.Concat("P: ", this.basecls.SpecialDecode(row4["Telephone"].ToString()));
                        }
                        if (row4["Fax"].ToString() == "")
                        {
                            this.lbl_DeliveryfaxValue.Text = "";
                        }
                        else
                        {
                            this.lbl_DeliveryfaxValue.Text = string.Concat("F: ", this.basecls.SpecialDecode(row4["Fax"].ToString()));
                        }
                    }
                    if (num1 == 0)
                    {
                    ...
                    DataTable dataTable6 = CompanyBasePage.address_select_For_Edit(this.CompanyID, Convert.ToInt32(this.InvoiceAddressID), this.UserID);
                    foreach (DataRow dataRow4 in dataTable6.Rows)
                    {
                        ...
                        {
                            this.lbl_Invoiceaddr1Value.Text = this.basecls.SpecialDecode(dataRow4["Address"].ToString());
                        }
                        ...
                        {
                            this.lbl_Invoiceaddr2Value.Text = this.basecls.SpecialDecode(dataRow4["AddressLine2"].ToString());
                        }
                        ...
                        {
                            this.lbl_Invoiceaddr3Value.Text = this.basecls.SpecialDecode(dataRow4["City"].ToString());
                        }
                        ...
                        {
                            this.lbl_Invoiceaddr4Value.Text = this.basecls.SpecialDecode(dataRow4["State"].ToString());
                        }
                        ...
                        {
                            this.lbl_Invoiceaddr5Value.Text = this.basecls.SpecialDecode(dataRow4["ZipCode"].ToString());
                        }
                        ...
                        {
                            this.lbl_InvoicecountryValue.Text = this.basecls.SpecialDecode(dataRow4["Country"].ToString());
                        }
                        ...
                        {
                            this.lbl_InvoicephoneValue.Text = string.Concat("P: ", this.basecls.SpecialDecode(dataRow4["Telephone"].ToString()));
                        }
                        ...
                        {
                            this.lbl_InvoicefaxValue.Text = string.Concat("F: ", this.basecls.SpecialDecode(dataRow4["Fax"].ToString()));
                        }
                    }
                    if (num2 == 0)
                    {
