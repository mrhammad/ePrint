...
{
    public partial class job_booklet_item : BaseClass, IRequiresSessionState
    {
            ...
            if (base.Request.Params["type"] != null)
            {
                ...
                if (string.Compare(base.Request.Params["type"].ToString(), "add", true) == 0)
                {
                    ...
                    if (base.Request.Params["FromAddAnItem"] != null)
                    {
                        if (base.Request.Params["FromAddAnItem"].ToString() == "Y")
                        {
                            ...
                            base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Job_Add_Bookelet_Item")));
                        }
                    }
                    else if (base.Request.Params["maintype"] != "edit")
                    {
                        ...
                        base.Navigation_Path(string.Concat(strArrays), "Job Add: Booklet");
                    }
                    else
                    {
                        if (empty.ToString().ToLower() != "yes")
                        ...
                        base.Navigation_Path(string.Concat(languageConversion1), "&nbsp;Job Add: Booklet");
                    }
                ...
                if (string.Compare(base.Request.Params["type"].ToString(), "edit", true) == 0)
                {
                    ...
                    if (this.IsItemCompleted == 1)
                    {
                        ...
                        base.Navigation_Path(string.Concat(strArrays1), "&nbsp;Job Edit: Booklet");
                    ...
                    base.Navigation_Path(string.Concat("<a href=../jobs/jobs_view.aspx class='subnavigator'  style='text-decoration:underline;'>", this.objLanguage.GetLanguageConversion("Job_View"), "</a>"), "&nbsp;>&nbsp;Job Add: Booklet ");
                    base.Title = this.objLanguage.convert(global.pageTitle("Job Add", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
                }
            }
        }
