...
************************************************************************************************************/	
	...
	var form_widget_amount_slider_handle = '/ODSprinting/images/slider_handle.gif';
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = "/ODSprinting/images/tab_right_" + suffix + ".gif";
	...
	{
		var txt = this.getAttribute('Color');
