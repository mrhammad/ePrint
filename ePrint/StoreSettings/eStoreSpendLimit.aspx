<%@ page title="" language="C#" masterpagefile="~/Templates/SettingsEstore.master" autoeventwireup="true" CodeBehind="eStoreSpendLimit.aspx.cs" Inherits="ePrint.StoreSettings.eStoreSpendLimit" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <div class="divpadding">
                                <div align="left" style="float: left;" nowrap="nowrap">
                                    <span class="navigatorpanel">
                                        <%=objLanguage.GetLanguageConversion("eStore_Settings") %>:&nbsp;Spend Limit&nbsp;
    ...
    <script type="text/javascript">
        function EnableDisable() {
            ...
            if (document.getElementById('ctl00_ContentPlaceHolder1_chkSpendLimit').checked == true) {
                document.getElementById('ctl00_ContentPlaceHolder1_rdoPerUser1').checked = true;
                document.getElementById('ctl00_ContentPlaceHolder1_rdoPerUser1').disabled = false;
                document.getElementById('ctl00_ContentPlaceHolder1_rdoPerdept').disabled = false;
            }
            else {
                document.getElementById('ctl00_ContentPlaceHolder1_rdoPerUser1').disabled = true;
                document.getElementById('ctl00_ContentPlaceHolder1_rdoPerdept').disabled = true;
            }
