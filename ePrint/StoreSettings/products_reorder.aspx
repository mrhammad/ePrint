<%@ page title="" language="C#" masterpagefile="~/Templates/SettingsEstore.master" autoeventwireup="true" CodeBehind="products_reorder.aspx.cs" Inherits="ePrint.StoreSettings.products_reorder"  enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="lnk_accountsList">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="GrdProductsList" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="GrdProductsList">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="GrdProductsList" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <div align="left">
                        ...
                        <div class="t">
                            <div class="divpadding">
                                <div align="left" style="float: left;" nowrap="nowrap">
                                    <span class="navigatorpanel">eStore Settings:&nbsp;Products Reorder&nbsp;
            ...
            <div class="manageedit">
                ...
                <div align="left" style="width: 50%;">
                    <div id="div_save" runat="server" style="padding: 0px 0px 10px 0px; margin-left: -2px">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                    ...
                                    <div id="div_btnsave" style="display: block; margin-left: 6px;">
                                    ...
                                    <div id="div_btnsaveprocess" style="display: none; margin-left: 16px;">
                    ...
                    <div id="div_Main" runat="server">
                        <div id="div_Grid">
                            <telerik:RadGrid ID="GrdProductsList" runat="server" GridLines="None" AllowFilteringByColumn="false"
                                ...
                                ShowStatusBar="true" OnRowDrop="grdPendingOrders_RowDrop">
                                <HeaderStyle Width="100px" Font-Bold="true" />
                                <FilterMenu CssClass="RadMenu_Eprint_Skin" />
                                <PagerStyle Mode="NextPrevAndNumeric" />
                                <MasterTableView AutoGenerateColumns="False" DataKeyNames="PriceCatalogueID" HorizontalAlign="NotSet"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn CurrentFilterFunction="Contains" DataField="CatalogueName"
                                            HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="42%" HeaderText="Products Name"
                                            ItemStyle-Width="30%" SortExpression="CatalogueName" UniqueName="CatalogueName"
                                            Visible="true">
                                            <HeaderTemplate>
                                                <div>
                                                    <asp:Label ID="label2" runat="server"></asp:Label><%=objLanguage.GetLanguageConversion("Products_Name")%></div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <div style="float: left; cursor: pointer; width: 99%; overflow: hidden; height: 15px">
                                                    <asp:Label ID="lblCatalogueName" runat="server" ToolTip='<%#Eval("CatalogueName")%>'><%#Eval("CatalogueName")%></a></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn CurrentFilterFunction="Contains" DataField="Description"
                                            ...
                                            <HeaderTemplate>
                                                <div>
                                                    <asp:Label ID="label3" runat="server"></asp:Label><%=objLanguage.GetLanguageConversion("Description")%></div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <div style="float: left; cursor: pointer; width: 99%; overflow: hidden; height: 15px">
