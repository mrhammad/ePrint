<%@ page title="" language="C#" masterpagefile="~/Templates/SettingsEstore.master" autoeventwireup="true" CodeBehind="customize_footer.aspx.cs" Inherits="ePrint.StoreSettings.customize_footer" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                ...
                                <div class="divpadding">
                                    <div align="left" style="float: left;" nowrap="nowrap">
                                        <span class="navigatorpanel">
                                            <%=objLanguage.GetLanguageConversion("Estore_Settings")%>:&nbsp;<%=objLanguage.GetLanguageConversion("Customize_Footer")%>&nbsp;
                                ...
                                <td>
                                    <div>
                                        <div style="float: left">
                                            <asp:FileUpload ID="fu_footer" size="30" CssClass="txtbox" runat="server" Style="display: block;" />
                                            <div id="div_customizeSize" runat="server" style="margin: 8px 0px 0px 2px">
                                                <%--  <div style="float: left; width: 100px;">
                                                    <asp:CheckBox ID="chk_imgSize" runat="server" Checked="false" Text='Image will be resized proportionately to a max width of 950 pixels'
                                                        onclick="javascript:customizeImgSize()" />
                                                </div>--%>
                                                <div>
                                                    <asp:RadioButton GroupName="logosize" ID="rdologosize" onclick="javascript:ChangeTextBox()"
                                                        runat="server" Text="Image will be resized proportionately to a max width of 950 pixels">
                                                    </asp:RadioButton>
                                                </div>
                                                <%--<div id="div_HeightWidht" runat="server" style="float: left; display: none; margin: 2px 0px 0px 0px">
                                                    <div style="float: left; width: 100px;">
                                                        <asp:Label ID="lbl_width" runat="server" Text="Width"></asp:Label>
                                                        <asp:TextBox ID="txt_width" runat="server" Style="width: 50px" MaxLength="4" onkeyup='javascript:checkForNumbers(this.value,"w");'></asp:TextBox>
                                                    </div>
                                                ...
                                                <div>
                                                    <div style="float: left; width: 260px;">
                                                        <div>
                                                            ...
                                                            <div id="div_HeightWidht" runat="server" style="float: right; margin: 2px 10px 0px 0px">
                                                                <div>
                                                                    <asp:TextBox ID="txt_width" Enabled="false" runat="server" Style="width: 50px; height: 13px;"
                                                    ...
                                                    <div style="float: left; width: 400px;">
                                                        <asp:RadioButton onclick="javascript:ChangeTextBox()" GroupName="logosize" ID="rdomakeitcentpercent"
                                    ...
                                    <div id="div_imageLink" runat="server" style="margin: 0px 0px 0px 0px;">
                                        <div style="float: left; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
                                            <asp:Label ID="lbl_curImg" runat="server" Text="Current Image:" Style="display: none;"></asp:Label>
                                        </div>
                                        ...
                                        <div style="float: left; padding: 0px 0px 0px 10px">
                                            <a id="A3" href="javascript:void(0);" runat="server">
                                                <asp:Label ID="lbl_remove" runat="server" Text="Change" Style="display: none;" onclick="javascript:ChangeImage();"></asp:Label>
                                            </a>
                                        </div>
                                    </div>
                                    <div style="clear: both">
                                    ...
                                    <div style="float: left; padding: 5px 0px 0px 5px; display:none">
                                        <%-- <asp:Label ID="lbl_msg" runat="server" Text="(Uploaded image size will be resized to 250px/70px)"
                                            Style="clear: both;" CssClass="smallerfontgrey">(<%=objLanguage.GetLanguageConversion("Uploaded_Image_Size_Will_Be_Resized_To_250px_70px")%>)</asp:Label><br />--%>
                            ...
                            <tr valign="top">
                                <td class="normaltext bglabel" style="width: 150px;" nowrap="nowrap">
                                    <asp:RadioButton ID="rdtemplate" GroupName="logo" Text='Custom HTML' CssClass="normaltext"
                                        Style="margin-left: -4px;" Checked="false" runat="server" onclick="CheckallRadiobutton()" />
                                </td>
                                <td>
                                    <asp:TextBox ID="txttemplate" runat="server" CssClass="txtbox" Width="550" MaxLength="50000"
    ...
    <script type="text/javascript" language="javascript">
        ...
        var fu_footer = document.getElementById("<%=fu_footer.ClientID %>");
        ...
        function ChangeImage() {
            document.getElementById("<%=fu_footer.ClientID %>").style.display = "block";
        ...
        function hide_textbox() {
            ...
            if (text.checked == true) {
                document.getElementById("<%=txttemplate.ClientID%>").disabled = true;
                document.getElementById("<%=fu_footer.ClientID%>").disabled = true;
                document.getElementById("<%=chk_imgSize.ClientID%>").disabled = true;
                document.getElementById("<%=txttext.ClientID%>").disabled = false;
                ...
                document.getElementById("<%=txttext.ClientID%>").disabled = true;
                document.getElementById("<%=txttemplate.ClientID%>").disabled = false;
                document.getElementById("<%=fu_footer.ClientID%>").disabled = true;
                document.getElementById("<%=chk_imgSize.ClientID%>").disabled = true;
                document.getElementById("<%=href_image.ClientID%>").style.textDecoration = "none";
                document.getElementById("<%=A3.ClientID%>").style.textDecoration = "none";
                ...
                document.getElementById("<%=txttext.ClientID%>").disabled = true;
                document.getElementById("<%=txttemplate.ClientID%>").disabled = true;
                document.getElementById("<%=fu_footer.ClientID%>").disabled = false;
