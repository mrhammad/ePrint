<%@ Page title="ShipEngine Sent Settings" Language="C#" masterpagefile="~/Templates/SettingsEstore.master" AutoEventWireup="true" CodeBehind="ShipEngine_Sent_Settings.aspx.cs" Inherits="ePrint.StoreSettings.ShipEngine_Sent_Settings" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
                    ...
                    <div id="">
                        ...
                        <div align="left" style="width: 100%">
                            <div style="float: left; width: 49%; border: 0px solid; display: block">
                                ...
                                <div align="left">
                                    <div class="bglabel">
                                        <asp:Label ID="lblCompanyAddress1" runat="server" Text="Address Line 1" CssClass="normalText"></asp:Label>
                                    </div>
                                    <div class="box">
                                ...
                                <div align="left">
                                    <div class="bglabel">
                                        <asp:Label ID="lblCompanyAddress2" runat="server" Text="Address Line 2" CssClass="normalText"></asp:Label>
                                    </div>
                                    <div class="box">
                                ...
                                <div align="left">
                                    <div class="bglabel">
                                        <asp:Label ID="lblCompanyAddress4" runat="server" Text="Postal Code" CssClass="normalText"></asp:Label>
                                    </div>
                                    <div class="box">
                                        ...
                                        <span id="spn_CompanyAddress4" class="spanerrorMsg" style="display: none; width: 175px">
                                          <asp:Label ID="lbl3" runat="server"></asp:Label></span>
                                    </div>
                                </div>
                                <div align="left">
                                    <div class="bglabel">
                                        <asp:Label ID="lblCity" runat="server" Text="City" CssClass="normalText"></asp:Label>
                                    </div>
                                    <div class="box">
                                        <asp:TextBox runat="server" ID="txtCity" SkinID="textPad" MaxLength="50"></asp:TextBox>
                                        <span id="spn_City" class="spanerrorMsg" style="display: none; width: 175px">
                                            <asp:Label ID="lbl4" runat="server"></asp:Label></span>
                                    </div>
                                </div>
                                <div align="left">
                                    <div class="bglabel">
                                        <asp:Label ID="lblState" runat="server" Text="State" CssClass="normalText"></asp:Label>
                                    </div>
                                    <div class="box">
                                        <asp:TextBox runat="server" ID="txtState" SkinID="textPad" MaxLength="50"></asp:TextBox>
                                        <span id="spn_State" class="spanerrorMsg" style="display: none; width: 175px">
                                            <asp:Label ID="lbl5" runat="server"></asp:Label></span>
                                    </div>
                                </div>
                                <div align="left">
                                    <div class="bglabel">
                                        <asp:Label ID="lblCompanyCountry" runat="server" Text="Country" CssClass="normalText"></asp:Label><span style="color: Red"> *</span>
                                    </div>
                                ...
                                <div align="left">
                                    <div class="bglabel">
                                        <asp:Label ID="lblweight" runat="server" Text="Weight" CssClass="normalText"></asp:Label>
                                    </div>
                                    <div class="box" style="width: 25px">
                                ...
                                <div align="left">
                                    <div class="bglabel">
                                        <asp:Label ID="lblMaxWeight" runat="server" Text="Maximum Box Weight" CssClass="normalText"></asp:Label>
                                    </div>
                                    <div class="box">
                                        <asp:TextBox runat="server" ID="txtMaxWeight" SkinID="textPad" MaxLength="50"></asp:TextBox>
                                        <span id="spn_MaxWeight" class="spanerrorMsg" style="display: none; width: 175px">
