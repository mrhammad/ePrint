<%@ page language="C#" masterpagefile="~/Templates/SettingsEstore.master" autoeventwireup="true"  CodeBehind="approval_system.aspx.cs" Inherits="ePrint.StoreSettings.approval_system" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>

<%@ Register Src="~/usercontrol/StoreSettings/approval_system.ascx" TagName="approvalsystem"
    TagPrefix="UC" %>
    ...
    <div style="float: left;" class="estore_settingBox" id="pnldetails">
        <div align="left">
                            ...
                            <div class="divpadding">
                                <div align="left" style="float: left;" nowrap="nowrap">
                                    <span class="navigatorpanel">
                                        <%=objLanguage.GetLanguageConversion("eStore_Settings_Panel")%>:&nbsp;<%=objLanguage.GetLanguageConversion("Approval_System")%>&nbsp;
            ...
            <div style="padding: 0px 10px 10px 10px">
                <UC:approvalsystem ID="ApprovalSystem" runat="server" />
            </div>
        </div>
    </div>
</asp:Content>
