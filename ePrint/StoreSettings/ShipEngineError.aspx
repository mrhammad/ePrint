<%@ Page title="ShipEngine Error" Language="C#" masterpagefile="~/Templates/SettingsEstore.master" AutoEventWireup="true" CodeBehind="ShipEngineError.aspx.cs" Inherits="ePrint.StoreSettings.ShipEngineError" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="<%=strSitepath%>js/jquery-ui-1.8.21.custom.min.js?VN='<%=VersionNumber%>'" type="text/javascript" language="javascript"></script>
                        ...
                        <div>
                            <div class="divpadding" style="height: 20px;">
                                <div style="float: left; margin-top: 3px;">
                                    <b><asp:Label ID="lblSettingName" runat="server"></asp:Label>:&nbsp; </b>

                                </div>
                                <div style="float: left; margin: 3px 0px 1px 0px;">
                                    <asp:Label ID="lbleStore" runat="server"></asp:Label></div>
                                <div id="divdrpdn" align="left" runat="server" onmouseover="javascript:OpenMoreActions(); return false;" onmouseout="javascript:ClosedMoreActions(); return false;" style="float: left; margin: -2px 0px 0px 0px; display: none;" nowrap="nowrap">
                                    <div id="divbtn" class="btnstyle" style="width: 250px; padding-left: 13px; text-align: left;" onmouseover="javascript:OpenMoreActions(); return false;">
                                    ...
                                    <div id="Div_AccountList" runat="server" class="Div_AccountList" onmouseover="javascript:OpenMoreActions(); return false;" onmouseout="javascript:ClosedMoreActions(); return false;">
                                ...
                                <div style="float: left; margin: 3px 0px 0px 10px;">
                                    <a id="spn_change" runat="server" onclick="javascript:OpenMoreActions(); return false;" style="text-decoration: underline; cursor: pointer; color: #10357F;">Select</a></div>
