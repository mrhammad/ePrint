<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eStoreHidePrice.aspx.cs" Inherits="ePrint.StoreSettings.eStoreHidePrice" masterpagefile="~/Templates/SettingsEstore.Master" %>
                            ...
                            <div class="divpadding">
                                <div align="left" style="float: left;" nowrap="nowrap">
                                    <span class="navigatorpanel">
                                        <%=objLanguage.GetLanguageConversion("eStore_Settings") %>:&nbsp;<%=objLanguage.GetLanguageConversion("Hide_Price") %> &nbsp;
                    ...
                    <div id="div1" runat="server">
                        <table width="100%" class="PrilivegeTab" style="padding-top: 8px;">
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblHidePrice" runat="server"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </div>
