<%@ page title="eStore Orders" language="C#" masterpagefile="~/Templates/SettingsEstore.master" autoeventwireup="true" CodeBehind="eStoreStatus.aspx.cs" Inherits="ePrint.StoreSettings.eStoreStatus" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="GridOrders">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="GridOrders" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <div align="left" style="width: 100%">
                    ...
                    <div class="t">
                        <div class="divpadding">
                            <div align="left" style="float: left;" nowrap="nowrap">
                                <asp:Label ID="lblheader" runat="server" CssClass="navigatorpanel"><%=objLanguage.GetLanguageConversion("Estore_Settings")%>:<%=objLanguage.GetLanguageConversion("Order_Status")%> </asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="content" class="estore_settingBox">
            <div class="">
                ...
                <div align="left" style="width: 100%; padding: 10px 0px 20px 10px;">
                    <div id="">
                            ...
                            <div align="left" style="width: 80%;">
                                    ...
                                    <MasterTableView DataKeyNames="StatusID" ToolTip="Drag and drop the rows to reorder"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn ItemStyle-Height="20px" ItemStyle-Wrap="false" ItemStyle-Width="200px"
                                                ...
                                                <HeaderTemplate>
                                                    <div style="height: 15px; width: 100%">
                                                        <asp:Label ID="lblStatus" runat="server" Text="Status" Visible="true"><%=objLanguage.GetLanguageConversion("Status")%></asp:Label>
                                                    </div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <div style="height: 15px; width: 100%; cursor: pointer;">
                                                        ...
                                                        <asp:LinkButton ID="lnkStatus" runat="server" CausesValidation="false" Text='<%#Eval("StatusTitle")%>'
                                                            ToolTip='<%#Eval("StatusTitle") %>' Visible="false"></asp:LinkButton>
                                                        <%#Eval("StatusTitle")%>
                                                    </div>
                                                    <%-- </a>--%>
                                                    <asp:Label ID="Label1" runat="server" Text='<%#Eval("StatusID")%>' Visible="false"></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn ItemStyle-Height="20px" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left">
                                                ...
                                                <HeaderStyle Font-Bold="true" />
                                                <HeaderTemplate>
                                                    <asp:Label ID="lblUserFrndName" runat="server" Text="User Friendly Name"><%=objLanguage.GetLanguageConversion("User_Friendly_Name")%></asp:Label>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <div style="height: 15px; cursor: pointer;">
                                                        <asp:Label ID="lblUserFrndNameID" runat="server" Text='<%#Eval("UserFriendlyName")%>'></asp:Label>
                                                    </div>
                                                    <%-- </a>--%>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                            ...
                                            <telerik:GridTemplateColumn ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                                                ...
                                                <HeaderTemplate>
                                                    <center>
                                                        <asp:Label ID="lbl_Orders" runat="server" Text="Default" Visible="true"><%=objLanguage.GetLanguageConversion("Default")%></asp:Label></center>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <div style="float: none; overflow: hidden; cursor: pointer;">
                                                        <center>
                                                            <asp:Image ID="img_orders" runat="server" />
                                                            <asp:HiddenField ID="hdn_Orders" runat="server" Value='<%#Eval("OrdersDefault")%>' />
                                                        </center>
                                                    </div>
                                                    <%-- </a>--%>
                                                </ItemTemplate>
                                                    ...
                                                    <tr>
                                                        <td valign="top" style="width: 140px;">
                                                            <div class="bglabel" style="width: 135px; margin: 0px">
                                                                <asp:HiddenField ID="hdn_statusid" runat="server" Value='<%#Eval("StatusID")%>' />
                                                                <asp:Label ID="lblOdrStsTtl" runat="server" Text="Order Status Title" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("Order_Status_Title")%></asp:Label>
                                                        ...
                                                        <td>
                                                            <div style="float: left; width: 100%;">
                                                                <telerik:RadTextBox ID="txtOdrStsTtl" Width="150px" runat="server" CssClass="textboxnew"
                                                                    onblur="getstring();" Text='<%#Eval("StatusTitle")%>' MaxLength="100">
                                                                </telerik:RadTextBox>
                                                                <asp:RequiredFieldValidator ID="rfvTxtStatus" runat="server" ControlToValidate="txtOdrStsTtl"
                                                                    ...
                                                                    padding-left: 4px; padding-right: 4px; float: right;margin-right: 184px;" ForeColor=""><%=objLanguage.GetLanguageConversion("Please_Enter_Orders_Status_Title")%></asp:RequiredFieldValidator>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="top" style="width: 140px;">
                                                            <div class="bglabel" style="width: 135px; margin: 0px">
                                                                <asp:Label ID="lblUsrFrndlyName" runat="server" Text="User Friendly Name" CssClass="normaltext"><%=objLanguage.GetLanguageConversion("User_Friendly_Name")%></asp:Label>
                                                                <span style="color: Red">*</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div style="float: left; width: 100%;">
                                                                <telerik:RadTextBox ID="txtUsrFrndlyName" runat="server" Width="150px" CssClass="textboxnew"
                                                                    Text='<%#Eval("UserFriendlyName")%>' MaxLength="100">
                                                                </telerik:RadTextBox>
                                                                <asp:RequiredFieldValidator ControlToValidate="txtUsrFrndlyName" ID="rfvUsrFrndName"
                                                                    ...
                                                                    Style="width: auto; padding-left: 4px; padding-right: 4px; float: right;margin-right: 179px;" ForeColor=""><%=objLanguage.GetLanguageConversion("Please_Enter_User_Friendly_Name")%></asp:RequiredFieldValidator>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="Chk_OrdersDefault" runat="server" Checked='<%# (DataBinder.Eval(Container.DataItem,"OrdersDefault") is DBNull ?false:Eval("OrdersDefault")) %>' />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                ...
                                <div style="padding-top: 5px; padding-left: 2px;">
                                    <asp:Label ID="lbl_message" runat="server">
                                                       ...
                                                       <%=objLanguage.GetLanguageConversion("InUse_Status_Delete_Alert_Message")%> 
                                                        </div>
                                    </asp:Label>
                                </div>
                            </div>
