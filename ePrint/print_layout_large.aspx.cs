...
namespace ePrint
{
    public partial class print_layout_large : System.Web.UI.Page, IRequiresSessionState
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.nonHeight = (base.Request.Params["nonHeight"].ToString() == "" ? 0 : Convert.ToDouble(base.Request.Params["nonHeight"].ToString()));
            this.nonWidth = (base.Request.Params["nonWidth"].ToString() == "" ? 0 : Convert.ToDouble(base.Request.Params["nonWidth"].ToString()));
            ...
            if (this.type != "landscape")
            {
                this.HorizontalGutter = (double)Convert.ToInt32(this.HorizontalGutter * num2 / num1);
                this.VerticalGutter = (double)Convert.ToInt32(this.VerticalGutter * num2 / num1);
                double num3 = 0;
                double num4 = 0;
                double sH = this.SH;
                double sW = this.SW;
                ...
                sH = (double)Convert.ToInt32(sH * num2 / num1);
                sW = (double)Convert.ToInt32(sW * num2 / num1);
                sH1 = (double)Convert.ToInt32(sH1 * num2 / num1);
                sW1 = (double)Convert.ToInt32(sW1 * num2 / num1);
                this.ItemHeight = (double)Convert.ToInt32(this.ItemHeight * num2 / num1);
                this.ItemWidth = (double)Convert.ToInt32(this.ItemWidth * num2 / num1);
                this.nonHeight = (double)Convert.ToInt32(this.nonHeight * num2 / num1);
                this.nonWidth = (double)Convert.ToInt32(this.nonWidth * num2 / num1);
                num3 = sH - this.nonHeight;
                num4 = sW - this.nonWidth;
                double itemWidth = 0;
                double itemHeight = 0;
                ...
                object[] objArray = new object[] { "<div  style='width: ", sW, "px; height: ", sH, "px;border:solid 1px black;'>" };
                controls.Add(new LiteralControl(string.Concat(objArray)));
                if (string.Compare(this.selected, "both", true) == 0 || string.Compare(this.selected, "restriction", true) == 0)
                {
                    ...
                    object[] objArray1 = new object[] { "<div style='width:", num4, "px;height:", num3, "px;border: dotted 1px black;' align='center'>" };
                ...
                for (int i = 0; i < this.row; i++)
                {
                    ...
                    for (int j = 0; j < this.col; j++)
                    {
                        ...
                        object[] objArray2 = new object[] { "<div style='width:", itemWidth, "px; height:", itemHeight, "px; border: solid 1px ", str, ";", str2, "'>&nbsp;", str1, "</div>" };
            ...
            else
            {
                ...
                this.HorizontalGutter = (double)Convert.ToInt32(this.HorizontalGutter * num2 / num1);
                this.VerticalGutter = (double)Convert.ToInt32(this.VerticalGutter * num2 / num1);
                sH2 = (double)Convert.ToInt32(sH2 * num2 / num1);
                sW2 = (double)Convert.ToInt32(sW2 * num2 / num1);
                ...
                this.nonHeight = (double)Convert.ToInt32(this.nonHeight * num2 / num1);
                this.nonWidth = (double)Convert.ToInt32(this.nonWidth * num2 / num1);
                num6 = sH2 - this.nonHeight;
                num7 = sW2 - this.nonWidth;
                ...
                double num8 = (horizontalGutter - horizontalGutter1) / 2;
                ...
                this.phtest.Controls.Add(new LiteralControl(string.Concat("<table  style='width: ", sW2, "px; border:solid 1px black;'>")));
                ...
                if (string.Compare(this.selected, "both", true) == 0 || string.Compare(this.selected, "restriction", true) == 0)
                {
                    ...
                    object[] objArray3 = new object[] { "<div style='width:", num7, "px;height:", num6, "px;border: dotted 1px black;' align='center'>" };
                ...
                for (int k = 0; k < this.row; k++)
                {
                    ...
                    for (int l = 0; l < this.col; l++)
                    {
                        ...
                        object[] objArray4 = new object[] { "<div style='width:", itemHeight1, "px; height:", itemWidth1, "px; border: solid 1px ", str3, ";", str5, "'>&nbsp;", str4, "</div>" };
