...
namespace jobsatprodTableAdapters
{
	[DataObject(true)]
	...
	[ToolboxItem(true)]
	public class PC_Job_At_Prod_StageTableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public PC_Job_At_Prod_StageTableAdapter()
		{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Fill(jobsatprod.PC_Job_At_Prod_StageDataTable dataTable, int? companyid)
		{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual jobsatprod.PC_Job_At_Prod_StageDataTable GetData(int? companyid)
		{
			this.Adapter.SelectCommand = this.CommandCollection[0];
			if (!companyid.HasValue)
			{
			...
			jobsatprod.PC_Job_At_Prod_StageDataTable pCJobAtProdStageDataTable = new jobsatprod.PC_Job_At_Prod_StageDataTable();
			this.Adapter.Fill(pCJobAtProdStageDataTable);
		...
		private void InitAdapter()
		{
			...
			{
				SourceTable = "Table",
				DataSetTable = "PC_Job_At_Prod_Stage"
			};
			...
			dataTableMapping.ColumnMappings.Add("quotegroupname", "quotegroupname");
			dataTableMapping.ColumnMappings.Add("quotename", "quotename");
			...
			dataTableMapping.ColumnMappings.Add("datetoprint", "datetoprint");
			dataTableMapping.ColumnMappings.Add("dateback", "dateback");
		...
		private void InitCommandCollection()
		{
			...
			this._commandCollection[0].CommandText = "dbo.PC_Job_At_Prod_Stage";
