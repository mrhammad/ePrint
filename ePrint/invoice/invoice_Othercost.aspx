<%@ page language="C#" masterpagefile="~/Templates/innerMasterPage_withoutPanel.master" autoeventwireup="true" CodeBehind="invoice_Othercost.aspx.cs" Inherits="ePrint.invoice.invoice_Othercost" title="Untitled Page" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
            ...
            <div id="Div_Options" runat="server" style="float: right; width: 35%;">
                <div style="float: left;">
                    <div id="div_btnprevious" style="display: block">
                        <asp:Button ID="btncostcentrePrevious" CssClass="button" runat="server" Text="Save"
                            Width="70px" OnClick="btnprevious_onclick" OnClientClick="javascript:loadingimg('div_btnprevious','div_prevprocess');" /></div>
                    <div id="div_prevprocess" class="button" align="center" style="width: 52px; display: none">
                ...
                <div style="float: left;">
                    <div id="div_btnfinish" style="display: block">
                        <asp:Button ID="btncostcentre" CssClass="button" OnClientClick="javascript:var a=OtherCostNext();if(a) loadingimg('div_btnfinish','div_finishprocess'); return a"
                            OnClick="btnCostFinish_OnClick" runat="server" Text="Finish" Width="65px" /></div>
                    <div id="div_finishprocess" class="button" align="center" style="width: 52px; display: none">
                        <img src="<%=strImagepath %>radimg1.gif" class="trans" alt="loading" border="0" />
                    </div>
                </div>
            </div>
