...
{
    public partial class invoice_warehouse : BaseClass, IRequiresSessionState
    {
            ...
            if (base.Request.Params["type"] != null)
            {
                if (string.Compare(base.Request.Params["type"].ToString(), "add", true) == 0)
                {
                    ...
                    if (base.Request.Params["FromAddAnItem"] != null)
                    {
                        if (base.Request.Params["FromAddAnItem"].ToString() == "Y")
                        {
                            if (str.ToLower() != "yes")
                            {
                                ...
                                string[] strArrays = new string[] { "<a href=", this.strSitepath, "<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>Invoice View</a> &nbsp;>&nbsp;", empty };
                                base.Navigation_Path(string.Concat(strArrays), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Add_Warehouse")));
                            }
                            else
                            {
                                ...
                                string[] strArrays1 = new string[] { "<a href=", this.strSitepath, "<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>Invoice View</a> &nbsp;>&nbsp;", empty };
                                base.Navigation_Path(string.Concat(strArrays1), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Add_Warehouse")));
                            }
                        }
                    }
                    else if (base.Request.Params["maintype"] != "edit")
                    {
                        base.Navigation_Path(string.Concat("<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>Invoice View</a> &nbsp;>&nbsp;", empty), this.objLanguage.GetLanguageConversion("Invoice_Add_Warehouse"));
                    }
                    else if (str.ToLower() != "yes")
                    {
                        ...
                        string[] strArrays2 = new string[] { "<a href=", this.strSitepath, "<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>Invoice View</a> &nbsp;>&nbsp;", empty };
                        base.Navigation_Path(string.Concat(strArrays2), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Add_Warehouse")));
                    }
                    else
                    {
                        ...
                        string[] strArrays3 = new string[] { "<a href=", this.strSitepath, "<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>Invoice View</a> &nbsp;>&nbsp;", empty };
                        base.Navigation_Path(string.Concat(strArrays3), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Add_Warehouse")));
                    }
                ...
                if (string.Compare(base.Request.Params["type"].ToString(), "edit", true) == 0)
                {
                    ...
                    {
                        base.Navigation_Path(string.Concat("<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>Invoice View</a> &nbsp;>&nbsp;", empty1), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Edit_Warehouse")));
                    ...
                    base.Navigation_Path("<a href=../invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>Invoice View</a>", string.Concat("&nbsp;>&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Edit_Warehouse")));
                    base.Title = this.objLanguage.convert(global.pageTitle("Invoice Add", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
                }
            }
        }
