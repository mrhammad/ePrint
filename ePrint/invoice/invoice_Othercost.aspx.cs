...
{
    public partial class invoice_Othercost : BaseClass, IRequiresSessionState
    {
        ...
        public string submodulename = "invoice";
        ...
        protected void btnCostFinish_OnClick(object sender, EventArgs e)
        {
            ...
            {
                empty = string.Concat("&InvID=", this.InvoiceID);
            }
            if (base.Request.Params["type"] != null)
            {
                ...
                if (this.isfrom_eStore.ToLower() != "yes")
                {
                    if (base.Request.Params["type"].ToString().ToLower() == "edit" && this.frmcopyitem != "yes")
                    {
                        ...
                        else
                        {
                            ...
                            {
                                this.QtyNo = Convert.ToInt16(row1["QtyNumber"].ToString());
                            }
                        ...
                        if (this.IsProductCreated == 1)
                        {
                            ...
                            if (dataTable1.Rows.Count > 0)
                            {
                                ...
                                if (num5 == 1 || num5 == 2)
                                {
                                    EstimateCommonMethods.insert_UpdatePriceCatalogueQty(Convert.ToInt64(dataTable1.Rows[0]["PricecatalogueID"].ToString()), this.EstimateID, this.EstimateItemID, "U", num5);
                                }
                            }
                        }
                    }
                    else if (base.Request.Params["type"].ToString() == "add" || this.frmcopyitem == "yes")
                    {
                        ...
                        if (this.ParentEstimateItemID != (long)0)
                        {
                            ...
                            {
                                this.ParentItemID = Convert.ToInt64(dataRow1["EstSPBWOUCitemID"].ToString());
                            }
                            foreach (DataRow row2 in EstimatesBasePage.selectEstimatetype_estimateitemid(this.ParentEstimateItemID, this.EstimateID).Rows)
                            {
                                this.EstTypeFromSP = row2["EstimateType"].ToString();
                                this.ParentItemType = row2["EstimateType"].ToString();
                            }
                            this.Est_OtherCost_Insert(this.ParentItemID, this.ParentEstimateType, this.EstimateItemID);
                        }
                        else
                        {
                            this.EstimateItemID = EstimatesBasePage.Estimate_Item_Insert(this.CompanyID, (long)0, "U", true, num6);
                    ...
                    if (this.ParentEstimateItemID == (long)0)
                    {
                        if (this.isfrom_eStore == "yes")
                        {
                            ...
                            object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, empty };
                            response.Redirect(string.Concat(estimateID));
                            return;
                        }
                        HttpResponse httpResponse = base.Response;
                        object[] objArray = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID, empty };
                    ...
                    if (this.isfrom_eStore == "yes")
                    {
                        ...
                        object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID, empty };
                        response1.Redirect(string.Concat(estimateID1));
                        return;
                    }
                    HttpResponse httpResponse1 = base.Response;
                    object[] objArray1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID, empty };
                ...
                if (this.hdn_EstQtyList.Value.ToString().Trim().Length > 0)
                {
                    ...
                    {
                        num11 = Convert.ToInt32(strArrays2[0].ToString());
                    }
                    if (strArrays2[1].ToString().Trim().Length > 0)
                    {
                        num12 = Convert.ToInt32(strArrays2[1].ToString());
                    }
                    if (strArrays2[2].ToString().Trim().Length > 0)
                    {
                        num13 = Convert.ToInt32(strArrays2[2].ToString());
                    }
                    if (strArrays2[3].ToString().Trim().Length > 0)
                    {
                        num14 = Convert.ToInt32(strArrays2[3].ToString());
                    }
                }
                if (base.Request.Params["type"].ToString().ToLower() == "edit" && this.frmcopyitem != "yes")
                {
                    ...
                    {
                        this.EstimateItemID = Convert.ToInt64(base.Request.Params["EstItemID"]);
                        EstimatesBasePage.update_OtherCostItemQty(this.EstimateItemID, "U", num11, num12, num13, num14);
                        this.Est_OtherCost_Insert(num, base.Request.Params["esttype"].ToString(), this.EstimateItemID);
                        EstimateCommonMethods.PCR_FormulaTags_Replace(this.EstimateItemID, "U");
                    }
                }
                else if (base.Request.Params["type"].ToString() == "add" || this.frmcopyitem == "yes")
                {
                    ...
                    if (this.ParentEstimateItemID != (long)0)
                    {
                        ...
                        num15 = EstimatesBasePage.Estimate_Item_Insert(this.CompanyID, this.EstimateID, "U", false, parentEstimateItemID);
                        ...
                        {
                            this.ParentItemID = Convert.ToInt64(dataRow2["EstSPBWOUCitemID"].ToString());
                        }
                        foreach (DataRow row3 in EstimatesBasePage.selectEstimatetype_estimateitemid(this.ParentEstimateItemID, this.EstimateID).Rows)
                        {
                            this.EstTypeFromSP = row3["EstimateType"].ToString();
                            this.ParentItemType = row3["EstimateType"].ToString();
                        }
                        if (base.Request.Params["type"].ToString() == "add")
                        {
                            EstimatesBasePage.estimatenumberupdateandiscomplete(this.CompanyID, this.EstimateID, num15, ConnectionClass.IsHandy);
                        }
                        this.Est_OtherCost_Insert(this.ParentItemID, this.ParentEstimateType, this.EstimateItemID);
                        this.EstimateItemID = num15;
                    }
                    else
                    {
                        this.EstimateItemID = EstimatesBasePage.Estimate_Item_Insert(this.CompanyID, (long)0, "U", true, parentEstimateItemID);
                        if (base.Request.Params["type"].ToString() == "add")
                        {
                            EstimatesBasePage.estimatenumberupdateandiscomplete(this.CompanyID, this.EstimateID, this.EstimateItemID, ConnectionClass.IsHandy);
                        }
                ...
                object[] estimateID2 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?frm=view&estid=", this.EstimateID, "&ordid=", this.EstimateID, empty };
        ...
        protected void btncostSkip_OnClick(object sender, EventArgs e)
        {
            ...
            {
                HttpResponse response = base.Response;
                object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&EstItemid=", this.ParentEstimateItemID, empty };
                response.Redirect(string.Concat(estimateID));
                return;
            }
            HttpResponse httpResponse = base.Response;
            object[] objArray = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&EstItemid=", this.ParentEstimateItemID, empty };
            httpResponse.Redirect(string.Concat(objArray));
        }
        ...
        protected void btnprevious_onclick(object sender, EventArgs e)
        {
            ...
            if (base.Request.Params["FromAddAnItem"] != null)
            {
                ...
                {
                    HttpResponse response2 = base.Response;
                    object[] estimateID2 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, this.jID, this.InvID };
                    response2.Redirect(string.Concat(estimateID2));
                }
                else
                {
                    HttpResponse httpResponse2 = base.Response;
                    object[] objArray2 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, this.jID, this.InvID };
            ...
            if (this.MainType == "add")
            {
                ...
                object[] estimateID3 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "s_add.aspx?type=Edit&prev=y&estid=", this.EstimateID, "&esttype=U&From=F&MainType=", this.MainType, this.jID, this.InvID };
                response3.Redirect(string.Concat(estimateID3));
            }
            if (this.ParentEstimateItemID == (long)0)
            {
                HttpResponse httpResponse3 = base.Response;
                object[] objArray3 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "s_add.aspx?type=Edit&prev=y&estid=", this.EstimateID, "&esttype=U&From=F&MainType=", this.MainType, this.jID, this.InvID };
            ...
            if (this.isfrom_eStore == "yes")
            {
                ...
                object[] estimateID4 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_order_summary.aspx?estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID, this.jID, this.InvID };
                response4.Redirect(string.Concat(estimateID4));
                return;
            }
            HttpResponse httpResponse4 = base.Response;
            object[] objArray4 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary_reeng.aspx?estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID, this.jID, this.InvID };
            ...
            for (int i = 0; i < (int)strArrays.Length - 1; i++)
            {
                ...
                for (int j = 0; j < (int)strArrays1.Length; j++)
                {
                    ...
                    else if (empty2 == "q")
                    {
                        ...
                        {
                            num12 = Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "UnitRate1", true) == 0)
                        {
                            num26 = Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "UnitRate2", true) == 0)
                        {
                            num27 = Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "UnitRate3", true) == 0)
                        {
                            num28 = Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        ...
                        {
                            num23 = Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "Quantity2", true) == 0)
                        {
                            num24 = Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "Quantity3", true) == 0)
                        {
                            num25 = Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "Markup", true) == 0)
                        {
                            num7 = Convert.ToDecimal(strArrays2[1].ToString());
                        ...
                        if (string.Compare(strArrays2[0], "SellingPrice", true) == 0 && !(strArrays2[1].ToString() == ""))
                        {
                            Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "SellingPrice1", true) == 0 && !(strArrays2[1].ToString() == ""))
                        {
                            Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "SellingPrice2", true) == 0 && !(strArrays2[1].ToString() == ""))
                        {
                            Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "SellingPrice3", true) == 0 && !(strArrays2[1].ToString() == ""))
                        {
                            Convert.ToDecimal(strArrays2[1].ToString());
                        }
                        if (string.Compare(strArrays2[0], "Cost", true) == 0)
                        {
                            num17 = (strArrays2[1].ToString() == "" ? new decimal(0) : Convert.ToDecimal(strArrays2[1].ToString()));
                        }
                        if (string.Compare(strArrays2[0], "Cost1", true) == 0)
                        {
                            num18 = (strArrays2[1].ToString() == "" ? new decimal(0) : Convert.ToDecimal(strArrays2[1].ToString()));
                        }
                        if (string.Compare(strArrays2[0], "Cost2", true) == 0)
                        {
                            num19 = (strArrays2[1].ToString() == "" ? new decimal(0) : Convert.ToDecimal(strArrays2[1].ToString()));
                        }
                        if (string.Compare(strArrays2[0], "Cost3", true) == 0)
                        {
                            num20 = (strArrays2[1].ToString() == "" ? new decimal(0) : Convert.ToDecimal(strArrays2[1].ToString()));
                        }
                        if (string.Compare(strArrays2[0], "SectionNo", true) == 0)
                        {
                            num29 = Convert.ToInt32(strArrays2[1]);
                    ...
                    foreach (DataRow row in dtSec.Rows)
                    {
                        if (EstType.ToLower() != "o")
                        {
                            ...
                            if (flag)
                            {
                                ...
                                num40 = num40;
                                num40 = this.ReturnExact2Decimal(num40);
                                num41 = this.objJava.Eprint_GetminimumCost_ComparedtoCostwithMarkup(num40, num41, num9, out this.CostexMarkup_forsummary, out this.MinimumCostMarkup, ref num8);
                                ...
                                decimal num78 = (num47 * num17) / new decimal(100);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.isfrom_eStore = InvoiceBasePage.IS_INVOICEorJOB_from_Webstore(this.InvoiceID, "invoice").ToLower();
            ...
            if (base.Request.Params["type"] != null)
            {
                if (string.Compare(base.Request.Params["type"].ToString(), "add", true) == 0)
                {
                    ...
                    if (base.Request.Params["FromAddAnItem"] != null)
                    {
                        if (base.Request.Params["FromAddAnItem"].ToString() == "Y")
                        {
                            if (this.isfrom_eStore != "yes")
                            {
                                ...
                                string[] languageConversion = new string[] { "<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>", this.objLanguage.GetLanguageConversion("Invoice_View"), "/a> &nbsp;>&nbsp;", empty };
                                base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Add_OtherCost")));
                            }
                            else
                            {
                                object[] objArray = new object[] { "<a href='", this.strSitepath, "Invoice/invoice_order_summary.aspx?frm=view&estid=", this.EstimateID, "&ordid=", this.EstimateID, this.InvID, "' class='subnavigator'  style='text-decoration:underline;'>", this.objLanguage.GetLanguageConversion("Invoice_Summary"), "</a>&nbsp;>" };
                                ...
                                base.Navigation_Path(string.Concat(strArrays), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Add_OtherCost")));
                            }
                        }
                    }
                    else if (base.Request.Params["maintype"] != "edit")
                    {
                        ...
                        base.Navigation_Path(string.Concat(languageConversion1), this.objLanguage.GetLanguageConversion("Invoice_Add_OtherCost"));
                    }
                    else if (this.isfrom_eStore != "yes")
                    {
                        ...
                        string[] strArrays1 = new string[] { "<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>", this.objLanguage.GetLanguageConversion("Invoice_View"), "</a> &nbsp;>&nbsp;", empty };
                        base.Navigation_Path(string.Concat(strArrays1), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Add_OtherCost")));
                    }
                    else
                    {
                        ...
                        string[] languageConversion2 = new string[] { "<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>", this.objLanguage.GetLanguageConversion("Invoice_View"), "</a> &nbsp;>&nbsp;", empty };
                        base.Navigation_Path(string.Concat(languageConversion2), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Add_OtherCost")));
                    }
                ...
                else if (string.Compare(base.Request.Params["type"].ToString(), "edit", true) == 0)
                {
                    ...
                    if (this.FromSummary == "sum" || base.Request.Params["type"].ToString() == "edit")
                    {
                        ...
                        {
                            object[] objArray2 = new object[] { "<a href='", this.strSitepath, "Invoice/invoice_order_summary.aspx?frm=view&estid=", this.EstimateID, "&ordid=", this.EstimateID, this.InvID, "' class='subnavigator'  style='text-decoration:underline;'>Invoice Summary</a>&nbsp;>" };
                            str = string.Concat(objArray2);
                        }
                    }
                    base.Navigation_Path(string.Concat("<a href=", this.strSitepath, "invoice/invoice_view.aspx class='subnavigator'  style='text-decoration:underline;'>Invoice View</a> &nbsp;>&nbsp;", str), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Invoice_Edit_OtherCost")));
