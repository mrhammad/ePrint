<%@ page language="C#" masterpagefile="~/Templates/innerMasterPage_withoutLeftTD.master" autoeventwireup="true" CodeBehind="invoices_add.aspx.cs" Inherits="ePrint.invoice.invoices_add" title="Untitled Page" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function Load_Invoice_Page() {
            ...
            document.getElementById("divEstNo").style.display = "none";
            document.getElementById("spn_txtEstimateTitle").innerHTML = "Please enter Invoice Title ";
        } 
    </script>
</asp:Content>
