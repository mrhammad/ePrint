...
{
    public partial class order_Othercost : BaseClass, IRequiresSessionState
    {
        //protected usercontrol_settings_loading_ascx ucLoading;

        //protected usercontrol_item_item_usercostcentres_new_ascx UCOtherCosts;
        ...
        //protected Button btncostcentrePrevious;

        //protected Button btncostSkip;

        //protected Button btncostcentre;
        ...
        //protected HiddenField hdn_EditOtherCostSelected;

        //protected HiddenField hdn_EditOtherCostNewItemSelected;

        //protected HiddenField hid_OtherCost_Question;

        //protected HiddenField hid_GuillotineID;

        //protected HiddenField hdnpaperID;

        //protected HiddenField hdn_IsOthChangedInAdd;

        //protected HiddenField hdn_EstQtyList;

        //protected HiddenField hdn_ItemTitle;

        //protected LinkButton lnkSaveSubOthercost;
        ...
        public string submodulename = "order";
            ...
            if (base.Request.Params["type"] != null)
            {
                ...
                else if (base.Request.Params["type"].ToString() == "add" || this.frmcopyitem == "yes")
                {
                    ...
                    if (this.ParentEstimateItemID != (long)0)
                    {
                        ...
                        num6 = EstimatesBasePage.Estimate_Item_Insert(this.CompanyID, this.EstimateID, "U", false, parentEstimateItemID);
                ...
                if (this.ParentEstimateItemID != (long)0)
                {
                    ...
                    object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID };
                    response1.Redirect(string.Concat(estimateID1));
                    return;
                }
                HttpResponse httpResponse1 = base.Response;
                object[] objArray1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID };
        ...
        {
            HttpResponse response = base.Response;
            object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID };
            response.Redirect(string.Concat(estimateID));
        }
        ...
        protected void btnprevious_onclick(object sender, EventArgs e)
        {
            if (this.QueryType != "add")
            {
                if (this.QueryType == "edit")
                {
                    ...
                    {
                        HttpResponse response = base.Response;
                        object[] estimateID = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", this.EstimateItemID };
                        response.Redirect(string.Concat(estimateID));
                        return;
                    }
                    HttpResponse httpResponse = base.Response;
                    object[] objArray = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID };
                    httpResponse.Redirect(string.Concat(objArray));
                }
                return;
            }
            ...
            {
                HttpResponse response1 = base.Response;
                object[] estimateID1 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID };
                response1.Redirect(string.Concat(estimateID1));
            }
            ...
            object[] objArray2 = new object[] { this.strSitepath, this.modulename, "/", this.submodulename, "_summary.aspx?ordid=", this.EstimateID, "&estid=", this.EstimateID, "&EstItemID=", this.ParentEstimateItemID };
        ...
        public void Insert_activity_history(int CompanyID, long EstimateID, long EstimateItemID)
        {
            if (string.Compare(this.MainType, "add", true) == 0)
            {
                ...
                string empty = string.Empty;
                foreach (DataRow row in Notes.select_item_Title_for_Activity_History(CompanyID, EstimateID, EstimateItemID, str).Rows)
                {
                ...
                if (this.modulename == "estimates")
                {
                    foreach (DataRow row1 in EstimatesBasePage.select_details_for_Activity_History(CompanyID, EstimateID, "", (long)0).Rows)
                    {
                ...
                {
                    foreach (DataRow dataRow1 in EstimatesBasePage.select_details_for_Activity_History(CompanyID, EstimateID, "", (long)0).Rows)
                    {
                ...
                {
                    foreach (DataRow row2 in EstimatesBasePage.select_details_for_Activity_History(CompanyID, EstimateID, "", (long)0).Rows)
                    {
            ...
            if (base.Request.Params["maintype"] != null && base.Request.Params["maintype"].ToString() == "edit")
            {
                ...
                if (this.modulename == "estimates")
                {
                    ...
                    {
                        DataTable dataTable = Notes.select_item_number_for_Activity_History(EstimateID, Convert.ToInt64(this.ParentEstimateItemID), this.modulename);
                        ...
                        if (this.ParentEstimateItemID == (long)0 || !(base.Request.Params["parentesttype"] != "") || !(base.Request.Params["type"].ToLower() == "edit"))
                        {
                ...
                {
                    foreach (DataRow row4 in Notes.select_item_number_for_Activity_History(EstimateID, EstimateItemID, this.modulename).Rows)
                    {
                ...
                else if (this.modulename == "orders")
                {
                    if (str2.ToLower() != "u")
                    {
                        foreach (DataRow row5 in Notes.select_item_number_for_Activity_History(EstimateID, EstimateItemID, this.modulename).Rows)
                        {
                    ...
                    {
                        DataTable dataTable1 = Notes.select_item_number_for_Activity_History(EstimateID, Convert.ToInt64(EstimateItemID), this.modulename);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (base.Request.Params["type"] != null)
            {
                if (string.Compare(base.Request.Params["type"].ToString(), "add", true) == 0)
                {
                    ...
                    if (base.Request.Params["FromAddAnItem"] != null)
                    {
                        if (base.Request.Params["FromAddAnItem"].ToString() == "Y")
                        {
                            ...
                            base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Order_Add_Othercost")));
                        }
                    }
                    else if (base.Request.Params["maintype"] != "edit")
                    {
                        ...
                        base.Navigation_Path(string.Concat(strArrays), this.objLanguage.GetLanguageConversion("Order_Add_Othercost"));
                    }
                    else
                    {
                        ...
                        base.Navigation_Path(string.Concat(languageConversion1), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Order_Add_Othercost")));
                    }
                ...
                else if (string.Compare(base.Request.Params["type"].ToString(), "edit", true) == 0)
                {
                    ...
                    {
                        base.Navigation_Path(string.Concat("<a href=", this.strSitepath, "orders/order_view.aspx class='subnavigator'  style='text-decoration:underline;'>Order View</a> &nbsp;>&nbsp;", str), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Order_Edit_Othercost")));
                    ...
                    {
                        base.Navigation_Path("<a href=../orders/order_view.aspx class='subnavigator'  style='text-decoration:underline;'>Order View</a>", string.Concat("&nbsp;>&nbsp;", this.objLanguage.GetLanguageConversion("Order_Add_Othercost")));
                        base.Title = this.objLanguage.convert(global.pageTitle("Order Add", int.Parse(this.Session["companyid"].ToString()), this.Session["companyName"].ToString()));
                    }
                }
            }
