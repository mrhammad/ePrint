<%@ Page Language="C#" MasterPageFile="~/Templates/innerMasterPage_withoutLeftTD.master" AutoEventWireup="true" CodeBehind="order_report.aspx.cs" Inherits="ePrint.orders.order_report" EnableViewStateMac="false" EnableEventValidation="false" Theme="Theme1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="reports">
                        ...
                        <li id="li_Save" class="EstimateList">
                            <div id="div_SR" nowrap="nowrap" class="EstimateUL">
                                <b><span id="spn_1" onclick="Call_Report(this.id);">
                                    <%=objLanguage.GetLanguageConversion("Saved_Reports") %>
                                </span></b>
                            </div>
                        </li>
                        <li id="li_Customize" class="EstimateList">
                            <div id="div_CR" nowrap="nowrap" class="EstimateUL">
                                <b><span id="spn_2" onclick="Call_Report(this.id);">
                                    <%=objLanguage.GetLanguageConversion("Customize_Reports")%></span></b>
                            </div>
                        </li>
                    </ul>
                    <div style="clear: both;">
                                                                            ...
                                                                            <td>
                                                                                <div align="left" style="margin-top: -4px">
                                                                                    <asp:CheckBoxList ID="chkColumns" runat="server" RepeatDirection="Horizontal" RepeatColumns="4"
                                                                                        onChecked="javascript:SelectAll();" Width="755px" CssClass="chkBoxListEst">
                                                                                        <asp:ListItem Text="" Value="OrderNo" Selected="true"></asp:ListItem>
                                                                                        ...
                                                                                        <asp:ListItem Text="" Value="OrderTitle" Selected="true"></asp:ListItem>
                                                                                        <asp:ListItem Text="" Value="CreatedDate" Selected="true"></asp:ListItem>
                                                                                        <asp:ListItem Text="" Value="OrderDate"></asp:ListItem>
                                                                                        <asp:ListItem Text="" Selected="true" Value="OrderValue"></asp:ListItem>
                                                                                        ...
                                                                                        <asp:ListItem Text="Item Status" Value="ItemStatus"></asp:ListItem>
                                                                                        ...
                                                                                        <asp:ListItem Text="Comments Field" Value="CommentsField"></asp:ListItem>
                                                                                        <asp:ListItem Text="Due Date" Value="DueDate"></asp:ListItem>
                                                                        ...
                                                                        <div id="div5" style="width: 49%; padding-left: 5px">
                                                                            <asp:UpdatePanel ID="UpdatePanel1" RenderMode="Inline" runat="server">
                                                                                <ContentTemplate>
                                                                                    <div align="left">
                                                                                        <div class="bgReportlabel" style="width: 195px">
                                                                                            <asp:Label ID="Label11" class="normalText" runat="server"><%=objLanguage.GetLanguageConversion("Report_Type")%></asp:Label>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td valign="bottom">
                                                                                                        <div id="DivSelect" runat="server" style="display: none">
                                                                                                            <a href="javascript:SummaryorDetialsSelectnone();" style="font-size: 0.8em">Select <span
                                                                                                                id="spn_SummaryDetail"></span></a>
                                                                                                        </div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                        ...
                                                                        <div id="divDetails" style="width: 49%; padding-left: 5px">
                                                                            <asp:UpdatePanel ID="UpdatePanel2" RenderMode="Inline" runat="server">
                                                                                <ContentTemplate>
                                                                                    <div align="left">
                                                                                        <div class="bgReportlabel" style="width: 195px">
                                                                                            <asp:Label ID="Label12" class="normalText" runat="server"><%=objLanguage.GetLanguageConversion("Group_The_Records_By")%></asp:Label>
                                                                                        </div>
                                                                                        <div class="box" style="float: left; padding-left: 5px;">
                                                                                            <asp:DropDownList ID="ddlsummarydetails" SkinID="onlyDDL" CssClass="normaltext" runat="server"
                                                                                                Width="200px">
                                                                                                <asp:ListItem Value="0" Text="Date">
                                                                                                </asp:ListItem>
                                                                                                <asp:ListItem Value="1" Selected="True" Text="&nbsp;&nbsp;&nbsp;Daily">
                                                                                                </asp:ListItem>
                                                                                                <asp:ListItem Value="2" Text="&nbsp;&nbsp;&nbsp;Monthly">
                                                                                                </asp:ListItem>
                                                                                                <asp:ListItem Value="3" Text="&nbsp;&nbsp;&nbsp;Yearly">
                                                                                                </asp:ListItem>
                                                                                                <asp:ListItem Value="4" Text="Customer">
                                                                                                </asp:ListItem>
                                                            ...
                                                            <div class="FilterJob">
                                                                <div align="left">
                                                                    <div align="left" style="width: 870px; padding: 5px">
                                                                        <div align="left">
                                                                            <div class="bgReportlabel" style="width: 195px">
                                                                                <span>
                                                                                    <%=objLanguage.GetLanguageConversion("Order_Range") %></span>
                                                                            </div>
                                                                            ...
                                                                            <div id="divchkEstimate" style="float: left; padding-left: 5px">
                                                                                <asp:CheckBox ID="chkEstimate" runat="server" Text="Show Order that has no assigned values"
                                                                                    Checked="true" />
                                                                            </div>
                                                                            <div class="onlyEmpty">
                                                                            </div>
                                                                        ...
                                                                        <div align="left">
                                                                            <div class="bgReportlabel" style="width: 195px">
                                                                                <span>
                                                                                    <%=objLanguage.GetLanguageConversion("Order_Status") %></span>
                                                                            </div>
                                                                            <div style="float: left; width: 5px">
                                                                                &nbsp;
                                                                            </div>
                                                                            <div style="float: left">
                                                                                ...
                                                                                <span class="smallgraytext" style="padding-left: 5px; vertical-align: top">&nbsp;(To
                                                                                    multiple select press "Ctrl" key and option)</span>
                                                                            </div>
                                                                            <div class="onlyEmpty">
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div style="float: left">
                                                                                <div style="float: left;">
                                                                                    <asp:TextBox ID="txtName" SkinID="textPad" runat="server" AutoCompleteType="disabled"
                                                                                        Width="200px">
                                                                                    </asp:TextBox><%--onkeyup="BindClientName(this.value,event,this);"--%>
                                                                                    <div class="onlyEmpty">
                                                                                    </div>
                                                                        ...
                                                                        <div align="left">
                                                                            ...
                                                                            <div style="float: left">
                                                                                <asp:DropDownList ID="ddlShowOrders" runat="server" CssClass="reportwidth175" Width="200px">
                                                                        ...
                                                                        <%--Customer Sales Person Drop down--%>
                                                                        <div align="left">
                                                                            <div class="bgReportlabel" style="width: 195px">
                                                                        ...
                                                                        <div align="left">
                                                                            ...
                                                                            <div style="float: left;">
                                                                                <div>
                                                                                    <asp:TextBox ID="txtFreetext" runat="server" SkinID="textPad" MaxLength="255" Width="200px">
                                                                                    </asp:TextBox>
                                                                                </div>
                                                                            </div>
                                                                            <div class="bgReportlabel" style="width: 195px">
                                                                            ...
                                                                            <div style="float: left;">
                                                                                <asp:CheckBoxList ID="chkfreetext" runat="server" RepeatDirection="Horizontal" RepeatColumns="4"
                                                                                    Width="550px">
                                                                                    <asp:ListItem Text="" Selected="True" Value="OrderNumber"></asp:ListItem>
                                                                                    <asp:ListItem Text="" Selected="True" Value="CustomerName"></asp:ListItem>
                                                                                    <asp:ListItem Text="" Value="StoreName"></asp:ListItem>
                                                                                    <asp:ListItem Text="" Value="ContactName"></asp:ListItem>
                                                                                    <asp:ListItem Text="" Value="Department"></asp:ListItem>
                                                                                    <asp:ListItem Text="" Value="CostCentre"></asp:ListItem>
                                                                                    <asp:ListItem Text="" Selected="True" Value="OrderTitle"></asp:ListItem>
                                                                                    ...
                                                                                    <asp:ListItem Text="" Selected="True" Value="EventName"></asp:ListItem>
                                                                                    <asp:ListItem Text="" Value="CustomerSalesperson"></asp:ListItem>
                                                                                    <asp:ListItem Text="" Value="AccountingCode"></asp:ListItem>
                                                                        ...
                                                                        <table style="width: 670px;">
                                                                            <tr>
                                                                                <td style="width: 145px;">
                                                                                    <asp:CheckBox ID="chkDateOption" runat="server" Text="Ordered Date" Font-Bold="true"
                                                                                ...
                                                                                <td style="width: 200px; padding-left: 12px">
                                                                                    ...
                                                                                    <span id="spn_lastque" runat="server" style="display: none" class="smallgraytext">(Oct - Dec 2009)</span> <span id="spn_year" runat="server" style="display: none" class="smallgraytext">(2009)</span> <span id="span_halfyear" runat="server" style="display: none" class="smallgraytext">(Oct 2013 - March 2014) </span>
                                                                                    ...
                                                                                    <div align="left" id="divjobdate" runat="server" style="display: none">
                                                                                        <asp:TextBox ID="txtFrom" runat="server" SkinID="textPad" Width="100px" Enabled="false">
                                                                                        </asp:TextBox><span class="normalText">&nbsp;To&nbsp;</span><asp:TextBox ID="txtTo"
                                                                                            runat="server" SkinID="textPad" Width="100px" Enabled="false"></asp:TextBox>
                                                                                        <span id="spn_txtFromDate" class="spanerrorMsg" style="display: none; width: 150px">Please enter Req'd Date </span><span id="spn_txtToDate" class="spanerrorMsg" style="display: none; width: 250px;">Please enter Req'd Date </span><span id="spndateRange" class="spanerrorMsg"
                                                                                            style="display: none">Date Range is not in Correct Format</span> </span>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                ...
                                                                <div id="divdates" align="left" style="display: <%=divdatesVisibility%>; margin-left: 460px; padding-bottom: 4px">
                                                                    <asp:DropDownList ID="ddldates" SkinID="onlyDDL" runat="server" Width="150px">
                                                                        <asp:ListItem Text="Apply Both Dates" Value="1">
                                                                        </asp:ListItem>
                                                                        <asp:ListItem Text="Apply Either Dates" Value="2">
                                                                        </asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </div>
                                                                <div align="left">
                                                                        ...
                                                                        <table style="width: 670px;">
                                                                            <tr>
                                                                                <td style="width: 215px;">
                                                                                    <asp:CheckBox ID="chkconvertedoption" runat="server" Text="Order Converted to Job"
                                                                                        Font-Bold="true" onclick="javascript:EnableConvertedDateOption();checkdates();OnCheckShowConverted();" />
                                                                                </td>
                                                                                <td align="center" style="width: 85px;">
                                                                                    <asp:DropDownList ID="rdlconverteddate" Enabled="false" runat="server" Width="200px"
                                                                                ...
                                                                                <td style="width: 250px; padding-left: 12px">
                                                                                    <span id="spn_daily_c" style="display: none" runat="server" class="smallgraytext">(01/10/2010)</span> <span id="spn_yest_c" style="display: none" runat="server" class="smallgraytext">(01/10/2010)</span> <span id="spn_month_c" style="display: none" runat="server"
                                                                                        class="smallgraytext">(1/10/2010 to 31/10/2010)</span> <span id="spn_quarter_c"
                                                                                            style="display: none" runat="server" class="smallgraytext">(Oct - Dec 2010)</span>
                                                                                    <span id="spn_lastque_c" style="display: none" runat="server" class="smallgraytext">(Oct - Dec 2010)</span> <span id="spn_year_c" runat="server" style="display: none"
                                                                                        class="smallgraytext">(2010)</span> <span id="spn__halfyear_c" runat="server"
                                                                                            style="display: none" class="smallgraytext">(Oct 2013 - March 2014)</span>
                                                                                    ...
                                                                                    <div align="left" id="divjobdate_c" runat="server" style="display: none">
                                                                                        <asp:TextBox ID="txtfromdate_converted" runat="server" SkinID="textPad" Width="100px"
                                                                                            Enabled="false"></asp:TextBox><span class="normalText">&nbsp;To&nbsp;</span><asp:TextBox
                                                                                                ID="txttodate_converted" runat="server" SkinID="textPad" Width="100px" Enabled="false"></asp:TextBox>
                                                                                        <span id="Span8" class="spanerrorMsg" style="display: none; width: 150px">Please enter
                                                                                            Req'd Date </span><span id="Span9" class="spanerrorMsg" style="display: none; width: 250px;">Please enter Req'd Date </span><span id="Span10" class="spanerrorMsg" style="display: none">Date Range is not in Correct Format</span> </span>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                ...
                                                                <div align="left" style="padding: 2px;">
                                                                    <table cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <div class="bgReportlabel12">
                                                                                    <span>&nbsp;<%=objLanguage.GetLanguageConversion("Count")%></span>
                                                                                </div>
                                                                            </td>
                                                                            <td colspan="3">
                                                                                <asp:CheckBoxList ID="chkColumns1" runat="server" RepeatDirection="Horizontal" RepeatColumns="4"
                                                                                    Width="520px">
                                                                                    <asp:ListItem Value="EstimateCount" Text="">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="jobcount" Text="">
                                                                                    </asp:ListItem>
                                                                                </asp:CheckBoxList>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <div class="bgReportlabel12">
                                                                                    <span>&nbsp;<%=objLanguage.GetLanguageConversion("Order_Value_Exc_Tax_With_Bracket")%></span>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <asp:CheckBoxList ID="chkExcTax" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
                                                                                    <asp:ListItem Value="chkTaxTotal" Text="" Selected="True">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="chkTaxAvg" Text="">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="chkTaxMax" Text="">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="chkTaxMin" Text="">
                                                                                    </asp:ListItem>
                                                                                </asp:CheckBoxList>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <div class="bgReportlabel12">
                                                                                    <span>&nbsp;<%=objLanguage.GetLanguageConversion("Order_Value") %></span>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <asp:CheckBoxList ID="chkColumns2" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
                                                                                    <asp:ListItem Value="OrderTotal" Text="" Selected="True">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="OrderAverage" Text="">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="OrderMaximum" Text="">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="OrderMinimum" Text="">
                                                                                    </asp:ListItem>
                                                                                </asp:CheckBoxList>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <div class="bgReportlabel12">
                                                                                    <span id="spn_GrossProfit" runat="server">&nbsp;<%=objLanguage.GetLanguageConversion("Gross_Profit") %>
                                                                            ...
                                                                            <td>
                                                                                <asp:CheckBoxList ID="ChkColumnsNetprofit" runat="server" RepeatDirection="Horizontal"
                                                                                    RepeatColumns="4">
                                                                                    <asp:ListItem Value="NetTotal" Text="">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="NetAverage" Text="Average">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="NetMaximum" Text="Maximum">
                                                                                    </asp:ListItem>
                                                                                    <asp:ListItem Value="NetMinimum" Text="Minimum">
                                                                                    </asp:ListItem>
                                                                                </asp:CheckBoxList>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <div class="bgReportlabel12">
                                                                                    <span id="Span3" runat="server">&nbsp;<%=objLanguage.GetLanguageConversion("Gross_Profit") %>
                                                                                        (%)</span>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                        ...
                                        <div align="left" style="padding: 5px">
                                            <div style="float: left">
                                                <div style="display: block">
                                                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" OnClientClick="javascript:loadingimage(this.id,'divCancelprocess')"
                                            ...
                                            <div style="float: left; width: 100px">
                                                <div id="div_update" style="display: block">
                                                    <asp:Button ID="btnUpdateExisting" runat="server" Text="Update Report" OnClick="btnUpdateExisting_OnClick"
                                                        CssClass="button" OnClientClick="javascript: var a=ValidateCaller(); if(a)loadingimage('div_update','div_btnUpdateExistingprocess'); return a;" Visible="false" />
                                                </div>
                                                <div id="div_btnUpdateExistingprocess" style="display: none;">
                                                    <img src="<%=strImagepath %>radimg1.gif" class="loadingimg" style="margin-top: 1px;" alt="loading" border="0" />
                                                </div>
                                            </div>
                                        </div>
                                        <div style="float: left; margin-top: -4px; margin-left: 11px;">
        ...
        <div id="divexport">
                                ...
                                <tr>
                                    ...
                                    <td class="act_floatleft">
                                        <asp:ImageButton ToolTip="Back to Search Option" ImageUrl="~/images/image_EM_b.png"
                                            ID="btnfilter" OnClick="btnfilter_OnClick" runat="server" Text="Back to Search Option"
                                    ...
                                    <td class="act_floatleft" nowrap="nowrap">
                                        <asp:TextBox ID="txt1" runat="server" Width="40px" Visible="false" onblur="javascript:AllowNumber(this,this.value)">
                                        </asp:TextBox>&nbsp;
                                    </td>
                                    <td class="act_floatleft" nowrap="nowrap">
                                        <asp:ImageButton ToolTip="Go To" ImageUrl="~/images/gotopage.gif" ID="btngo" runat="server"
                                            Visible="false" BackColor="Transparent" OnClick="btngo_OnClick" OnClientClick="javascript:return showWaitMessage();" />
                                    </td>
                                    <td></td>
                                </tr>
                            </table>
            ...
            <div id="divexport1">
                <div id="div_Main" runat="server">
                    ...
                    <div id="div_Grid">
                        <%--    <asp:GridView ID="GridOrderReport" runat="server" Width="100%" SkinID="GridStyleReport"
                            HeaderStyle-HorizontalAlign="Left" PageSize="100" RowStyle-HorizontalAlign="Left"
                            OnDataBound="GridOrdReport_DataBound" CellPadding="4">
                        </asp:GridView>--%>

                        <telerik:RadGrid ID="GridOrderReport" Width="100%" runat="server" AllowAutomaticDeletes="false"
                            ShowFooter="True" AllowAutomaticInserts="false" CssClass="RadGrid_Eprint_Skin"
                            OnItemDataBound="GridOrdReport_DataBound" AllowAutomaticUpdates="false" Skin="RadGrid_Eprint_Skin"
                            ...
                            OnPageIndexChanged="GridOrder_PageIndexChanged" OnNeedDataSource="GridOrder_OnNeedDataSource"
                            OnPageSizeChanged="GridOrder_PageSizeChanged" PageSize="50" Visible="false" EnableAjaxSkinRendering="true" EnableViewState="true">
                    ...
                    <table width="350px" cellpadding="3" cellspacing="0">
                        ...
                        <tr id="CountValue" visible="false" runat="server">
                            <td style="width: 200px; border-right: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black">
                                <span style="font-weight: bold">Order. Converted to Jobs</span>
                            </td>
                        ...
                        <table width="350" cellpadding="3" cellspacing="0" border="1px solid black" style="border-left: 0; border-right: 0; border-top: 0;">
                            ...
                            <tr id="tableEstExc" runat="server" visible="false">
                                <td style="width: 200px; border-bottom: 0; border-right: 0;">
                                    <span style="font-weight: bold;">Order Value (Ex. Tax)</span>
                                </td>
                            ...
                            <tr id="tableEstValue" runat="server" visible="false">
                                <td style="width: 200px; border-bottom: 0; border-right: 0;">
                                    <span style="font-weight: bold;">Order Value (Inc. Tax)</span>
                                </td>
                                <td style="text-align: right; border-bottom: 0;">
        ...
        <asp:HiddenField ID="HdnSortBy" runat="server" Value="OrderNo" />
            ...
            function SelectAll() {
                ...
                if (trim12(lnkSelectAll.innerHTML) == trim12('<%=objLangClass.GetLanguageConversion("Select_All_Columns") %>')) {
                    for (var i = 0; i < chk.length; i++) {
                        ...
                        var option1 = document.createElement("option");
                        if (i == 0) {
                            option1.text = "Order Number";
                            option1.value = "OrderNo";
                        }
                        else if (i == 1) {
                            ...
                            option1.text = "Order Title";
                            option1.value = "OrderTitle";
                        }
                        else if (i == 10) {
                            option1.text = "Order Salesperson";
                            ...
                            option1.text = "Order Date";
                            option1.value = "OrderDate";
                        }

                        else if (i == 14) {
                            option1.text = "Order Value";
                            option1.value = "OrderValue";
                        }
                        ...
                        if (i == 0 || i == 1 || i == 11 || i == 10 || i == 12 || i == 16 || i == 13 || i == 14 || i == 28 || i == 29 || i == 52) {
                            if (columnsList[i].checked) {
                                dropDownListRef.options.add(option1);
                            }
                        }
                    }
                    dropDownListRef.value = "OrderNo";
                    HdnSortBy.value = "OrderNo";
        ...
        <script type="text/javascript">
            ...
            function CheckDateFormat() {
                ...
                if (estno.checked == false) {
                    alert('Please check Order number to generate report');
                    return false;
                }
                var estval = document.getElementById('ctl00_ContentPlaceHolder1_chkColumns_14');
                if (estval.checked == false) {
                    alert('Please check Order value to generate report');
                    return false;
                }
        ...
        <asp:Panel ID="pnlGridview" runat="server" Visible="false">
            <script type="text/javascript">
                var GridItemTitle = document.getElementById("<%=GridOrderReport.ClientID %>");
        ...
        <script language="javascript" type="text/javascript">
            ...
            function ValidateSave() {
                ...
                //                var estval = document.getElementById('ctl00_ContentPlaceHolder1_RadPanelBar1_i0_chkColumns_14');
                //                if (estval.checked == false) {
                //                    alert('Please check Order value to generate report');
                //                    return false;
                //                }
            ...
            function GetDropdownBindonBack() {
                ...
                var ddlJobCreated = document.getElementById("ctl00_ContentPlaceHolder1_RadPanelBar1_i2_rdlDate");
                var spnAnnualYear = document.getElementById("ctl00_ContentPlaceHolder1_RadPanelBar1_i2_spn_rdlDate_annualYear");
                var ddlvalue = ddlJobCreated.options[ddlJobCreated.selectedIndex].value;
                ...
                if (chkDateOption.checked) {
                    ...
                    if (ddlvalue == "daily") {
                        ...
                        spnAnnualYear.style.display = "none";
                        txtFromDate.disabled = true;
                        txtToDate.disabled = true;
                    }
                    ...
                    else if (ddlvalue == "thisannualyear") {
                        spn_1.style.display = "none";
                        spn_2.style.display = "none";
                        spn_3.style.display = "none";
                        spn_4.style.display = "none";
                        ...
                        txtFromDate.disabled = true;
                        txtToDate.disabled = true;
                        spnAnnualYear.style.display = "block";
                    }
                }
            }
            ...
            function GetDropdownBindback() {
                ...
                var tilldate = document.getElementById("ctl00_ContentPlaceHolder1_RadPanelBar2_i2_tilldate");
        ...
        <script>
            ...
            //====Created On 18-12-2012== By Sharan
            ...
            function GetDropdownBind() {
                ...
                var spn_7 = document.getElementById("ctl00_ContentPlaceHolder1_RadPanelBar1_i2_spn_lastque");
                var spn_8 = document.getElementById("ctl00_ContentPlaceHolder1_RadPanelBar1_i2_span_halfyear");
                var spn_lastyear = document.getElementById("ctl00_ContentPlaceHolder1_RadPanelBar1_i2_spn_lastyear");
                var ddlJobCreated = document.getElementById("ctl00_ContentPlaceHolder1_RadPanelBar1_i2_rdlDate");
                ...
                if (ddlvalue == "thisannualyear") {
                    ...
                    spn_7.style.display = "none";
                    spn_8.style.display = "none";
                    spn_lastyear.style.display = "none";
                    ...
                    spn_7.style.display = "none";
                    spn_8.style.display = "none";
                    spn_lastyear.style.display = "block";
                    spn_rdlDate_annualYear.style.display = "none";
                    txtFromDate.disabled = true;
                    txtToDate.disabled = true;
                }
