...
{
    public partial class order_litho_booklet_item : BaseClass, IRequiresSessionState
    {
        ...
        public order_litho_booklet_item()
        {
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (base.Request.Params["type"] != null)
            {
                if (string.Compare(base.Request.Params["type"].ToString(), "add", true) == 0)
                {
                    ...
                    {
                        base.Navigation_Path(string.Concat("<a href=../orders/order_view.aspx class='subnavigator'  style='text-decoration:underline;'>", this.objLanguage.GetLanguageConversion("Order_View"), "</a>"), string.Concat("&nbsp;>&nbsp;", this.objLanguage.GetLanguageConversion("Order_Add_Litho_Booklet")));
                    }
                    else
                    {
                        ...
                        base.Navigation_Path(string.Concat(languageConversion), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Order_Add_Litho_Booklet")));
                    }
                ...
                if (string.Compare(base.Request.Params["type"].ToString(), "edit", true) == 0)
                {
                    ...
                    {
                        object[] objArray = new object[] { "<a href='", this.strSitepath, "orders/order_summary.aspx?frm=view&ordid=", this.EstimateID, "&estid=", this.EstimateID, "' class='subnavigator'  style='text-decoration:underline;'>", this.objLanguage.GetLanguageConversion("Order_Summary"), "</a>&nbsp;></a>" };
                    ...
                    if (this.IsItemCompleted == 1)
                    {
                        ...
                        base.Navigation_Path(string.Concat(strArrays), string.Concat("&nbsp;", this.objLanguage.GetLanguageConversion("Order_Edit_Litho_Booklet")));
