<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="activity_taskeventreport.aspx.cs" Inherits="ePrint.client.activity_taskeventreport" %>--%>

<%@ page title="Task Report" language="C#" masterpagefile="~/Templates/innerMasterPage_withoutLeftTD.master" autoeventwireup="true" CodeBehind="activity_taskeventreport.aspx.cs" Inherits="ePrint.client.activity_taskeventreport" enableviewstatemac="false" enableEventValidation="false" theme="Theme1" %>
    ...
    <div id="reports">
                                                    ...
                                                    <ContentTemplate>
                                                        <telerik:RadMultiPage runat="server" ID="RadMultiPage3" SelectedIndex="0">
                                                            <telerik:RadPageView runat="server" ID="RadPageView3">
                                                                <div class="FilterJob">
                                                                    <div align="left">
                                                                        <span id="Span2" runat="server" class="smallgraytext act_paddingleft5px">(<%=objLangClass.GetLanguageConversion("Date_Filter_applied_on_Task_Event_DueDate")%>
                                                                            )</span>
        ...
        <div align="left" class="act_width100">
            ...
            <div id="divexport" runat="server">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="act_floatleft" nowrap="nowrap">
                                            <asp:TextBox ID="txt1" runat="server" Visible="false" CssClass="act_txtpage" onblur="javascript:AllowNumber(this,this.value)"></asp:TextBox>&nbsp;
                                        </td>
                                        <td>
                    ...
                    <div id="div_Main" runat="server">
                        ...
                        <div id="div_Grid">
                           <%-- <asp:GridView ID="GridEstReport" CssClass="t" runat="server" Width="100%" SkinID="GridStyleReport"
                                ...
                                RowStyle-VerticalAlign="Top" CellPadding="4" OnDataBound="GridTaskEventReport_DataBound">
                            </asp:GridView>--%>
                ...
                OnItemDataBound="GridTaskEventReport_DataBound" AllowAutomaticUpdates="false" Skin="RadGrid_Eprint_Skin"
                ...
                OnPageIndexChanged="GridTask_PageIndexChanged" OnNeedDataSource="GridTask_OnNeedDataSource"
                OnPageSizeChanged="GridTask_PageSizeChanged" PageSize="50" Visible="false" EnableAjaxSkinRendering="true" EnableViewState="true">
