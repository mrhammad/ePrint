...
namespace TemplateEditorFrontEnd
{
	public class TemplateDetails
	{
		...
		private string _cropedImageName;

		private string _cropedPDFName;
		...
		public string CropedImageName
		{
			get
			{
				return this._cropedImageName;
			}
			set
			{
				this._cropedImageName = value;
			}
		}

		public string CropedPDFName
		{
			get
			{
				return this._cropedPDFName;
			}
			set
			{
				this._cropedPDFName = value;
			}
		}
