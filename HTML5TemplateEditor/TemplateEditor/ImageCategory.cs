...
namespace TemplateEditor
{
    public class ImageCategory
    {
        ...
        public ImageCategory(long cImageID, long cCompanyID, long cCategoryID, long cUserID, string cUserType, string cOriginalFileName, string cFileName, long cFileSize, string cImageDescription, string cMetaTags, bool cIspdf)
        {
