<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="start.aspx.cs" Inherits="HTML5TemplateEditor.start" %>
...
<head id="Head1" runat="server">
    <title>Back End Templates</title>
    ...
    <style type="text/css">
        ...
        .linkfonts {
            ...
            .linkfonts:hover, .TemplateDiv:hover {
...
<body>
    <form id="form1" runat="server">
        <div class="maindiv">
            <div class="heading">
                <span style="font-size: 30px; font-family: Calibri; font-weight: bold; color: white;">Back End Templates</span>
            </div>
